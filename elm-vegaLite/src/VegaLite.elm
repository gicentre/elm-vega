...
{-| Generated by [loLeft](#loLeft), [loTopLeft](#loTopLeft), [loTopRight](#loTopRight),
...
{-| Generated by [ttEncoding](#ttEncoding) and [ttData](#ttData).
-}
type TooltipContent
    = TTEncoding
    | TTData
...
{-| Generated by [vaTop](#vaTop), [vaMiddle](#vaMiddle) and [vaBottom](#vaBottom).
-}
type VAlign
    = AlignTop
    | AlignMiddle
...
{-| Indicate tooltips are generated by data.
-}
...
{-| Indicate tooltips are generated by encoding (default).
-}
