...
var author$project$GalleryFacet$facet1 = function () {
	var trans = A2(
...
var author$project$GalleryFacet$facet4 = function () {
	var enc = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$VegaLite$biMaxBins(15)
								]))
						]))),
			A2(
				author$project$VegaLite$position,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(author$project$VegaLite$soByField, 'Horsepower', author$project$VegaLite$opMean),
							...
							[
								...
								_List_fromArray(
									[
										...
										author$project$VegaLite$axTitle('Time'),
		...
		author$project$VegaLite$row(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$VegaLite$hdTitle('Company')
						]))
				])));
	var des = author$project$VegaLite$description('Stock prices of four large companies as a small multiples of area charts');
	return author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				des,
				author$project$VegaLite$width(300),
				author$project$VegaLite$height(40),
...
var author$project$GalleryFacet$mySpecs = author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('facet1', author$project$GalleryFacet$facet1),
			_Utils_Tuple2('facet2', author$project$GalleryFacet$facet2),
			_Utils_Tuple2('facet3', author$project$GalleryFacet$facet3),
			_Utils_Tuple2('facet4', author$project$GalleryFacet$facet4),
			_Utils_Tuple2('facet5', author$project$GalleryFacet$facet5),
			_Utils_Tuple2('facet6', author$project$GalleryFacet$facet6),
			_Utils_Tuple2('facet7', author$project$GalleryFacet$facet7)
		]));
...
var author$project$GalleryFacet$main = elm$core$Platform$worker(
	{
		at: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$GalleryFacet$mySpecs,
				author$project$GalleryFacet$elmToJS(author$project$GalleryFacet$mySpecs))),
...
_Platform_export({'GalleryFacet':{'init':author$project$GalleryFacet$main(
