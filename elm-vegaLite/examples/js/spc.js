...
var author$project$Spc$Model = F2(
	function (num, spec) {
		return {B: num, D: spec};
	});
...
var author$project$Spc$elmToJS = _Platform_outgoingPort('elmToJS', elm$core$Basics$identity);
...
var author$project$Spc$mean = function (xs) {
	return _Utils_eq(xs, _List_Nil) ? 0 : (elm$core$List$sum(xs) / elm$core$List$length(xs));
};
var author$project$Spc$rawData = _List_fromArray(
	[
		_Utils_Tuple2('2011-01', 25.5),
		_Utils_Tuple2('2011-02', 25.7),
		_Utils_Tuple2('2011-03', 28.8),
		_Utils_Tuple2('2011-04', 31.3),
		_Utils_Tuple2('2011-05', 30.0),
		_Utils_Tuple2('2011-06', 29.0),
		_Utils_Tuple2('2011-07', 30.2),
		_Utils_Tuple2('2011-08', 28.7),
		_Utils_Tuple2('2011-09', 24.1),
		_Utils_Tuple2('2011-10', 24.2),
		_Utils_Tuple2('2011-11', 22.7),
		_Utils_Tuple2('2011-12', 20.8),
		_Utils_Tuple2('2012-01', 20.9),
		_Utils_Tuple2('2012-02', 20.9),
		_Utils_Tuple2('2012-03', 22.9),
		_Utils_Tuple2('2012-04', 20.6),
		_Utils_Tuple2('2012-05', 22.1),
		_Utils_Tuple2('2012-06', 20.4),
		_Utils_Tuple2('2012-07', 22.1),
		_Utils_Tuple2('2012-08', 20.3),
		_Utils_Tuple2('2012-09', 22.7),
		_Utils_Tuple2('2012-10', 22.9),
		_Utils_Tuple2('2012-11', 20.9),
		_Utils_Tuple2('2012-12', 21.4),
		_Utils_Tuple2('2013-01', 20.4),
		_Utils_Tuple2('2013-02', 19.1),
		_Utils_Tuple2('2013-03', 20.6),
		_Utils_Tuple2('2013-04', 18.5),
		_Utils_Tuple2('2013-05', 19.8),
		_Utils_Tuple2('2013-06', 20.6),
		_Utils_Tuple2('2013-07', 21.3),
		_Utils_Tuple2('2013-08', 21.4),
		_Utils_Tuple2('2013-09', 24.1),
		_Utils_Tuple2('2013-10', 22.9),
		_Utils_Tuple2('2013-11', 20.3),
		_Utils_Tuple2('2013-12', 20.8),
		_Utils_Tuple2('2014-01', 19.8),
		_Utils_Tuple2('2014-02', 19.0),
		_Utils_Tuple2('2014-03', 18.6),
		_Utils_Tuple2('2014-04', 17.6),
		_Utils_Tuple2('2014-05', 20.6),
		_Utils_Tuple2('2014-06', 20.1),
		_Utils_Tuple2('2014-07', 20.8),
		_Utils_Tuple2('2014-08', 21.9),
		_Utils_Tuple2('2014-09', 22.9),
		_Utils_Tuple2('2014-10', 21.3),
		_Utils_Tuple2('2014-11', 21.4),
		_Utils_Tuple2('2014-12', 21.1),
		_Utils_Tuple2('2015-01', 20.3),
		_Utils_Tuple2('2015-02', 18.5),
		_Utils_Tuple2('2015-03', 19.1),
		_Utils_Tuple2('2015-04', 17.8),
		_Utils_Tuple2('2015-05', 19.8),
		_Utils_Tuple2('2015-06', 19.9),
		_Utils_Tuple2('2015-07', 20.6),
		_Utils_Tuple2('2015-08', 21.4),
		_Utils_Tuple2('2015-09', 21.8),
		_Utils_Tuple2('2015-10', 20.6),
		_Utils_Tuple2('2015-11', 20.3),
		_Utils_Tuple2('2015-12', 21.4),
		_Utils_Tuple2('2016-01', 20.4),
		_Utils_Tuple2('2016-02', 19.8),
		_Utils_Tuple2('2016-03', 19.9),
		_Utils_Tuple2('2016-04', 19.5),
		_Utils_Tuple2('2016-05', 20.9),
		_Utils_Tuple2('2016-06', 20.3),
		_Utils_Tuple2('2016-07', 22.3),
		_Utils_Tuple2('2016-08', 21.8),
		_Utils_Tuple2('2016-09', 23.2),
		_Utils_Tuple2('2016-10', 22.7),
		_Utils_Tuple2('2016-11', 22.4),
		_Utils_Tuple2('2016-12', 23.9),
		_Utils_Tuple2('2017-01', 21.9),
		_Utils_Tuple2('2017-02', 21.3)
	]);
...
var author$project$Spc$meanCrimes = author$project$Spc$mean(
	A2(elm$core$List$map, elm$core$Tuple$second, author$project$Spc$rawData));
				...
				author$project$VegaLite$coView(
					_List_fromArray(
						[
							...
							author$project$VegaLite$vicoHeight(220)
						])))),
		author$project$VegaLite$configuration(
			author$project$VegaLite$coBackground('#fffff8'))),
	author$project$VegaLite$configuration(
		author$project$VegaLite$coAxis(
			_List_fromArray(
				[
					author$project$VegaLite$axcoLabelFont('ETBembo'),
					author$project$VegaLite$axcoTitleFont('ETBembo')
				]))))(_List_Nil);
...
var author$project$Spc$scanl = F2(
	function (fn, b) {
		var scan = F2(
			function (a, bs) {
				if (bs.b) {
...
var author$project$Spc$cusum = function (baseline) {
	return A2(
		elm$core$Basics$composeR,
		A2(
			author$project$Spc$scanl,
			F2(
				function (x, acc) {
					return acc + (x - baseline);
				}),
			0),
...
var author$project$Spc$cusumData = function (x) {
	var numCrimes = A2(elm$core$List$map, elm$core$Tuple$second, author$project$Spc$rawData);
	var month = A2(elm$core$List$map, elm$core$Tuple$first, author$project$Spc$rawData);
	var baseline = (x < 0) ? author$project$Spc$mean(numCrimes) : x;
	return A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					A2(
						...
						'month',
						author$project$VegaLite$strs(month))),
				A2(
					author$project$VegaLite$dataColumn,
					'crimes',
					author$project$VegaLite$nums(numCrimes))),
			A2(
				author$project$VegaLite$dataColumn,
				'cusum',
				author$project$VegaLite$nums(
					A2(author$project$Spc$cusum, baseline, numCrimes)))),
		A2(
			author$project$VegaLite$dataColumn,
			'zeroLine',
			author$project$VegaLite$nums(
...
var author$project$VegaLite$NYear = {$: 7};
var author$project$VegaLite$niYear = author$project$VegaLite$NYear;
...
var author$project$Spc$encCusum = A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$VegaLite$scNice(author$project$VegaLite$niYear)
							]))
					]))),
		A2(
			author$project$VegaLite$position,
	...
	author$project$VegaLite$color(
		_List_fromArray(
			[
				author$project$VegaLite$mStr('#777')
			])))(_List_Nil);
...
var author$project$Spc$cusum1 = function () {
	var specCusum = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
	...
	var encZeroLine = A2(
		...
		author$project$VegaLite$color(
			_List_fromArray(
				[
					author$project$VegaLite$mStr('rgb(62,156,167)')
				])));
	...
	return author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[specZeroLine, specCusum]))
			]));
}();
var author$project$Spc$cusum2 = function () {
	var specCusum = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				author$project$VegaLite$line(_List_Nil),
...
var author$project$VegaLite$AContent = 0;
var author$project$VegaLite$asContent = 0;
var author$project$VegaLite$AFit = 1;
var author$project$VegaLite$asFit = 1;
var author$project$VegaLite$VLAutosize = 5;
...
var author$project$Spc$cusumInteractive = function (baseline) {
	var specCusum = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				author$project$VegaLite$line(_List_Nil),
	...
	return author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[author$project$VegaLite$asFit, author$project$VegaLite$asContent])),
				author$project$Spc$cusumData(baseline),
				author$project$VegaLite$layer(
				_List_fromArray(
					[specZeroLine, specCusum]))
			]));
};
var author$project$Spc$dropWhile = F2(
...
var author$project$Spc$takeWhile = F2(
	function (predicate, list) {
		if (!list.b) {
			return _List_Nil;
		} else {
			...
			return predicate(hd) ? A2(
				elm$core$List$cons,
				hd,
				A2(author$project$Spc$takeWhile, predicate, tl)) : _List_Nil;
		}
	});
var author$project$Spc$pack = function (list) {
	if (!list.b) {
		return _List_Nil;
	} else {
		var hd = list.a;
		var tl = list.b;
		var restOfList = A2(
			author$project$Spc$dropWhile,
			function (a) {
				return _Utils_eq(hd, a);
			},
			list);
		return A2(
			elm$core$List$cons,
			A2(
				author$project$Spc$takeWhile,
				function (a) {
					return _Utils_eq(hd, a);
				},
				list),
			author$project$Spc$pack(restOfList));
	}
};
...
var author$project$Spc$runGroups = A2(
	elm$core$Basics$composeR,
	author$project$Spc$pack,
	A2(
		elm$core$Basics$composeR,
...
var author$project$Spc$shiftDirection = function () {
	var toDirection = function (shift) {
		switch (shift) {
			case 'upperOutlier':
				return 'above';
			case 'above2SD':
	...
	return elm$core$List$map(toDirection);
}();
...
var author$project$Spc$runs = F2(
	function (n, predicate) {
		var run = function (bs) {
			return (_Utils_cmp(
				elm$core$List$length(
					A2(elm$core$List$filter, elm$core$Basics$identity, bs)),
				n) > -1) ? A2(
				elm$core$List$map,
		...
		return A2(
			elm$core$Basics$composeR,
			elm$core$List$map(predicate),
			A2(
				elm$core$Basics$composeR,
				author$project$Spc$pack,
				elm$core$List$concatMap(run)));
	});
var elm$core$Basics$sqrt = _Basics_sqrt;
var author$project$Spc$stdevp = function (xs) {
	var av = author$project$Spc$mean(xs);
	return elm$core$Basics$sqrt(
		author$project$Spc$mean(
			A2(
				elm$core$List$map,
				function (x) {
					return (x - av) * (x - av);
...
var author$project$Spc$transpose = function (ll) {
	var tails = A2(elm$core$List$filterMap, elm$core$List$tail, ll);
	var heads = A2(elm$core$List$filterMap, elm$core$List$head, ll);
	return _Utils_eq(
		elm$core$List$length(heads),
		elm$core$List$length(ll)) ? A2(
		elm$core$List$cons,
		heads,
		author$project$Spc$transpose(tails)) : _List_Nil;
};
var author$project$Spc$shifts = function (xs) {
	var toShift = function (xss) {
		if ((((((xss.b && xss.b.b) && xss.b.b.b) && xss.b.b.b.b) && xss.b.b.b.b.b) && xss.b.b.b.b.b.b) && (!xss.b.b.b.b.b.b.b)) {
			var uOutlier = xss.a;
			var _n1 = xss.b;
			var lOutlier = _n1.a;
			var _n2 = _n1.b;
			...
			var _n5 = _n4.b;
			var beSd2 = _n5.a;
			return uOutlier ? 'upperOutlier' : (abSd2 ? 'above2SD' : (abM ? 'aboveMean' : (lOutlier ? 'lowerOutlier' : (beSd2 ? 'below2SD' : (beM ? 'belowMean' : 'normal')))));
		} else {
			return 'normal';
		}
	};
	var sd = author$project$Spc$stdevp(xs);
	var average = author$project$Spc$mean(xs);
	var belowSd2 = A2(
		elm$core$List$map,
		function (x) {
			return _Utils_cmp(x, average - (sd * 2)) < 0;
		},
		xs);
	var lowerOutlier = A2(
		elm$core$List$map,
		function (x) {
			return _Utils_cmp(x, average - (sd * 3)) < 0;
		},
		xs);
	var runAboveMean = A3(
		author$project$Spc$runs,
		7,
		function (x) {
			return _Utils_cmp(x, average) > 0;
		},
		xs);
	var runBelowMean = A3(
		author$project$Spc$runs,
	...
	return A2(
		elm$core$List$map,
		toShift,
		author$project$Spc$transpose(
			_List_fromArray(
				[upperOutlier, lowerOutlier, runAboveMean, runBelowMean, aboveSd2, belowSd2])));
};
var author$project$Spc$spcData = function () {
	var numCrimes = A2(elm$core$List$map, elm$core$Tuple$second, author$project$Spc$rawData);
	var shift = author$project$Spc$shifts(numCrimes);
	var shiftDir = author$project$Spc$shiftDirection(shift);
	var month = A2(elm$core$List$map, elm$core$Tuple$first, author$project$Spc$rawData);
	return A2(
		elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				A2(
					author$project$VegaLite$dataColumn,
					'shifts',
					author$project$VegaLite$strs(shift))),
			A2(
				author$project$VegaLite$dataColumn,
				'shiftDirection',
				author$project$VegaLite$strs(shiftDir))),
		A2(
			author$project$VegaLite$dataColumn,
			'groups',
			author$project$VegaLite$nums(
				author$project$Spc$runGroups(shiftDir))))(_List_Nil);
}();
...
var author$project$Spc$spc1 = function () {
	var enc = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$Spc$encLine = A2(
	elm$core$Basics$composeL,
	A2(
		elm$core$Basics$composeL,
		A2(
...
var author$project$VegaLite$Stdev = 14;
var author$project$VegaLite$opStdev = 14;
...
var author$project$Spc$sdLine = function (n) {
	var trans = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						A3(author$project$VegaLite$opAs, author$project$VegaLite$opMean, 'crimes', 'mean'),
						A3(author$project$VegaLite$opAs, author$project$VegaLite$opStdev, 'crimes', 'stdev')
					]),
				_List_Nil)),
		A2(
			author$project$VegaLite$calculateAs,
			'datum.mean + ' + (elm$core$String$fromFloat(n) + '*datum.stdev'),
			'sd'));
	var enc = A2(
		elm$core$Basics$composeL,
		A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$VegaLite$axGrid(false),
								author$project$VegaLite$axTitle('Crimes (thousands)')
							]))
					]))),
		author$project$VegaLite$color(
			_List_fromArray(
	...
	var dash = (elm$core$Basics$abs(n) === 1.5) ? _List_fromArray(
		[
			author$project$VegaLite$maStrokeDash(
			_List_fromArray(
				[12, 12]))
		]) : ((elm$core$Basics$abs(n) === 2) ? _List_fromArray(
		[
			author$project$VegaLite$maStrokeDash(
			_List_fromArray(
				[6, 6]))
		]) : ((elm$core$Basics$abs(n) === 3) ? _List_fromArray(
		[
			author$project$VegaLite$maStrokeDash(
			_List_fromArray(
				[3, 4]))
...
var author$project$Spc$shiftColours = author$project$VegaLite$categoricalDomainMap(
	_List_fromArray(
		[
			_Utils_Tuple2('above', 'rgb(202,0,32)'),
			_Utils_Tuple2('normal', 'rgb(119,119,119)'),
			_Utils_Tuple2('below', 'rgb(5,113,176)')
		]));
var author$project$Spc$shiftShapes = author$project$VegaLite$categoricalDomainMap(
	_List_fromArray(
		[
			_Utils_Tuple2('upperOutlier', 'triangle-up'),
			_Utils_Tuple2('above2SD', 'diamond'),
			_Utils_Tuple2('aboveMean', 'circle'),
			_Utils_Tuple2('normal', ' '),
			_Utils_Tuple2('belowMean', 'circle'),
...
var author$project$Spc$spc4 = function () {
...
var author$project$Spc$sdRegion = function (n) {
	var trans = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
		...
		A2(
			...
			'datum.mean - ' + (elm$core$String$fromFloat(n) + '*datum.stdev'),
			'lower'));
	var fillCol = (elm$core$Basics$abs(n) === 1.5) ? _List_fromArray(
		[
			author$project$VegaLite$maFill('#fffff8')
		]) : ((elm$core$Basics$abs(n) === 2) ? _List_fromArray(
		[
			author$project$VegaLite$maFill('rgb(247,251,244)')
		]) : ((elm$core$Basics$abs(n) === 3) ? _List_fromArray(
		[
			author$project$VegaLite$maFill('rgb(240,247,241)')
		]) : _List_fromArray(
		[
			author$project$VegaLite$maFill('rgb(234,244,238)')
		])));
	var enc = A2(
		elm$core$Basics$composeL,
		A2(
...
var author$project$Spc$spc5 = function () {
	var trans = A2(
		elm$core$Basics$composeL,
		author$project$VegaLite$transform,
		author$project$VegaLite$filter(
			author$project$VegaLite$fiExpr('datum.shiftDirection != \'normal\'')));
	var specLine = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$VegaLite$maStrokeWidth(1.4)
					])),
				author$project$Spc$encLine
			]));
	var encShifts = A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					A2(
						elm$core$List$map,
						author$project$Spc$sdRegion,
						_List_fromArray(
							[3.5, 3, 2, 1.5])),
					_List_fromArray(
						[
							author$project$Spc$sdLine(0),
							specLine,
							specShifts
						])))
			]));
...
var author$project$Spc$specs = author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('lineChart', author$project$Spc$spc1),
			_Utils_Tuple2('lineChartFormatted', author$project$Spc$spc2),
			_Utils_Tuple2('spcWithRules', author$project$Spc$spc3),
			_Utils_Tuple2('spcWithRulesAndPoints', author$project$Spc$spc4),
			_Utils_Tuple2('spcWithRegions', author$project$Spc$spc5),
			_Utils_Tuple2('cusumMean', author$project$Spc$cusum1),
			_Utils_Tuple2('cusumStrict', author$project$Spc$cusum2),
			_Utils_Tuple2(
			'cusumInteractive',
			author$project$Spc$cusumInteractive(author$project$Spc$meanCrimes))
		]));
var author$project$Spc$dynamicSpecs = function (x) {
	return author$project$VegaLite$combineSpecs(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'cusumInteractive',
				author$project$Spc$cusumInteractive(x))
			]));
};
...
var author$project$Spc$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var sliderVal = msg.a;
			var baseline = A2(
				...
				0,
				elm$core$String$toFloat(sliderVal));
			var newModel = _Utils_update(
				model,
				{
					B: baseline,
					D: author$project$Spc$dynamicSpecs(baseline)
				});
			return _Utils_Tuple2(
				newModel,
				author$project$Spc$elmToJS(newModel.D));
		} else {
			var baseline = author$project$Spc$meanCrimes;
			var newModel = _Utils_update(
				model,
				{
					B: baseline,
...
var author$project$Spc$Reset = {$: 1};
var author$project$Spc$Update = function (a) {
	return {$: 0, a: a};
};
...
var author$project$Spc$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('cusumInteractive')
					]),
				_List_Nil),
				A2(
				elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$core$String$fromFloat(model.B)),
								elm$html$Html$Events$onInput(author$project$Spc$Update)
							]),
						_List_Nil),
						elm$html$Html$text(
						' Baseline: ' + A2(
							...
							5,
							elm$core$String$fromFloat(model.B + 1.0e-4)))
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Spc$Reset)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Reset to average')
					]))
			]));
};
...
var author$project$Spc$main = elm$browser$Browser$element(
	{
		au: elm$core$Basics$always(
			_Utils_Tuple2(
				A2(author$project$Spc$Model, author$project$Spc$meanCrimes, author$project$Spc$specs),
				author$project$Spc$elmToJS(author$project$Spc$specs))),
		aA: elm$core$Basics$always(elm$core$Platform$Sub$none),
		aC: author$project$Spc$update,
		aE: author$project$Spc$view
	});
_Platform_export({'Spc':{'init':author$project$Spc$main(
