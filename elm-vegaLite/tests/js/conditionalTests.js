...
var author$project$ConditionalTests$markCondition1 = function () {
					...
					_List_fromArray(
						[
							...
							A2(
								...
								author$project$VegaLite$expr('datum.IMDB_Rating === null'),
								author$project$VegaLite$expr('datum.Rotten_Tomatoes_Rating === null')),
							_List_fromArray(
								[
	...
	var data = A2(author$project$VegaLite$dataFromUrl, 'data/movies.json', _List_Nil);
	var config = A2(
		elm$core$Basics$composeL,
...
var author$project$ConditionalTests$selectionCondition1 = function () {
	...
	var data = A2(author$project$VegaLite$dataFromUrl, 'data/cars.json', _List_Nil);
	return author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				data,
			...
			_List_fromArray(
				[
					...
					A2(
						...
						author$project$VegaLite$selectionName('alex'),
						author$project$VegaLite$selectionName('morgan')),
					_List_fromArray(
						[
							author$project$VegaLite$mAggregate(author$project$VegaLite$opCount),
							author$project$VegaLite$mName('*'),
...
var author$project$ConditionalTests$mySpecs = author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
...
var author$project$ConditionalTests$sourceExample = author$project$ConditionalTests$markCondition2;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$json$Json$Encode$encode, 2, author$project$ConditionalTests$sourceExample))
					]))
			]));
};
...
var author$project$ConditionalTests$main = elm$browser$Browser$element(
	{
		as: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$ConditionalTests$mySpecs,
				author$project$ConditionalTests$elmToJS(author$project$ConditionalTests$mySpecs))),
		ay: elm$core$Basics$always(elm$core$Platform$Sub$none),
		aA: F2(
			function (_n0, model) {
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}),
		aC: author$project$ConditionalTests$view
	});
