...
var author$project$NullTests$axis1 = function () {
	var enc = A2(
...
var author$project$NullTests$filter1 = function () {
	var enc = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$NullTests$filter2 = function () {
	var trans = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$NullTests$scaleEncode = function (enc) {
	var data = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$NullTests$scale0 = author$project$NullTests$scaleEncode(
	A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$NullTests$scale1 = author$project$NullTests$scaleEncode(
	A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$NullTests$scale3 = author$project$NullTests$scaleEncode(
	A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$NullTests$mySpecs = author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('axis1', author$project$NullTests$axis1),
			_Utils_Tuple2('scale0', author$project$NullTests$scale0),
			_Utils_Tuple2('scale1', author$project$NullTests$scale1),
			_Utils_Tuple2('scale2', author$project$NullTests$scale2),
			_Utils_Tuple2('scale3', author$project$NullTests$scale3),
			_Utils_Tuple2('scale4', author$project$NullTests$scale4),
			_Utils_Tuple2('scale5', author$project$NullTests$scale5),
			_Utils_Tuple2('filter1', author$project$NullTests$filter1),
			_Utils_Tuple2('filter2', author$project$NullTests$filter2)
		]));
var author$project$NullTests$sourceExample = author$project$NullTests$axis1;
...
var author$project$NullTests$view = function (spec) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$json$Json$Encode$encode, 2, author$project$NullTests$sourceExample))
					]))
			]));
};
...
var author$project$NullTests$main = elm$browser$Browser$element(
	{
		as: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$NullTests$mySpecs,
				author$project$NullTests$elmToJS(author$project$NullTests$mySpecs))),
		ay: elm$core$Basics$always(elm$core$Platform$Sub$none),
		aA: F2(
			function (_n0, model) {
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}),
		aC: author$project$NullTests$view
	});
_Platform_export({'NullTests':{'init':author$project$NullTests$main(
