...
var author$project$SortTests$sortQuant = F2(
	function (yField, sps) {
		var enc = A2(
...
var author$project$VegaLite$Ascending = {$: 0};
var author$project$VegaLite$soAscending = author$project$VegaLite$Ascending;
var author$project$SortTests$sortAsc = A2(
	author$project$SortTests$sortQuant,
	'Horsepower',
	_List_fromArray(
...
var author$project$SortTests$sortCustom = function () {
	var enc = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$SortTests$sortDesc = A2(
	author$project$SortTests$sortQuant,
	'Horsepower',
	_List_fromArray(
...
var author$project$SortTests$sortWeight = A2(
	author$project$SortTests$sortQuant,
	'Weight_in_lbs',
	_List_fromArray(
		[
...
var author$project$SortTests$stack1 = function () {
	var trans = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
...
var author$project$SortTests$mySpecs = author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('sortAsc', author$project$SortTests$sortAsc),
			_Utils_Tuple2('sortDesc', author$project$SortTests$sortDesc),
			_Utils_Tuple2('sortWeight', author$project$SortTests$sortWeight),
			_Utils_Tuple2('sortCustom', author$project$SortTests$sortCustom),
			_Utils_Tuple2('stack1', author$project$SortTests$stack1)
		]));
var author$project$SortTests$sourceExample = author$project$SortTests$stack1;
...
var author$project$SortTests$view = function (spec) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$json$Json$Encode$encode, 2, author$project$SortTests$sourceExample))
					]))
			]));
};
...
var author$project$SortTests$main = elm$browser$Browser$element(
	{
		as: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$SortTests$mySpecs,
				author$project$SortTests$elmToJS(author$project$SortTests$mySpecs))),
		ay: elm$core$Basics$always(elm$core$Platform$Sub$none),
		aA: F2(
			function (_n0, model) {
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}),
		aC: author$project$SortTests$view
	});
_Platform_export({'SortTests':{'init':author$project$SortTests$main(
