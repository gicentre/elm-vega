...
var author$project$CompositeTests$main = elm$core$Platform$worker(
	{
		at: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$CompositeTests$mySpecs,
				author$project$CompositeTests$elmToJS(author$project$CompositeTests$mySpecs))),
