...
var author$project$EventTests$mySpecs = author$project$Vega$combineSpecs(
	_List_fromArray(
		[
...
var author$project$EventTests$sourceExample = author$project$EventTests$eventStream1;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$json$Json$Encode$encode, 2, author$project$EventTests$sourceExample))
					]))
			]));
};
...
var author$project$EventTests$main = elm$browser$Browser$element(
	{
		as: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$EventTests$mySpecs,
				author$project$EventTests$elmToJS(author$project$EventTests$mySpecs))),
		ay: elm$core$Basics$always(elm$core$Platform$Sub$none),
		aA: F2(
			function (_n0, model) {
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}),
		aC: author$project$EventTests$view
	});
