...
var $author$project$EventTests$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$EventTests$eventStream1 = function () {
	var si = A2(
...
var $author$project$Vega$INumber = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$iNumber = $author$project$Vega$INumber;
...
var $author$project$Vega$ITime = function (a) {
	return {$: 7, a: a};
};
...
var $author$project$EventTests$uiEvents = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										$author$project$Vega$siValue($author$project$Vega$black),
										$author$project$Vega$siBind(
						...
						_List_fromArray(
							[
								...
								$author$project$Vega$iText(
									_List_fromArray(
										[
											$author$project$Vega$inPlaceholder('Type label here')
										])))
							]))),
				A2(
					$author$project$Vega$signal,
					...
					_List_fromArray(
						[
							...
							$author$project$Vega$siBind(
							$author$project$Vega$iNumber(_List_Nil))
						]))),
			A2(
				$author$project$Vega$signal,
				'borderWidth',
				_List_fromArray(
					[
						$author$project$Vega$siValue(
						$author$project$Vega$vStr('medium')),
						$author$project$Vega$siBind(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siValue(
					$author$project$Vega$vStr('12:00')),
					$author$project$Vega$siBind(
					$author$project$Vega$iTime(_List_Nil))
				])));
	var mk = A2(
		$elm$core$Basics$composeL,
		A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vSignal('rFill ? 1 : 0')
											])),
										$author$project$Vega$maFill(
										_List_fromArray(
											[
												$author$project$Vega$vSignal('rColor')
											])),
										$author$project$Vega$maStroke(
										_List_fromArray(
											[
												$author$project$Vega$vSignal('borderColor')
											])),
										$author$project$Vega$maStrokeWidth(
										_List_fromArray(
											[
												$author$project$Vega$vSignal('borderWidth == \'thin\' ? 1 : borderWidth == \'medium\' ? 4 : 10')
											])),
										$author$project$Vega$maWidth(
										_List_fromArray(
											[
												$author$project$Vega$vSignal('rSize')
											])),
										$author$project$Vega$maHeight(
										_List_fromArray(
											[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('rSize / 2')
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('rLabel +\' \'+ timestamp')
										])),
									$author$project$Vega$maFill(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('rColor == \'black\' && rFill ? \'white\' : \'black\'')
										])),
									$author$project$Vega$maFontSize(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('labelSize')
										]))
								]))
						]))
				])));
...
var $author$project$EventTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('uiEvents', $author$project$EventTests$uiEvents),
		_Utils_Tuple2('eventStream1', $author$project$EventTests$eventStream1)
	]);
...
var $author$project$EventTests$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var srcName = msg.a;
			return _Utils_Tuple2(
				A2(
					...
					A2(
						$elm$core$Dict$get,
						srcName,
						$elm$core$Dict$fromList($author$project$EventTests$specs))),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2($elm$json$Json$Encode$null, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$EventTests$NewSource = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$EventTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$EventTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$EventTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$EventTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$EventTests$elmToJS(
					$author$project$Vega$combineSpecs($author$project$EventTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$EventTests$update,
		aA: $author$project$EventTests$view
	});
_Platform_export({'EventTests':{'init':$author$project$EventTests$main(
