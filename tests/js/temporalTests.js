...
var $author$project$Vega$Month = {$: 1};
...
var $author$project$TemporalTests$mySpecs = $author$project$Vega$combineSpecs(
	_List_fromArray(
		[
...
var $author$project$TemporalTests$sourceExample = $author$project$TemporalTests$temporalTest2;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$TemporalTests$sourceExample))
					]))
			]));
};
var $author$project$TemporalTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$TemporalTests$mySpecs,
				$author$project$TemporalTests$elmToJS($author$project$TemporalTests$mySpecs))),
