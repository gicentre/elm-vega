...
var $author$project$TemporalTests$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$Vega$AxLabelAngle = function (a) {
	return {$: 25, a: a};
};
var $author$project$Vega$axLabelAngle = $author$project$Vega$AxLabelAngle;
var $author$project$Vega$AxTemporalTickCount = F2(
	function (a, b) {
		return {$: 50, a: a, b: b};
	});
var $author$project$Vega$axTemporalTickCount = $author$project$Vega$AxTemporalTickCount;
...
var $author$project$Vega$month = $author$project$Vega$Month;
...
var $author$project$TemporalTests$temporalTest1 = function () {
	var sc = A2(
	...
	var ds = $author$project$Vega$dataSource(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$Vega$trFormula, 'datetime(year(datum.date),month(datum.date),0,0,0,0,0)', 'year'),
		...
		A2(
			...
			A3(
				...
				_List_fromArray(
					[
						A2(
						$author$project$Vega$axTemporalTickCount,
						$author$project$Vega$month,
						$author$project$Vega$num(1)),
						$author$project$Vega$axLabelAngle(
						$author$project$Vega$num(60)),
...
var $author$project$Vega$LeTemporalTickCount = F2(
	function (a, b) {
		return {$: 64, a: a, b: b};
	});
var $author$project$Vega$leTemporalTickCount = $author$project$Vega$LeTemporalTickCount;
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('binned'),
								$author$project$Vega$daField(
								$author$project$Vega$field('meanDate'))
							]))),
		...
		$author$project$Vega$legend(
			_List_fromArray(
				[
					...
					$author$project$Vega$str('%b %Y')),
					A2(
					$author$project$Vega$leTemporalTickCount,
					$author$project$Vega$month,
		...
		_List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$daSource('timeData')
						])))
			]));
	var ax = A2(
		$elm$core$Basics$composeL,
		...
		A3(
			...
			_List_fromArray(
				[
					$author$project$Vega$axTitle(
					$author$project$Vega$str('temperature (C)'))
				])));
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
...
var $author$project$TemporalTests$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var srcName = msg.a;
			return _Utils_Tuple2(
				A2(
					...
					A2(
						$elm$core$Dict$get,
						srcName,
						$elm$core$Dict$fromList($author$project$TemporalTests$specs))),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2($elm$json$Json$Encode$null, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$TemporalTests$NewSource = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$TemporalTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$TemporalTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$TemporalTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$TemporalTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$TemporalTests$elmToJS(
					$author$project$Vega$combineSpecs($author$project$TemporalTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$TemporalTests$update,
		aA: $author$project$TemporalTests$view
	});
_Platform_export({'TemporalTests':{'init':$author$project$TemporalTests$main(
