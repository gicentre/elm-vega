...
var $author$project$Vega$MCornerRadiusBL = function (a) {
	return {$: 28, a: a};
};
var $author$project$Vega$maCornerRadiusBottomLeft = $author$project$Vega$MCornerRadiusBL;
var $author$project$Vega$MCornerRadiusBR = function (a) {
	return {$: 29, a: a};
};
var $author$project$Vega$maCornerRadiusBottomRight = $author$project$Vega$MCornerRadiusBR;
var $author$project$Vega$MCornerRadiusTL = function (a) {
	return {$: 26, a: a};
};
var $author$project$Vega$maCornerRadiusTopLeft = $author$project$Vega$MCornerRadiusTL;
var $author$project$Vega$MCornerRadiusTR = function (a) {
	return {$: 27, a: a};
};
var $author$project$Vega$maCornerRadiusTopRight = $author$project$Vega$MCornerRadiusTR;
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$maCornerRadiusTopLeft(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('topLeft? cornerRadiusTopLeft : null')
										])),
									$author$project$Vega$maCornerRadiusTopRight(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('topRight? cornerRadiusTopRight : null')
										])),
									$author$project$Vega$maCornerRadiusBottomLeft(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('bottomLeft? cornerRadiusBottomLeft: null')
										])),
									$author$project$Vega$maCornerRadiusBottomRight(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('bottomRight? cornerRadiusBottomRight: null')
										])),
									$author$project$Vega$maStrokeWidth(
									_List_fromArray(
										[
...
var $author$project$Vega$maStrokeJoin = $author$project$Vega$MStrokeJoin;
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siValue(
						$author$project$Vega$vStr('miter')),
						$author$project$Vega$siBind(
						$author$project$Vega$iRadio(
							_List_fromArray(
								[
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$maScaleX(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('scaleX')
										])),
									$author$project$Vega$maScaleY(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('scaleY')
										])),
									...
									$author$project$Vega$maStrokeJoin(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('strokeJoin')
										])),
									$author$project$Vega$maFillOpacity(
									_List_fromArray(
										[
...
var $author$project$Vega$GrR1 = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$grR1 = $author$project$Vega$GrR1;
var $author$project$Vega$GrR2 = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$grR2 = $author$project$Vega$GrR2;
var $author$project$Vega$GrRadial = 1;
var $author$project$Vega$grRadial = 1;
var $author$project$Vega$GrStops = function (a) {
	return {$: 6, a: a};
};
var $author$project$Vega$grStops = $author$project$Vega$GrStops;
var $author$project$Vega$GrX1 = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$grX1 = $author$project$Vega$GrX1;
var $author$project$Vega$GrX2 = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$grX2 = $author$project$Vega$GrX2;
var $author$project$Vega$GrY1 = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vega$grY1 = $author$project$Vega$GrY1;
var $author$project$Vega$GrY2 = function (a) {
	return {$: 3, a: a};
};
var $author$project$Vega$grY2 = $author$project$Vega$GrY2;
var $author$project$Vega$Num = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$num = $author$project$Vega$Num;
var $author$project$Vega$VGradient = F2(
	function (a, b) {
		return {$: 11, a: a, b: b};
	});
var $author$project$Vega$vGradient = $author$project$Vega$VGradient;
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2(
											$author$project$Vega$vGradient,
											$author$project$Vega$grRadial,
											_List_fromArray(
												[
													$author$project$Vega$grStops(
													_List_fromArray(
														[
															_Utils_Tuple2(
													...
													$author$project$Vega$grX1(
													$author$project$Vega$num(0.2)),
													$author$project$Vega$grX2(
													$author$project$Vega$num(0.3)),
													$author$project$Vega$grY1(
													$author$project$Vega$num(0.8)),
													$author$project$Vega$grY2(
													$author$project$Vega$num(0.7)),
													$author$project$Vega$grR1(
													$author$project$Vega$num(0.3)),
													$author$project$Vega$grR2(
													$author$project$Vega$num(0.8))
												]))
										]))
								])),
...
var $author$project$MarkTests$shapeTest = function () {
	var projs = $author$project$Vega$inOptions(
		$author$project$Vega$vStrs(
			_List_fromArray(
				['albers', 'albersUsa', 'azimuthalEqualArea', 'azimuthalEquidistant', 'conicConformal', 'conicEqualArea', 'conicEquidistant', 'equalEarth', 'equirectangular', 'gnomonic', 'mercator', 'orthographic', 'stereographic', 'transverseMercator'])));
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$maLineBreak(
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$maLineHeight(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('fontSize*1.2')
										]))
								])),
							$author$project$Vega$enHover(
							_List_fromArray(
...
var $author$project$MarkTests$specs = _List_fromArray(
	[
...
var $author$project$MarkTests$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var srcName = msg.a;
			return _Utils_Tuple2(
				A2(
					...
					A2(
						$elm$core$Dict$get,
						srcName,
						$elm$core$Dict$fromList($author$project$MarkTests$specs))),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2($elm$json$Json$Encode$null, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$MarkTests$NewSource = function (a) {
	return {$: 0, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$MarkTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$MarkTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$MarkTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$MarkTests$elmToJS(
					$author$project$Vega$combineSpecs($author$project$MarkTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$MarkTests$update,
		aA: $author$project$MarkTests$view
	});
