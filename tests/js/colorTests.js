...
var $author$project$Vega$GrLinear = 0;
var $author$project$Vega$grLinear = 0;
...
var $author$project$Vega$MBlend = function (a) {
	return {$: 11, a: a};
};
var $author$project$Vega$maBlend = $author$project$Vega$MBlend;
...
var $author$project$ColorTests$colorTest1 = function () {
	var si = A2(
	...
	var ellipse = function () {
		var thetas = A2(
			$elm$core$List$map,
			function (n) {
				return ((2 * $elm$core$Basics$pi) / 40) * n;
			},
			A2($elm$core$List$range, 0, 40));
		var rminor = 0.3;
		var pair = function (t) {
			var y = rminor * $elm$core$Basics$sin(t);
			var x = $elm$core$Basics$cos(t);
	...
	var ellipseEncoding = F2(
		function (c, a) {
			var _v0 = (a < 0) ? _Utils_Tuple2(1, 0) : ((a > 0) ? _Utils_Tuple2(0.1, 1) : _Utils_Tuple2(1, 0));
			var y1 = _v0.a;
			var y2 = _v0.b;
			var _v1 = (a < 0) ? _Utils_Tuple2(1, 0) : ((a > 0) ? _Utils_Tuple2(0.7, 0.3) : _Utils_Tuple2(0.5, 0.5));
			var x1 = _v1.a;
			var x2 = _v1.b;
			return _List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													$author$project$Vega$num(x1)),
													$author$project$Vega$grX2(
													$author$project$Vega$num(x2)),
													$author$project$Vega$grY1(
													$author$project$Vega$num(y1)),
													$author$project$Vega$grY2(
													$author$project$Vega$num(y2))
												]))
										])),
									...
									_List_fromArray(
										[
											$author$project$Vega$vStr(ellipse)
										])),
									$author$project$Vega$maAngle(
									_List_fromArray(
										[
											$author$project$Vega$vNum(a)
										])),
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$maBlend(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('blend')
										]))
								])),
		...
		A2(
			...
			A2(
				...
				A2(
					...
					A2(ellipseEncoding, '#f00', 45))),
			A2(
				$author$project$Vega$mark,
				$author$project$Vega$path,
				A2(ellipseEncoding, '#0f0', 0))),
		A2(
			$author$project$Vega$mark,
			$author$project$Vega$path,
			A2(ellipseEncoding, '#00f', -45)));
	var ax = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$ColorTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('colorTest1', $author$project$ColorTests$colorTest1)
	]);
		...
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				...
				$author$project$ColorTests$elmToJS(
					$author$project$Vega$combineSpecs($author$project$ColorTests$specs)))),
