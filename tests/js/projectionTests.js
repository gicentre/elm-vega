...
var $author$project$ProjectionTests$projTest = function () {
	var si = A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('[mapWidth / 2, mapHeight / 2]')
				])));
	var nestedSi = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siUpdate('mapWidth')
					]))),
		A2(
			$author$project$Vega$signal,
			'height',
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('mapHeight')
				])));
	var nestedPr = A2(
		$elm$core$Basics$composeL,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$numSignal('parent.data === \'orthographic\' ? projScale * 2 : projScale')),
					$author$project$Vega$prTranslate(
					$author$project$Vega$numSignal('projTranslate'))
				])));
	var nestedMk = A2(
		$elm$core$Basics$composeL,
		A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vSignal('mapHeight -5')
											])),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('mapWidth')
										])),
									$author$project$Vega$maHeight(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('mapHeight')
										])),
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$str($author$project$ProjectionTests$dPath + 'world-110m.json')),
...
var $author$project$ProjectionTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('projTest', $author$project$ProjectionTests$projTest)
	]);
			...
			[
				...
				A2(
					...
					A2(
						...
						$author$project$ProjectionTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$ProjectionTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$ProjectionTests$elmToJS(
					$author$project$Vega$combineSpecs($author$project$ProjectionTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$ProjectionTests$update,
		aA: $author$project$ProjectionTests$view
	});
