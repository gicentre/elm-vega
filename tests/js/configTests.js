...
var $author$project$ConfigTests$mySpecs = $author$project$Vega$combineSpecs(
	_List_fromArray(
		[
...
var $author$project$ConfigTests$sourceExample = $author$project$ConfigTests$configTest9;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$ConfigTests$sourceExample))
					]))
			]));
};
var $author$project$ConfigTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$ConfigTests$mySpecs,
				$author$project$ConfigTests$elmToJS($author$project$ConfigTests$mySpecs))),
