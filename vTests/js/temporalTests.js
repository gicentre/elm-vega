...
var _user$project$TemporalTests$temporalTest1 = function () {
					...
					_0: _user$project$Vega$mFrom(
						{
							ctor: '::',
							_0: _user$project$Vega$srData(
								_user$project$Vega$str('timeData')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
											...
											_0: _user$project$Vega$maY(
												{
													...
													_1: {
														ctor: '::',
														_0: _user$project$Vega$vField(
															_user$project$Vega$field('meanTemperature')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
		...
		return _user$project$Vega$axes(
			A4(
				...
				_user$project$Vega$SBottom,
				{
					ctor: '::',
					_0: A2(
						_user$project$Vega$axTemporalTickCount,
						_user$project$Vega$Month,
						_user$project$Vega$num(1)),
					_1: {
						ctor: '::',
						_0: _user$project$Vega$axLabelAngle(
							_user$project$Vega$num(60)),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$axLabelAlign(_user$project$Vega$AlignLeft),
							_1: {ctor: '[]'}
						}
					}
				},
	...
	return _user$project$Vega$toVega(
		{
			ctor: '::',
			_0: _user$project$Vega$width(800),
			_1: {
				ctor: '::',
				_0: _user$project$Vega$height(200),
				_1: {
...
var _user$project$TemporalTests$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _user$project$TemporalTests$mySpecs,
			_1: _user$project$TemporalTests$elmToJS(_user$project$TemporalTests$mySpecs)
		},
...
var Elm = {};
Elm['TemporalTests'] = Elm['TemporalTests'] || {};
if (typeof _user$project$TemporalTests$main !== 'undefined') {
    _user$project$TemporalTests$main(Elm['TemporalTests'], 'TemporalTests', undefined);
}
