...
var _user$project$Vega$axisProperty = function (ap) {
	...
	switch (_p129.ctor) {
		...
		case 'AxTemporalTickCount':
			...
			switch (_p136.ctor) {
				case 'Num':
					return (_elm_lang$core$Native_Utils.cmp(_p136._0, 0) < 1) ? {
						ctor: '_Tuple2',
						_0: 'tickCount',
						_1: _user$project$Vega$timeUnitSpec(_p138)
					} : {
						ctor: '_Tuple2',
						_0: 'tickCount',
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'step',
										_1: _user$project$Vega$numSpec(_p137)
									},
									_1: {ctor: '[]'}
								}
							})
	...
	switch (_p139.ctor) {
		case 'EnLegend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p139._0))
			};
		case 'EnTitle':
			return {
				ctor: '_Tuple2',
	...
	switch (_p140.ctor) {
		case 'LeType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _user$project$Vega$legendTypeSpec(_p140._0)
			};
		case 'LeDirection':
			return {
				ctor: '_Tuple2',
				_0: 'direction',
				_1: _user$project$Vega$orientationSpec(_p140._0)
			};
		case 'LeOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$legendOrientSpec(_p140._0)
			};
		case 'LeFill':
			return {
				ctor: '_Tuple2',
		...
		case 'LeEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$legendEncodingProperty, _p140._0))
			};
		case 'LeFormat':
			return {
				ctor: '_Tuple2',
				_0: 'format',
				_1: _user$project$Vega$strSpec(_p140._0)
			};
		case 'LeGridAlign':
			return {
				ctor: '_Tuple2',
				_0: 'gridAlign',
				_1: _user$project$Vega$gridAlignSpec(_p140._0)
			};
		case 'LeClipHeight':
			return {
				ctor: '_Tuple2',
				_0: 'clipHeight',
				_1: _user$project$Vega$numSpec(_p140._0)
			};
		case 'LeColumns':
			return {
				ctor: '_Tuple2',
		...
		case 'LeOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$valueSpec(_p140._0)
			};
		case 'LePadding':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelAlign':
			return {
				ctor: '_Tuple2',
				_0: 'labelAlign',
				_1: _user$project$Vega$hAlignSpec(_p140._0)
			};
		case 'LeLabelBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'labelBaseline',
				_1: _user$project$Vega$vAlignSpec(_p140._0)
			};
		case 'LeLabelColor':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelOverlap':
			return {
				ctor: '_Tuple2',
				_0: 'labelOverlap',
				_1: _user$project$Vega$overlapStrategySpec(_p140._0)
			};
		...
		case 'LeSymbolType':
			return {
				ctor: '_Tuple2',
				_0: 'symbolType',
				_1: _user$project$Vega$symbolSpec(_p140._0)
			};
		case 'LeTickCount':
			return {
				ctor: '_Tuple2',
		...
		case 'LeTemporalTickCount':
			...
			switch (_p141.ctor) {
				case 'Num':
					return (_elm_lang$core$Native_Utils.cmp(_p141._0, 0) < 1) ? {
						ctor: '_Tuple2',
						_0: 'tickCount',
						_1: _user$project$Vega$timeUnitSpec(_p143)
					} : {
						ctor: '_Tuple2',
						_0: 'tickCount',
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'step',
										_1: _user$project$Vega$numSpec(_p142)
									},
									_1: {ctor: '[]'}
								}
							})
		...
		case 'LeValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p140._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p144.ctor) {
		case 'TText':
			return {
				ctor: '_Tuple2',
				_0: 'text',
				_1: _user$project$Vega$strSpec(_p144._0)
			};
		case 'TOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$sideSpec(_p144._0)
			};
		case 'TAnchor':
			return {
				ctor: '_Tuple2',
				_0: 'anchor',
				_1: _user$project$Vega$anchorSpec(_p144._0)
			};
		case 'TAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'TBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'baseline',
				_1: _user$project$Vega$vAlignSpec(_p144._0)
			};
		case 'TColor':
			return {
				ctor: '_Tuple2',
		...
		case 'TEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p144._0))
			};
		case 'TFont':
			return {
				ctor: '_Tuple2',
		...
		case 'TFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _user$project$Vega$valueSpec(_p144._0)
			};
		case 'TFrame':
			return {
				ctor: '_Tuple2',
				_0: 'fame',
				_1: _user$project$Vega$titleFrameSpec(_p144._0)
			};
		case 'TInteractive':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$windowOperationProperties = function (wos) {
	var windowAsSpec = function (wo) {
		...
		if (_p145.ctor === 'WnOperation') {
			return _elm_lang$core$Json_Encode$string(_p145._3);
		} else {
			return _elm_lang$core$Json_Encode$string(_p145._3);
		}
	};
	var windowFieldSpec = function (wo) {
		...
		if (_p146.ctor === 'WnOperation') {
			...
			var _p148 = _p146._2;
			if (_p148.ctor === 'Just') {
				return _user$project$Vega$fieldSpec(_p148._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		}
	...
	var windowParamSpec = function (wo) {
		...
		if (_p149.ctor === 'WnOperation') {
			...
			var _p151 = _p149._1;
			if (_p151.ctor === 'Just') {
				return _user$project$Vega$numSpec(_p151._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		}
	...
	var windowOpSpec = function (wo) {
		...
		if (_p152.ctor === 'WnOperation') {
			return _user$project$Vega$wOperationSpec(_p152._0);
		} else {
			return _user$project$Vega$opSpec(_p152._0);
		}
	};
	return {
		ctor: '::',
	...
	switch (_p153.ctor) {
		case 'WnSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$comparatorProperties(_p153._0))
			};
		case 'WnGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p153._0))
			};
		case 'WnFrame':
			return A3(_user$project$Vega$numArrayProperty, 2, 'frame', _p153._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'ignorePeers',
				_1: _user$project$Vega$booSpec(_p153._0)
			};
	}
};
	...
	switch (_p154.ctor) {
		case 'WcFont':
			return {
				ctor: '_Tuple2',
				_0: 'font',
				_1: _user$project$Vega$strSpec(_p154._0)
			};
		case 'WcFontStyle':
			return {
				ctor: '_Tuple2',
		...
		case 'WcFontSizeRange':
			return A3(_user$project$Vega$numArrayProperty, 2, 'fontSizeRange', _p154._0);
		case 'WcPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
		...
		case 'WcSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p154._0);
		case 'WcSpiral':
			return {
				ctor: '_Tuple2',
				_0: 'spiral',
				_1: _user$project$Vega$spiralSpec(_p154._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$transformSpec = function (trans) {
	...
	switch (_p155.ctor) {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$aggregateProperty, _p155._0)
				});
		case 'TBin':
			var _p157 = _p155._1;
				...
				if (_p156.ctor === 'Num') {
					return A2(
						...
						A2(
							...
							_elm_lang$core$Basics$toString(_p157)),
						_elm_lang$core$Json_Encode$null);
				} else {
					return _user$project$Vega$numSpec(_p157);
				}
			}();
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'field',
							_1: _user$project$Vega$fieldSpec(_p155._0)
						},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'extent', _1: extSpec},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$binProperty, _p155._2)
						}
					}
				});
		case 'TCollect':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_0: 'sort',
							_1: _elm_lang$core$Json_Encode$object(
								_user$project$Vega$comparatorProperties(_p155._0))
						},
						_1: {ctor: '[]'}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$countPatternProperty, _p155._1)
					}
				});
		case 'TCross':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$crossProperty, _p155._0)
				});
		case 'TCrossFilter':
			var _p158 = _elm_lang$core$List$unzip(_p155._0);
			var fs = _p158._0;
			var nums = _p158._1;
			return _elm_lang$core$Json_Encode$object(
				{
		...
		case 'TCrossFilterAsSignal':
			var _p159 = _elm_lang$core$List$unzip(_p155._0);
			var fs = _p159._0;
			var nums = _p159._1;
			return _elm_lang$core$Json_Encode$object(
				{
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'signal',
									_1: _elm_lang$core$Json_Encode$string(_p155._1)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'distribution',
							_1: _user$project$Vega$distributionSpec(_p155._0)
						},
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$densityProperty, _p155._1)
					}
				});
		case 'TExtent':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Vega$exprProperty(_p155._0),
						_1: {ctor: '[]'}
					}
				});
		case 'TFlatten':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_0: 'fields',
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p155._0))
						},
						_1: {ctor: '[]'}
					}
				});
					...
					_1: {
						...
						_1: {
							...
							_0: {
								...
								_0: 'as',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p155._1))
							},
							_1: {ctor: '[]'}
						}
					}
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'fields',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p161))
							},
							_1: {ctor: '[]'}
						}
					});
									...
									_1: _elm_lang$core$Json_Encode$list(
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$string(_p165),
												_1: {ctor: '[]'}
											}
										})
								},
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'fields',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p163))
							},
							_1: {
								ctor: '::',
								_0: {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'expr',
							_1: _user$project$Vega$expressionSpec(_p155._0)
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'initonly',
									_1: _user$project$Vega$formulaUpdateSpec(_p155._2)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'as',
							_1: _elm_lang$core$Json_Encode$string(_p155._0)
						},
						_1: {ctor: '[]'}
					}
				});
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'key',
								_1: _user$project$Vega$fieldSpec(_p155._1)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$imputeProperty, _p155._2)
						}
					}
				});
		case 'TJoinAggregate':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$joinAggregateProperty, _p155._0)
				});
		case 'TLookup':
			return _elm_lang$core$Json_Encode$object(
				{
						...
						_1: {
							...
							_1: {
								...
								_0: {
									...
									_0: 'fields',
									_1: _elm_lang$core$Json_Encode$list(
										A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p155._2))
								},
								_1: A2(_elm_lang$core$List$map, _user$project$Vega$lookupProperty, _p155._3)
							}
						}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$pivotProperty, _p155._2)
						}
					}
				});
		case 'TProject':
			var _p166 = _elm_lang$core$List$unzip(_p155._0);
			var fields = _p166._0;
			var names = _p166._1;
			return _elm_lang$core$Json_Encode$object(
				{
			...
			var stepProp = function () {
				...
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'step',
						_1: _user$project$Vega$numSpec(_p168)
					},
					_1: {ctor: '[]'}
				};
			}();
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'stop',
									_1: _user$project$Vega$numSpec(_p155._1)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Vega$windowOperationProperties(_p155._0),
						A2(_elm_lang$core$List$map, _user$project$Vega$windowProperty, _p155._1))
				});
		case 'TContour':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								{
									ctor: '::',
									_0: _user$project$Vega$numSpec(_p155._0),
									_1: {
										ctor: '::',
										_0: _user$project$Vega$numSpec(_p155._1),
										_1: {ctor: '[]'}
									}
								})
						},
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$contourProperty, _p155._2)
					}
				});
		case 'TGeoJson':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoJsonProperty, _p155._0)
				});
		case 'TGeoPath':
			var _p171 = _p155._0;
			var _p170 = _p155._1;
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p170)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'projection',
								_1: _elm_lang$core$Json_Encode$string(_p171)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p170)
						}
					});
						...
						_1: {
							...
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _user$project$Vega$fieldSpec(_p155._1),
										_1: {
											ctor: '::',
											_0: _user$project$Vega$fieldSpec(_p155._2),
											_1: {ctor: '[]'}
										}
									})
							},
							...
							_1: {
								...
								_0: {
									...
									_1: _elm_lang$core$Json_Encode$list(
										{
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$string(_p155._3),
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$string(_p155._4),
												_1: {ctor: '[]'}
											}
										})
								},
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p173)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'projection',
								_1: _elm_lang$core$Json_Encode$string(_p174)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p173)
						}
					});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$graticuleProperty, _p155._0)
				});
		case 'TLinkPath':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$linkPathProperty, _p155._0)
				});
		case 'TPie':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$pieProperty, _p155._0)
				});
		case 'TStack':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$stackProperty, _p155._0)
				});
		case 'TForce':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$forceSimulationProperty, _p155._0)
				});
		case 'TVoronoi':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$voronoiProperty, _p155._2)
						}
					}
				});
		case 'TWordcloud':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$wordcloudProperty, _p155._0)
				});
		case 'TNest':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'generate',
								_1: _user$project$Vega$booSpec(_p155._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$packProperty, _p155._0)
				});
		case 'TPartition':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$partitionProperty, _p155._0)
				});
		case 'TTree':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$treeProperty, _p155._0)
				});
		case 'TTreemap':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$treemapProperty, _p155._0)
				});
		default:
			return _elm_lang$core$Json_Encode$object(
				{
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p175._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _user$project$Vega$clipSpec(_p175._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'description',
					_1: _elm_lang$core$Json_Encode$string(_p175._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p175._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p175._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'interactive',
					_1: _user$project$Vega$booSpec(_p175._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MKey':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'key',
					_1: _user$project$Vega$fieldSpec(_p175._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MName':
		...
		case 'MOn':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'on',
					_1: _elm_lang$core$Json_Encode$list(_p175._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MRole':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						_user$project$Vega$comparatorProperties(_p175._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$transformSpec, _p175._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
			return {
				...
				_0: {
					...
					_0: 'style',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p175._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MGroup':
			return A2(
				...
				function (_p176) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p177._0),
						_1: _p177._1
					};
				},
				_p175._0);
		default:
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'zindex',
					_1: _user$project$Vega$numSpec(_p175._0)
				},
				_1: {ctor: '[]'}
			};
	}
	...
	while (true) {
		...
		switch (_p178.ctor) {
			case 'Str':
				return _p178._0;
			case 'Strs':
				return _elm_lang$core$Basics$toString(_p178._0);
			case 'StrList':
				var _p180 = _p178._0;
				var _p179 = _p180;
				if (_p179.ctor === '[]') {
					...
					if (_p179._1.ctor === '[]') {
						...
						var lastStr = A2(
							...
							_elm_lang$core$List$head(
								_elm_lang$core$List$reverse(_p180)));
			...
			case 'StrSignal':
				return A2(
					_elm_lang$core$Basics_ops['++'],
					'{\'signal\': \'',
					A2(_elm_lang$core$Basics_ops['++'], _p178._0, '\'}'));
			case 'StrSignals':
				return _elm_lang$core$Basics$toString(_p178._0);
			case 'StrExpr':
				return _elm_lang$core$Basics$toString(_p178._0);
		...
		case 'Proj':
			return A2(
				...
				A2(
					...
					_user$project$Vega$strString(_p181._0)),
				'');
		default:
			return A2(
				_elm_lang$core$Debug$log,
				A2(_elm_lang$core$Basics_ops['++'], 'Warning: Attempting to set projection type to ', _p181._0),
				'');
	}
};
var _user$project$Vega$projectionSpec = function (proj) {
	...
	switch (_p182.ctor) {
		case 'Proj':
			return _user$project$Vega$strSpec(_p182._0);
		case 'ProjectionSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p182._0),
					_1: {ctor: '[]'}
				});
		default:
			return _elm_lang$core$Json_Encode$string(
	...
	switch (_p183.ctor) {
		case 'PrType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _user$project$Vega$projectionSpec(_p183._0)
			};
		case 'PrClipAngle':
			var _p185 = _p183._0;
			var _p184 = _p185;
			if ((_p184.ctor === 'Num') && (_p184._0 === 0)) {
				return {ctor: '_Tuple2', _0: 'clipAngle', _1: _elm_lang$core$Json_Encode$null};
			} else {
				return {
					ctor: '_Tuple2',
					_0: 'clipAngle',
					_1: _user$project$Vega$numSpec(_p185)
				};
			}
		case 'PrClipExtent':
			var _p187 = _p183._0;
			...
			do {
				switch (_p186.ctor) {
					case 'Nums':
						if (((((_p186._0.ctor === '::') && (_p186._0._1.ctor === '::')) && (_p186._0._1._1.ctor === '::')) && (_p186._0._1._1._1.ctor === '::')) && (_p186._0._1._1._1._1.ctor === '[]')) {
							return {
								ctor: '_Tuple2',
								_0: 'clipExtent',
								_1: _elm_lang$core$Json_Encode$list(
									{
										...
										_0: _elm_lang$core$Json_Encode$list(
											{
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$float(_p186._0._0),
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p186._0._1._0),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: _elm_lang$core$Json_Encode$list(
												{
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p186._0._1._1._0),
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Json_Encode$float(_p186._0._1._1._1._0),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
					...
					case 'NumSignal':
						return {
							...
							_0: 'clipExtent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p186._0))
						};
					case 'NumSignals':
						if (((((_p186._0.ctor === '::') && (_p186._0._1.ctor === '::')) && (_p186._0._1._1.ctor === '::')) && (_p186._0._1._1._1.ctor === '::')) && (_p186._0._1._1._1._1.ctor === '[]')) {
							return {
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$Basics$toString(_p187)),
				{ctor: '_Tuple2', _0: 'clipExtent', _1: _elm_lang$core$Json_Encode$null});
		case 'PrScale':
			return {
				ctor: '_Tuple2',
				_0: 'scale',
				_1: _user$project$Vega$numSpec(_p183._0)
			};
		case 'PrTranslate':
			return A3(_user$project$Vega$numArrayProperty, 2, 'translate', _p183._0);
		case 'PrCenter':
			return {
				ctor: '_Tuple2',
				_0: 'center',
		...
		case 'PrRotate':
			...
			do {
				switch (_p188.ctor) {
					case 'Nums':
						if ((_p188._0.ctor === '::') && (_p188._0._1.ctor === '::')) {
							if (_p188._0._1._1.ctor === '[]') {
								return {
									ctor: '_Tuple2',
									_0: 'rotate',
									_1: _elm_lang$core$Json_Encode$list(
										{
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$float(_p188._0._0),
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$float(_p188._0._1._0),
												_1: {ctor: '[]'}
											}
										})
								};
							} else {
								if (_p188._0._1._1._1.ctor === '[]') {
									return {
										ctor: '_Tuple2',
										_0: 'rotate',
										_1: _elm_lang$core$Json_Encode$list(
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Json_Encode$float(_p188._0._1._1._0),
														_1: {ctor: '[]'}
													}
												}
											})
					...
					case 'NumSignal':
						return {
							...
							_0: 'rotate',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p188._0))
						};
					case 'NumSignals':
						if ((_p188._0.ctor === '::') && (_p188._0._1.ctor === '::')) {
							if (_p188._0._1._1.ctor === '[]') {
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$Basics$toString(_p189)),
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'signal',
								_1: _elm_lang$core$Json_Encode$string(_p190._0)
							},
							_1: {ctor: '[]'}
						})
				};
		...
		case 'PrExtent':
			...
			do {
				switch (_p191.ctor) {
					case 'Nums':
						if (((((_p191._0.ctor === '::') && (_p191._0._1.ctor === '::')) && (_p191._0._1._1.ctor === '::')) && (_p191._0._1._1._1.ctor === '::')) && (_p191._0._1._1._1._1.ctor === '[]')) {
							return {
								ctor: '_Tuple2',
								_0: 'extent',
								_1: _elm_lang$core$Json_Encode$list(
									{
										...
										_0: _elm_lang$core$Json_Encode$list(
											{
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$float(_p191._0._0),
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p191._0._1._0),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: _elm_lang$core$Json_Encode$list(
												{
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p191._0._1._1._0),
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Json_Encode$float(_p191._0._1._1._1._0),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
					...
					case 'NumSignal':
						return {
							...
							_0: 'extent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p191._0))
						};
					case 'NumSignals':
						if (((((_p191._0.ctor === '::') && (_p191._0._1.ctor === '::')) && (_p191._0._1._1.ctor === '::')) && (_p191._0._1._1._1.ctor === '::')) && (_p191._0._1._1._1._1.ctor === '[]')) {
							return {
										...
										_1: {
											...
											_0: _user$project$Vega$numSpec(
												_user$project$Vega$NumSignals(
													{
														ctor: '::',
														_0: _p191._0._1._1._0,
														_1: {
															ctor: '::',
															_0: _p191._0._1._1._1._0,
															_1: {ctor: '[]'}
														}
													})),
											_1: {ctor: '[]'}
		...
		case 'PrSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p183._0);
		case 'PrCoefficient':
			return {
				ctor: '_Tuple2',
				_0: 'coefficient',
