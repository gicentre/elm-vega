	...
	switch (_p11.ctor) {
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _user$project$Vega$opSpec(_p11._0)
			};
	}
};
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$timeUnitLabel(_p12._0))
					},
					_1: {
						ctor: '::',
						_0: {
						...
						A2(
							...
							function (_p20) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p21._0,
									_1: _user$project$Vega$foDataTypeSpec(_p21._1)
								};
							},
							_p19._0))
				},
...
var _user$project$Vega$sourceProperty = function (src) {
	...
	if (_p23.ctor === 'SData') {
		...
		return {
			...
			_0: 'facet',
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$facetProperty, _p23._0))
		};
	}
};
...
var _user$project$Vega$signalReferenceProperty = function (signal) {
	var _p24 = signal;
	if (_p24.ctor === 'SName') {
		return {
			ctor: '_Tuple2',
		...
		return {
			ctor: '_Tuple2',
			_0: 'signal',
			_1: _user$project$Vega$expressionSpec(_p24._0)
		};
	}
};
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'datum',
						_1: _user$project$Vega$fieldValueSpec(_p25._0)
					},
					_1: {ctor: '[]'}
				});
		case 'FGroup':
		...
		case 'TrTrigger':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'trigger',
					_1: _user$project$Vega$expressionSpec(_p28._0)
				},
				_1: {ctor: '[]'}
			};
		case 'TrInsert':
			...
			return {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'values',
						_1: _user$project$Vega$expressionSpec(_p28._1)
					},
					_1: {ctor: '[]'}
				}
			};
...
var _user$project$Vega$dataValues = function (vals) {
	...
	switch (_p32.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataValues, _p32._0));
	}
};
	...
	switch (_p33.ctor) {
		...
		case 'InOptions':
			return {
				ctor: '_Tuple2',
				_0: 'options',
				_1: _user$project$Vega$dataValues(_p33._0)
			};
		case 'InPlaceholder':
			return {
				ctor: '_Tuple2',
	...
	switch (_p35.ctor) {
		case 'DFormat':
			return {
				...
				_0: 'format',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$formatProperty(_p35._0))
			};
		case 'DSource':
			return {
				ctor: '_Tuple2',
	...
	switch (_p37.ctor) {
		...
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$colorProperty(_p37._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _user$project$Vega$fieldValueSpec(_p37._0);
		case 'VScale':
			return _user$project$Vega$fieldValueSpec(_p37._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'VExponent':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$valueProperty(_p37._0),
					_1: {ctor: '[]'}
				});
		case 'VMultiply':
			return _elm_lang$core$Json_Encode$object(
...
var _user$project$Vega$valueProperty = function (val) {
	...
	switch (_p39.ctor) {
		case 'VSignal':
			return _user$project$Vega$signalReferenceProperty(_p39._0);
		case 'VColor':
			return _user$project$Vega$colorProperty(_p39._0);
		case 'VField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldValueSpec(_p39._0)
			};
		case 'VScale':
			return {
				ctor: '_Tuple2',
				...
				_0: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p40._0._1)
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p40._0._2)),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _user$project$Vega$signalProperty = function (sigProp) {
	...
	switch (_p42.ctor) {
		...
		case 'SiBind':
			return _user$project$Vega$bindingProperty(_p42._0);
		case 'SiDescription':
			return {
				ctor: '_Tuple2',
				_0: 'description',
		...
		case 'SiUpdate':
			return {
				ctor: '_Tuple2',
				_0: 'update',
				_1: _user$project$Vega$expressionSpec(_p42._0)
			};
		case 'SiOn':
			return {
				ctor: '_Tuple2',
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$eventHandlerSpec, _p42._0))
			};
		case 'SiReact':
			return {
				ctor: '_Tuple2',
		...
		case 'SiValue':
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _user$project$Vega$dataValue(_p42._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _user$project$Vega$dataValues(_p42._0)
			};
	}
};
	...
	switch (_p43.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$sideLabel(_p43._0))
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$overlapStrategyLabel(_p43._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p48) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p49._0),
						_1: _p49._1
					};
				},
				spec)
	...
	switch (_p52.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$valRef(_p52._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		case 'MStrokeJoin':
			return {
				...
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$strokeJoinLabel(_p52._0))
			};
	...
	switch (_p53.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p53._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p53._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p53._1))
			};
	}
};
			...
			A2(
				...
				function (_p59) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p60._0,
						_1: _user$project$Vega$dataValue(_p60._1)
					};
				},
				row)));
};
...
var _user$project$Vega$FieldSignal = function (a) {
	return {ctor: 'FieldSignal', _0: a};
};
var _user$project$Vega$FieldName = function (a) {
...
var _user$project$Vega$IsNice = function (a) {
...
var _user$project$Vega$SExpr = function (a) {
	return {ctor: 'SExpr', _0: a};
};
var _user$project$Vega$SName = function (a) {
	return {ctor: 'SName', _0: a};
};
var _user$project$Vega$sigHeight = _user$project$Vega$SigNumRef(
	_user$project$Vega$SName('height'));
var _user$project$Vega$sigPadding = _user$project$Vega$SigNumRef(
	_user$project$Vega$SName('padding'));
var _user$project$Vega$sigWidth = _user$project$Vega$SigNumRef(
	_user$project$Vega$SName('width'));
var _user$project$Vega$fieldSpec = function (f) {
	var _p63 = f;
	if (_p63.ctor === 'FieldName') {
		return _elm_lang$core$Json_Encode$string(_p63._0);
	} else {
		return _user$project$Vega$signalStrSpec(
			_user$project$Vega$SigStrRef(
				_user$project$Vega$SName(_p63._0)));
	}
};
...
var _user$project$Vega$orderSpec = function (order) {
	...
	switch (_p65.ctor) {
		...
		default:
			return _user$project$Vega$signalStrSpec(
				_user$project$Vega$SigStrRef(
					_user$project$Vega$SName(_p65._0)));
	}
};
var _user$project$Vega$comparatorProperty = function (comp) {
	...
	if (_p66.ctor === 'CoField') {
		return {
			...
			_0: 'field',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p66._0))
		};
	} else {
		return {
			ctor: '_Tuple2',
			_0: 'order',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$orderSpec, _p66._0))
		};
	}
};
	...
	switch (_p67.ctor) {
		case 'PaField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p67._0)
			};
		case 'PaSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p67._0))
			};
		case 'PaSize':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _user$project$Vega$signalNumSpec(_p67._0),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$signalNumSpec(_p67._1),
							_1: {ctor: '[]'}
						}
					})
			};
		...
		case 'PaPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _user$project$Vega$signalNumSpec(_p67._0)
			};
		default:
			return {
				ctor: '_Tuple2',
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p69._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
		...
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p69._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p69._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p69._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
		...
		default:
			return A2(
				...
				function (_p70) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p71._0),
						_1: _p71._1
					};
				},
				_p69._0);
...
var _user$project$Vega$stackOffsetSpec = function (off) {
	...
	switch (_p72.ctor) {
		...
		default:
			return _user$project$Vega$signalStrSpec(
				_user$project$Vega$SigStrRef(
					_user$project$Vega$SName(_p72._0)));
	}
};
	...
	switch (_p73.ctor) {
		case 'StField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p73._0)
			};
		case 'StGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p73._0))
			};
		case 'StSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p73._0))
			};
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$stackOffsetSpec(_p73._0)
			};
		default:
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$aggregateProperty, _p74._0)
				});
		case 'TBin':
			return _elm_lang$core$Json_Encode$object(
				{
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Vega$exprProperty(_p74._0),
						_1: {ctor: '[]'}
					}
				});
		case 'TFold':
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'expr',
							_1: _user$project$Vega$expressionSpec(_p74._0)
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'initonly',
									_1: _user$project$Vega$formulaUpdateSpec(_p74._2)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$stackProperty, _p74._0)
				});
		case 'TForce':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'parentKey',
								_1: _user$project$Vega$fieldSpec(_p74._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$packProperty, _p74._0)
				});
		case 'TPartition':
			return _elm_lang$core$Json_Encode$object(
				{
	...
	switch (_p75.ctor) {
		...
		case 'DReferences':
			return {
				...
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p75._0))
			};
		default:
			var _p76 = _p75._0;
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p76))
			};
	}
};
var _user$project$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p77.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p77._0));
	}
};
	...
	switch (_p78.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$scaleLabel(_p78._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p78._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
			...
			switch (_p79.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p79._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p79._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p79._0),
									_1: _p79._1
								}))
					};
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$dataRefProperty(_p79._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _user$project$Vega$valueSpec(_p79._0)
								},
								_1: {ctor: '[]'}
							})
					};
				default:
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$rangeDefaultLabel(_p79._0))
					};
			}
		case 'SPadding':
			return {
		...
		case 'SPaddingInner':
			return {
				ctor: '_Tuple2',
				_0: 'paddingInner',
				_1: _user$project$Vega$valueSpec(_p78._0)
			};
		case 'SPaddingOuter':
			return {
				ctor: '_Tuple2',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p78._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p78._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$scaleProperty, sProps)
				}));
	});
...
var _user$project$Vega$TPie = {ctor: 'TPie'};
...
var _user$project$Vega$VString = function (a) {
								...
								_0: _user$project$Vega$Enter(
									{
										...
										_1: {
											...
											_0: _user$project$Vega$MStroke(
												{
													ctor: '::',
													_0: _user$project$Vega$VString('white'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
								...
								_user$project$Vega$DData(
									{
										...
										_1: {
											ctor: '::',
											_0: _user$project$Vega$DField('y1'),
											_1: {ctor: '[]'}
										}
									})),
							_1: {
		...
		return _user$project$Vega$signals(
			A3(
				...
				A3(
					...
					{
						ctor: '::',
						_0: _user$project$Vega$SiValue(_user$project$Vega$Null),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$SiBind(
					...
					A3(
						...
						'sortOrder',
						{
							ctor: '::',
							_0: _user$project$Vega$SiValue(
								_user$project$Vega$Str('ascending')),
							_1: {
								ctor: '::',
								_0: _user$project$Vega$SiBind(
									_user$project$Vega$IRadio(
						...
						A3(
							...
							{
								ctor: '::',
								_0: _user$project$Vega$SiValue(_user$project$Vega$Empty),
								_1: {
									ctor: '::',
						...
						_0: _user$project$Vega$TStack(
							{
								...
								_0: _user$project$Vega$StField(
									_user$project$Vega$FieldName('value')),
								_1: {
									ctor: '::',
									_0: _user$project$Vega$StGroupBy(
										{
											ctor: '::',
											_0: _user$project$Vega$FieldName('key'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
											...
											_0: _user$project$Vega$StSort(
												{
													...
													_0: _user$project$Vega$CoField(
														{
															ctor: '::',
															_0: _user$project$Vega$FieldSignal('sortField'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
													...
													_0: _user$project$Vega$MSize(
														{
															...
															_0: _user$project$Vega$VSignal(
																_user$project$Vega$SExpr('4*datum.r*datum.r')),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
	...
	var ds = _user$project$Vega$dataSource(
		{
			...
			_0: A2(
				_user$project$Vega$transform,
				{
					ctor: '::',
					_0: A2(
						_user$project$Vega$TStratify,
						_user$project$Vega$FieldName('id'),
						_user$project$Vega$FieldName('parent')),
					_1: {
						ctor: '::',
						_0: _user$project$Vega$TPack(
							{
								...
								_1: {
									...
									_0: _user$project$Vega$PaPadding(
										_user$project$Vega$SigNumRef(
											_user$project$Vega$SName('padding between circles'))),
									_1: {
										ctor: '::',
