...
var _user$project$Vega$valRef = function (vs) {
	var _p135 = vs;
	if (((_p135.ctor === '::') && (_p135._0.ctor === 'VIfElse')) && (_p135._1.ctor === '[]')) {
		var _p137 = _p135._0._1;
		var _p136 = _p135._0._0;
		return _elm_lang$core$Json_Encode$list(
			A4(
					...
					_0: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p137)
						}),
					_1: {ctor: '[]'}
				}));
	} else {
...
var _user$project$Vega$valIfElse = F4(
	function (ex, ifVals, elseVals, ifSpecs) {
		...
		while (true) {
			var _p138 = elseVals;
			if (((_p138.ctor === '::') && (_p138._0.ctor === 'VIfElse')) && (_p138._1.ctor === '[]')) {
				var _p140 = _p138._0._1;
						...
						_0: _elm_lang$core$Json_Encode$object(
							{
								...
								_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p140)
							}),
						_1: {ctor: '[]'}
					});
				ex = _v114;
	...
	switch (_p141.ctor) {
		...
		case 'MStrokeJoin':
			return {
				...
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$strokeJoinLabel(_p141._0))
			};
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: _p141._0,
				_1: _user$project$Vega$valRef(_p141._1)
			};
	}
};
	...
	switch (_p142.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p142._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p142._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p142._1))
			};
	}
};
	...
	switch (_p143.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$sideLabel(_p143._0))
			};
		case 'AxBandPosition':
			return {
				ctor: '_Tuple2',
		...
		case 'AxEncode':
			var enc = function (_p144) {
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Vega$axisElementLabel(_p145._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p145._1))
				};
			};
			return {
				ctor: '_Tuple2',
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, enc, _p143._0))
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxGridDash':
			return {
				ctor: '_Tuple2',
				_0: 'gridDash',
				_1: _user$project$Vega$valRef(_p143._0)
			};
		case 'AxGridOpacity':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelBound':
			...
			if (_p146.ctor === 'Nothing') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'labelBound',
					_1: _elm_lang$core$Json_Encode$float(_p146._0)
				};
			}
		case 'AxLabelColor':
			return {
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$overlapStrategyLabel(_p143._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'AxTitleAlign':
			return {
				...
				_0: 'titleAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$hAlignLabel(_p143._0))
			};
		case 'AxTitleAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'AxTitleBaseline':
			return {
				...
				_0: 'titleBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$vAlignLabel(_p143._0))
			};
		case 'AxTitleColor':
			return {
				ctor: '_Tuple2',
	...
	switch (_p149.ctor) {
		...
		case 'LeDirection':
			return {
				...
				_0: 'direction',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$markOrientationLabel(_p149._0))
			};
		case 'LeOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$legendOrientLabel(_p149._0))
			};
		case 'LeFill':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelAlign':
			return {
				...
				_0: 'labelAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$hAlignLabel(_p149._0))
			};
		case 'LeLabelBaseline':
			return {
				...
				_0: 'labelBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$vAlignLabel(_p149._0))
			};
		case 'LeLabelColor':
			return {
				ctor: '_Tuple2',
		...
		case 'LeTickCount':
			return {
				ctor: '_Tuple2',
				_0: 'tickCount',
				_1: _elm_lang$core$Json_Encode$int(_p149._0)
			};
		case 'LeTitlePadding':
			return {
				ctor: '_Tuple2',
			...
			var stepProp = function () {
				...
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'step',
						_1: _user$project$Vega$numSpec(_p173)
					},
					_1: {ctor: '[]'}
				};
			}();
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p175)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'projection',
								_1: _elm_lang$core$Json_Encode$string(_p176)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p175)
						}
					});
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p178)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'projection',
								_1: _elm_lang$core$Json_Encode$string(_p179)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p178)
						}
					});
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p180._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _user$project$Vega$clipSpec(_p180._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'description',
					_1: _elm_lang$core$Json_Encode$string(_p180._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p180._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p180._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'interactive',
					_1: _user$project$Vega$booSpec(_p180._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MKey':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'key',
					_1: _user$project$Vega$fieldSpec(_p180._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MName':
		...
		case 'MOn':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'on',
					_1: _elm_lang$core$Json_Encode$list(_p180._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MRole':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						_user$project$Vega$comparatorProperties(_p180._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$transformSpec, _p180._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
			return {
				...
				_0: {
					...
					_0: 'style',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p180._0))
				},
				_1: {ctor: '[]'}
			};
		default:
			return A2(
				...
				function (_p181) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p182._0),
						_1: _p182._1
					};
				},
				_p180._0);
...
var _user$project$Vega$TPivot = {ctor: 'TPivot'};
	...
	switch (_p183.ctor) {
		case 'CfAutosize':
			return {
				...
				_0: 'autosize',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$autosizeProperty, _p183._0))
			};
		case 'CfBackground':
			return {
				ctor: '_Tuple2',
				_0: 'background',
				_1: _user$project$Vega$strSpec(_p183._0)
			};
		case 'CfGroup':
			return {
				ctor: '_Tuple2',
				_0: 'group',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p183._0))
			};
		case 'CfEvents':
			var _p184 = _p183._1;
			var listSpec = _elm_lang$core$Native_Utils.eq(
				...
				A2(
					...
					_p184));
			var filterLabel = _elm_lang$core$Native_Utils.eq(_p183._0, _user$project$Vega$Allow) ? 'allow' : 'prevent';
			return {
				ctor: '_Tuple2',
				_0: 'events',
				_1: _elm_lang$core$Json_Encode$object(
		...
		case 'CfMark':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Vega$markLabel(_p183._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p183._1))
			};
		case 'CfMarks':
			return {
				ctor: '_Tuple2',
		...
		case 'CfAxis':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Vega$axTypeLabel(_p183._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$axisProperty, _p183._1))
			};
		case 'CfLegend':
			return {
				ctor: '_Tuple2',
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$legendProperty, _p183._0))
			};
		case 'CfTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$titleProperty, _p183._0))
			};
		default:
			var _p188 = _p183._1;
			var _p187 = _p183._0;
			var raVals = function () {
				...
				switch (_p185.ctor) {
					case 'RStrs':
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p185._0));
					case 'RSignal':
						return _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p185._0),
								_1: {ctor: '[]'}
							});
					case 'RScheme':
						return _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p185._0),
									_1: _p185._1
								}));
					default:
						return A2(
...
var _user$project$Vega$dataRefProperty = function (dataRef) {
	var nestedSpec = function (dRef2) {
		var _p189 = dRef2;
		if (((_p189.ctor === '::') && (_p189._0.ctor === 'DValues')) && (_p189._1.ctor === '[]')) {
			return _user$project$Vega$valueSpec(_p189._0._0);
		} else {
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p190.ctor) {
		...
		case 'DField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p190._0)
			};
		case 'DFields':
			return {
				ctor: '_Tuple2',
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p190._0))
			};
		case 'DValues':
			return {
				ctor: '_Tuple2',
				_0: 'values',
				_1: _user$project$Vega$valueSpec(_p190._0)
			};
		case 'DSignal':
			return {
				ctor: '_Tuple2',
		...
		default:
			...
			return (_elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p191))
			};
	}
};
var _user$project$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p192.ctor) {
		case 'DoNums':
			return _user$project$Vega$numSpec(_p192._0);
		case 'DoStrs':
			return _user$project$Vega$strSpec(_p192._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p192._0));
	}
};
	...
	switch (_p193.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$scaleLabel(_p193._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p193._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
				_0: 'domainMax',
				_1: _user$project$Vega$numSpec(_p193._0)
			};
		case 'SDomainMin':
			return {
				ctor: '_Tuple2',
		...
		case 'SDomainRaw':
			return {
				ctor: '_Tuple2',
				_0: 'domainRaw',
				_1: _user$project$Vega$valueSpec(_p193._0)
			};
		case 'SRange':
			var _p194 = _p193._0;
			switch (_p194.ctor) {
				case 'RNums':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p194._0))
					};
				case 'RStrs':
					return {
						ctor: '_Tuple2',
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p194._0))
					};
				case 'RValues':
					return {
						ctor: '_Tuple2',
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p194._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p194._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p194._0),
									_1: _p194._1
								}))
					};
				case 'RData':
		...
		case 'SRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _user$project$Vega$booSpec(_p193._0)
			};
		case 'SClamp':
			return {
				ctor: '_Tuple2',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p193._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p193._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
