...
var _user$project$Vega$spiralSpec = function (sp) {
	var _p5 = sp;
	switch (_p5.ctor) {
		case 'Archimedean':
...
var _user$project$Vega$symbolSpec = function (sym) {
	var _p7 = sym;
	if (_p7.ctor === 'SymbolSignal') {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
		...
		return _elm_lang$core$Json_Encode$string(
			_user$project$Vega$symbolLabel(sym));
	}
};
...
var _user$project$Vega$timeUnitSpec = function (tu) {
		...
		switch (_p9.ctor) {
			...
			case 'Utc':
				return A2(
					_elm_lang$core$Basics_ops['++'],
					'utc',
					timeUnitLabel(_p9._0));
			default:
				return '';
		}
	};
	var _p10 = tu;
	if (_p10.ctor === 'TimeUnitSignal') {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: _user$project$Vega$signalReferenceProperty(_p10._0),
				_1: {ctor: '[]'}
			});
	} else {
		return _elm_lang$core$Json_Encode$string(
...
var _user$project$Vega$titleFrameSpec = function (tf) {
	var _p11 = tf;
	switch (_p11.ctor) {
		case 'FrGroup':
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p11._0),
					_1: {ctor: '[]'}
				});
	}
};
	...
	switch (_p12.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p12._0),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Vega$vAlignSpec = function (align) {
	var _p13 = align;
	switch (_p13.ctor) {
		case 'AlignTop':
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p13._0),
					_1: {ctor: '[]'}
				});
	}
};
...
var _user$project$Vega$sideSpec = function (orient) {
	var _p15 = orient;
	switch (_p15.ctor) {
		case 'SLeft':
...
var _user$project$Vega$scaleSpec = function (scType) {
	var _p16 = scType;
	switch (_p16.ctor) {
		case 'ScLinear':
		...
		case 'ScCustom':
			return _elm_lang$core$Json_Encode$string(_p16._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
...
var _user$project$Vega$projectionLabel = function (pr) {
	var _p17 = pr;
	switch (_p17.ctor) {
		case 'Albers':
			return 'albers';
		...
		case 'Proj':
			return A2(
				...
				A2(
					...
					_user$project$Vega$strString(_p17._0)),
				'');
		default:
			return A2(
				_elm_lang$core$Debug$log,
				A2(_elm_lang$core$Basics_ops['++'], 'Warning: Attempting to set projection type to ', _p17._0),
				'');
	}
};
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'top',
						_1: _elm_lang$core$Json_Encode$float(_p18._1)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'right',
							_1: _elm_lang$core$Json_Encode$float(_p18._2)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bottom',
								_1: _elm_lang$core$Json_Encode$float(_p18._3)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Vega$overlapStrategySpec = function (strat) {
	var _p19 = strat;
	switch (_p19.ctor) {
		case 'ONone':
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p19._0),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Vega$orientationSpec = function (orient) {
	var _p20 = orient;
	switch (_p20.ctor) {
		case 'Horizontal':
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p20._0),
					_1: {ctor: '[]'}
				});
	}
};
	...
	switch (_p21.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p21._0),
					_1: {ctor: '[]'}
				});
	}
};
	...
	switch (_p22.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p22._0),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Vega$niceSpec = function (ni) {
	...
	switch (_p23.ctor) {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'interval',
						_1: _user$project$Vega$timeUnitSpec(_p23._0)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'step',
							_1: _elm_lang$core$Json_Encode$int(_p23._1)
						},
						_1: {ctor: '[]'}
					}
				});
		...
		case 'NTickCount':
			return _elm_lang$core$Json_Encode$int(_p23._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p23._0),
					_1: {ctor: '[]'}
				});
	}
};
...
var _user$project$Vega$linkShapeSpec = function (ls) {
	var _p25 = ls;
	switch (_p25.ctor) {
		case 'LinkLine':
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p25._0),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Vega$legendTypeSpec = function (lt) {
	var _p26 = lt;
	switch (_p26.ctor) {
		case 'LSymbol':
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p26._0),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Vega$legendOrientSpec = function (orient) {
	var _p27 = orient;
	switch (_p27.ctor) {
		case 'Left':
			return _elm_lang$core$Json_Encode$string('left');
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p27._0),
					_1: {ctor: '[]'}
				});
	}
};
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'gamma',
							_1: _elm_lang$core$Json_Encode$float(_p28._0)
						},
						_1: {ctor: '[]'}
					}
				});
...
var _user$project$Vega$imputeMethodLabel = function (im) {
	var _p29 = im;
	switch (_p29.ctor) {
		case 'ByValue':
			return 'value';
...
var _user$project$Vega$hAlignSpec = function (align) {
	var _p30 = align;
	switch (_p30.ctor) {
		case 'AlignLeft':
			return _elm_lang$core$Json_Encode$string('left');
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p30._0),
					_1: {ctor: '[]'}
				});
	}
};
	...
	switch (_p31.ctor) {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'row',
						_1: _user$project$Vega$gridAlignSpec(_p31._0)
					},
					_1: {ctor: '[]'}
				});
		case 'AlignColumn':
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p31._0),
					_1: {ctor: '[]'}
				});
	}
};
...
var _user$project$Vega$foDataTypeSpec = function (dType) {
	...
	switch (_p33.ctor) {
		...
		case 'FoDate':
			var _p34 = _p33._0;
			return _elm_lang$core$Native_Utils.eq(_p34, '') ? _elm_lang$core$Json_Encode$string('date') : _elm_lang$core$Json_Encode$string(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'date:\'',
		...
		default:
			var _p35 = _p33._0;
			return _elm_lang$core$Native_Utils.eq(_p35, '') ? _elm_lang$core$Json_Encode$string('utc') : _elm_lang$core$Json_Encode$string(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'utc:\'',
						...
						A2(
							...
							function (_p37) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p38._0,
									_1: _user$project$Vega$foDataTypeSpec(_p38._1)
								};
							},
							_p36._0))
				},
		...
		case 'TgTrigger':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'trigger',
					_1: _user$project$Vega$expressionSpec(_p39._0)
				},
				_1: {ctor: '[]'}
			};
		case 'TgInsert':
			...
			return {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'values',
						_1: _user$project$Vega$expressionSpec(_p39._1)
					},
					_1: {ctor: '[]'}
				}
			};
...
var _user$project$Vega$exprProperty = function (expr) {
	...
	if (_p40.ctor === 'ExField') {
		...
		return {
			ctor: '_Tuple2',
			_0: 'expr',
			_1: _user$project$Vega$expressionSpec(_p40._0)
		};
	}
};
var _user$project$Vega$numSpec = function (num) {
	...
	switch (_p41.ctor) {
		case 'Num':
			return _elm_lang$core$Json_Encode$float(_p41._0);
		case 'Nums':
		...
		case 'NumSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p41._0),
					_1: {ctor: '[]'}
				});
		case 'NumSignals':
			return _elm_lang$core$Json_Encode$list(
		...
		case 'NumExpr':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$exprProperty(_p41._0),
					_1: {ctor: '[]'}
				});
		case 'NumList':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$numSpec, _p41._0));
		default:
			return _elm_lang$core$Json_Encode$null;
	}
};
var _user$project$Vega$voronoiProperty = function (vp) {
	var numPairSpec = function (ns) {
		...
		do {
			switch (_p42.ctor) {
				case 'Nums':
					if (((_p42._0.ctor === '::') && (_p42._0._1.ctor === '::')) && (_p42._0._1._1.ctor === '[]')) {
						return _user$project$Vega$numSpec(ns);
					} else {
						break _v39_4;
					}
				case 'NumSignal':
		...
		case 'VoExtent':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: numPairSpec(_p43._0),
						_1: {
							ctor: '::',
							_0: numPairSpec(_p43._1),
							_1: {ctor: '[]'}
						}
					})
			};
	...
	switch (_p44.ctor) {
		...
		case 'StrExpr':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$exprProperty(_p44._0),
					_1: {ctor: '[]'}
				});
		default:
			return _elm_lang$core$Json_Encode$null;
...
var _user$project$Vega$projectionSpec = function (proj) {
	...
	switch (_p45.ctor) {
		case 'Proj':
			return _user$project$Vega$strSpec(_p45._0);
		case 'ProjectionSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p45._0),
					_1: {ctor: '[]'}
				});
		default:
			return _elm_lang$core$Json_Encode$string(
	...
	switch (_p46.ctor) {
		...
		case 'ByField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$strSpec(_p46._0)
			};
		case 'Op':
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _user$project$Vega$opSpec(_p46._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	if (_p49.ctor === 'CrFilter') {
		return {
			...
			_1: _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$exprProperty(_p49._0),
					_1: {ctor: '[]'}
				})
		};
	} else {
		return {
			...
			_1: _elm_lang$core$Json_Encode$list(
				{
					ctor: '::',
					_0: _elm_lang$core$Json_Encode$string(_p49._0),
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p49._1),
						_1: {ctor: '[]'}
					}
				})
		};
...
var _user$project$Vega$caseLabel = function (c) {
	var _p50 = c;
	switch (_p50.ctor) {
		case 'Lowercase':
			return 'lower';
...
var _user$project$Vega$countPatternProperty = function (cpProp) {
	var _p51 = cpProp;
	switch (_p51.ctor) {
		case 'CPPattern':
			return {
				ctor: '_Tuple2',
				_0: 'pattern',
				_1: _user$project$Vega$strSpec(_p51._0)
			};
		case 'CPCase':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$caseLabel(_p51._0))
			};
		case 'CPStopwords':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p51._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p51._1),
							_1: {ctor: '[]'}
						}
					})
			};
	...
	switch (_p53.ctor) {
		case 'LAlign':
			return {
				ctor: '_Tuple2',
				_0: 'align',
				_1: _user$project$Vega$gridAlignSpec(_p53._0)
			};
		case 'LBounds':
			return {
				ctor: '_Tuple2',
				_0: 'bounds',
				_1: _user$project$Vega$boundsCalculationSpec(_p53._0)
			};
		case 'LColumns':
			return {
				ctor: '_Tuple2',
				_0: 'columns',
				_1: _user$project$Vega$numSpec(_p53._0)
			};
		case 'LPadding':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'col',
								_1: _user$project$Vega$numSpec(_p53._1)
							},
							_1: {ctor: '[]'}
						}
					})
...
var _user$project$Vega$booSpec = function (b) {
	...
	switch (_p54.ctor) {
		case 'Boo':
			return _elm_lang$core$Json_Encode$bool(_p54._0);
		case 'Boos':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p54._0));
		case 'BooSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p54._0),
					_1: {ctor: '[]'}
				});
		case 'BooSignals':
			return _elm_lang$core$Json_Encode$list(
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$exprProperty(_p54._0),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Vega$clipSpec = function (clip) {
	...
	switch (_p55.ctor) {
		case 'ClEnabled':
			return _user$project$Vega$booSpec(_p55._0);
		case 'ClPath':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'path',
						_1: _user$project$Vega$strSpec(_p55._0)
					},
					_1: {ctor: '[]'}
				});
		default:
		...
		switch (_p56.ctor) {
			case 'ESSource':
				return {
					...
					_0: 'source',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventSourceLabel(_p56._0))
				};
			case 'ESType':
				return {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventTypeLabel(_p56._0))
				};
			case 'ESBetween':
				return {
					ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _user$project$Vega$eventStreamObjectSpec(_p56._0),
							_1: {
								ctor: '::',
								_0: _user$project$Vega$eventStreamObjectSpec(_p56._1),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'ESConsume':
				return {
					ctor: '_Tuple2',
					_0: 'consume',
					_1: _user$project$Vega$booSpec(_p56._0)
				};
			case 'ESFilter':
				var _p58 = _p56._0;
				var _p57 = _p58;
				if ((_p57.ctor === '::') && (_p57._1.ctor === '[]')) {
					...
					return {
						...
						_0: 'filter',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p58))
					};
				}
			case 'ESDebounce':
				return {
					ctor: '_Tuple2',
					_0: 'debounce',
					_1: _user$project$Vega$numSpec(_p56._0)
				};
			case 'ESMarkName':
				return {
					ctor: '_Tuple2',
			...
			case 'ESMark':
				return {
					...
					_0: 'marktype',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p56._0))
				};
			case 'ESThrottle':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: 'stream',
					_1: _user$project$Vega$eventStreamSpec(_p56._0)
				};
		}
	};
	return _elm_lang$core$Json_Encode$object(
...
var _user$project$Vega$eventStreamSpec = function (es) {
	...
	switch (_p59.ctor) {
		case 'ESSelector':
			return _user$project$Vega$strSpec(_p59._0);
		case 'ESObject':
			return _user$project$Vega$eventStreamObjectSpec(_p59._0);
		case 'ESSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_0: 'merge',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$eventStreamSpec, _p59._0))
					},
					_1: {ctor: '[]'}
				});
	}
			...
			case 'EEvents':
				...
				if ((_p61.ctor === '::') && (_p61._1.ctor === '[]')) {
					return {
						ctor: '_Tuple2',
						_0: 'events',
						_1: _user$project$Vega$eventStreamSpec(_p61._0)
					};
				} else {
					return {
						ctor: '_Tuple2',
						_0: 'events',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$eventStreamSpec, _p62))
					};
				}
			case 'EUpdate':
				var _p63 = _p60._0;
				return _elm_lang$core$Native_Utils.eq(_p63, '') ? {
					ctor: '_Tuple2',
					_0: 'update',
					_1: _elm_lang$core$Json_Encode$string('{}')
				} : {
					ctor: '_Tuple2',
					_0: 'update',
					_1: _elm_lang$core$Json_Encode$string(_p63)
				};
			case 'EEncode':
				return {
					ctor: '_Tuple2',
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$string(_p60._0)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: 'force',
					_1: _user$project$Vega$booSpec(_p60._0)
				};
		}
	};
	return _elm_lang$core$Json_Encode$object(
	...
	switch (_p64.ctor) {
		case 'BnAnchor':
			return {
				ctor: '_Tuple2',
				_0: 'anchor',
				_1: _user$project$Vega$numSpec(_p64._0)
			};
		case 'BnMaxBins':
			return {
				ctor: '_Tuple2',
			...
			switch (_p65.ctor) {
				case 'Num':
					return {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _user$project$Vega$numSpec(_p66),
								_1: {ctor: '[]'}
							})
					};
				case 'NumSignal':
				...
				default:
					return {
						ctor: '_Tuple2',
						_0: 'steps',
						_1: _user$project$Vega$numSpec(_p66)
					};
			}
		case 'BnMinStep':
			return {
		...
		case 'BnNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$booSpec(_p64._0)
			};
		case 'BnSignal':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p64._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p64._1),
							_1: {ctor: '[]'}
						}
					})
			};
...
var _user$project$Vega$axTypeLabel = function (axType) {
	var _p67 = axType;
	switch (_p67.ctor) {
		case 'AxAll':
			return 'axis';
...
var _user$project$Vega$autosizeProperty = function (asCfg) {
	...
	switch (_p69.ctor) {
		...
		default:
			return _user$project$Vega$signalReferenceProperty(_p69._0);
	}
};
...
var _user$project$Vega$AxTitleY = function (a) {
	return {ctor: 'AxTitleY', _0: a};
};
var _user$project$Vega$axTitleY = _user$project$Vega$AxTitleY;
var _user$project$Vega$AxTitleX = function (a) {
	return {ctor: 'AxTitleX', _0: a};
};
var _user$project$Vega$axTitleX = _user$project$Vega$AxTitleX;
...
var _user$project$Vega$axTitleLimit = _user$project$Vega$AxTitleLimit;
var _user$project$Vega$AxTitleFontWeight = function (a) {
	return {ctor: 'AxTitleFontWeight', _0: a};
};
var _user$project$Vega$axTitleFontWeight = _user$project$Vega$AxTitleFontWeight;
var _user$project$Vega$AxTitleFontSize = function (a) {
	return {ctor: 'AxTitleFontSize', _0: a};
};
var _user$project$Vega$axTitleFontSize = _user$project$Vega$AxTitleFontSize;
var _user$project$Vega$AxTitleFont = function (a) {
	return {ctor: 'AxTitleFont', _0: a};
};
var _user$project$Vega$axTitleFont = _user$project$Vega$AxTitleFont;
var _user$project$Vega$AxTitleColor = function (a) {
	return {ctor: 'AxTitleColor', _0: a};
};
var _user$project$Vega$axTitleColor = _user$project$Vega$AxTitleColor;
var _user$project$Vega$AxTitleBaseline = function (a) {
	return {ctor: 'AxTitleBaseline', _0: a};
};
var _user$project$Vega$axTitleBaseline = _user$project$Vega$AxTitleBaseline;
var _user$project$Vega$AxTitleAngle = function (a) {
	return {ctor: 'AxTitleAngle', _0: a};
};
var _user$project$Vega$axTitleAngle = _user$project$Vega$AxTitleAngle;
var _user$project$Vega$AxTitleAlign = function (a) {
	return {ctor: 'AxTitleAlign', _0: a};
};
var _user$project$Vega$axTitleAlign = _user$project$Vega$AxTitleAlign;
...
var _user$project$Vega$AxTickWidth = function (a) {
	return {ctor: 'AxTickWidth', _0: a};
};
var _user$project$Vega$axTickWidth = _user$project$Vega$AxTickWidth;
...
var _user$project$Vega$AxTickRound = function (a) {
...
var _user$project$Vega$axTickOffset = _user$project$Vega$AxTickOffset;
var _user$project$Vega$AxTickExtra = function (a) {
	return {ctor: 'AxTickExtra', _0: a};
};
var _user$project$Vega$axTickExtra = _user$project$Vega$AxTickExtra;
...
var _user$project$Vega$AxTickColor = function (a) {
	return {ctor: 'AxTickColor', _0: a};
};
var _user$project$Vega$axTickColor = _user$project$Vega$AxTickColor;
...
var _user$project$Vega$axLabelLimit = _user$project$Vega$AxLabelLimit;
var _user$project$Vega$AxLabelFontWeight = function (a) {
	return {ctor: 'AxLabelFontWeight', _0: a};
};
var _user$project$Vega$axLabelFontWeight = _user$project$Vega$AxLabelFontWeight;
var _user$project$Vega$AxLabelFontSize = function (a) {
	return {ctor: 'AxLabelFontSize', _0: a};
};
var _user$project$Vega$axLabelFontSize = _user$project$Vega$AxLabelFontSize;
var _user$project$Vega$AxLabelFont = function (a) {
	return {ctor: 'AxLabelFont', _0: a};
};
var _user$project$Vega$axLabelFont = _user$project$Vega$AxLabelFont;
...
var _user$project$Vega$AxLabelColor = function (a) {
	return {ctor: 'AxLabelColor', _0: a};
};
var _user$project$Vega$axLabelColor = _user$project$Vega$AxLabelColor;
...
var _user$project$Vega$axGridDash = _user$project$Vega$AxGridDash;
var _user$project$Vega$AxGridColor = function (a) {
	return {ctor: 'AxGridColor', _0: a};
};
var _user$project$Vega$axGridColor = _user$project$Vega$AxGridColor;
...
var _user$project$Vega$AxDomainWidth = function (a) {
...
var _user$project$Vega$axDomainColor = _user$project$Vega$AxDomainColor;
...
var _user$project$Vega$AxBandPosition = function (a) {
	return {ctor: 'AxBandPosition', _0: a};
};
var _user$project$Vega$axBandPosition = _user$project$Vega$AxBandPosition;
...
var _user$project$Vega$SExtent = function (a) {
	return {ctor: 'SExtent', _0: a};
};
var _user$project$Vega$csExtent = _user$project$Vega$SExtent;
...
var _user$project$Vega$CfScaleRange = F2(
	function (a, b) {
		return {ctor: 'CfScaleRange', _0: a, _1: b};
	});
var _user$project$Vega$cfScaleRange = _user$project$Vega$CfScaleRange;
var _user$project$Vega$CfTitle = function (a) {
	return {ctor: 'CfTitle', _0: a};
};
var _user$project$Vega$cfTitle = _user$project$Vega$CfTitle;
var _user$project$Vega$CfLegend = function (a) {
	return {ctor: 'CfLegend', _0: a};
};
var _user$project$Vega$cfLegend = _user$project$Vega$CfLegend;
var _user$project$Vega$CfAxis = F2(
	function (a, b) {
		return {ctor: 'CfAxis', _0: a, _1: b};
	});
var _user$project$Vega$cfAxis = _user$project$Vega$CfAxis;
var _user$project$Vega$CfStyle = F2(
	function (a, b) {
		return {ctor: 'CfStyle', _0: a, _1: b};
	});
var _user$project$Vega$cfStyle = _user$project$Vega$CfStyle;
var _user$project$Vega$CfMarks = function (a) {
	return {ctor: 'CfMarks', _0: a};
};
var _user$project$Vega$cfMarks = _user$project$Vega$CfMarks;
var _user$project$Vega$CfMark = F2(
	function (a, b) {
		return {ctor: 'CfMark', _0: a, _1: b};
	});
var _user$project$Vega$cfMark = _user$project$Vega$CfMark;
var _user$project$Vega$CfEvents = F2(
	function (a, b) {
		return {ctor: 'CfEvents', _0: a, _1: b};
	});
var _user$project$Vega$cfEvents = _user$project$Vega$CfEvents;
var _user$project$Vega$CfGroup = function (a) {
	return {ctor: 'CfGroup', _0: a};
};
var _user$project$Vega$cfGroup = _user$project$Vega$CfGroup;
var _user$project$Vega$CfBackground = function (a) {
	return {ctor: 'CfBackground', _0: a};
};
var _user$project$Vega$cfBackground = _user$project$Vega$CfBackground;
var _user$project$Vega$CfAutosize = function (a) {
	return {ctor: 'CfAutosize', _0: a};
};
var _user$project$Vega$cfAutosize = _user$project$Vega$CfAutosize;
...
var _user$project$Vega$CPAs = F2(
	function (a, b) {
		return {ctor: 'CPAs', _0: a, _1: b};
	});
var _user$project$Vega$cpAs = _user$project$Vega$CPAs;
var _user$project$Vega$CPStopwords = function (a) {
	return {ctor: 'CPStopwords', _0: a};
};
var _user$project$Vega$cpStopwords = _user$project$Vega$CPStopwords;
var _user$project$Vega$CPCase = function (a) {
	return {ctor: 'CPCase', _0: a};
};
var _user$project$Vega$cpCase = _user$project$Vega$CPCase;
var _user$project$Vega$CPPattern = function (a) {
	return {ctor: 'CPPattern', _0: a};
};
var _user$project$Vega$cpPattern = _user$project$Vega$CPPattern;
...
var _user$project$Vega$DValues = function (a) {
	return {ctor: 'DValues', _0: a};
};
var _user$project$Vega$daValues = _user$project$Vega$DValues;
var _user$project$Vega$DSignal = function (a) {
	return {ctor: 'DSignal', _0: a};
};
var _user$project$Vega$daSignal = _user$project$Vega$DSignal;
...
var _user$project$Vega$evHandler = F2(
	function (ess, eHandlers) {
		return {
			ctor: '::',
			_0: _user$project$Vega$EEvents(ess),
			_1: eHandlers
		};
	});
...
var _user$project$Vega$ESSignal = function (a) {
	return {ctor: 'ESSignal', _0: a};
};
var _user$project$Vega$esSignal = _user$project$Vega$ESSignal;
...
var _user$project$Vega$FeName = function (a) {
...
var _user$project$Vega$GjSignal = function (a) {
	return {ctor: 'GjSignal', _0: a};
};
var _user$project$Vega$gjSignal = _user$project$Vega$GjSignal;
var _user$project$Vega$GjFeature = function (a) {
	return {ctor: 'GjFeature', _0: a};
};
var _user$project$Vega$gjFeature = _user$project$Vega$GjFeature;
var _user$project$Vega$GjFields = F2(
	function (a, b) {
		return {ctor: 'GjFields', _0: a, _1: b};
	});
var _user$project$Vega$gjFields = _user$project$Vega$GjFields;
...
var _user$project$Vega$ImValue = function (a) {
	return {ctor: 'ImValue', _0: a};
};
var _user$project$Vega$imValue = _user$project$Vega$ImValue;
var _user$project$Vega$ImGroupBy = function (a) {
	return {ctor: 'ImGroupBy', _0: a};
};
var _user$project$Vega$imGroupBy = _user$project$Vega$ImGroupBy;
var _user$project$Vega$ImMethod = function (a) {
	return {ctor: 'ImMethod', _0: a};
};
var _user$project$Vega$imMethod = _user$project$Vega$ImMethod;
var _user$project$Vega$ImKeyVals = function (a) {
	return {ctor: 'ImKeyVals', _0: a};
};
var _user$project$Vega$imKeyVals = _user$project$Vega$ImKeyVals;
var _user$project$Vega$ByMin = {ctor: 'ByMin'};
var _user$project$Vega$ByMax = {ctor: 'ByMax'};
var _user$project$Vega$ByMedian = {ctor: 'ByMedian'};
var _user$project$Vega$ByMean = {ctor: 'ByMean'};
var _user$project$Vega$ByValue = {ctor: 'ByValue'};
...
var _user$project$Vega$JAAs = function (a) {
	return {ctor: 'JAAs', _0: a};
};
var _user$project$Vega$jaAs = _user$project$Vega$JAAs;
var _user$project$Vega$JAOps = function (a) {
	return {ctor: 'JAOps', _0: a};
};
var _user$project$Vega$jaOps = _user$project$Vega$JAOps;
var _user$project$Vega$JAFields = function (a) {
	return {ctor: 'JAFields', _0: a};
};
var _user$project$Vega$jaFields = _user$project$Vega$JAFields;
var _user$project$Vega$JAGroupBy = function (a) {
	return {ctor: 'JAGroupBy', _0: a};
};
var _user$project$Vega$jaGroupBy = _user$project$Vega$JAGroupBy;
...
var _user$project$Vega$LeGradientLabelOffset = function (a) {
	return {ctor: 'LeGradientLabelOffset', _0: a};
};
var _user$project$Vega$leGradientLabelOffset = _user$project$Vega$LeGradientLabelOffset;
var _user$project$Vega$LeGradientLabelLimit = function (a) {
		...
		switch (_p74.ctor) {
			case 'Nums':
				...
				return _elm_lang$core$Native_Utils.eq(
					...
					_0: name,
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p75))
				} : A2(
					_elm_lang$core$Debug$log,
					A2(
						_elm_lang$core$Basics_ops['++'],
			...
			case 'NumSignal':
				return {
					...
					_1: _user$project$Vega$numSpec(
						_user$project$Vega$NumSignal(_p74._0))
				};
			case 'NumSignals':
				var _p76 = _p74._0;
				return _elm_lang$core$Native_Utils.eq(
					_elm_lang$core$List$length(_p76),
					len) ? {
					ctor: '_Tuple2',
					_0: name,
					_1: _user$project$Vega$numSpec(
						_user$project$Vega$NumSignals(_p76))
				} : A2(
					_elm_lang$core$Debug$log,
					A2(
						_elm_lang$core$Basics_ops['++'],
			...
			case 'NumList':
				var _p77 = _p74._0;
				return _elm_lang$core$Native_Utils.eq(
					_elm_lang$core$List$length(_p77),
					len) ? {
					ctor: '_Tuple2',
					_0: name,
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$numSpec, _p77))
				} : A2(
					_elm_lang$core$Debug$log,
					A2(
						_elm_lang$core$Basics_ops['++'],
...
var _user$project$Vega$densityProperty = function (dnp) {
	...
	switch (_p78.ctor) {
		case 'DnExtent':
			return A3(_user$project$Vega$numArrayProperty, 2, 'extent', _p78._0);
		case 'DnMethod':
			var _p79 = _p78._0;
			switch (_p79.ctor) {
				case 'PDF':
		...
		case 'DnSteps':
			return {
				ctor: '_Tuple2',
				_0: 'steps',
				_1: _user$project$Vega$numSpec(_p78._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p78._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p78._1),
							_1: {ctor: '[]'}
						}
					})
			};
	...
	switch (_p80.ctor) {
		case 'SScheme':
			return {
				ctor: '_Tuple2',
				_0: 'scheme',
				_1: _user$project$Vega$strSpec(_p80._0)
			};
		case 'SCount':
			return {
				ctor: '_Tuple2',
		...
		default:
			return A3(_user$project$Vega$numArrayProperty, 2, 'extent', _p80._0);
	}
};
	...
	switch (_p81.ctor) {
		case 'PrType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _user$project$Vega$projectionSpec(_p81._0)
			};
		case 'PrClipAngle':
			var _p83 = _p81._0;
			var _p82 = _p83;
			if ((_p82.ctor === 'Num') && (_p82._0 === 0)) {
		...
		case 'PrClipExtent':
			...
			do {
				switch (_p84.ctor) {
					case 'Nums':
						if (((((_p84._0.ctor === '::') && (_p84._0._1.ctor === '::')) && (_p84._0._1._1.ctor === '::')) && (_p84._0._1._1._1.ctor === '::')) && (_p84._0._1._1._1._1.ctor === '[]')) {
							return {
								ctor: '_Tuple2',
								_0: 'clipExtent',
								_1: _elm_lang$core$Json_Encode$list(
									{
										...
										_0: _elm_lang$core$Json_Encode$list(
											{
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$float(_p84._0._0),
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p84._0._1._0),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: _elm_lang$core$Json_Encode$list(
												{
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p84._0._1._1._0),
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Json_Encode$float(_p84._0._1._1._1._0),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
					...
					case 'NumSignal':
						return {
							...
							_0: 'clipExtent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p84._0))
						};
					case 'NumSignals':
						if (((((_p84._0.ctor === '::') && (_p84._0._1.ctor === '::')) && (_p84._0._1._1.ctor === '::')) && (_p84._0._1._1._1.ctor === '::')) && (_p84._0._1._1._1._1.ctor === '[]')) {
							return {
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$Basics$toString(_p85)),
		...
		case 'PrTranslate':
			return A3(_user$project$Vega$numArrayProperty, 2, 'translate', _p81._0);
		case 'PrCenter':
			return {
				ctor: '_Tuple2',
				_0: 'center',
		...
		case 'PrRotate':
			...
			do {
				switch (_p86.ctor) {
					case 'Nums':
						if ((_p86._0.ctor === '::') && (_p86._0._1.ctor === '::')) {
							if (_p86._0._1._1.ctor === '[]') {
								return {
									ctor: '_Tuple2',
									_0: 'rotate',
									_1: _elm_lang$core$Json_Encode$list(
										{
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$float(_p86._0._0),
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$float(_p86._0._1._0),
												_1: {ctor: '[]'}
											}
										})
								};
							} else {
								if (_p86._0._1._1._1.ctor === '[]') {
									return {
										ctor: '_Tuple2',
										_0: 'rotate',
										_1: _elm_lang$core$Json_Encode$list(
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Json_Encode$float(_p86._0._1._1._0),
														_1: {ctor: '[]'}
													}
												}
											})
					...
					case 'NumSignal':
						return {
							...
							_0: 'rotate',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p86._0))
						};
					case 'NumSignals':
						if ((_p86._0.ctor === '::') && (_p86._0._1.ctor === '::')) {
							if (_p86._0._1._1.ctor === '[]') {
							...
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$string(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'data(\'',
										A2(_elm_lang$core$Basics_ops['++'], _p88._0, '\')')))
							},
							_1: {ctor: '[]'}
						})
				};
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'signal',
								_1: _elm_lang$core$Json_Encode$string(_p88._0)
							},
							_1: {ctor: '[]'}
						})
				};
		...
		case 'PrExtent':
			...
			do {
				switch (_p89.ctor) {
					case 'Nums':
						if (((((_p89._0.ctor === '::') && (_p89._0._1.ctor === '::')) && (_p89._0._1._1.ctor === '::')) && (_p89._0._1._1._1.ctor === '::')) && (_p89._0._1._1._1._1.ctor === '[]')) {
							return {
								ctor: '_Tuple2',
								_0: 'extent',
								_1: _elm_lang$core$Json_Encode$list(
									{
										...
										_0: _elm_lang$core$Json_Encode$list(
											{
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$float(_p89._0._0),
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p89._0._1._0),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: _elm_lang$core$Json_Encode$list(
												{
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$float(_p89._0._1._1._0),
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Json_Encode$float(_p89._0._1._1._1._0),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
					...
					case 'NumSignal':
						return {
							...
							_0: 'extent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p89._0))
						};
					case 'NumSignals':
						if (((((_p89._0.ctor === '::') && (_p89._0._1.ctor === '::')) && (_p89._0._1._1.ctor === '::')) && (_p89._0._1._1._1.ctor === '::')) && (_p89._0._1._1._1._1.ctor === '[]')) {
							return {
		...
		case 'PrSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p81._0);
		case 'PrCoefficient':
			return {
				ctor: '_Tuple2',
				_0: 'coefficient',
...
var _user$project$Vega$PiOp = function (a) {
	return {ctor: 'PiOp', _0: a};
};
var _user$project$Vega$piOp = _user$project$Vega$PiOp;
var _user$project$Vega$PiLimit = function (a) {
	return {ctor: 'PiLimit', _0: a};
};
var _user$project$Vega$piLimit = _user$project$Vega$PiLimit;
var _user$project$Vega$PiGroupBy = function (a) {
	return {ctor: 'PiGroupBy', _0: a};
};
var _user$project$Vega$piGroupBy = _user$project$Vega$PiGroupBy;
...
var _user$project$Vega$ScaleRangeSignal = function (a) {
	return {ctor: 'ScaleRangeSignal', _0: a};
};
var _user$project$Vega$scaleRangeSignal = _user$project$Vega$ScaleRangeSignal;
var _user$project$Vega$RaHeatmap = {ctor: 'RaHeatmap'};
var _user$project$Vega$RaRamp = {ctor: 'RaRamp'};
var _user$project$Vega$RaOrdinal = {ctor: 'RaOrdinal'};
var _user$project$Vega$RaDiverging = {ctor: 'RaDiverging'};
var _user$project$Vega$RaCategory = {ctor: 'RaCategory'};
var _user$project$Vega$RaSymbol = {ctor: 'RaSymbol'};
var _user$project$Vega$RaHeight = {ctor: 'RaHeight'};
var _user$project$Vega$RaWidth = {ctor: 'RaWidth'};
var _user$project$Vega$RCustom = function (a) {
	return {ctor: 'RCustom', _0: a};
};
var _user$project$Vega$raCustomDefault = _user$project$Vega$RCustom;
...
var _user$project$Vega$raScheme = _user$project$Vega$RScheme;
...
var _user$project$Vega$fieldSpec = function (fVal) {
	...
	switch (_p91.ctor) {
		case 'FName':
			return _elm_lang$core$Json_Encode$string(_p91._0);
		case 'FExpr':
			return _user$project$Vega$strSpec(
				_user$project$Vega$strExpr(
					_user$project$Vega$expr(_p91._0)));
		case 'FSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p91._0),
					_1: {ctor: '[]'}
				});
		case 'FDatum':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'datum',
						_1: _user$project$Vega$fieldSpec(_p91._0)
					},
					_1: {ctor: '[]'}
				});
		case 'FGroup':
	...
	switch (_p92.ctor) {
		case 'AgGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p92._0))
			};
		case 'AgFields':
			return {
				ctor: '_Tuple2',
		...
		case 'AgOps':
			return {
				...
				_0: 'ops',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$opSpec, _p92._0))
			};
		case 'AgAs':
			return {
				ctor: '_Tuple2',
		...
		case 'AgCross':
			return {
				ctor: '_Tuple2',
				_0: 'cross',
				_1: _user$project$Vega$booSpec(_p92._0)
			};
		case 'AgDrop':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'key',
				_1: _user$project$Vega$fieldSpec(_p92._0)
			};
	}
};
var _user$project$Vega$comparatorProperties = function (comp) {
	var _p93 = _elm_lang$core$List$unzip(comp);
	var fs = _p93._0;
	var os = _p93._1;
	return {
		ctor: '::',
	...
	switch (_p94.ctor) {
			...
			if (_p95.ctor === 'Num') {
				return A2(
					...
					A2(
						...
						_elm_lang$core$Basics$toString(_p96)),
					{ctor: '_Tuple2', _0: 'values', _1: _elm_lang$core$Json_Encode$null});
			} else {
				return {
					ctor: '_Tuple2',
					_0: 'values',
					_1: _user$project$Vega$numSpec(_p96)
				};
			}
		case 'CnX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$fieldSpec(_p94._0)
			};
		case 'CnY':
			return {
				ctor: '_Tuple2',
		...
		case 'CnSmooth':
			return {
				ctor: '_Tuple2',
				_0: 'smooth',
				_1: _user$project$Vega$booSpec(_p94._0)
			};
		case 'CnThresholds':
			var _p98 = _p94._0;
			var _p97 = _p98;
			if (_p97.ctor === 'Num') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'thresholds',
					_1: _user$project$Vega$numSpec(_p98)
				};
			}
		case 'CnCount':
			return {
...
var _user$project$Vega$distributionSpec = function (dist) {
	...
	switch (_p99.ctor) {
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'stdev',
								_1: _user$project$Vega$numSpec(_p99._1)
							},
							_1: {ctor: '[]'}
						}
					}
		...
		case 'DiKde':
			...
			var _p101 = _p99._0;
			var _p100 = _p99._2;
			return _elm_lang$core$Native_Utils.eq(_p101, '') ? _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'field',
							_1: _user$project$Vega$fieldSpec(_p102)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bandwidth',
								_1: _user$project$Vega$numSpec(_p100)
							},
							_1: {ctor: '[]'}
						}
					}
				}) : _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'from',
							_1: _elm_lang$core$Json_Encode$string(_p101)
						},
						_1: {
							ctor: '::',
							_0: {
		...
		default:
			...
			var probs = A2(
				...
				_elm_lang$core$Tuple$second(
					_elm_lang$core$List$unzip(_p103)));
			var dists = A2(
				_elm_lang$core$List$map,
	...
	switch (_p104.ctor) {
		...
		case 'FaGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p104._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$aggregateProperty, _p104._0))
			};
	}
};
var _user$project$Vega$sourceProperty = function (src) {
	...
	if (_p105.ctor === 'SData') {
		return {
			ctor: '_Tuple2',
			_0: 'data',
			_1: _user$project$Vega$strSpec(_p105._0)
		};
	} else {
		return {
			ctor: '_Tuple2',
			...
			_1: _elm_lang$core$Json_Encode$object(
				A2(
					...
					{
						ctor: '::',
						_0: _user$project$Vega$FaData(_p105._0),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$FaName(_p105._1),
							_1: _p105._2
						}
					}))
		};
	...
	switch (_p106.ctor) {
		...
		case 'FpCx':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$numSpec(_p106._0)
			};
		case 'FpCy':
			return {
				ctor: '_Tuple2',
		...
		case 'FpLinks':
			return {
				ctor: '_Tuple2',
				_0: 'links',
				_1: _user$project$Vega$strSpec(_p106._0)
			};
		case 'FpId':
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$forceProperty, _p107._0)
				});
		case 'FCollide':
			return _elm_lang$core$Json_Encode$object(
				{
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$forceProperty, _p107._1)
					}
				});
		default:
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p108.ctor) {
		case 'FsStatic':
			return {
				ctor: '_Tuple2',
				_0: 'static',
				_1: _user$project$Vega$booSpec(_p108._0)
			};
		case 'FsRestart':
			return {
				ctor: '_Tuple2',
		...
		case 'FsIterations':
			return {
				ctor: '_Tuple2',
				_0: 'iterations',
				_1: _user$project$Vega$numSpec(_p108._0)
			};
		case 'FsAlpha':
			return {
				ctor: '_Tuple2',
		...
		case 'FsForces':
			return {
				...
				_0: 'forces',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$forceSpec, _p108._0))
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$geoJsonProperty = function (gjProp) {
	var _p109 = gjProp;
	switch (_p109.ctor) {
		case 'GjFields':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _user$project$Vega$fieldSpec(_p109._0),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$fieldSpec(_p109._1),
							_1: {ctor: '[]'}
						}
					})
			};
		case 'GjFeature':
			return {
				ctor: '_Tuple2',
				_0: 'geojson',
				_1: _user$project$Vega$fieldSpec(_p109._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p110.ctor) {
		case 'GeField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p110._0)
			};
		case 'GePointRadius':
			return {
				ctor: '_Tuple2',
				_0: 'pointRadius',
				_1: _user$project$Vega$numSpec(_p110._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$graticuleProperty = function (grProp) {
	...
	switch (_p111.ctor) {
		...
		case 'GrExtentMajor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'extentMajor', _p111._0);
		case 'GrExtentMinor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'extentMinor', _p111._0);
		case 'GrExtent':
			return A3(_user$project$Vega$numArrayProperty, 2, 'extentr', _p111._0);
		case 'GrStepMajor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'stepMajor', _p111._0);
		case 'GrStepMinor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'stepMinor', _p111._0);
		case 'GrStep':
			return A3(_user$project$Vega$numArrayProperty, 2, 'step', _p111._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'precision',
				_1: _user$project$Vega$numSpec(_p111._0)
			};
	}
};
var _user$project$Vega$joinAggregateProperty = function (ap) {
	var _p112 = ap;
	switch (_p112.ctor) {
		case 'JAGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p112._0))
			};
		case 'JAFields':
			return {
				ctor: '_Tuple2',
		...
		case 'JAOps':
			return {
				...
				_0: 'ops',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$opSpec, _p112._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p113.ctor) {
		case 'LPSourceX':
			return {
				ctor: '_Tuple2',
				_0: 'sourceX',
				_1: _user$project$Vega$fieldSpec(_p113._0)
			};
		case 'LPSourceY':
			return {
				ctor: '_Tuple2',
		...
		case 'LPOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$orientationSpec(_p113._0)
			};
		case 'LPShape':
			return {
				ctor: '_Tuple2',
				_0: 'shape',
				_1: _user$project$Vega$linkShapeSpec(_p113._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p114.ctor) {
		case 'PaField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p114._0)
			};
		case 'PaSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$comparatorProperties(_p114._0))
			};
		case 'PaSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p114._0);
		case 'PaRadius':
			var _p115 = _p114._0;
			if (_p115.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: 'radius',
					_1: _user$project$Vega$fieldSpec(_p115._0)
				};
			} else {
		...
		case 'PaPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _user$project$Vega$numSpec(_p114._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p116.ctor) {
		case 'PtField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p116._0)
			};
		case 'PtSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$comparatorProperties(_p116._0))
			};
		case 'PtPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _user$project$Vega$numSpec(_p116._0)
			};
		case 'PtRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _user$project$Vega$booSpec(_p116._0)
			};
		case 'PtSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p116._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'as',
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p116._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p116._1),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$string(_p116._2),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$string(_p116._3),
									_1: {
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$string(_p116._4),
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$string(_p116._5),
											_1: {ctor: '[]'}
										}
									}
								}
	...
	switch (_p117.ctor) {
		case 'PiField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p117._0)
			};
		case 'PiStartAngle':
			return {
				ctor: '_Tuple2',
				_0: 'startAngle',
				_1: _user$project$Vega$numSpec(_p117._0)
			};
		case 'PiEndAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'PiSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _user$project$Vega$booSpec(_p117._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$pivotProperty = function (pp) {
	var _p118 = pp;
	switch (_p118.ctor) {
		case 'PiGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p118._0))
			};
		case 'PiLimit':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _user$project$Vega$opSpec(_p118._0)
			};
	}
};
	...
	switch (_p119.ctor) {
		case 'StField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p119._0)
			};
		case 'StGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p119._0))
			};
		case 'StSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$comparatorProperties(_p119._0))
			};
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$stackOffsetSpec(_p119._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p120.ctor) {
		...
		case 'TmSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$comparatorProperties(_p120._0))
			};
		case 'TmMethod':
			return {
				ctor: '_Tuple2',
				_0: 'method',
				_1: _user$project$Vega$tmMethodSpec(_p120._0)
			};
		case 'TmPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'TmRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _user$project$Vega$booSpec(_p120._0)
			};
		case 'TmSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p120._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'as',
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p120._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p120._1),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$string(_p120._2),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$string(_p120._3),
									_1: {
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$string(_p120._4),
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$string(_p120._5),
											_1: {ctor: '[]'}
										}
									}
								}
	...
	switch (_p121.ctor) {
		...
		case 'TeMethod':
			return {
				ctor: '_Tuple2',
				_0: 'method',
				_1: _user$project$Vega$teMethodSpec(_p121._0)
			};
		case 'TeSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p121._0);
		case 'TeNodeSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'nodeSize', _p121._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'as',
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p121._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p121._1),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$string(_p121._2),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$string(_p121._3),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Vega$valueSpec = function (val) {
	...
	switch (_p122.ctor) {
		case 'VStr':
			return _elm_lang$core$Json_Encode$string(_p122._0);
		case 'VStrs':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p122._0));
		case 'VSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p122._0),
					_1: {ctor: '[]'}
				});
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$colorProperty(_p122._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _user$project$Vega$fieldSpec(_p122._0);
		case 'VScale':
			return _user$project$Vega$fieldSpec(_p122._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'band',
						_1: _user$project$Vega$numSpec(_p122._0)
					},
					_1: {ctor: '[]'}
				});
		case 'VExponent':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'exponent',
						_1: _user$project$Vega$valueSpec(_p122._0)
					},
					_1: {ctor: '[]'}
				});
		case 'VMultiply':
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'round',
						_1: _user$project$Vega$booSpec(_p122._0)
					},
					_1: {ctor: '[]'}
				});
		case 'VNum':
			return _elm_lang$core$Json_Encode$float(_p122._0);
		case 'VNums':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p122._0));
		case 'VKeyValue':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: _p122._0,
						_1: _user$project$Vega$valueSpec(_p122._1)
					},
					_1: {ctor: '[]'}
				});
		case 'VObject':
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p122._0));
		case 'Values':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p122._0));
		case 'VBoo':
			return _elm_lang$core$Json_Encode$bool(_p122._0);
		case 'VBoos':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p122._0));
		case 'VNull':
			return _elm_lang$core$Json_Encode$null;
		default:
			return _elm_lang$core$Json_Encode$null;
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: 'r',
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p123._0))
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_0: 'g',
								_1: _elm_lang$core$Json_Encode$object(
									A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p123._1))
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_0: 'b',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p123._2))
								},
								_1: {ctor: '[]'}
							}
						}
	...
	switch (_p124.ctor) {
		case 'VStr':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$string(_p124._0)
				},
				_1: {ctor: '[]'}
			};
		case 'VStrs':
			return {
				...
				_0: {
					...
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p124._0))
				},
				_1: {ctor: '[]'}
			};
		case 'VSignal':
			return {
				ctor: '::',
				_0: _user$project$Vega$signalReferenceProperty(_p124._0),
				_1: {ctor: '[]'}
			};
		case 'VColor':
			return {
				ctor: '::',
				_0: _user$project$Vega$colorProperty(_p124._0),
				_1: {ctor: '[]'}
			};
		case 'VField':
			return {
		...
		case 'VKeyValue':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: _p124._0,
					_1: _user$project$Vega$valueSpec(_p124._1)
				},
				_1: {ctor: '[]'}
			};
		case 'VBand':
		...
		case 'VExponent':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'exponent',
					_1: _user$project$Vega$valueSpec(_p124._0)
				},
				_1: {ctor: '[]'}
			};
		case 'VMultiply':
		...
		case 'VNum':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$float(_p124._0)
				},
				_1: {ctor: '[]'}
			};
		case 'VNums':
			return {
				...
				_0: {
					...
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p124._0))
				},
				_1: {ctor: '[]'}
			};
		case 'VObject':
			return {
				...
				_0: {
					...
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p124._0))
				},
				_1: {ctor: '[]'}
			};
		case 'Values':
			return {
				...
				_0: {
					...
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p124._0))
				},
				_1: {ctor: '[]'}
			};
		case 'VBoo':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$bool(_p124._0)
				},
				_1: {ctor: '[]'}
			};
		case 'VBoos':
			return {
				...
				_0: {
					...
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p124._0))
				},
				_1: {ctor: '[]'}
			};
		case 'VNull':
		...
		default:
			return {
				...
				_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p124._1)
			};
	}
};
			...
			A2(
				...
				function (_p125) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p126._0,
						_1: _user$project$Vega$valueSpec(_p126._1)
					};
				},
				row)));
};
	...
	switch (_p127.ctor) {
		case 'DaFormat':
			return {
				...
				_0: 'format',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$concatMap, _user$project$Vega$formatProperty, _p127._0))
			};
		case 'DaSource':
			return {
				ctor: '_Tuple2',
		...
		case 'DaSources':
			return {
				...
				_0: 'source',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p127._0))
			};
		case 'DaOn':
			return {
				ctor: '_Tuple2',
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(_p127._0)
			};
		case 'DaUrl':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$imputeProperty = function (ip) {
	var _p128 = ip;
	switch (_p128.ctor) {
		case 'ImKeyVals':
			return {
				ctor: '_Tuple2',
				_0: 'keyvals',
				_1: _user$project$Vega$valueSpec(_p128._0)
			};
		case 'ImMethod':
			return {
				ctor: '_Tuple2',
				_0: 'method',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$imputeMethodLabel(_p128._0))
			};
		case 'ImGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p128._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p129.ctor) {
		case 'InMin':
			return {
				ctor: '_Tuple2',
				_0: 'min',
				_1: _elm_lang$core$Json_Encode$float(_p129._0)
			};
		case 'InMax':
			return {
				ctor: '_Tuple2',
		...
		case 'InOptions':
			return {
				ctor: '_Tuple2',
				_0: 'options',
				_1: _user$project$Vega$valueSpec(_p129._0)
			};
		case 'InPlaceholder':
			return {
				ctor: '_Tuple2',
				_0: 'placeholder',
				_1: _elm_lang$core$Json_Encode$string(_p129._0)
			};
		case 'InElement':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$bindingProperty = function (bnd) {
	...
	switch (_p130.ctor) {
		case 'IRange':
			return A2(bSpec, 'range', _p130._0);
		case 'ICheckbox':
			return A2(bSpec, 'checkbox', _p130._0);
		case 'IRadio':
			return A2(bSpec, 'radio', _p130._0);
		case 'ISelect':
			return A2(bSpec, 'select', _p130._0);
		case 'IText':
			return A2(bSpec, 'text', _p130._0);
		case 'INumber':
			return A2(bSpec, 'number', _p130._0);
		case 'IDate':
			return A2(bSpec, 'date', _p130._0);
		case 'ITime':
			return A2(bSpec, 'time', _p130._0);
		case 'IMonth':
			return A2(bSpec, 'month', _p130._0);
		case 'IWeek':
			return A2(bSpec, 'week', _p130._0);
		case 'IDateTimeLocal':
			return A2(bSpec, 'datetimelocal', _p130._0);
		case 'ITel':
			return A2(bSpec, 'tel', _p130._0);
		default:
			return A2(bSpec, 'color', _p130._0);
	}
};
	...
	switch (_p131.ctor) {
		...
		case 'LAs':
			return {
				...
				_0: 'as',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p131._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'default',
				_1: _user$project$Vega$valueSpec(_p131._0)
			};
	}
};
var _user$project$Vega$signalProperty = function (sigProp) {
	...
	switch (_p132.ctor) {
		...
		case 'SiBind':
			return _user$project$Vega$bindingProperty(_p132._0);
		case 'SiDescription':
			return {
				ctor: '_Tuple2',
				_0: 'description',
		...
		case 'SiOn':
			return {
				...
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$eventHandlerSpec, _p132._0))
			};
		case 'SiReact':
			return {
				ctor: '_Tuple2',
				_0: 'react',
				_1: _user$project$Vega$booSpec(_p132._0)
			};
		case 'SiValue':
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _user$project$Vega$valueSpec(_p132._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				return F2(
					...
					})(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: colName,
							_1: _elm_lang$core$Json_Encode$float(_p133._0)
						},
						_1: {ctor: '[]'}
					});
			case 'VBoos':
				...
				return F2(
					...
					})(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: colName,
							_1: _elm_lang$core$Json_Encode$bool(_p133._0)
						},
						_1: {ctor: '[]'}
					});
			case 'VStrs':
				...
				return F2(
					...
					})(
					{
						...
						_0: {
							...
							_0: colName,
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p133._0))
						},
						_1: {ctor: '[]'}
					});
			case 'Values':
...
var _user$project$Vega$valRef = function (vs) {
	var _p134 = vs;
	if (((_p134.ctor === '::') && (_p134._0.ctor === 'VIfElse')) && (_p134._1.ctor === '[]')) {
					...
					_0: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'test',
								_1: _elm_lang$core$Json_Encode$string(_p135)
							},
							_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p136)
						}),
					_1: {ctor: '[]'}
				}));
	} else {
...
var _user$project$Vega$valIfElse = F4(
	function (ex, ifVals, elseVals, ifSpecs) {
		...
		while (true) {
			var _p137 = elseVals;
			if (((_p137.ctor === '::') && (_p137._0.ctor === 'VIfElse')) && (_p137._1.ctor === '[]')) {
				var _p139 = _p137._0._1;
						...
						_0: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'test',
									_1: _elm_lang$core$Json_Encode$string(_p138)
								},
								_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p139)
							}),
						_1: {ctor: '[]'}
					});
				ex = _v113;
	...
	switch (_p140.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$valRef(_p140._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: _p140._0,
				_1: _user$project$Vega$valRef(_p140._1)
			};
	}
};
	...
	switch (_p141.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p141._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		case 'EnName':
			return {
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(_p141._0)
			};
		case 'EnInteractive':
			return {
				ctor: '_Tuple2',
				_0: 'interactive',
				_1: _user$project$Vega$booSpec(_p141._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: _p141._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p141._1))
			};
	}
};
	...
	switch (_p142.ctor) {
		...
		case 'AxSide':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$sideSpec(_p142._0)
			};
		case 'AxBandPosition':
			return {
				ctor: '_Tuple2',
				_0: 'bandPosition',
				_1: _user$project$Vega$numSpec(_p142._0)
			};
		case 'AxDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$booSpec(_p142._0)
			};
		case 'AxDomainColor':
			return {
				ctor: '_Tuple2',
				_0: 'domainColor',
				_1: _user$project$Vega$strSpec(_p142._0)
			};
		case 'AxDomainWidth':
			return {
				ctor: '_Tuple2',
		...
		case 'AxEncode':
			var enc = function (_p143) {
				var _p144 = _p143;
				return {
					ctor: '_Tuple2',
					_0: _user$project$Vega$axisElementLabel(_p144._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p144._1))
				};
			};
			return {
				ctor: '_Tuple2',
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, enc, _p142._0))
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxGridDash':
			return {
				ctor: '_Tuple2',
				_0: 'gridDash',
				_1: _user$project$Vega$valRef(_p142._0)
			};
		case 'AxGridOpacity':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelAlign':
			return {
				ctor: '_Tuple2',
				_0: 'labelAlign',
				_1: _user$project$Vega$hAlignSpec(_p142._0)
			};
		case 'AxLabelAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'labelBaseline',
				_1: _user$project$Vega$vAlignSpec(_p142._0)
			};
		case 'AxLabelBound':
			var _p146 = _p142._0;
			var _p145 = _p146;
			if (_p145.ctor === 'NumNull') {
				return {
					ctor: '_Tuple2',
					_0: 'labelBound',
				...
				return {
					ctor: '_Tuple2',
					_0: 'labelBound',
					_1: _user$project$Vega$numSpec(_p146)
				};
			}
		case 'AxLabelColor':
			return {
		...
		case 'AxLabelFlush':
			...
			if (_p147.ctor === 'NumNull') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'labelFlush',
					_1: _user$project$Vega$numSpec(_p148)
				};
			}
		...
		case 'AxLabelFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'labelFontWeight',
				_1: _user$project$Vega$valueSpec(_p142._0)
			};
		case 'AxLabelLimit':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				ctor: '_Tuple2',
				_0: 'labelOverlap',
				_1: _user$project$Vega$overlapStrategySpec(_p142._0)
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
	...
	switch (_p149.ctor) {
		case 'EnLegend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p149._0))
			};
		case 'EnTitle':
			return {
				ctor: '_Tuple2',
	...
	switch (_p150.ctor) {
		case 'LeType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _user$project$Vega$legendTypeSpec(_p150._0)
			};
		case 'LeDirection':
			return {
				ctor: '_Tuple2',
				_0: 'direction',
				_1: _user$project$Vega$orientationSpec(_p150._0)
			};
		case 'LeOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$legendOrientSpec(_p150._0)
			};
		case 'LeFill':
			return {
				ctor: '_Tuple2',
				_0: 'fill',
				_1: _elm_lang$core$Json_Encode$string(_p150._0)
			};
		case 'LeOpacity':
			return {
				ctor: '_Tuple2',
		...
		case 'LeEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$legendEncodingProperty, _p150._0))
			};
		case 'LeFormat':
			return {
				ctor: '_Tuple2',
				_0: 'format',
				_1: _user$project$Vega$strSpec(_p150._0)
			};
		case 'LeGridAlign':
			return {
				ctor: '_Tuple2',
				_0: 'gridAlign',
				_1: _user$project$Vega$gridAlignSpec(_p150._0)
			};
		case 'LeClipHeight':
			return {
				ctor: '_Tuple2',
				_0: 'clipHeight',
				_1: _user$project$Vega$numSpec(_p150._0)
			};
		case 'LeColumns':
			return {
				ctor: '_Tuple2',
		...
		case 'LeOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$valueSpec(_p150._0)
			};
		case 'LePadding':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelAlign':
			return {
				ctor: '_Tuple2',
				_0: 'labelAlign',
				_1: _user$project$Vega$hAlignSpec(_p150._0)
			};
		case 'LeLabelBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'labelBaseline',
				_1: _user$project$Vega$vAlignSpec(_p150._0)
			};
		case 'LeLabelColor':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelOverlap':
			return {
				ctor: '_Tuple2',
				_0: 'labelOverlap',
				_1: _user$project$Vega$overlapStrategySpec(_p150._0)
			};
		...
		case 'LeSymbolType':
			return {
				ctor: '_Tuple2',
				_0: 'symbolType',
				_1: _user$project$Vega$symbolSpec(_p150._0)
			};
		case 'LeTickCount':
			return {
				ctor: '_Tuple2',
		...
		case 'LeValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p150._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p151.ctor) {
		case 'TText':
			return {
				ctor: '_Tuple2',
				_0: 'text',
				_1: _user$project$Vega$strSpec(_p151._0)
			};
		case 'TOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$sideSpec(_p151._0)
			};
		case 'TAnchor':
			return {
				ctor: '_Tuple2',
				_0: 'anchor',
				_1: _user$project$Vega$anchorSpec(_p151._0)
			};
		case 'TAngle':
			return {
				ctor: '_Tuple2',
				_0: 'angle',
				_1: _user$project$Vega$numSpec(_p151._0)
			};
		case 'TBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'baseline',
				_1: _user$project$Vega$vAlignSpec(_p151._0)
			};
		case 'TColor':
			return {
				ctor: '_Tuple2',
		...
		case 'TEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p151._0))
			};
		case 'TFont':
			return {
				ctor: '_Tuple2',
		...
		case 'TFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _user$project$Vega$valueSpec(_p151._0)
			};
		case 'TFrame':
			return {
				ctor: '_Tuple2',
				_0: 'fame',
				_1: _user$project$Vega$titleFrameSpec(_p151._0)
			};
		case 'TInteractive':
			return {
				ctor: '_Tuple2',
				_0: 'interactive',
				_1: _user$project$Vega$booSpec(_p151._0)
			};
		case 'TLimit':
			return {
				ctor: '_Tuple2',
		...
		case 'TName':
			return {
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(_p151._0)
			};
		case 'TStyle':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$windowOperationProperties = function (wos) {
	var windowAsSpec = function (wo) {
		var _p152 = wo;
		if (_p152.ctor === 'WnOperation') {
			return _elm_lang$core$Json_Encode$string(_p152._3);
		} else {
			return _elm_lang$core$Json_Encode$string(_p152._3);
		}
	};
	var windowFieldSpec = function (wo) {
		var _p153 = wo;
		if (_p153.ctor === 'WnOperation') {
			var _p154 = _p153._2;
			if (_p154.ctor === 'Just') {
				return _user$project$Vega$fieldSpec(_p154._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		} else {
			var _p155 = _p153._2;
			if (_p155.ctor === 'Just') {
				return _user$project$Vega$fieldSpec(_p155._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		}
	...
	var windowParamSpec = function (wo) {
		var _p156 = wo;
		if (_p156.ctor === 'WnOperation') {
			var _p157 = _p156._1;
			if (_p157.ctor === 'Just') {
				return _user$project$Vega$numSpec(_p157._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		} else {
			var _p158 = _p156._1;
			if (_p158.ctor === 'Just') {
				return _user$project$Vega$numSpec(_p158._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		}
	...
	var windowOpSpec = function (wo) {
		var _p159 = wo;
		if (_p159.ctor === 'WnOperation') {
			return _user$project$Vega$wOperationSpec(_p159._0);
		} else {
			return _user$project$Vega$opSpec(_p159._0);
		}
	};
	return {
		ctor: '::',
	...
	switch (_p160.ctor) {
		case 'WnSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$comparatorProperties(_p160._0))
			};
		case 'WnGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p160._0))
			};
		case 'WnFrame':
			return A3(_user$project$Vega$numArrayProperty, 2, 'frame', _p160._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'ignorePeers',
...
var _user$project$Vega$wordcloudProperty = function (wcp) {
	var _p161 = wcp;
	switch (_p161.ctor) {
		case 'WcFont':
			return {
				ctor: '_Tuple2',
				_0: 'font',
				_1: _user$project$Vega$strSpec(_p161._0)
			};
		case 'WcFontStyle':
			return {
				ctor: '_Tuple2',
		...
		case 'WcFontSizeRange':
			return A3(_user$project$Vega$numArrayProperty, 2, 'fontSizeRange', _p161._0);
		case 'WcPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
		...
		case 'WcText':
			return {
				ctor: '_Tuple2',
				_0: 'text',
				_1: _user$project$Vega$fieldSpec(_p161._0)
			};
		case 'WcSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p161._0);
		case 'WcSpiral':
			return {
				ctor: '_Tuple2',
				_0: 'spiral',
				_1: _user$project$Vega$spiralSpec(_p161._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$transformSpec = function (trans) {
	...
	switch (_p162.ctor) {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$aggregateProperty, _p162._0)
				});
		case 'TBin':
			var _p164 = _p162._1;
				...
				if (_p163.ctor === 'Num') {
					return A2(
						...
						A2(
							...
							_elm_lang$core$Basics$toString(_p164)),
						_elm_lang$core$Json_Encode$null);
				} else {
					return _user$project$Vega$numSpec(_p164);
				}
			}();
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$binProperty, _p162._2)
						}
					}
				});
		case 'TCollect':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_0: 'sort',
							_1: _elm_lang$core$Json_Encode$object(
								_user$project$Vega$comparatorProperties(_p162._0))
						},
						_1: {ctor: '[]'}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$countPatternProperty, _p162._1)
					}
				});
		case 'TCross':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$crossProperty, _p162._0)
				});
		case 'TCrossFilter':
			var _p165 = _elm_lang$core$List$unzip(_p162._0);
			var fs = _p165._0;
			var nums = _p165._1;
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								...
								_0: 'query',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _user$project$Vega$numSpec, nums))
							},
							_1: {ctor: '[]'}
						}
					}
		...
		case 'TCrossFilterAsSignal':
			var _p166 = _elm_lang$core$List$unzip(_p162._0);
			var fs = _p166._0;
			var nums = _p166._1;
			return _elm_lang$core$Json_Encode$object(
				{
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'signal',
									_1: _elm_lang$core$Json_Encode$string(_p162._1)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'distribution',
							_1: _user$project$Vega$distributionSpec(_p162._0)
						},
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$densityProperty, _p162._1)
					}
				});
		case 'TExtent':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Vega$exprProperty(_p162._0),
						_1: {ctor: '[]'}
					}
				});
		case 'TFlatten':
					...
					_1: {
						...
						_1: {
							...
							_0: {
								...
								_0: 'as',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p162._1))
							},
							_1: {ctor: '[]'}
						}
					}
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'fields',
								_1: _user$project$Vega$fieldSpec(_p167._0)
							},
							_1: {ctor: '[]'}
						}
					});
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'fields',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p168))
							},
							_1: {ctor: '[]'}
						}
					});
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'fields',
								_1: _user$project$Vega$fieldSpec(_p169._0)
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_1: _elm_lang$core$Json_Encode$list(
										{
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$string(_p171),
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$string(_p172),
												_1: {ctor: '[]'}
											}
										})
								},
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'fields',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p170))
							},
							_1: {
								ctor: '::',
								_0: {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'expr',
							_1: _user$project$Vega$expressionSpec(_p162._0)
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'initonly',
									_1: _user$project$Vega$formulaUpdateSpec(_p162._2)
								},
								_1: {ctor: '[]'}
							}
						}
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'key',
								_1: _user$project$Vega$fieldSpec(_p162._1)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$imputeProperty, _p162._2)
						}
					}
				});
		case 'TJoinAggregate':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$joinAggregateProperty, _p162._0)
				});
		case 'TLookup':
			return _elm_lang$core$Json_Encode$object(
				{
						...
						_1: {
							...
							_1: {
								...
								_0: {
									...
									_0: 'fields',
									_1: _elm_lang$core$Json_Encode$list(
										A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p162._2))
								},
								_1: A2(_elm_lang$core$List$map, _user$project$Vega$lookupProperty, _p162._3)
							}
						}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$pivotProperty, _p162._2)
						}
					}
				});
		case 'TProject':
			var _p173 = _elm_lang$core$List$unzip(_p162._0);
			var fields = _p173._0;
			var names = _p173._1;
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_0: 'fields',
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, fields))
						},
						_1: {
							ctor: '::',
							_0: {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'size',
							_1: _user$project$Vega$numSpec(_p162._0)
						},
						_1: {ctor: '[]'}
					}
				});
			...
			var stepProp = function () {
				...
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'step',
						_1: _user$project$Vega$numSpec(_p175)
					},
					_1: {ctor: '[]'}
				};
			}();
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'stop',
									_1: _user$project$Vega$numSpec(_p162._1)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Vega$windowOperationProperties(_p162._0),
						A2(_elm_lang$core$List$map, _user$project$Vega$windowProperty, _p162._1))
				});
		case 'TContour':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								{
									ctor: '::',
									_0: _user$project$Vega$numSpec(_p162._0),
									_1: {
										ctor: '::',
										_0: _user$project$Vega$numSpec(_p162._1),
										_1: {ctor: '[]'}
									}
								})
						},
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$contourProperty, _p162._2)
					}
				});
		case 'TGeoJson':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoJsonProperty, _p162._0)
				});
		case 'TGeoPath':
			var _p178 = _p162._0;
			var _p177 = _p162._1;
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p177)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'projection',
								_1: _elm_lang$core$Json_Encode$string(_p178)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p177)
						}
					});
						...
						_1: {
							...
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _user$project$Vega$fieldSpec(_p162._1),
										_1: {
											ctor: '::',
											_0: _user$project$Vega$fieldSpec(_p162._2),
											_1: {ctor: '[]'}
										}
									})
							},
							...
							_1: {
								...
								_0: {
									...
									_1: _elm_lang$core$Json_Encode$list(
										{
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$string(_p162._3),
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$string(_p162._4),
												_1: {ctor: '[]'}
											}
										})
								},
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p180)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'projection',
								_1: _elm_lang$core$Json_Encode$string(_p181)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p180)
						}
					});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$graticuleProperty, _p162._0)
				});
		case 'TLinkPath':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$linkPathProperty, _p162._0)
				});
		case 'TPie':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$pieProperty, _p162._0)
				});
		case 'TStack':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$stackProperty, _p162._0)
				});
		case 'TForce':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$forceSimulationProperty, _p162._0)
				});
		case 'TVoronoi':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$voronoiProperty, _p162._2)
						}
					}
				});
		case 'TWordcloud':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$wordcloudProperty, _p162._0)
				});
		case 'TNest':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'generate',
								_1: _user$project$Vega$booSpec(_p162._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$packProperty, _p162._0)
				});
		case 'TPartition':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$partitionProperty, _p162._0)
				});
		case 'TTree':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$treeProperty, _p162._0)
				});
		case 'TTreemap':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$treemapProperty, _p162._0)
				});
		default:
			return _elm_lang$core$Json_Encode$object(
				{
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _user$project$Vega$clipSpec(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'description',
					_1: _elm_lang$core$Json_Encode$string(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'interactive',
					_1: _user$project$Vega$booSpec(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MKey':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'key',
					_1: _user$project$Vega$fieldSpec(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MName':
		...
		case 'MOn':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'on',
					_1: _elm_lang$core$Json_Encode$list(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MRole':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						_user$project$Vega$comparatorProperties(_p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$transformSpec, _p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
			return {
				...
				_0: {
					...
					_0: 'style',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p182._0))
				},
				_1: {ctor: '[]'}
			};
		default:
			return A2(
				...
				function (_p183) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p184._0),
						_1: _p184._1
					};
				},
				_p182._0);
...
var _user$project$Vega$doSignals = function (ss) {
	return _user$project$Vega$DoStrs(
		_user$project$Vega$StrSignals(ss));
};
...
var _user$project$Vega$doSignal = function (s) {
	return _user$project$Vega$DoStrs(
		_user$project$Vega$StrSignal(s));
};
...
var _user$project$Vega$TLimit = function (a) {
	return {ctor: 'TLimit', _0: a};
};
var _user$project$Vega$tiLimit = _user$project$Vega$TLimit;
...
var _user$project$Vega$TFrame = function (a) {
	return {ctor: 'TFrame', _0: a};
};
var _user$project$Vega$tiFrame = _user$project$Vega$TFrame;
var _user$project$Vega$TFontWeight = function (a) {
	return {ctor: 'TFontWeight', _0: a};
};
var _user$project$Vega$tiFontWeight = _user$project$Vega$TFontWeight;
var _user$project$Vega$TFontSize = function (a) {
	return {ctor: 'TFontSize', _0: a};
};
var _user$project$Vega$tiFontSize = _user$project$Vega$TFontSize;
var _user$project$Vega$TFont = function (a) {
	return {ctor: 'TFont', _0: a};
};
var _user$project$Vega$tiFont = _user$project$Vega$TFont;
...
var _user$project$Vega$TColor = function (a) {
	return {ctor: 'TColor', _0: a};
};
var _user$project$Vega$tiColor = _user$project$Vega$TColor;
var _user$project$Vega$TBaseline = function (a) {
	return {ctor: 'TBaseline', _0: a};
};
var _user$project$Vega$tiBaseline = _user$project$Vega$TBaseline;
var _user$project$Vega$TAngle = function (a) {
	return {ctor: 'TAngle', _0: a};
};
var _user$project$Vega$tiAngle = _user$project$Vega$TAngle;
...
var _user$project$Vega$TWordcloud = function (a) {
	return {ctor: 'TWordcloud', _0: a};
};
var _user$project$Vega$trWordcloud = _user$project$Vega$TWordcloud;
var _user$project$Vega$TWindow = F2(
	function (a, b) {
		return {ctor: 'TWindow', _0: a, _1: b};
	});
var _user$project$Vega$trWindow = _user$project$Vega$TWindow;
var _user$project$Vega$TVoronoi = F3(
	function (a, b, c) {
		return {ctor: 'TVoronoi', _0: a, _1: b, _2: c};
	});
var _user$project$Vega$trVoronoi = _user$project$Vega$TVoronoi;
...
var _user$project$Vega$TSequence = F3(
	function (a, b, c) {
...
var _user$project$Vega$trResolveFilter = _user$project$Vega$TResolveFilter;
var _user$project$Vega$TProject = function (a) {
	return {ctor: 'TProject', _0: a};
};
var _user$project$Vega$trProject = _user$project$Vega$TProject;
var _user$project$Vega$TPivot = F3(
	function (a, b, c) {
		return {ctor: 'TPivot', _0: a, _1: b, _2: c};
	});
var _user$project$Vega$trPivot = _user$project$Vega$TPivot;
...
var _user$project$Vega$TJoinAggregate = function (a) {
	return {ctor: 'TJoinAggregate', _0: a};
};
var _user$project$Vega$trJoinAggregate = _user$project$Vega$TJoinAggregate;
var _user$project$Vega$TImpute = F3(
	function (a, b, c) {
		return {ctor: 'TImpute', _0: a, _1: b, _2: c};
	});
var _user$project$Vega$trImpute = _user$project$Vega$TImpute;
var _user$project$Vega$TIdentifier = function (a) {
	return {ctor: 'TIdentifier', _0: a};
};
var _user$project$Vega$trIdentifier = _user$project$Vega$TIdentifier;
...
var _user$project$Vega$TGeoPointAs = F5(
	function (a, b, c, d, e) {
		return {ctor: 'TGeoPointAs', _0: a, _1: b, _2: c, _3: d, _4: e};
	});
var _user$project$Vega$trGeoPointAs = _user$project$Vega$TGeoPointAs;
var _user$project$Vega$TGeoPoint = F3(
	function (a, b, c) {
		return {ctor: 'TGeoPoint', _0: a, _1: b, _2: c};
	});
var _user$project$Vega$trGeoPoint = _user$project$Vega$TGeoPoint;
...
var _user$project$Vega$TGeoJson = function (a) {
	return {ctor: 'TGeoJson', _0: a};
};
var _user$project$Vega$trGeoJson = _user$project$Vega$TGeoJson;
...
var _user$project$Vega$TFlattenAs = F2(
	function (a, b) {
		return {ctor: 'TFlattenAs', _0: a, _1: b};
	});
var _user$project$Vega$trFlattenAs = _user$project$Vega$TFlattenAs;
var _user$project$Vega$TFlatten = function (a) {
	return {ctor: 'TFlatten', _0: a};
};
var _user$project$Vega$trFlatten = _user$project$Vega$TFlatten;
...
var _user$project$Vega$TCrossFilterAsSignal = F2(
	function (a, b) {
		return {ctor: 'TCrossFilterAsSignal', _0: a, _1: b};
	});
var _user$project$Vega$trCrossFilterAsSignal = _user$project$Vega$TCrossFilterAsSignal;
var _user$project$Vega$TCrossFilter = function (a) {
	return {ctor: 'TCrossFilter', _0: a};
};
var _user$project$Vega$trCrossFilter = _user$project$Vega$TCrossFilter;
var _user$project$Vega$TCross = function (a) {
	return {ctor: 'TCross', _0: a};
};
var _user$project$Vega$trCross = _user$project$Vega$TCross;
var _user$project$Vega$TCountPattern = F2(
	function (a, b) {
		return {ctor: 'TCountPattern', _0: a, _1: b};
	});
var _user$project$Vega$trCountPattern = _user$project$Vega$TCountPattern;
...
var _user$project$Vega$TCollect = function (a) {
	return {ctor: 'TCollect', _0: a};
};
var _user$project$Vega$trCollect = _user$project$Vega$TCollect;
...
var _user$project$Vega$vScale = function (s) {
	return _user$project$Vega$VScale(
		_user$project$Vega$field(s));
};
var _user$project$Vega$vScaleField = _user$project$Vega$VScale;
...
var _user$project$Vega$black = _user$project$Vega$vStr('black');
var _user$project$Vega$hCenter = _user$project$Vega$vStr('center');
var _user$project$Vega$hLeft = _user$project$Vega$vStr('left');
var _user$project$Vega$hRight = _user$project$Vega$vStr('right');
var _user$project$Vega$markInterpolationValue = function (interp) {
	var _p185 = interp;
	switch (_p185.ctor) {
		case 'Basis':
			return _user$project$Vega$vStr('basis');
		case 'Bundle':
			return _user$project$Vega$vStr('bundle');
		case 'Cardinal':
			return _user$project$Vega$vStr('cardinal');
		case 'CatmullRom':
			return _user$project$Vega$vStr('catmull-rom');
		case 'Linear':
			return _user$project$Vega$vStr('linear');
		case 'Monotone':
			return _user$project$Vega$vStr('monotone');
		case 'Natural':
			return _user$project$Vega$vStr('natural');
		case 'Stepwise':
			return _user$project$Vega$vStr('step');
		case 'StepAfter':
			return _user$project$Vega$vStr('step-after');
		default:
			return _user$project$Vega$vStr('step-before');
	}
};
var _user$project$Vega$orientationValue = function (orient) {
	var _p186 = orient;
	switch (_p186.ctor) {
		case 'Horizontal':
			return _user$project$Vega$vStr('horizontal');
		case 'Vertical':
			return _user$project$Vega$vStr('vertical');
		case 'Radial':
			return _user$project$Vega$vStr('radial');
		default:
			return _user$project$Vega$vSignal(_p186._0);
	}
};
var _user$project$Vega$projectionValue = function (proj) {
	return _user$project$Vega$vStr(
		_user$project$Vega$projectionLabel(proj));
};
var _user$project$Vega$strokeCapValue = function (cap) {
	var _p187 = cap;
	switch (_p187.ctor) {
		case 'CButt':
			return _user$project$Vega$vStr('butt');
		case 'CRound':
			return _user$project$Vega$vStr('round');
		case 'CSquare':
			return _user$project$Vega$vStr('square');
		default:
			return _user$project$Vega$vSignal(_p187._0);
	}
};
var _user$project$Vega$strokeJoinValue = function (jn) {
	var _p188 = jn;
	switch (_p188.ctor) {
		case 'JMiter':
			return _user$project$Vega$vStr('miter');
		case 'JRound':
			return _user$project$Vega$vStr('round');
		case 'JBevel':
			return _user$project$Vega$vStr('bevel');
		default:
			return _user$project$Vega$vSignal(_p188._0);
	}
};
var _user$project$Vega$symbolValue = function (sym) {
	return _user$project$Vega$vStr(
		_user$project$Vega$symbolLabel(sym));
};
var _user$project$Vega$transparent = _user$project$Vega$vStr('transparent');
var _user$project$Vega$vAlphabetic = _user$project$Vega$vStr('alphabetic');
var _user$project$Vega$vBottom = _user$project$Vega$vStr('bottom');
var _user$project$Vega$vMiddle = _user$project$Vega$vStr('middle');
var _user$project$Vega$vTop = _user$project$Vega$vStr('top');
var _user$project$Vega$white = _user$project$Vega$vStr('white');
var _user$project$Vega$VoAs = function (a) {
	return {ctor: 'VoAs', _0: a};
};
var _user$project$Vega$voAs = _user$project$Vega$VoAs;
var _user$project$Vega$VoSize = function (a) {
	return {ctor: 'VoSize', _0: a};
};
var _user$project$Vega$voSize = _user$project$Vega$VoSize;
var _user$project$Vega$VoExtent = F2(
	function (a, b) {
		return {ctor: 'VoExtent', _0: a, _1: b};
	});
var _user$project$Vega$voExtent = _user$project$Vega$VoExtent;
...
var _user$project$Vega$WcAs = F7(
	function (a, b, c, d, e, f, g) {
		return {ctor: 'WcAs', _0: a, _1: b, _2: c, _3: d, _4: e, _5: f, _6: g};
	});
var _user$project$Vega$wcAs = _user$project$Vega$WcAs;
var _user$project$Vega$WcSpiral = function (a) {
	return {ctor: 'WcSpiral', _0: a};
};
var _user$project$Vega$wcSpiral = _user$project$Vega$WcSpiral;
var _user$project$Vega$WcSize = function (a) {
	return {ctor: 'WcSize', _0: a};
};
var _user$project$Vega$wcSize = _user$project$Vega$WcSize;
var _user$project$Vega$WcText = function (a) {
	return {ctor: 'WcText', _0: a};
};
var _user$project$Vega$wcText = _user$project$Vega$WcText;
var _user$project$Vega$WcRotate = function (a) {
	return {ctor: 'WcRotate', _0: a};
};
var _user$project$Vega$wcRotate = _user$project$Vega$WcRotate;
var _user$project$Vega$WcPadding = function (a) {
	return {ctor: 'WcPadding', _0: a};
};
var _user$project$Vega$wcPadding = _user$project$Vega$WcPadding;
var _user$project$Vega$WcFontSizeRange = function (a) {
	return {ctor: 'WcFontSizeRange', _0: a};
};
var _user$project$Vega$wcFontSizeRange = _user$project$Vega$WcFontSizeRange;
var _user$project$Vega$WcFontSize = function (a) {
	return {ctor: 'WcFontSize', _0: a};
};
var _user$project$Vega$wcFontSize = _user$project$Vega$WcFontSize;
var _user$project$Vega$WcFontWeight = function (a) {
	return {ctor: 'WcFontWeight', _0: a};
};
var _user$project$Vega$wcFontWeight = _user$project$Vega$WcFontWeight;
var _user$project$Vega$WcFontStyle = function (a) {
	return {ctor: 'WcFontStyle', _0: a};
};
var _user$project$Vega$wcFontStyle = _user$project$Vega$WcFontStyle;
var _user$project$Vega$WcFont = function (a) {
	return {ctor: 'WcFont', _0: a};
};
var _user$project$Vega$wcFont = _user$project$Vega$WcFont;
var _user$project$Vega$AnchorSignal = function (a) {
	return {ctor: 'AnchorSignal', _0: a};
};
var _user$project$Vega$anchorSignal = _user$project$Vega$AnchorSignal;
...
var _user$project$Vega$autosizeSignal = _user$project$Vega$AutosizeSignal;
...
var _user$project$Vega$AxBand = {ctor: 'AxBand'};
var _user$project$Vega$AxY = {ctor: 'AxY'};
var _user$project$Vega$AxX = {ctor: 'AxX'};
var _user$project$Vega$AxBottom = {ctor: 'AxBottom'};
var _user$project$Vega$AxRight = {ctor: 'AxRight'};
var _user$project$Vega$AxTop = {ctor: 'AxTop'};
var _user$project$Vega$AxLeft = {ctor: 'AxLeft'};
var _user$project$Vega$AxAll = {ctor: 'AxAll'};
...
var _user$project$Vega$Mixedcase = {ctor: 'Mixedcase'};
var _user$project$Vega$Uppercase = {ctor: 'Uppercase'};
var _user$project$Vega$Lowercase = {ctor: 'Lowercase'};
...
var _user$project$Vega$DensityFunctionSignal = function (a) {
	return {ctor: 'DensityFunctionSignal', _0: a};
};
var _user$project$Vega$densityFunctionSignal = _user$project$Vega$DensityFunctionSignal;
var _user$project$Vega$CDF = {ctor: 'CDF'};
var _user$project$Vega$PDF = {ctor: 'PDF'};
var _user$project$Vega$Allow = {ctor: 'Allow'};
var _user$project$Vega$configProperty = function (cp) {
	var _p189 = cp;
	switch (_p189.ctor) {
		case 'CfAutosize':
			return {
				...
				_0: 'autosize',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$autosizeProperty, _p189._0))
			};
		case 'CfBackground':
			return {
				ctor: '_Tuple2',
				_0: 'background',
				_1: _user$project$Vega$strSpec(_p189._0)
			};
		case 'CfGroup':
			return {
				ctor: '_Tuple2',
				_0: 'group',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p189._0))
			};
		case 'CfEvents':
			var _p190 = _p189._1;
			var listSpec = _elm_lang$core$Native_Utils.eq(
				...
				A2(
					...
					function (et) {
						return _elm_lang$core$Json_Encode$string(
							_user$project$Vega$eventTypeLabel(et));
					},
					_p190));
			var filterLabel = _elm_lang$core$Native_Utils.eq(_p189._0, _user$project$Vega$Allow) ? 'allow' : 'prevent';
			return {
				ctor: '_Tuple2',
				_0: 'events',
				_1: _elm_lang$core$Json_Encode$object(
		...
		case 'CfMark':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Vega$markLabel(_p189._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p189._1))
			};
		case 'CfMarks':
			return {
				ctor: '_Tuple2',
		...
		case 'CfAxis':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Vega$axTypeLabel(_p189._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$axisProperty, _p189._1))
			};
		case 'CfLegend':
			return {
				ctor: '_Tuple2',
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$legendProperty, _p189._0))
			};
		case 'CfTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$titleProperty, _p189._0))
			};
		default:
			var _p194 = _p189._1;
			var _p193 = _p189._0;
			var raVals = function () {
				...
				switch (_p191.ctor) {
					case 'RStrs':
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p191._0));
					case 'RSignal':
						return _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p191._0),
								_1: {ctor: '[]'}
							});
					case 'RScheme':
						return _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p191._0),
									_1: _p191._1
								}));
					default:
						return A2(
							...
							A2(
								...
								_elm_lang$core$Basics$toString(_p194)),
							_elm_lang$core$Json_Encode$null);
				}
			}();
					...
					default:
						return A2(
							...
							A2(
								...
								_elm_lang$core$Basics$toString(_p193)),
							'');
				}
			}();
			return {
...
var _user$project$Vega$Prevent = {ctor: 'Prevent'};
...
var _user$project$Vega$AlignSignal = function (a) {
	return {ctor: 'AlignSignal', _0: a};
};
var _user$project$Vega$gridAlignSignal = _user$project$Vega$AlignSignal;
...
var _user$project$Vega$HAlignSignal = function (a) {
	return {ctor: 'HAlignSignal', _0: a};
};
var _user$project$Vega$hAlignSignal = _user$project$Vega$HAlignSignal;
...
var _user$project$Vega$LegendOrientationSignal = function (a) {
	return {ctor: 'LegendOrientationSignal', _0: a};
};
var _user$project$Vega$legendOrientationSignal = _user$project$Vega$LegendOrientationSignal;
...
var _user$project$Vega$LegendTypeSignal = function (a) {
	return {ctor: 'LegendTypeSignal', _0: a};
};
var _user$project$Vega$legendTypeSignal = _user$project$Vega$LegendTypeSignal;
var _user$project$Vega$LGradient = {ctor: 'LGradient'};
var _user$project$Vega$LSymbol = {ctor: 'LSymbol'};
var _user$project$Vega$LinkShapeSignal = function (a) {
	return {ctor: 'LinkShapeSignal', _0: a};
};
var _user$project$Vega$linkShapeSignal = _user$project$Vega$LinkShapeSignal;
...
var _user$project$Vega$operationSignal = _user$project$Vega$OperationSignal;
...
var _user$project$Vega$orderSignal = _user$project$Vega$OrderSignal;
var _user$project$Vega$Descend = {ctor: 'Descend'};
var _user$project$Vega$Ascend = {ctor: 'Ascend'};
var _user$project$Vega$OrientationSignal = function (a) {
	return {ctor: 'OrientationSignal', _0: a};
};
var _user$project$Vega$orientationSignal = _user$project$Vega$OrientationSignal;
...
var _user$project$Vega$OverlapStrategySignal = function (a) {
	return {ctor: 'OverlapStrategySignal', _0: a};
};
var _user$project$Vega$overlapStrategySignal = _user$project$Vega$OverlapStrategySignal;
...
var _user$project$Vega$ProjectionSignal = function (a) {
	return {ctor: 'ProjectionSignal', _0: a};
};
var _user$project$Vega$projectionSignal = _user$project$Vega$ProjectionSignal;
...
var _user$project$Vega$ScaleSignal = function (a) {
	return {ctor: 'ScaleSignal', _0: a};
};
var _user$project$Vega$scaleSignal = _user$project$Vega$ScaleSignal;
...
var _user$project$Vega$ScaleNiceSignal = function (a) {
	return {ctor: 'ScaleNiceSignal', _0: a};
};
var _user$project$Vega$scaleNiceSignal = _user$project$Vega$ScaleNiceSignal;
...
var _user$project$Vega$SideSignal = function (a) {
	return {ctor: 'SideSignal', _0: a};
};
var _user$project$Vega$sideSignal = _user$project$Vega$SideSignal;
...
var _user$project$Vega$SortPropertySignal = function (a) {
	return {ctor: 'SortPropertySignal', _0: a};
};
var _user$project$Vega$sortPropertySignal = _user$project$Vega$SortPropertySignal;
...
var _user$project$Vega$dataRefProperty = function (dataRef) {
	var nestedSpec = function (dRef2) {
		var _p195 = dRef2;
		if (((_p195.ctor === '::') && (_p195._0.ctor === 'DValues')) && (_p195._1.ctor === '[]')) {
			return _user$project$Vega$valueSpec(_p195._0._0);
		} else {
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, dRef2));
		}
	};
	var _p196 = dataRef;
	switch (_p196.ctor) {
		case 'DDataset':
			return {
				ctor: '_Tuple2',
				_0: 'data',
				_1: _elm_lang$core$Json_Encode$string(_p196._0)
			};
		case 'DField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p196._0)
			};
		case 'DFields':
			return {
				ctor: '_Tuple2',
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p196._0))
			};
		case 'DValues':
			return {
				ctor: '_Tuple2',
				_0: 'values',
				_1: _user$project$Vega$valueSpec(_p196._0)
			};
		case 'DSignal':
			return {
				ctor: '_Tuple2',
		...
		default:
			...
			return (_elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p197))
			};
	}
};
var _user$project$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p198.ctor) {
		case 'DoNums':
			return _user$project$Vega$numSpec(_p198._0);
		case 'DoStrs':
			return _user$project$Vega$strSpec(_p198._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p198._0));
	}
};
	...
	switch (_p199.ctor) {
		case 'SType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _user$project$Vega$scaleSpec(_p199._0)
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p199._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
				_0: 'domainMax',
				_1: _user$project$Vega$numSpec(_p199._0)
			};
		case 'SDomainMin':
			return {
				ctor: '_Tuple2',
		...
		case 'SDomainRaw':
			return {
				ctor: '_Tuple2',
				_0: 'domainRaw',
				_1: _user$project$Vega$valueSpec(_p199._0)
			};
		case 'SRange':
			var _p200 = _p199._0;
			switch (_p200.ctor) {
				case 'RNums':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p200._0))
					};
				case 'RStrs':
					return {
						ctor: '_Tuple2',
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p200._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p200._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p200._0),
									_1: _p200._1
								}))
					};
				case 'RData':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$object(
							A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p200._0))
					};
				case 'RStep':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _user$project$Vega$valueSpec(_p200._0)
								},
								_1: {ctor: '[]'}
							})
					};
				...
				case 'RCustom':
					return {
						ctor: '_Tuple2',
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(_p200._0)
					};
				default:
					return {
						ctor: '_Tuple2',
		...
		case 'SRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _user$project$Vega$booSpec(_p199._0)
			};
		case 'SClamp':
			return {
				ctor: '_Tuple2',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p199._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p199._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$SpiralSignal = function (a) {
	return {ctor: 'SpiralSignal', _0: a};
};
var _user$project$Vega$spiralSignal = _user$project$Vega$SpiralSignal;
var _user$project$Vega$Rectangular = {ctor: 'Rectangular'};
var _user$project$Vega$Archimedean = {ctor: 'Archimedean'};
var _user$project$Vega$StackOffsetSignal = function (a) {
	return {ctor: 'StackOffsetSignal', _0: a};
};
var _user$project$Vega$stackOffsetSignal = _user$project$Vega$StackOffsetSignal;
...
var _user$project$Vega$StrokeCapSignal = function (a) {
	return {ctor: 'StrokeCapSignal', _0: a};
};
var _user$project$Vega$strokeCapSignal = _user$project$Vega$StrokeCapSignal;
...
var _user$project$Vega$StrokeJoinSignal = function (a) {
	return {ctor: 'StrokeJoinSignal', _0: a};
};
var _user$project$Vega$strokeJoinSignal = _user$project$Vega$StrokeJoinSignal;
...
var _user$project$Vega$SymbolSignal = function (a) {
	return {ctor: 'SymbolSignal', _0: a};
};
var _user$project$Vega$symbolSignal = _user$project$Vega$SymbolSignal;
...
var _user$project$Vega$TextDirectionSignal = function (a) {
	return {ctor: 'TextDirectionSignal', _0: a};
};
var _user$project$Vega$textDirectionSignal = _user$project$Vega$TextDirectionSignal;
var _user$project$Vega$RightToLeft = {ctor: 'RightToLeft'};
var _user$project$Vega$LeftToRight = {ctor: 'LeftToRight'};
var _user$project$Vega$TimeUnitSignal = function (a) {
...
var _user$project$Vega$TitleFrameSignal = function (a) {
	return {ctor: 'TitleFrameSignal', _0: a};
};
var _user$project$Vega$titleFrameSignal = _user$project$Vega$TitleFrameSignal;
var _user$project$Vega$FrGroup = {ctor: 'FrGroup'};
var _user$project$Vega$FrBounds = {ctor: 'FrBounds'};
var _user$project$Vega$TreemapMethodSignal = function (a) {
	return {ctor: 'TreemapMethodSignal', _0: a};
};
var _user$project$Vega$treemapMethodSignal = _user$project$Vega$TreemapMethodSignal;
...
var _user$project$Vega$treeMethodSignal = _user$project$Vega$TreeMethodSignal;
var _user$project$Vega$Cluster = {ctor: 'Cluster'};
var _user$project$Vega$Tidy = {ctor: 'Tidy'};
var _user$project$Vega$VAlignSignal = function (a) {
	return {ctor: 'VAlignSignal', _0: a};
};
var _user$project$Vega$vAlignSignal = _user$project$Vega$VAlignSignal;
...
var _user$project$Vega$config = function (cps) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Vega$VConfig,
		_1: _elm_lang$core$Json_Encode$object(
			A2(_elm_lang$core$List$map, _user$project$Vega$configProperty, cps))
	};
};
...
var _user$project$Vega$wOperationSignal = _user$project$Vega$WOperationSignal;
...
var _user$project$Vega$trFormula = F2(
	function (exp, fName) {
		return A3(_user$project$Vega$TFormula, exp, fName, _user$project$Vega$AlwaysUpdate);
	});
var _user$project$Vega$InitOnly = {ctor: 'InitOnly'};
var _user$project$Vega$trFormulaInitOnly = F2(
	function (exp, fName) {
...
var _user$project$TransformTests$nestTest1 = function () {
											...
											_1: {
												...
												_1: {
													...
													_0: _user$project$Vega$maSize(
														{
															ctor: '::',
															_0: _user$project$Vega$vNum(600),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_0: _user$project$Vega$maFontWeight(
																		{
																			ctor: '::',
																			_0: _user$project$Vega$vStr('normal'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
					...
					_1: {
						...
						_0: _user$project$Vega$scRange(
							A2(
								...
								_user$project$Vega$str('category20'),
								{ctor: '[]'})),
						_1: {ctor: '[]'}
					}
				},
	...
	var ds = _user$project$Vega$dataSource(
		{
			...
			_0: A2(
				_user$project$Vega$transform,
				{
					ctor: '::',
					_0: A2(
						_user$project$Vega$trNest,
						{
							ctor: '::',
							_0: _user$project$Vega$field('job'),
							_1: {
								ctor: '::',
								_0: _user$project$Vega$field('region'),
								_1: {ctor: '[]'}
							}
						},
						_user$project$Vega$booSignal('generate')),
					_1: {
						ctor: '::',
						_0: _user$project$Vega$trTree(
							{
								ctor: '::',
								_0: _user$project$Vega$teMethod(_user$project$Vega$Tidy),
								_1: {
									ctor: '::',
									_0: _user$project$Vega$teSize(
										_user$project$Vega$numSignals(
											{
												ctor: '::',
												_0: 'width',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Vega$trTreeLinks,
						_1: {
							ctor: '::',
							_0: _user$project$Vega$trLinkPath(
								{ctor: '[]'}),
							_1: {ctor: '[]'}
						}
					},
					A2(
						...
						{
							ctor: '::',
							_0: _user$project$Vega$daSource('tree'),
							_1: {ctor: '[]'}
						})),
				_1: {ctor: '[]'}
			}
	...
	return _user$project$Vega$toVega(
		{
			ctor: '::',
			_0: _user$project$Vega$width(300),
			_1: {
				ctor: '::',
				_0: _user$project$Vega$height(100),
				_1: {
					ctor: '::',
...
var _user$project$TransformTests$sourceExample = _user$project$TransformTests$nestTest1;
									...
									_0: _user$project$Vega$mTransform(
										{
											...
											_0: _user$project$Vega$trLinkPath(
												{
													ctor: '::',
													_0: _user$project$Vega$lpShape(_user$project$Vega$LinkDiagonal),
													_1: {
														ctor: '::',
														_0: _user$project$Vega$lpSourceX(
															_user$project$Vega$field('datum.source.x')),
														_1: {
															ctor: '::',
															_0: _user$project$Vega$lpSourceY(
																_user$project$Vega$field('datum.source.y')),
															_1: {
																ctor: '::',
																_0: _user$project$Vega$lpTargetX(
																	_user$project$Vega$field('datum.target.x')),
																_1: {
																	ctor: '::',
																	_0: _user$project$Vega$lpTargetY(
																		_user$project$Vega$field('datum.target.y')),
																	_1: {ctor: '[]'}
																}
															}
														}
				...
				'cScale',
				{
					...
					_1: {
						...
						_0: _user$project$Vega$scRange(
							A2(
								_user$project$Vega$raScheme,
								_user$project$Vega$str('category20c'),
								{ctor: '[]'})),
						_1: {ctor: '[]'}
					}
				},
														...
														_0: _user$project$Vega$siOn(
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _user$project$Vega$esMerge(
																			{
																				ctor: '::',
																				_0: _user$project$Vega$esObject(
																					{
																						ctor: '::',
																						_0: _user$project$Vega$esMark(_user$project$Vega$Symbol),
																						_1: {
																							ctor: '::',
																							_0: _user$project$Vega$esType(_user$project$Vega$MouseOut),
																							_1: {
																								ctor: '::',
																								_0: _user$project$Vega$esFilter(
																									{
																										ctor: '::',
																										_0: '!event.buttons',
																										_1: {ctor: '[]'}
																				...
																				_1: {
																					...
																					_0: _user$project$Vega$esObject(
																						{
																							ctor: '::',
																							_0: _user$project$Vega$esSource(_user$project$Vega$ESWindow),
																							_1: {
																								ctor: '::',
																								_0: _user$project$Vega$esType(_user$project$Vega$MouseUp),
																								_1: {ctor: '[]'}
																							}
																						}),
																					_1: {ctor: '[]'}
																	...
																	_1: {
																		...
																		_0: A2(
																				...
																				_0: _user$project$Vega$esObject(
																					{
																						ctor: '::',
																						_0: A2(
																							_user$project$Vega$esBetween,
																							{
																								ctor: '::',
																								_0: _user$project$Vega$esMark(_user$project$Vega$Symbol),
																								_1: {
																									ctor: '::',
																									_0: _user$project$Vega$esType(_user$project$Vega$MouseDown),
																									_1: {ctor: '[]'}
																								}
																							},
																							{
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _user$project$Vega$esType(_user$project$Vega$MouseMove),
																								_1: {
																									ctor: '::',
																									_0: _user$project$Vega$esConsume(_user$project$Vega$true),
																									_1: {ctor: '[]'}
																								}
																							}
																						}
																			...
																			},
																			{
																				...
																				_1: {
																					ctor: '::',
																					_0: _user$project$Vega$evForce(_user$project$Vega$true),
																					_1: {ctor: '[]'}
																				}
																			}),
																		_1: {ctor: '[]'}
																...
																_0: _user$project$Vega$siOn(
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _user$project$Vega$esSelector(
				...
				'node-data',
				{
					...
					_1: {
						...
						_0: _user$project$Vega$daFormat(
							{
								ctor: '::',
								_0: _user$project$Vega$jsonProperty('nodes'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
					...
					'link-data',
					{
						...
						_1: {
							...
							_0: _user$project$Vega$daFormat(
								{
									ctor: '::',
									_0: _user$project$Vega$jsonProperty('links'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
						...
						'cScale',
						{
							...
							_1: {
								...
								_0: _user$project$Vega$scRange(
									A2(
										_user$project$Vega$raScheme,
										_user$project$Vega$str('category10'),
										{ctor: '[]'})),
								_1: {ctor: '[]'}
							}
						},
			...
			_0: A2(
				_user$project$Vega$on,
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Vega$tgInsert('add'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Vega$tgRemove('rem'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				A2(
					_user$project$Vega$transform,
					{
						...
						_0: _user$project$Vega$trStack(
							{
								ctor: '::',
								_0: _user$project$Vega$stField(
									_user$project$Vega$field('value')),
								_1: {
									ctor: '::',
									_0: _user$project$Vega$stGroupBy(
										{
											ctor: '::',
											_0: _user$project$Vega$field('key'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _user$project$Vega$stOffset(
											_user$project$Vega$stackOffsetSignal('offset')),
										_1: {
											ctor: '::',
											_0: _user$project$Vega$stSort(
												{
													...
													_0: {
														ctor: '_Tuple2',
														_0: _user$project$Vega$fSignal('sortField'),
														_1: _user$project$Vega$orderSignal('sortOrder')
													},
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
	...
	var ds = _user$project$Vega$dataSource(
		{
			...
			_0: A2(
				_user$project$Vega$transform,
				{
					ctor: '::',
					_0: A2(
						_user$project$Vega$trStratify,
						_user$project$Vega$field('id'),
						_user$project$Vega$field('parent')),
					_1: {
						ctor: '::',
						_0: _user$project$Vega$trPack(
							{
								ctor: '::',
								_0: _user$project$Vega$paField(
									_user$project$Vega$field('value')),
								_1: {
									ctor: '::',
									_0: _user$project$Vega$paPadding(
										_user$project$Vega$numSignal('padding between circles')),
									_1: {
										ctor: '::',
										_0: _user$project$Vega$paSize(
											_user$project$Vega$numSignals(
												{
													ctor: '::',
													_0: 'width',
...
var _user$project$TransformTests$mySpecs = _user$project$Vega$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'packTest1', _1: _user$project$TransformTests$packTest1},
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'nestTest1', _1: _user$project$TransformTests$nestTest1},
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$TransformTests$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _user$project$TransformTests$mySpecs,
			_1: _user$project$TransformTests$elmToJS(_user$project$TransformTests$mySpecs)
		},
...
var Elm = {};
Elm['TransformTests'] = Elm['TransformTests'] || {};
if (typeof _user$project$TransformTests$main !== 'undefined') {
    _user$project$TransformTests$main(Elm['TransformTests'], 'TransformTests', undefined);
}
