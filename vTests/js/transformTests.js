	...
	switch (_p17.ctor) {
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _user$project$Vega$opSpec(_p17._0)
			};
	}
};
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$timeUnitLabel(_p19._0))
					},
					_1: {
						ctor: '::',
						_0: {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'datum',
						_1: _user$project$Vega$fieldValueSpec(_p31._0)
					},
					_1: {ctor: '[]'}
				});
		case 'FGroup':
	...
	switch (_p32.ctor) {
		...
		case 'PiStartAngle':
			return {
				ctor: '_Tuple2',
				_0: 'startAngle',
				_1: _user$project$Vega$signalNumSpec(_p32._0)
			};
		case 'PiEndAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'PiSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _user$project$Vega$signalBoolSpec(_p32._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$sourceProperty = function (src) {
	...
	if (_p34.ctor === 'SData') {
		...
		return {
			...
			_0: 'facet',
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$facetProperty, _p34._0))
		};
	}
};
			...
			return {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'values',
						_1: _user$project$Vega$expressionSpec(_p35._1)
					},
					_1: {ctor: '[]'}
				}
			};
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'g',
								_1: _elm_lang$core$Json_Encode$float(_p41._1)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'b',
									_1: _elm_lang$core$Json_Encode$float(_p41._2)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Vega$valueProperty = function (val) {
	...
	switch (_p43.ctor) {
		...
		case 'VSignal':
			return _user$project$Vega$signalReferenceProperty(_p43._0);
		case 'VColor':
			return _user$project$Vega$colorProperty(_p43._0);
		case 'VField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldValueSpec(_p43._0)
			};
		case 'VScale':
			return {
				ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									...
									_0: 'if',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p43._1))
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_0: 'else',
										_1: _elm_lang$core$Json_Encode$object(
											A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p43._2))
									},
									_1: {ctor: '[]'}
								}
							}
	...
	switch (_p46.ctor) {
		...
		case 'PaPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _user$project$Vega$signalNumSpec(_p46._0)
			};
		default:
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$aggregateProperty, _p54._0)
				});
		case 'TBin':
			return _elm_lang$core$Json_Encode$object(
				{
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'initonly',
									_1: _user$project$Vega$formulaUpdateSpec(_p54._2)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$pieProperty, _p54._0)
				});
		case 'TStack':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$stackProperty, _p54._0)
				});
		case 'TForce':
			return _elm_lang$core$Json_Encode$object(
				{
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$packProperty, _p54._0)
				});
		case 'TPartition':
			return _elm_lang$core$Json_Encode$object(
				{
	...
	switch (_p81.ctor) {
		...
		default:
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p82))
			};
	}
};
	...
	switch (_p84.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$scaleLabel(_p84._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p84._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
			...
			switch (_p85.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p85._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
					...
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p85._0),
									_1: _p85._1
								}))
					};
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$dataRefProperty(_p85._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
				...
				default:
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$rangeDefaultLabel(_p85._0))
					};
			}
		case 'SPadding':
			return {
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p84._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p84._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
						...
						_0: _user$project$Vega$TPack(
							{
								...
								_1: {
									...
									_0: _user$project$Vega$PaPadding(
										_user$project$Vega$SigNumRef('padding between circles')),
									_1: {
										ctor: '::',
