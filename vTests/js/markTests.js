...
var _user$project$Vega$eventHandlerSpec = function (_p35) {
	var _p36 = _p35;
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(_elm_lang$core$List$map, eventHandler, _p36._1)
		});
};
...
var _user$project$Vega$eventStream = function (eStr) {
	return eStr;
};
