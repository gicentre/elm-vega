											...
											_1: {
												...
												_1: {
													...
													_0: _user$project$Vega$maSize(
														{
															ctor: '::',
															_0: _user$project$Vega$vScale('zscale'),
															_1: {
																ctor: '::',
																_0: _user$project$Vega$vField(
																	_user$project$Vega$field('v')),
							...
							A3(
								...
								A3(
									...
									A3(
										...
										{
											ctor: '::',
											_0: _user$project$Vega$siValue(_user$project$Vega$hLeft),
											_1: {
												ctor: '::',
												_0: _user$project$Vega$siBind(
										...
										A3(
											...
											{
												ctor: '::',
												_0: _user$project$Vega$siValue(_user$project$Vega$vAlphabetic),
												_1: {
													ctor: '::',
													_0: _user$project$Vega$siBind(
														_user$project$Vega$iSelect(
							...
							_user$project$Vega$iSelect(
								{
									ctor: '::',
									_0: _user$project$Vega$inOptions(
										_user$project$Vega$vValues(
											{
												ctor: '::',
												_0: _user$project$Vega$symbolValue(_user$project$Vega$SymCircle),
												_1: {
													ctor: '::',
													_0: _user$project$Vega$symbolValue(_user$project$Vega$SymSquare),
													_1: {
														ctor: '::',
														_0: _user$project$Vega$symbolValue(_user$project$Vega$SymCross),
														_1: {
															ctor: '::',
															_0: _user$project$Vega$symbolValue(_user$project$Vega$SymDiamond),
															_1: {
																ctor: '::',
																_0: _user$project$Vega$symbolValue(_user$project$Vega$SymTriangleUp),
																_1: {
																	ctor: '::',
																	_0: _user$project$Vega$symbolValue(_user$project$Vega$SymTriangleDown),
																	_1: {
																		ctor: '::',
																		_0: _user$project$Vega$symbolValue(_user$project$Vega$SymTriangleRight),
																		_1: {
																			ctor: '::',
																			_0: _user$project$Vega$symbolValue(_user$project$Vega$SymTriangleLeft),
																			_1: {
																				ctor: '::',
																				_0: _user$project$Vega$symbolValue(
																					_user$project$Vega$symPath('M-1,-1H1V1H-1Z')),
																				_1: {
																					ctor: '::',
																					_0: _user$project$Vega$symbolValue(
																						_user$project$Vega$symPath('M0,.5L.6,.8L.5,.1L1,-.3L.3,-.4L0,-1L-.3,-.4L-1,-.3L-.5,.1L-.6,.8L0,.5Z')),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
						...
						A3(
							...
							A3(
								...
								'strokeCap',
								{
									ctor: '::',
									_0: _user$project$Vega$siValue(
										_user$project$Vega$strokeCapValue(_user$project$Vega$CButt)),
									_1: {
										ctor: '::',
										_0: _user$project$Vega$siBind(
											_user$project$Vega$iSelect(
