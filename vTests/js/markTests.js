	...
	switch (_p45.ctor) {
		...
		case 'MAlign':
			return {
				...
				_0: 'align',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$hAlignLabel(_p45._0))
			};
		case 'MAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'MBaseline':
			return {
				...
				_0: 'baseline',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$vAlignLabel(_p45._0))
			};
		case 'MDir':
			return {
				ctor: '_Tuple2',
...
var _user$project$MarkTests$sourceExample = _user$project$MarkTests$areaTest;
