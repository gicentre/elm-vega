			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$timeUnitLabel(_p15._0))
					},
					_1: {
						ctor: '::',
						_0: {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'row',
						_1: _user$project$Vega$gridAlignSpec(_p20._0)
					},
					_1: {ctor: '[]'}
				});
		default:
						...
						A2(
							...
							function (_p26) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p27._0,
									_1: _user$project$Vega$foDataTypeSpec(_p27._1)
								};
							},
							_p25._0))
				},
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'datum',
						_1: _user$project$Vega$fieldValueSpec(_p28._0)
					},
					_1: {ctor: '[]'}
				});
		case 'FGroup':
		...
		case 'TgTrigger':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'trigger',
					_1: _user$project$Vega$expressionSpec(_p29._0)
				},
				_1: {ctor: '[]'}
			};
		case 'TgInsert':
			...
			return {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'values',
						_1: _user$project$Vega$expressionSpec(_p29._1)
					},
					_1: {ctor: '[]'}
				}
			};
	...
	switch (_p33.ctor) {
		case 'FpX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$fieldSpec(_p33._0)
			};
		case 'FpY':
			return {
				ctor: '_Tuple2',
		...
		case 'FpCx':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$numSpec(_p33._0)
			};
		case 'FpCy':
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _user$project$Vega$forceProperty, _p34._0)
				});
		case 'FCollide':
			return _elm_lang$core$Json_Encode$object(
				{
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$forceProperty, _p34._1)
					}
				});
		default:
			return _elm_lang$core$Json_Encode$object(
...
var _user$project$Vega$windowOperationProperties = function (wos) {
	...
	var windowFieldSpec = function (wo) {
		...
		if (_p37.ctor === 'WnOperation') {
			return _user$project$Vega$fieldSpec(_p37._2);
		} else {
			return _user$project$Vega$fieldSpec(_p37._2);
		}
	};
	var windowParamSpec = function (wo) {
		...
		if (_p38.ctor === 'WnOperation') {
			var _p39 = _p38._1;
			if (_p39.ctor === 'Just') {
				return _user$project$Vega$numSpec(_p39._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		} else {
	...
	var windowOpSpec = function (wo) {
		...
		if (_p41.ctor === 'WnOperation') {
			return _user$project$Vega$wOperationSpec(_p41._0);
		} else {
			return _user$project$Vega$opSpec(_p41._0);
		}
	};
	return {
		ctor: '::',
	...
	switch (_p42.ctor) {
		case 'LPSourceX':
			return {
				ctor: '_Tuple2',
				_0: 'sourceX',
				_1: _user$project$Vega$fieldSpec(_p42._0)
			};
		case 'LPSourceY':
			return {
				ctor: '_Tuple2',
		...
		case 'LPOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$strSpec(_p42._0)
			};
		case 'LPShape':
			return {
				ctor: '_Tuple2',
		...
		switch (_p46.ctor) {
			case 'ESSource':
				return {
					...
					_0: 'source',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventSourceLabel(_p46._0))
				};
			case 'ESType':
				return {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventTypeLabel(_p46._0))
				};
			case 'ESBetween':
				return {
					ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _user$project$Vega$eventStreamObjectSpec(_p46._0),
							_1: {
								ctor: '::',
								_0: _user$project$Vega$eventStreamObjectSpec(_p46._1),
								_1: {ctor: '[]'}
							}
						})
				};
			...
			case 'ESMark':
				return {
					...
					_0: 'marktype',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p46._0))
				};
			case 'ESThrottle':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: 'stream',
					_1: _user$project$Vega$eventStreamSpec(_p46._0)
				};
		}
	};
	return _elm_lang$core$Json_Encode$object(
...
var _user$project$Vega$eventStreamSpec = function (es) {
	...
	switch (_p49.ctor) {
		case 'ESSelector':
			return _user$project$Vega$strSpec(_p49._0);
		case 'ESObject':
			return _user$project$Vega$eventStreamObjectSpec(_p49._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						...
						_0: 'merge',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$eventStreamSpec, _p49._0))
					},
					_1: {ctor: '[]'}
				});
	}
		...
		switch (_p50.ctor) {
			case 'EEvents':
				return {
					ctor: '_Tuple2',
					_0: 'events',
					_1: _user$project$Vega$eventStreamSpec(_p50._0)
				};
			case 'EUpdate':
				var _p51 = _p50._0;
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'stdev',
								_1: _user$project$Vega$numSpec(_p52._1)
							},
							_1: {ctor: '[]'}
						}
					}
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'field',
								_1: _user$project$Vega$fieldSpec(_p52._1)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'bandwidth',
									_1: _user$project$Vega$numSpec(_p52._2)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Vega$comparatorProperty = function (comp) {
	...
	if (_p54.ctor === 'CoField') {
		...
		return {
			...
			_0: 'order',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$orderSpec, _p54._0))
		};
	}
};
	...
	switch (_p55.ctor) {
		...
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$stackOffsetSpec(_p55._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: 'r',
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p56._0))
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_0: 'g',
								_1: _elm_lang$core$Json_Encode$object(
									A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p56._1))
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_0: 'b',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p56._2))
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Vega$valueProperty = function (val) {
	...
	switch (_p57.ctor) {
		...
		case 'VColor':
			return _user$project$Vega$colorProperty(_p57._0);
		case 'VField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldValueSpec(_p57._0)
			};
		case 'VScale':
			return {
				ctor: '_Tuple2',
		...
		case 'VKeyValue':
			return {
				ctor: '_Tuple2',
				_0: _p57._0,
				_1: _user$project$Vega$valueSpec(_p57._1)
			};
		case 'VBand':
			return {
				ctor: '_Tuple2',
		...
		case 'VExponent':
			return {
				ctor: '_Tuple2',
				_0: 'exponent',
				_1: _user$project$Vega$valueSpec(_p57._0)
			};
		case 'VMultiply':
			return {
				ctor: '_Tuple2',
		...
		case 'Values':
			return {
				...
				_0: 'value',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p57._0))
			};
		case 'VBoo':
			return {
				ctor: '_Tuple2',
	...
	switch (_p58.ctor) {
		...
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$colorProperty(_p58._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _user$project$Vega$fieldValueSpec(_p58._0);
		case 'VScale':
			return _user$project$Vega$fieldValueSpec(_p58._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'VExponent':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$valueProperty(_p58._0),
					_1: {ctor: '[]'}
				});
		case 'VMultiply':
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p59.ctor) {
		case 'DaFormat':
			return {
				...
				_0: 'format',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$formatProperty(_p59._0))
			};
		case 'DaSource':
			return {
				ctor: '_Tuple2',
	...
	switch (_p61.ctor) {
		case 'LValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p61._0))
			};
		case 'LAs':
			return {
				ctor: '_Tuple2',
	...
	switch (_p62.ctor) {
		...
		case 'PaSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p62._0))
			};
		case 'PaSize':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _user$project$Vega$valueSpec(_p62._0),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$valueSpec(_p62._1),
							_1: {ctor: '[]'}
						}
					})
			};
				...
				switch (_p128.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'extent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p128._0))
						};
					case 'NumSignals':
						if (((_p128._0.ctor === '::') && (_p128._0._1.ctor === '::')) && (_p128._0._1._1.ctor === '[]')) {
							return {
	...
	switch (_p131.ctor) {
		case 'PrType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _user$project$Vega$projectionSpec(_p131._0)
			};
		case 'PrClipAngle':
			var _p133 = _p131._0;
			var _p132 = _p133;
				...
				switch (_p134.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'clipExtent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p134._0))
						};
					case 'NumSignals':
						if (((((_p134._0.ctor === '::') && (_p134._0._1.ctor === '::')) && (_p134._0._1._1.ctor === '::')) && (_p134._0._1._1._1.ctor === '::')) && (_p134._0._1._1._1._1.ctor === '[]')) {
							return {
		...
		case 'PrScale':
			return {
				ctor: '_Tuple2',
				_0: 'scale',
				_1: _user$project$Vega$numSpec(_p131._0)
			};
		case 'PrTranslate':
			var _p137 = _p131._0;
			var _p136 = _p137;
				...
				switch (_p136.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'translate',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p136._0))
						};
					case 'NumSignals':
						if (((_p136._0.ctor === '::') && (_p136._0._1.ctor === '::')) && (_p136._0._1._1.ctor === '[]')) {
							return {
				...
				switch (_p138.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'rotate',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p138._0))
						};
					case 'NumSignals':
						if ((_p138._0.ctor === '::') && (_p138._0._1.ctor === '::')) {
							if (_p138._0._1._1.ctor === '[]') {
				...
				switch (_p140.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'extent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p140._0))
						};
					case 'NumSignals':
						if (((((_p140._0.ctor === '::') && (_p140._0._1.ctor === '::')) && (_p140._0._1._1.ctor === '::')) && (_p140._0._1._1._1.ctor === '::')) && (_p140._0._1._1._1._1.ctor === '[]')) {
							return {
				...
				switch (_p142.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'size',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p142._0))
						};
					case 'NumSignals':
						if (((_p142._0.ctor === '::') && (_p142._0._1.ctor === '::')) && (_p142._0._1._1.ctor === '[]')) {
							return {
	...
	switch (_p144.ctor) {
		case 'WnSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p144._0))
			};
		case 'WnGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p144._0))
			};
		case 'WnFrame':
			var _p146 = _p144._0;
			var _p145 = _p146;
		...
		case 'TFold':
			...
			var fSpec = function () {
				...
				if (_p150.ctor === 'Str') {
					...
					return _user$project$Vega$strSpec(_p151);
				}
			}();
			return _elm_lang$core$Json_Encode$object(
				{
		...
		case 'TFoldAs':
			...
			var fSpec = function () {
				...
				if (_p152.ctor === 'Str') {
					...
					return _user$project$Vega$strSpec(_p153);
				}
			}();
			return _elm_lang$core$Json_Encode$object(
				{
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p155)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p160._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _user$project$Vega$clipSpec(_p160._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
		...
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p160._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p160._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p160._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$transformSpec, _p160._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
		...
		default:
			return A2(
				...
				function (_p161) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p162._0),
						_1: _p162._1
					};
				},
				_p160._0);
	...
	switch (_p163.ctor) {
		...
		default:
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p164))
			};
	}
};
var _user$project$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p165.ctor) {
		case 'DoNums':
			return _user$project$Vega$numSpec(_p165._0);
		case 'DoStrs':
			return _user$project$Vega$strSpec(_p165._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p165._0));
	}
};
	...
	switch (_p166.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$scaleLabel(_p166._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p166._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
				_0: 'domainMax',
				_1: _user$project$Vega$numSpec(_p166._0)
			};
		case 'SDomainMin':
			return {
				ctor: '_Tuple2',
			...
			switch (_p167.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p167._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p167._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p167._0),
									_1: _p167._1
								}))
					};
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$dataRefProperty(_p167._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _user$project$Vega$valueSpec(_p167._0)
								},
								_1: {ctor: '[]'}
							})
					};
				default:
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$rangeDefaultLabel(_p167._0))
					};
			}
		case 'SPadding':
			return {
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p166._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p166._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
