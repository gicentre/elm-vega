	...
	switch (_p15.ctor) {
		...
		case 'ByField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$strSpec(_p15._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _user$project$Vega$opSpec(_p15._0)
			};
	}
};
	...
	switch (_p30.ctor) {
		...
		case 'LPOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$strSpec(_p30._0)
			};
		case 'LPShape':
			return {
				ctor: '_Tuple2',
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'field',
								_1: _user$project$Vega$fieldSpec(_p45._1)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'bandwidth',
									_1: _user$project$Vega$numSpec(_p45._2)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Vega$comparatorProperty = function (comp) {
	...
	if (_p47.ctor === 'CoField') {
		return {
			...
			_0: 'field',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p47._0))
		};
	} else {
		return {
			ctor: '_Tuple2',
			_0: 'order',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$orderSpec, _p47._0))
		};
	}
};
	...
	switch (_p48.ctor) {
		...
		case 'StGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p48._0))
			};
		case 'StSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p48._0))
			};
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$stackOffsetSpec(_p48._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: 'r',
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p49._0))
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_0: 'g',
								_1: _elm_lang$core$Json_Encode$object(
									A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p49._1))
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_0: 'b',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p49._2))
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Vega$valueProperty = function (val) {
	...
	switch (_p50.ctor) {
		...
		case 'VSignal':
			return _user$project$Vega$signalReferenceProperty(_p50._0);
		case 'VColor':
			return _user$project$Vega$colorProperty(_p50._0);
		case 'VField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldValueSpec(_p50._0)
			};
		case 'VScale':
			return {
				ctor: '_Tuple2',
		...
		case 'VKeyValue':
			return {
				ctor: '_Tuple2',
				_0: _p50._0,
				_1: _user$project$Vega$valueSpec(_p50._1)
			};
		case 'VBand':
			return {
				ctor: '_Tuple2',
		...
		case 'VExponent':
			return {
				ctor: '_Tuple2',
				_0: 'exponent',
				_1: _user$project$Vega$valueSpec(_p50._0)
			};
		case 'VMultiply':
			return {
				ctor: '_Tuple2',
		...
		case 'VObject':
			return {
				...
				_0: 'value',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p50._0))
			};
		case 'Values':
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p50._0))
			};
		case 'VBoo':
			return {
				ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									...
									_0: 'if',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p50._1))
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_0: 'else',
										_1: _elm_lang$core$Json_Encode$object(
											A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p50._2))
									},
									_1: {ctor: '[]'}
								}
							}
	...
	switch (_p51.ctor) {
		...
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$colorProperty(_p51._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _user$project$Vega$fieldValueSpec(_p51._0);
		case 'VScale':
			return _user$project$Vega$fieldValueSpec(_p51._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'VExponent':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$valueProperty(_p51._0),
					_1: {ctor: '[]'}
				});
		case 'VMultiply':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: _p51._0,
						_1: _user$project$Vega$valueSpec(_p51._1)
					},
					_1: {ctor: '[]'}
				});
		case 'VObject':
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p51._0));
		case 'Values':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p51._0));
		case 'VBoo':
	...
	switch (_p52.ctor) {
		case 'DaFormat':
			return {
				...
				_0: 'format',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$formatProperty(_p52._0))
			};
		case 'DaSource':
			return {
				ctor: '_Tuple2',
		...
		case 'DaValue':
			return {
				ctor: '_Tuple2',
				_0: 'values',
				_1: _user$project$Vega$valueSpec(_p52._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p53.ctor) {
		...
		case 'InOptions':
			return {
				ctor: '_Tuple2',
				_0: 'options',
				_1: _user$project$Vega$valueSpec(_p53._0)
			};
		case 'InPlaceholder':
			return {
				ctor: '_Tuple2',
	...
	switch (_p54.ctor) {
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'default',
				_1: _user$project$Vega$valueSpec(_p54._0)
			};
	}
};
	...
	switch (_p55.ctor) {
		...
		case 'PaSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p55._0))
			};
		case 'PaSize':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _user$project$Vega$valueSpec(_p55._0),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$valueSpec(_p55._1),
							_1: {ctor: '[]'}
						}
					})
			};
		...
		case 'PaPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _user$project$Vega$numSpec(_p55._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				_0: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p57._0._1)
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$valueProperty, _p57._0._2)),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _user$project$Vega$boundsCalculationLabel = function (bc) {
	var _p58 = bc;
	if (_p58.ctor === 'Full') {
		return 'full';
	} else {
	...
	switch (_p59.ctor) {
		case 'LAlign':
			return {
				ctor: '_Tuple2',
				_0: 'align',
				_1: _user$project$Vega$gridAlignSpec(_p59._0)
			};
		case 'LBounds':
			return {
				ctor: '_Tuple2',
				_0: 'bounds',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$boundsCalculationLabel(_p59._0))
			};
		case 'LColumns':
			return {
				ctor: '_Tuple2',
				_0: 'columns',
				_1: _user$project$Vega$numSpec(_p59._0)
			};
		case 'LPadding':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'col',
								_1: _user$project$Vega$numSpec(_p59._1)
							},
							_1: {ctor: '[]'}
						}
					})
	...
	switch (_p60.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$exprProperty(_p60._0),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Vega$clipSpec = function (clip) {
	...
	switch (_p61.ctor) {
		case 'ClEnabled':
			return _user$project$Vega$booSpec(_p61._0);
		case 'ClPath':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'path',
						_1: _user$project$Vega$strSpec(_p61._0)
					},
					_1: {ctor: '[]'}
				});
		default:
	...
	switch (_p62.ctor) {
		...
		case 'CnX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$fieldSpec(_p62._0)
			};
		case 'CnY':
			return {
				ctor: '_Tuple2',
	...
	switch (_p67.ctor) {
		case 'FsStatic':
			return {
				ctor: '_Tuple2',
				_0: 'static',
				_1: _user$project$Vega$booSpec(_p67._0)
			};
		case 'FsRestart':
			return {
				ctor: '_Tuple2',
		...
		case 'FsForces':
			return {
				...
				_0: 'forces',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$forceSpec, _p67._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p68.ctor) {
		case 'PiField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$fieldSpec(_p68._0)
			};
		case 'PiStartAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'PiSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _user$project$Vega$booSpec(_p68._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				case 'Num':
					return {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _user$project$Vega$numSpec(_p71),
								_1: {ctor: '[]'}
							})
					};
				case 'NumSignal':
...
var _user$project$Vega$signalProperty = function (sigProp) {
	...
	switch (_p73.ctor) {
		...
		case 'SiBind':
			return _user$project$Vega$bindingProperty(_p73._0);
		case 'SiDescription':
			return {
				ctor: '_Tuple2',
				_0: 'description',
		...
		case 'SiUpdate':
			return {
				ctor: '_Tuple2',
				_0: 'update',
				_1: _user$project$Vega$expressionSpec(_p73._0)
			};
		case 'SiOn':
			return {
				ctor: '_Tuple2',
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$eventHandlerSpec, _p73._0))
			};
		case 'SiReact':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _user$project$Vega$valueSpec(_p73._0)
			};
	}
};
...
var _user$project$Vega$anchorLabel = function (anchor) {
	var _p76 = anchor;
	switch (_p76.ctor) {
		case 'Start':
			return 'start';
	...
	switch (_p77.ctor) {
		case 'AgGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p77._0))
			};
		case 'AgFields':
			return {
				ctor: '_Tuple2',
	...
	switch (_p78.ctor) {
		...
		default:
			return {
				...
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$aggregateProperty, _p78._0))
			};
	}
};
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p80) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p81._0),
						_1: _p81._1
					};
				},
				spec)
	...
	switch (_p84.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$valRef(_p84._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		case 'MStrokeJoin':
			return {
				...
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$strokeJoinLabel(_p84._0))
			};
	...
	switch (_p85.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p85._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p85._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p85._1))
			};
	}
};
	...
	switch (_p86.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$sideLabel(_p86._0))
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxEncode':
			var enc = function (_p87) {
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Vega$axisElementLabel(_p88._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p88._1))
				};
			};
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$overlapStrategyLabel(_p86._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'AxTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _user$project$Vega$strSpec(_p86._0)
			};
		case 'AxTitlePadding':
			return {
				ctor: '_Tuple2',
	...
	switch (_p91.ctor) {
		case 'EnLegend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p91._0))
			};
		case 'EnTitle':
			return {
				ctor: '_Tuple2',
	...
	switch (_p92.ctor) {
		case 'TOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$sideLabel(_p92._0))
			};
		case 'TAnchor':
			return {
				ctor: '_Tuple2',
				_0: 'anchor',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$anchorLabel(_p92._0))
			};
		case 'TEncode':
			return {
				ctor: '_Tuple2',
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p92._0))
			};
		case 'TInteractive':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$projectionLabel = function (proj) {
	...
	switch (_p94.ctor) {
		...
		default:
			return _user$project$Vega$strString(_p94._0);
	}
};
var _user$project$Vega$projectionSpec = function (proj) {
	var _p95 = proj;
	if (_p95.ctor === 'Proj') {
		return _user$project$Vega$strSpec(_p95._0);
	} else {
	...
	switch (_p100.ctor) {
		case 'LeType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$legendTypeLabel(_p100._0))
			};
		case 'LeDirection':
			return {
				ctor: '_Tuple2',
				_0: 'direction',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$markOrientationLabel(_p100._0))
			};
		case 'LeOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$legendOrientLabel(_p100._0))
			};
		case 'LeFill':
			return {
				ctor: '_Tuple2',
		...
		case 'LeEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$legendEncodingProperty, _p100._0))
			};
		case 'LeFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'LeGridAlign':
			return {
				ctor: '_Tuple2',
				_0: 'gridAlign',
				_1: _user$project$Vega$gridAlignSpec(_p100._0)
			};
		case 'LeClipHeight':
			return {
				ctor: '_Tuple2',
		...
		case 'LeOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$valueSpec(_p100._0)
			};
		case 'LePadding':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelAlign':
			return {
				...
				_0: 'labelAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$hAlignLabel(_p100._0))
			};
		case 'LeLabelBaseline':
			return {
				...
				_0: 'labelBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$vAlignLabel(_p100._0))
			};
		case 'LeLabelColor':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$overlapStrategyLabel(_p100._0))
			};
		...
		case 'LeSymbolType':
			return {
				...
				_0: 'symbolType',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$symbolLabel(_p100._0))
			};
		case 'LeTickCount':
			return {
				ctor: '_Tuple2',
		...
		case 'LeValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p100._0))
			};
		default:
			return {
				ctor: '_Tuple2',
			...
			A2(
				...
				function (_p102) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p103._0,
						_1: _user$project$Vega$valueSpec(_p103._1)
					};
				},
				row)));
};
		...
		return {
			...
			_1: _elm_lang$core$Json_Encode$object(
				A2(
					...
					{
						ctor: '::',
						_0: _user$project$Vega$FaData(_p106._0),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$FaName(_p106._1),
							_1: _p106._2
						}
					}))
		};
				...
				switch (_p121.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'extent',
							_1: _user$project$Vega$numSpec(
								_user$project$Vega$NumSignal(_p121._0))
						};
					case 'NumSignals':
						if (((_p121._0.ctor === '::') && (_p121._0._1.ctor === '::')) && (_p121._0._1._1.ctor === '[]')) {
							return {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p124._1)
					}
				});
		case 'TGeoPoint':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p131._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _user$project$Vega$clipSpec(_p131._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
		...
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p131._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p131._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p131._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$transformSpec, _p131._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
		...
		default:
			return A2(
				...
				function (_p132) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p133._0),
						_1: _p133._1
					};
				},
				_p131._0);
	...
	switch (_p134.ctor) {
		case 'PrType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _user$project$Vega$projectionSpec(_p134._0)
			};
		case 'PrClipAngle':
			var _p136 = _p134._0;
			var _p135 = _p136;
...
var _user$project$Vega$trContour = F3(
	function (sizeX, sizeY, cnProps) {
		return A3(_user$project$Vega$TContour, sizeX, sizeY, cnProps);
	});
	...
	switch (_p147.ctor) {
		...
		default:
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p148))
			};
	}
};
var _user$project$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p149.ctor) {
		...
		case 'DoStrs':
			return _user$project$Vega$strSpec(_p149._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p149._0));
	}
};
	...
	switch (_p150.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$scaleLabel(_p150._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p150._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
			...
			switch (_p151.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p151._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p151._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p151._0),
									_1: _p151._1
								}))
					};
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$dataRefProperty(_p151._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
				...
				default:
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$rangeDefaultLabel(_p151._0))
					};
			}
		case 'SPadding':
			return {
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p150._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p150._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$title = F2(
	function (s, tps) {
		return {
			...
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$titleProperty, tps))
		};
	});
