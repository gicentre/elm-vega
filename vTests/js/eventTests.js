...
var _user$project$EventTests$eventStream1 = function () {
	var mk = function (_p0) {
								...
								_0: _user$project$Vega$enUpdate(
									{
										...
										_0: _user$project$Vega$maX(
											{
												ctor: '::',
												_0: _user$project$Vega$vSignal('myDrag[0]'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _user$project$Vega$maY(
												{
													ctor: '::',
													_0: _user$project$Vega$vSignal('myDrag[1]'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
											...
											_1: {
												...
												_1: {
													...
													_0: _user$project$Vega$maText(
														{
															ctor: '::',
															_0: _user$project$Vega$vStr('Drag me'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
									...
									_0: _user$project$Vega$enUpdate(
										{
											...
											_0: _user$project$Vega$maX(
												{
													ctor: '::',
													_0: _user$project$Vega$vSignal('myDrag[0]+40'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _user$project$Vega$maY(
													{
														ctor: '::',
														_0: _user$project$Vega$vSignal('myDrag[1]+25'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
						...
						_0: _user$project$Vega$siOn(
							{
								...
								_0: A2(
										...
										_0: _user$project$Vega$esObject(
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _user$project$Vega$esSource(_user$project$Vega$ESView),
														_1: {
															ctor: '::',
									...
									{
										ctor: '::',
										_0: _user$project$Vega$evUpdate('xy()'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
	...
	return _user$project$Vega$toVega(
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Vega$height(400),
				_1: {
					ctor: '::',
					_0: _user$project$Vega$background(
						_user$project$Vega$str('rgb(252,247,236)')),
					_1: {
						ctor: '::',
...
var _user$project$EventTests$sourceExample = _user$project$EventTests$eventStream1;
var _user$project$EventTests$view = function (spec) {
	return A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Json_Encode$encode, 2, _user$project$EventTests$sourceExample)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$EventTests$uiEvents = function () {
	var mk = function (_p2) {
		return _user$project$Vega$marks(
			A3(
				_user$project$Vega$mark,
							...
							_0: _user$project$Vega$enUpdate(
								{
									...
									_0: _user$project$Vega$maFillOpacity(
										{
											ctor: '::',
											_0: _user$project$Vega$vSignal('rFill ? 1 : 0'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _user$project$Vega$maFill(
											{
												ctor: '::',
												_0: _user$project$Vega$vSignal('rColor'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _user$project$Vega$maStroke(
												{
													ctor: '::',
													_0: _user$project$Vega$vSignal('borderColor'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _user$project$Vega$maStrokeWidth(
													{
														ctor: '::',
														_0: _user$project$Vega$vSignal('borderWidth == \'thin\' ? 1 : borderWidth == \'medium\' ? 4 : 10'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: _user$project$Vega$maWidth(
														{
															ctor: '::',
															_0: _user$project$Vega$vSignal('rSize'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
									...
									_0: _user$project$Vega$enUpdate(
										{
											...
											_0: _user$project$Vega$maX(
												{
													ctor: '::',
													_0: _user$project$Vega$vSignal('rSize / 2'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_0: _user$project$Vega$maText(
														{
															ctor: '::',
															_0: _user$project$Vega$vSignal('rLabel +\' \'+ timestamp'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _user$project$Vega$maFill(
															{
																ctor: '::',
																_0: _user$project$Vega$vSignal('rColor == \'black\' && rFill ? \'white\' : \'black\''),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: _user$project$Vega$maFontSize(
																{
																	ctor: '::',
																	_0: _user$project$Vega$vSignal('labelSize'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
			...
			A3(
							...
							_user$project$Vega$iRange(
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$Vega$inMax(400),
										_1: {ctor: '[]'}
									}
								})),
						_1: {ctor: '[]'}
				...
				A3(
					...
					A3(
						...
						{
							ctor: '::',
							_0: _user$project$Vega$siValue(_user$project$Vega$black),
							_1: {
								ctor: '::',
								_0: _user$project$Vega$siBind(
									_user$project$Vega$iColor(
										{ctor: '[]'})),
								_1: {ctor: '[]'}
							}
						},
									...
									_1: {
										...
										_0: _user$project$Vega$siBind(
											_user$project$Vega$iText(
												{
													ctor: '::',
													_0: _user$project$Vega$inPlaceholder('Type label here'),
													_1: {ctor: '[]'}
												})),
										_1: {ctor: '[]'}
									}
								...
								A3(
									...
									A3(
										...
										'borderWidth',
										{
											ctor: '::',
											_0: _user$project$Vega$siValue(
												_user$project$Vega$vStr('medium')),
											_1: {
												ctor: '::',
												_0: _user$project$Vega$siBind(
										...
										A3(
											...
											'timestamp',
											{
												ctor: '::',
												_0: _user$project$Vega$siValue(
													_user$project$Vega$vStr('12:00')),
												_1: {
													ctor: '::',
													_0: _user$project$Vega$siBind(
														_user$project$Vega$iTime(
															{ctor: '[]'})),
													_1: {ctor: '[]'}
												}
											},
...
var _user$project$EventTests$mySpecs = _user$project$Vega$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'uiEvents', _1: _user$project$EventTests$uiEvents},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'eventStream1', _1: _user$project$EventTests$eventStream1},
			_1: {ctor: '[]'}
		}
	});
var _user$project$EventTests$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _user$project$EventTests$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _user$project$EventTests$mySpecs,
			_1: _user$project$EventTests$elmToJS(_user$project$EventTests$mySpecs)
		},
		view: _user$project$EventTests$view,
		update: F2(
			function (_p4, model) {
...
var Elm = {};
Elm['EventTests'] = Elm['EventTests'] || {};
if (typeof _user$project$EventTests$main !== 'undefined') {
    _user$project$EventTests$main(Elm['EventTests'], 'EventTests', undefined);
}
