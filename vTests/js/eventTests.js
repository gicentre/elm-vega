			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'row',
						_1: _user$project$Vega$gridAlignSpec(_p23._0)
					},
					_1: {ctor: '[]'}
				});
		default:
						...
						A2(
							...
							function (_p29) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p30._0,
									_1: _user$project$Vega$foDataTypeSpec(_p30._1)
								};
							},
							_p28._0))
				},
			...
			return {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'values',
						_1: _user$project$Vega$expressionSpec(_p31._1)
					},
					_1: {ctor: '[]'}
				}
			};
...
var _user$project$Vega$numSpec = function (num) {
	...
	switch (_p33.ctor) {
		...
		case 'NumList':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$numSpec, _p33._0));
		default:
	...
	switch (_p37.ctor) {
		...
		case 'ByField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _user$project$Vega$strSpec(_p37._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _user$project$Vega$opSpec(_p37._0)
			};
	}
};
		...
		switch (_p40.ctor) {
			case 'ESSource':
				return {
					...
					_0: 'source',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventSourceLabel(_p40._0))
				};
			case 'ESType':
				return {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventTypeLabel(_p40._0))
				};
			case 'ESBetween':
				return {
					ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _user$project$Vega$eventStreamObjectSpec(_p40._0),
							_1: {
								ctor: '::',
								_0: _user$project$Vega$eventStreamObjectSpec(_p40._1),
								_1: {ctor: '[]'}
							}
						})
				};
			...
			case 'ESDebounce':
				return {
					ctor: '_Tuple2',
					_0: 'debounce',
					_1: _user$project$Vega$numSpec(_p40._0)
				};
			case 'ESMarkName':
				return {
					ctor: '_Tuple2',
			...
			case 'ESMark':
				return {
					...
					_0: 'marktype',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p40._0))
				};
			case 'ESThrottle':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: 'stream',
					_1: _user$project$Vega$eventStreamSpec(_p40._0)
				};
		}
	};
	return _elm_lang$core$Json_Encode$object(
...
var _user$project$Vega$eventStreamSpec = function (es) {
	...
	switch (_p43.ctor) {
		...
		case 'ESObject':
			return _user$project$Vega$eventStreamObjectSpec(_p43._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						...
						_0: 'merge',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$eventStreamSpec, _p43._0))
					},
					_1: {ctor: '[]'}
				});
	}
		...
		switch (_p44.ctor) {
			case 'EEvents':
				return {
					ctor: '_Tuple2',
					_0: 'events',
					_1: _user$project$Vega$eventStreamSpec(_p44._0)
				};
			case 'EUpdate':
				var _p45 = _p44._0;
			...
			switch (_p54.ctor) {
				case 'Num':
					return {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _user$project$Vega$numSpec(_p55),
								_1: {ctor: '[]'}
							})
					};
				case 'NumSignal':
				...
				default:
					return {
						ctor: '_Tuple2',
						_0: 'steps',
						_1: _user$project$Vega$numSpec(_p55)
					};
			}
		case 'BnMinStep':
			return {
	...
	switch (_p171.ctor) {
		...
		case 'DFields':
			return {
				...
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p171._0))
			};
		case 'DSignal':
			return {
				ctor: '_Tuple2',
		...
		default:
			...
			return (_elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p172))
			};
	}
};
var _user$project$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p173.ctor) {
		case 'DoNums':
			return _user$project$Vega$numSpec(_p173._0);
		case 'DoStrs':
			return _user$project$Vega$strSpec(_p173._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p173._0));
	}
};
	...
	switch (_p174.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$scaleLabel(_p174._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p174._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
			...
			switch (_p175.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p175._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$signalReferenceProperty(_p175._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p175._0),
									_1: _p175._1
								}))
					};
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$dataRefProperty(_p175._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _user$project$Vega$valueSpec(_p175._0)
								},
								_1: {ctor: '[]'}
							})
					};
				default:
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(
							_user$project$Vega$rangeDefaultLabel(_p175._0))
					};
			}
		case 'SPadding':
			return {
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p174._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p174._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
