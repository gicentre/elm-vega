		...
		switch (_p41.ctor) {
			case 'ESSource':
				return {
					...
					_0: 'source',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventSourceLabel(_p41._0))
				};
			case 'ESType':
				return {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$eventTypeLabel(_p41._0))
				};
			case 'ESBetween':
				return {
					ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _user$project$Vega$eventStreamObjectSpec(_p41._0),
							_1: {
								ctor: '::',
								_0: _user$project$Vega$eventStreamObjectSpec(_p41._1),
								_1: {ctor: '[]'}
							}
						})
				};
			...
			case 'ESFilter':
				...
				if ((_p42.ctor === '::') && (_p42._1.ctor === '[]')) {
					...
					return {
						...
						_0: 'filter',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p43))
					};
				}
			case 'ESDebounce':
				return {
					ctor: '_Tuple2',
					_0: 'debounce',
					_1: _user$project$Vega$numSpec(_p41._0)
				};
			case 'ESMarkName':
				return {
					ctor: '_Tuple2',
			...
			case 'ESMark':
				return {
					...
					_0: 'marktype',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p41._0))
				};
			case 'ESThrottle':
				return {
					ctor: '_Tuple2',
...
var _user$project$Vega$eventStreamSpec = function (es) {
	...
	switch (_p44.ctor) {
		case 'ESSelector':
			return _user$project$Vega$strSpec(_p44._0);
		case 'ESObject':
			return _user$project$Vega$eventStreamObjectSpec(_p44._0);
		case 'ESSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_0: 'merge',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$eventStreamSpec, _p44._0))
					},
					_1: {ctor: '[]'}
				});
	}
		...
		switch (_p45.ctor) {
			case 'EEvents':
				return {
					ctor: '_Tuple2',
					_0: 'events',
					_1: _user$project$Vega$eventStreamSpec(_p45._0)
				};
			case 'EUpdate':
				var _p46 = _p45._0;
				return _elm_lang$core$Native_Utils.eq(_p46, '') ? {
					ctor: '_Tuple2',
					_0: 'update',
					_1: _elm_lang$core$Json_Encode$string('{}')
				} : {
			...
			switch (_p55.ctor) {
				case 'Num':
					return {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _user$project$Vega$numSpec(_p56),
								_1: {ctor: '[]'}
							})
					};
				case 'NumSignal':
				...
				default:
					return {
						ctor: '_Tuple2',
						_0: 'steps',
						_1: _user$project$Vega$numSpec(_p56)
					};
			}
		case 'BnMinStep':
			return {
		...
		default:
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p54._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p54._1),
							_1: {ctor: '[]'}
						}
					})
			};
	...
	switch (_p60.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p60._0),
					_1: {ctor: '[]'}
				});
	}
};
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p61) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p62._0),
						_1: _p62._1
					};
				},
				spec)
...
var _user$project$Vega$projectionLabel = function (proj) {
	...
	switch (_p66.ctor) {
		...
		default:
			return _user$project$Vega$strString(_p66._0);
	}
};
var _user$project$Vega$projectionSpec = function (proj) {
	var _p67 = proj;
	if (_p67.ctor === 'Proj') {
		return _user$project$Vega$strSpec(_p67._0);
	} else {
...
var _user$project$Vega$projectionProperty = function (projProp) {
	...
	switch (_p81.ctor) {
		...
		case 'PrFit':
			return {ctor: '_Tuple2', _0: 'fit', _1: _p81._0};
		case 'PrExtent':
			var _p89 = _p81._0;
			var _p88 = _p89;
			_v75_3:
	...
	switch (_p92.ctor) {
		...
		default:
			return {
				...
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$aggregateProperty, _p92._0))
			};
	}
};
		...
		return {
			...
			_1: _elm_lang$core$Json_Encode$object(
				A2(
					...
					{
						ctor: '::',
						_0: _user$project$Vega$FaData(_p93._0),
						_1: {
							ctor: '::',
							_0: _user$project$Vega$FaName(_p93._1),
							_1: _p93._2
						}
					}))
		};
...
var _user$project$Vega$comparatorProperties = function (comp) {
	var _p94 = _elm_lang$core$List$unzip(comp);
	var fs = _p94._0;
	var os = _p94._1;
	return {
		ctor: '::',
...
var _user$project$Vega$distributionSpec = function (dist) {
	...
	switch (_p100.ctor) {
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'stdev',
								_1: _user$project$Vega$numSpec(_p100._1)
							},
							_1: {ctor: '[]'}
						}
					}
		...
		case 'DiKde':
			...
			var _p102 = _p100._0;
			var _p101 = _p100._2;
			return _elm_lang$core$Native_Utils.eq(_p102, '') ? _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'field',
							_1: _user$project$Vega$fieldSpec(_p103)
						},
						_1: {
							ctor: '::',
							_0: {
				...
				}) : _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'from',
							_1: _elm_lang$core$Json_Encode$string(_p102)
						},
						_1: {
							ctor: '::',
							_0: {
		...
		default:
			...
			var probs = A2(
				...
				_elm_lang$core$Tuple$second(
					_elm_lang$core$List$unzip(_p104)));
			var dists = A2(
				_elm_lang$core$List$map,
...
var _user$project$Vega$graticuleProperty = function (grProp) {
	...
	switch (_p109.ctor) {
		...
		case 'GrExtentMajor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'extentMajor', _p109._0);
		case 'GrExtentMinor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'extentMinor', _p109._0);
		case 'GrExtent':
			return A3(_user$project$Vega$numArrayProperty, 2, 'extentr', _p109._0);
		case 'GrStepMajor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'stepMajor', _p109._0);
		case 'GrStepMinor':
			return A3(_user$project$Vega$numArrayProperty, 2, 'stepMinor', _p109._0);
		case 'GrStep':
			return A3(_user$project$Vega$numArrayProperty, 2, 'step', _p109._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'precision',
	...
	switch (_p110.ctor) {
		...
		case 'LPOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _user$project$Vega$strSpec(_p110._0)
			};
		case 'LPShape':
			return {
				ctor: '_Tuple2',
	...
	switch (_p111.ctor) {
		...
		case 'PaSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_user$project$Vega$comparatorProperties(_p111._0))
			};
		case 'PaSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p111._0);
		case 'PaRadius':
			var _p112 = _p111._0;
			if (_p112.ctor === 'Just') {
				return {
	...
	switch (_p113.ctor) {
		...
		case 'PtRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _user$project$Vega$booSpec(_p113._0)
			};
		case 'PtSize':
		...
		default:
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p113._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(_p113._1),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$string(_p113._2),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$string(_p113._3),
									_1: {
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$string(_p113._4),
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$string(_p113._5),
											_1: {ctor: '[]'}
										}
									}
								}
	...
	switch (_p114.ctor) {
		...
		case 'PiSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _user$project$Vega$booSpec(_p114._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p115.ctor) {
		...
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _user$project$Vega$stackOffsetSpec(_p115._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p116.ctor) {
		...
		case 'TmMethod':
			return {
				ctor: '_Tuple2',
				_0: 'method',
				_1: _user$project$Vega$tmMethodSpec(_p116._0)
			};
		case 'TmPadding':
			return {
				ctor: '_Tuple2',
	...
	switch (_p117.ctor) {
		...
		case 'TeMethod':
			return {
				ctor: '_Tuple2',
				_0: 'method',
				_1: _user$project$Vega$teMethodSpec(_p117._0)
			};
		case 'TeSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'size', _p117._0);
		case 'TeNodeSize':
			return A3(_user$project$Vega$numArrayProperty, 2, 'nodeSize', _p117._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'as',
...
var _user$project$Vega$valueSpec = function (val) {
	...
	switch (_p118.ctor) {
		case 'VStr':
			return _elm_lang$core$Json_Encode$string(_p118._0);
		case 'VStrs':
			return _elm_lang$core$Json_Encode$list(
		...
		case 'VSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$signalReferenceProperty(_p118._0),
					_1: {ctor: '[]'}
				});
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _user$project$Vega$colorProperty(_p118._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _user$project$Vega$fieldSpec(_p118._0);
		case 'VScale':
			return _user$project$Vega$fieldSpec(_p118._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'VNum':
			return _elm_lang$core$Json_Encode$float(_p118._0);
		case 'VNums':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p118._0));
		case 'VKeyValue':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: _p118._0,
						_1: _user$project$Vega$valueSpec(_p118._1)
					},
					_1: {ctor: '[]'}
				});
		case 'VObject':
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p118._0));
		case 'Values':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p118._0));
		case 'VBoo':
			return _elm_lang$core$Json_Encode$bool(_p118._0);
		case 'VBoos':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p118._0));
		case 'VNull':
			return _elm_lang$core$Json_Encode$null;
		default:
			return _elm_lang$core$Json_Encode$null;
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'g',
								_1: _elm_lang$core$Json_Encode$object(
									A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p119._1))
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_0: 'b',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p119._2))
								},
								_1: {ctor: '[]'}
							}
						}
	...
	switch (_p120.ctor) {
		...
		default:
			return {
				...
				_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p120._1)
			};
	}
};
	...
	switch (_p123.ctor) {
		case 'DaFormat':
			return {
				...
				_0: 'format',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$concatMap, _user$project$Vega$formatProperty, _p123._0))
			};
		case 'DaSource':
			return {
				ctor: '_Tuple2',
		...
		case 'DaOn':
			return {
				ctor: '_Tuple2',
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(_p123._0)
			};
		case 'DaUrl':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$bindingProperty = function (bnd) {
	...
	switch (_p125.ctor) {
		case 'IRange':
			return A2(bSpec, 'range', _p125._0);
		case 'ICheckbox':
			return A2(bSpec, 'checkbox', _p125._0);
		case 'IRadio':
			return A2(bSpec, 'radio', _p125._0);
		case 'ISelect':
			return A2(bSpec, 'select', _p125._0);
		case 'IText':
			return A2(bSpec, 'text', _p125._0);
		case 'INumber':
			return A2(bSpec, 'number', _p125._0);
		case 'IDate':
			return A2(bSpec, 'date', _p125._0);
		case 'ITime':
			return A2(bSpec, 'time', _p125._0);
		case 'IMonth':
			return A2(bSpec, 'month', _p125._0);
		case 'IWeek':
			return A2(bSpec, 'week', _p125._0);
		case 'IDateTimeLocal':
			return A2(bSpec, 'datetimelocal', _p125._0);
		case 'ITel':
			return A2(bSpec, 'tel', _p125._0);
		default:
			return A2(bSpec, 'color', _p125._0);
	}
};
...
var _user$project$Vega$signalProperty = function (sigProp) {
	...
	switch (_p127.ctor) {
		...
		case 'SiBind':
			return _user$project$Vega$bindingProperty(_p127._0);
		case 'SiDescription':
			return {
				ctor: '_Tuple2',
				_0: 'description',
		...
		case 'SiOn':
			return {
				...
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$eventHandlerSpec, _p127._0))
			};
		case 'SiReact':
			return {
				ctor: '_Tuple2',
...
var _user$project$Vega$valRef = function (vs) {
	var _p128 = vs;
	if (((_p128.ctor === '::') && (_p128._0.ctor === 'VIfElse')) && (_p128._1.ctor === '[]')) {
		var _p130 = _p128._0._1;
		var _p129 = _p128._0._0;
		return _elm_lang$core$Json_Encode$list(
			A4(
					...
					_0: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'test',
								_1: _elm_lang$core$Json_Encode$string(_p129)
							},
							_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p130)
						}),
					_1: {ctor: '[]'}
				}));
	} else {
...
var _user$project$Vega$valIfElse = F4(
	function (ex, ifVals, elseVals, ifSpecs) {
		...
		while (true) {
			var _p131 = elseVals;
			if (((_p131.ctor === '::') && (_p131._0.ctor === 'VIfElse')) && (_p131._1.ctor === '[]')) {
				var _p133 = _p131._0._1;
				var _p132 = _p131._0._0;
				var _v108 = _p132,
					_v109 = _p133,
					_v110 = _p131._0._2,
					_v111 = A2(
						...
						_0: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'test',
									_1: _elm_lang$core$Json_Encode$string(_p132)
								},
								_1: A2(_elm_lang$core$List$concatMap, _user$project$Vega$valueProperties, _p133)
							}),
						_1: {ctor: '[]'}
					});
				ex = _v108;
	...
	switch (_p134.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _user$project$Vega$valRef(_p134._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		case 'MStrokeJoin':
			return {
				...
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$strokeJoinLabel(_p134._0))
			};
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: _p134._0,
				_1: _user$project$Vega$valRef(_p134._1)
			};
	}
};
	...
	switch (_p135.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p135._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p135._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p135._1))
			};
	}
};
	...
	switch (_p136.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$sideLabel(_p136._0))
			};
		case 'AxBandPosition':
			return {
				ctor: '_Tuple2',
				_0: 'bandPosition',
				_1: _user$project$Vega$numSpec(_p136._0)
			};
		case 'AxDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$booSpec(_p136._0)
			};
		case 'AxDomainColor':
			return {
				ctor: '_Tuple2',
		...
		case 'AxEncode':
			var enc = function (_p137) {
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Vega$axisElementLabel(_p138._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p138._1))
				};
			};
			return {
				ctor: '_Tuple2',
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, enc, _p136._0))
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelFlush':
			...
			if (_p140.ctor === 'Nothing') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'labelFlush',
					_1: _elm_lang$core$Json_Encode$float(_p140._0)
				};
			}
		...
		case 'AxLabelFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'labelFontWeight',
				_1: _user$project$Vega$valueSpec(_p136._0)
			};
		case 'AxLabelLimit':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$overlapStrategyLabel(_p136._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'AxTitleAlign':
			return {
				...
				_0: 'titleAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$hAlignLabel(_p136._0))
			};
		case 'AxTitleAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'AxTitleBaseline':
			return {
				...
				_0: 'titleBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$vAlignLabel(_p136._0))
			};
		case 'AxTitleColor':
			return {
				ctor: '_Tuple2',
	...
	switch (_p141.ctor) {
		case 'EnLegend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p141._0))
			};
		case 'EnTitle':
			return {
				ctor: '_Tuple2',
	...
	switch (_p142.ctor) {
		case 'LeType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$legendTypeLabel(_p142._0))
			};
		case 'LeDirection':
			return {
				ctor: '_Tuple2',
				_0: 'direction',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$markOrientationLabel(_p142._0))
			};
		case 'LeOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$legendOrientLabel(_p142._0))
			};
		case 'LeFill':
			return {
				ctor: '_Tuple2',
		...
		case 'LeEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$legendEncodingProperty, _p142._0))
			};
		case 'LeFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'LeGridAlign':
			return {
				ctor: '_Tuple2',
				_0: 'gridAlign',
				_1: _user$project$Vega$gridAlignSpec(_p142._0)
			};
		case 'LeClipHeight':
			return {
				ctor: '_Tuple2',
		...
		case 'LeSymbolType':
			return {
				...
				_0: 'symbolType',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$symbolLabel(_p142._0))
			};
		case 'LeTickCount':
			return {
				ctor: '_Tuple2',
				_0: 'tickCount',
				_1: _elm_lang$core$Json_Encode$int(_p142._0)
			};
		case 'LeTitlePadding':
			return {
				ctor: '_Tuple2',
		...
		case 'LeValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p142._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p143.ctor) {
		...
		case 'TFrame':
			return {
				...
				_0: 'fame',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$titleFrameLabel(_p143._0))
			};
		case 'TInteractive':
			return {
				ctor: '_Tuple2',
	...
	switch (_p153.ctor) {
		...
		case 'WcSpiral':
			return {
				...
				_0: 'spiral',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$spiralLabel(_p153._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p166)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'projection',
								_1: _elm_lang$core$Json_Encode$string(_p167)
							},
							_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p166)
						}
					});
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p171._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _user$project$Vega$clipSpec(_p171._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'description',
					_1: _elm_lang$core$Json_Encode$string(_p171._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p171._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p171._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'interactive',
					_1: _user$project$Vega$booSpec(_p171._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MKey':
		...
		case 'MOn':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'on',
					_1: _elm_lang$core$Json_Encode$list(_p171._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MRole':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						_user$project$Vega$comparatorProperties(_p171._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$transformSpec, _p171._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
			return {
				...
				_0: {
					...
					_0: 'style',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p171._0))
				},
				_1: {ctor: '[]'}
			};
		default:
			return A2(
				...
				function (_p172) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p173._0),
						_1: _p173._1
					};
				},
				_p171._0);
	...
	switch (_p174.ctor) {
		case 'CfAutosize':
			return {
				...
				_0: 'autosize',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$autosizeProperty, _p174._0))
			};
		case 'CfBackground':
			return {
				ctor: '_Tuple2',
				_0: 'background',
				_1: _user$project$Vega$strSpec(_p174._0)
			};
		case 'CfGroup':
			return {
				ctor: '_Tuple2',
				_0: 'group',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p174._0))
			};
		case 'CfEvents':
			var _p175 = _p174._1;
			var listSpec = _elm_lang$core$Native_Utils.eq(
				...
				A2(
					...
					_p175));
			var filterLabel = _elm_lang$core$Native_Utils.eq(_p174._0, _user$project$Vega$Allow) ? 'allow' : 'prevent';
			return {
				ctor: '_Tuple2',
				_0: 'events',
				_1: _elm_lang$core$Json_Encode$object(
		...
		case 'CfMark':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Vega$markLabel(_p174._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$markProperty, _p174._1))
			};
		case 'CfMarks':
			return {
				ctor: '_Tuple2',
		...
		case 'CfAxis':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Vega$axTypeLabel(_p174._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$axisProperty, _p174._1))
			};
		case 'CfLegend':
			return {
				ctor: '_Tuple2',
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$legendProperty, _p174._0))
			};
		case 'CfTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$titleProperty, _p174._0))
			};
		default:
			var _p179 = _p174._1;
			var _p178 = _p174._0;
					...
					case 'RScheme':
						return _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Vega$SScheme(_p176._0),
									_1: _p176._1
								}));
					default:
						return A2(
	...
	switch (_p180.ctor) {
		...
		case 'DFields':
			return {
				...
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Vega$fieldSpec, _p180._0))
			};
		case 'DSignal':
			return {
				ctor: '_Tuple2',
		...
		default:
			...
			return (_elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _user$project$Vega$sortProperty, _p181))
			};
	}
};
var _user$project$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p182.ctor) {
		case 'DoNums':
			return _user$project$Vega$numSpec(_p182._0);
		case 'DoStrs':
			return _user$project$Vega$strSpec(_p182._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _user$project$Vega$dataRefProperty, _p182._0));
	}
};
	...
	switch (_p183.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Vega$scaleLabel(_p183._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _user$project$Vega$scaleDomainSpec(_p183._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
		...
		case 'SDomainRaw':
			return {
				ctor: '_Tuple2',
				_0: 'domainRaw',
				_1: _user$project$Vega$valueSpec(_p183._0)
			};
		case 'SRange':
			var _p184 = _p183._0;
			switch (_p184.ctor) {
				case 'RNums':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p184._0))
					};
				case 'RStrs':
					return {
						ctor: '_Tuple2',
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _user$project$Vega$valueSpec, _p184._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
				...
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _user$project$Vega$dataRefProperty(_p184._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _user$project$Vega$valueSpec(_p184._0)
								},
								_1: {ctor: '[]'}
							})
					};
		...
		case 'SRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _user$project$Vega$booSpec(_p183._0)
			};
		case 'SClamp':
			return {
				ctor: '_Tuple2',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _user$project$Vega$interpolateSpec(_p183._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _user$project$Vega$niceSpec(_p183._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
