			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _user$project$Vega$geoPathProperty, _p147._1)
					}
				});
		case 'TGeoPoint':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_user$project$Vega$markLabel(_p154._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _user$project$Vega$clipSpec(_p154._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
		...
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$encodingProperty, _p154._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$sourceProperty, _p154._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _user$project$Vega$comparatorProperty, _p154._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Vega$transformSpec, _p154._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
		...
		default:
			return A2(
				...
				function (_p155) {
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Vega$vPropertyLabel(_p156._0),
						_1: _p156._1
					};
				},
				_p154._0);
