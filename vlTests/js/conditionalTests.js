	...
	var trans = function (_p3) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				...
				_gicentre$elm_vega$VegaLite$fiCompose(
					A2(
						_gicentre$elm_vega$VegaLite$and,
						_gicentre$elm_vega$VegaLite$selected('brush'),
	...
	var sel = function (_p5) {
		return _gicentre$elm_vega$VegaLite$selection(
			A4(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$seOn('[mousedown[!event.shiftKey], mouseup] > mousemove'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$seTranslate('[mousedown[!event.shiftKey], mouseup] > mousemove'),
						_1: {ctor: '[]'}
					}
				},
				A4(
					...
					_gicentre$elm_vega$VegaLite$Interval,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$seSelectionMark(
									{
										ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: _gicentre$elm_vega$VegaLite$rect(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$maCursor(_gicentre$elm_vega$VegaLite$CGrab),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _gicentre$elm_vega$ConditionalTests$markCondition2 = function () {
					...
					_gicentre$elm_vega$VegaLite$color,
					{
						...
						_0: A2(
							_gicentre$elm_vega$VegaLite$mDataCondition,
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: _gicentre$elm_vega$VegaLite$expr('datum.value < 40'),
									_1: {
										ctor: '::',
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: _gicentre$elm_vega$VegaLite$expr('datum.value < 50'),
										_1: {
											ctor: '::',
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: _gicentre$elm_vega$VegaLite$expr('datum.value < 60'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$mStr('yellow'),
												_1: {ctor: '[]'}
											}
										},
										_1: {ctor: '[]'}
			...
			_1: {
				...
				_1: {
					...
					_0: _gicentre$elm_vega$VegaLite$circle(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$maSize(800),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _gicentre$elm_vega$ConditionalTests$sourceExample = _gicentre$elm_vega$ConditionalTests$markCondition2;
					...
					A2(
						_gicentre$elm_vega$VegaLite$color,
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mStr('#0099ee'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
...
var _gicentre$elm_vega$ConditionalTests$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'markCondition2', _1: _gicentre$elm_vega$ConditionalTests$markCondition2},
			_1: {
				ctor: '::',
