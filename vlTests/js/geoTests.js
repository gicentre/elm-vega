...
var _gicentre$elm_vega$GeoTests$scribbleMap2 = function () {
			...
			A3(
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$oName('zip_code'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$oMType(_gicentre$elm_vega$VegaLite$Quantitative),
								_1: {ctor: '[]'}
							}
						},
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mName('digit3'),
								_1: {
									ctor: '::',
							...
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$dName('ziplen'),
									_1: {
										ctor: '::',
	...
	var config = function (_p1) {
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				...
				_gicentre$elm_vega$VegaLite$coTitle(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$ticoFont('Roboto'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$ticoFontWeight(_gicentre$elm_vega$VegaLite$W300),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$ticoFontSize(28),
								_1: {ctor: '[]'}
							}
						}
					}),
	...
	var trans = function (_p2) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				...
				_gicentre$elm_vega$VegaLite$fiExpr(
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$title('US connected zip codes, coloured by first three digits'),
			_1: {
				ctor: '::',
				_0: config(
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$width(1000),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$height(600),
						_1: {
							ctor: '::',
...
var _gicentre$elm_vega$GeoTests$scribbleMap1 = function () {
					...
					A2(
						...
						A2(
							...
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$dName('conterminous'),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$dMType(_gicentre$elm_vega$VegaLite$Nominal),
										_1: {ctor: '[]'}
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$title('US connected zip codes'),
			_1: {
				ctor: '::',
				_0: config(
					{ctor: '[]'}),
...
var _gicentre$elm_vega$GeoTests$mapComp4 = function () {
						...
						_0: _gicentre$elm_vega$VegaLite$projection(
							{
								...
								_1: {
									ctor: '::',
									_0: A3(_gicentre$elm_vega$VegaLite$prRotate, rot, 0, 0),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_1: {
								...
								_0: _gicentre$elm_vega$VegaLite$geoshape(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$maStroke('white'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$maFill('#242'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$maStrokeWidth(0.1),
												_1: {ctor: '[]'}
											}
										}
									}),
								...
								_0: _gicentre$elm_vega$VegaLite$geoshape(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$maStroke('#411'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$maStrokeWidth(0.1),
												_1: {ctor: '[]'}
						...
						_0: _gicentre$elm_vega$VegaLite$projection(
							{
								...
								_1: {
									ctor: '::',
									_0: A3(_gicentre$elm_vega$VegaLite$prRotate, 0, 0, 0),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_1: {
								...
								_0: _gicentre$elm_vega$VegaLite$geoshape(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$maFill('#c1e7f5'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$maStrokeOpacity(0),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
...
var _gicentre$elm_vega$GeoTests$mapComp3 = function () {
	var rotatedSpec = function (rot) {
		var countrySpec = _gicentre$elm_vega$VegaLite$asSpec(
			{
				ctor: '::',
								...
								_0: _gicentre$elm_vega$VegaLite$geoshape(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$maFill('black'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$maStrokeWidth(0.5),
												_1: {ctor: '[]'}
											}
										}
									}),
		...
		var countrySpec = _gicentre$elm_vega$VegaLite$asSpec(
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$topojsonFeature('land'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$geoshape(
						{
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$maFillOpacity(0.7),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _gicentre$elm_vega$GeoTests$mapComp1 = function () {
	var globe = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$width(300),
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Json_Encode$encode, 2, _gicentre$elm_vega$GeoTests$sourceExample)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
			...
			_0: _gicentre$elm_vega$VegaLite$configure(
				A2(
					...
					_gicentre$elm_vega$VegaLite$coView(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$vicoWidth(500),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$vicoHeight(300),
								_1: {ctor: '[]'}
							}
						}),
					{ctor: '[]'})),
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'mapComp3', _1: _gicentre$elm_vega$GeoTests$mapComp3},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'mapComp4', _1: _gicentre$elm_vega$GeoTests$mapComp4},
												_1: {
													ctor: '::',
...
var _gicentre$elm_vega$GeoTests$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GeoTests$mySpecs,
			_1: _gicentre$elm_vega$GeoTests$elmToJS(_gicentre$elm_vega$GeoTests$mySpecs)
		},
...
if (typeof _gicentre$elm_vega$GeoTests$main !== 'undefined') {
    _gicentre$elm_vega$GeoTests$main(Elm['GeoTests'], 'GeoTests', undefined);
}
