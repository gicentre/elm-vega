							...
							return _gicentre$elm_vega$VegaLite$transform(
								A3(
									...
									A2(
										...
										_gicentre$elm_vega$VegaLite$fiExpr('datum.YearOfManufacture == 1970'),
										_p0)));
						}(
							{ctor: '[]'}),
						_1: {
...
var _gicentre$elm_vega$ShapeTests$scatter12 = A2(
	...
	_gicentre$elm_vega$VegaLite$shape(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$mPath(_gicentre$elm_vega$ShapeTests$unitSquare),
			_1: {ctor: '[]'}
		}));
...
var _gicentre$elm_vega$ShapeTests$scatter14 = A2(
	...
	function (_p11) {
		return A2(
			...
			{
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$mPath(_gicentre$elm_vega$ShapeTests$largeSquare),
				_1: {ctor: '[]'}
			},
			A2(
				_gicentre$elm_vega$VegaLite$color,
