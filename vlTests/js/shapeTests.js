			...
			_List_fromArray(
				[
					...
					A2(
						...
						A2(author$project$VegaLite$calculateAs, 'year(datum.Year)', 'YearOfManufacture')),
					author$project$VegaLite$filter(
						author$project$VegaLite$fiExpr('datum.YearOfManufacture == 1970')))(_List_Nil),
...
var author$project$ShapeTests$tri = 'M -1.5 -1.5 h 3 l -1.5 3z';
...
var author$project$ShapeTests$scatter10 = A2(
	author$project$ShapeTests$chart,
			...
			_List_fromArray(
				[
					...
					author$project$VegaLite$categoricalDomainMap(
						_List_fromArray(
							[
								_Utils_Tuple2('Europe', author$project$ShapeTests$square),
								_Utils_Tuple2('Japan', author$project$ShapeTests$cross),
								_Utils_Tuple2('USA', author$project$ShapeTests$tri)
							])))
				])),
...
var author$project$ShapeTests$scatter12 = A2(
	...
	author$project$VegaLite$shape(
		_List_fromArray(
			[
				author$project$VegaLite$mPath(author$project$ShapeTests$unitSquare)
			])));
var author$project$ShapeTests$scatter13 = A2(
	author$project$ShapeTests$chart,
...
var author$project$ShapeTests$scatter14 = A2(
	...
	A2(
		...
		author$project$VegaLite$shape(
			_List_fromArray(
				[
					author$project$VegaLite$mPath(author$project$ShapeTests$largeSquare)
				])),
		author$project$VegaLite$color(
			_List_fromArray(
				[
...
var author$project$ShapeTests$scatter2 = A2(
	author$project$ShapeTests$chart,
...
var author$project$ShapeTests$scatter4 = A2(
	author$project$ShapeTests$chart,
...
var author$project$ShapeTests$scatter5 = A2(
	author$project$ShapeTests$chart,
...
var author$project$ShapeTests$main = elm$core$Platform$worker(
	{
