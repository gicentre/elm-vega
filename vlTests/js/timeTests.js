...
var _gicentre$elm_vega$TimeTests$parseTime = function (dType) {
	var timeScale = function () {
		var _p0 = dType;
		if (_p0.ctor === 'Local') {
			return _gicentre$elm_vega$VegaLite$pScale(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$scType(_gicentre$elm_vega$VegaLite$ScTime),
					_1: {ctor: '[]'}
				});
		} else {
			return _gicentre$elm_vega$VegaLite$pScale(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$scType(_gicentre$elm_vega$VegaLite$ScUtc),
					_1: {ctor: '[]'}
				});
		}
	}();
			...
			A3(
							...
							_1: {
								...
								_1: {
									...
									_0: _gicentre$elm_vega$VegaLite$pAxis(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$axFormat('%d %b %H:%M'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$mNum(500),
							_1: {ctor: '[]'}
						},
						_p2))));
	};
	var format = function () {
		var _p3 = dType;
		if (_p3.ctor === 'Local') {
			return _gicentre$elm_vega$VegaLite$foDate('%d %b %Y %H:%M');
		} else {
			return _gicentre$elm_vega$VegaLite$foUtc('%d %b %Y %H:%M');
		}
	}();
		...
		return A2(
			_gicentre$elm_vega$VegaLite$dataFromColumns,
			{
				...
				_0: _gicentre$elm_vega$VegaLite$parse(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'date', _1: format},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			A3(
				...
				_gicentre$elm_vega$VegaLite$strs(
					{
						ctor: '::',
						_0: '28 Oct 2017 22:00',
						_1: {
							ctor: '::',
							_0: '28 Oct 2017 23:00',
							_1: {
								ctor: '::',
								_0: '29 Oct 2017 00:00',
								_1: {
									ctor: '::',
									_0: '29 Oct 2017 01:00',
									_1: {
										ctor: '::',
										_0: '29 Oct 2017 02:00',
										_1: {
											ctor: '::',
											_0: '29 Oct 2017 03:00',
											_1: {
												ctor: '::',
												_0: '29 Oct 2017 04:00',
												_1: {ctor: '[]'}
											}
										}
									}
...
var _gicentre$elm_vega$TimeTests$timeByUnit = function (tu) {
			...
			A3(
				...
				_gicentre$elm_vega$VegaLite$X,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pTimeUnit(tu),
							_1: {ctor: '[]'}
						}
					}
				},
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pName('temperature'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
							_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: _gicentre$elm_vega$VegaLite$line(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$maStrokeWidth(0.2),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _gicentre$elm_vega$TimeTests$timeYear = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Year);
var _gicentre$elm_vega$TimeTests$timeQuarter = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Quarter);
var _gicentre$elm_vega$TimeTests$timeQuarterMonth = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$QuarterMonth);
var _gicentre$elm_vega$TimeTests$timeMonth = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Month);
var _gicentre$elm_vega$TimeTests$timeMonthDate = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$MonthDate);
var _gicentre$elm_vega$TimeTests$timeDate = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Date);
var _gicentre$elm_vega$TimeTests$timeYearMonthDateHours = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$YearMonthDateHours);
var _gicentre$elm_vega$TimeTests$timeYearMonthDateHoursMinutes = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$YearMonthDateHoursMinutes);
var _gicentre$elm_vega$TimeTests$timeYearMonthDateHoursMinutesSeconds = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$YearMonthDateHoursMinutesSeconds);
var _gicentre$elm_vega$TimeTests$timeDay = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Day);
var _gicentre$elm_vega$TimeTests$timeHours = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Hours);
var _gicentre$elm_vega$TimeTests$timeHoursMinutes = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$HoursMinutes);
var _gicentre$elm_vega$TimeTests$timeHoursMinutesSeconds = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$HoursMinutesSeconds);
var _gicentre$elm_vega$TimeTests$timeMinutes = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Minutes);
var _gicentre$elm_vega$TimeTests$timeMinutesSeconds = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$MinutesSeconds);
var _gicentre$elm_vega$TimeTests$sourceExample = _gicentre$elm_vega$TimeTests$timeByUnit(_gicentre$elm_vega$VegaLite$Year);
var _gicentre$elm_vega$TimeTests$view = function (spec) {
	return A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Json_Encode$encode, 2, _gicentre$elm_vega$TimeTests$sourceExample)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _gicentre$elm_vega$TimeTests$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$TimeTests$UTC = {ctor: 'UTC'};
var _gicentre$elm_vega$TimeTests$utcTime = _gicentre$elm_vega$TimeTests$parseTime(_gicentre$elm_vega$TimeTests$UTC);
var _gicentre$elm_vega$TimeTests$Local = {ctor: 'Local'};
var _gicentre$elm_vega$TimeTests$localTime = _gicentre$elm_vega$TimeTests$parseTime(_gicentre$elm_vega$TimeTests$Local);
var _gicentre$elm_vega$TimeTests$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'timeYear', _1: _gicentre$elm_vega$TimeTests$timeYear},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'timeQuarter', _1: _gicentre$elm_vega$TimeTests$timeQuarter},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'timeQuarterMonth', _1: _gicentre$elm_vega$TimeTests$timeQuarterMonth},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'timeMonth', _1: _gicentre$elm_vega$TimeTests$timeMonth},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'timeMonthDate', _1: _gicentre$elm_vega$TimeTests$timeMonthDate},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'timeDate', _1: _gicentre$elm_vega$TimeTests$timeDate},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'timeYearMonthDateHours', _1: _gicentre$elm_vega$TimeTests$timeYearMonthDateHours},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'timeYearMonthDateHoursMinutes', _1: _gicentre$elm_vega$TimeTests$timeYearMonthDateHoursMinutes},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'timeYearMonthDateHoursMinutesSeconds', _1: _gicentre$elm_vega$TimeTests$timeYearMonthDateHoursMinutesSeconds},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'timeDay', _1: _gicentre$elm_vega$TimeTests$timeDay},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'timeHours', _1: _gicentre$elm_vega$TimeTests$timeHours},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'timeHoursMinutes', _1: _gicentre$elm_vega$TimeTests$timeHoursMinutes},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'timeHoursMinutesSeconds', _1: _gicentre$elm_vega$TimeTests$timeHoursMinutesSeconds},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'timeMinutes', _1: _gicentre$elm_vega$TimeTests$timeMinutes},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'timeMinutesSeconds', _1: _gicentre$elm_vega$TimeTests$timeMinutesSeconds},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'localTime', _1: _gicentre$elm_vega$TimeTests$localTime},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'utcTime', _1: _gicentre$elm_vega$TimeTests$utcTime},
																		_1: {ctor: '[]'}
																	}
																}
															}
...
var _gicentre$elm_vega$TimeTests$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$TimeTests$mySpecs,
			_1: _gicentre$elm_vega$TimeTests$elmToJS(_gicentre$elm_vega$TimeTests$mySpecs)
		},
		view: _gicentre$elm_vega$TimeTests$view,
		update: F2(
			function (_p6, model) {
...
var Elm = {};
Elm['TimeTests'] = Elm['TimeTests'] || {};
if (typeof _gicentre$elm_vega$TimeTests$main !== 'undefined') {
    _gicentre$elm_vega$TimeTests$main(Elm['TimeTests'], 'TimeTests', undefined);
}
