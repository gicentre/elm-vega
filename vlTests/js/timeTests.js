	...
	var timeScale = function () {
		...
		if (_p0.ctor === 'Local') {
			return _gicentre$elm_vega$VegaLite$PScale(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$SType(_gicentre$elm_vega$VegaLite$ScTime),
					_1: {ctor: '[]'}
				});
		} else {
			return _gicentre$elm_vega$VegaLite$PScale(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$SType(_gicentre$elm_vega$VegaLite$ScUtc),
					_1: {ctor: '[]'}
				});
		}
	}();
			...
			A3(
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$MNumber(500),
							_1: {ctor: '[]'}
						},
						_p2))));
	};
				...
				_1: {
					...
					_1: {
						...
						_0: _gicentre$elm_vega$VegaLite$line(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$MStrokeWidth(0.2),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
