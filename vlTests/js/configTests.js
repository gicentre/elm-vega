				...
				_1: {
					...
					_1: {
						...
						_0: _gicentre$elm_vega$VegaLite$padding(
							_gicentre$elm_vega$VegaLite$paSize(20)),
						_1: {
							ctor: '::',
	...
	function (_p4) {
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				...
				_gicentre$elm_vega$VegaLite$coBackground('black'),
				A2(
					_gicentre$elm_vega$VegaLite$configuration,
					_gicentre$elm_vega$VegaLite$coTitle(
						{
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$ticoColor('#fff'),
								_1: {ctor: '[]'}
							}
						}),
					A2(
						...
						_gicentre$elm_vega$VegaLite$coAxis(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$axcoDomainColor('yellow'),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$axcoGridColor('rgb(255,255,200)'),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$axcoGridOpacity(0.2),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$axcoLabelColor('#fcf'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$axcoTickColor('white'),
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$VegaLite$axcoTitleColor('rgb(200,255,200)'),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$VegaLite$axcoLabelFont('Roboto'),
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$VegaLite$axcoTitleFont('Roboto'),
															_1: {ctor: '[]'}
														}
													}
												}
						...
						A2(
							_gicentre$elm_vega$VegaLite$configuration,
							_gicentre$elm_vega$VegaLite$coLegend(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$lecoFillColor('#333'),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$lecoStrokeColor('#444'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$lecoTitleColor('rgb(200,200,200)'),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$VegaLite$lecoLabelFont('Roboto'),
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$VegaLite$lecoTitleFont('Roboto'),
																_1: {ctor: '[]'}
															}
														}
													}
...
var _gicentre$elm_vega$ConfigTests$markCfg1 = _gicentre$elm_vega$ConfigTests$compositeVis(
	function (_p5) {
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				_gicentre$elm_vega$VegaLite$configuration,
				_gicentre$elm_vega$VegaLite$coMark(
					{
						ctor: '::',
	...
	function (_p6) {
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				...
				A2(
					_gicentre$elm_vega$VegaLite$configuration,
					_gicentre$elm_vega$VegaLite$coBar(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$maFilled(true),
							_1: {ctor: '[]'}
					...
					A2(
						...
						A2(
							_gicentre$elm_vega$VegaLite$configuration,
							_gicentre$elm_vega$VegaLite$coPoint(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$maFilled(true),
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$maStrokeOpacity(0.2),
											_1: {ctor: '[]'}
										}
									}
								}),
...
var _gicentre$elm_vega$ConfigTests$paddingCfg = _gicentre$elm_vega$ConfigTests$singleVis(
	function (_p8) {
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				_gicentre$elm_vega$VegaLite$configuration,
				_gicentre$elm_vega$VegaLite$coAutosize(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$AFit,
						_1: {ctor: '[]'}
					}),
				A2(
					_gicentre$elm_vega$VegaLite$configuration,
					_gicentre$elm_vega$VegaLite$coPadding(
						A4(_gicentre$elm_vega$VegaLite$paEdges, 90, 60, 30, 0)),
					_p8)));
	});
