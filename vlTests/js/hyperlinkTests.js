						...
						_gicentre$elm_vega$VegaLite$color,
						{
							...
							_0: A2(
								_gicentre$elm_vega$VegaLite$mDataCondition,
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: _gicentre$elm_vega$VegaLite$expr('datum.IMDB_Rating*10 > datum.Rotten_Tomatoes_Rating'),
										_1: {
											ctor: '::',
						...
						A2(
							_gicentre$elm_vega$VegaLite$hyperlink,
							{
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$hStr('http://www.imdb.com'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$hStr('https://www.rottentomatoes.com'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				...
				_0: _gicentre$elm_vega$VegaLite$point(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$maCursor(_gicentre$elm_vega$VegaLite$CPointer),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
				...
				A2(
					...
					A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mNum(16),
								_1: {ctor: '[]'}
							},
							_p2)))));
	};
		...
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				A2(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$mNum(8000),
						_1: {ctor: '[]'}
					},
					A2(
						_gicentre$elm_vega$VegaLite$color,
