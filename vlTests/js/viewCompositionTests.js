...
var _gicentre$elm_vega$ViewCompositionTests$genderChart = F2(
				...
				A2(
					_gicentre$elm_vega$VegaLite$column,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$fHeader(hdProps),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _gicentre$elm_vega$ViewCompositionTests$columns1 = A2(
	_gicentre$elm_vega$ViewCompositionTests$genderChart,
	{ctor: '[]'},
	{ctor: '[]'});
var _gicentre$elm_vega$ViewCompositionTests$columns2 = A2(
	_gicentre$elm_vega$ViewCompositionTests$genderChart,
	{
		ctor: '::',
		_0: _gicentre$elm_vega$VegaLite$hdTitleFontSize(20),
		_1: {
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$hdLabelFontSize(15),
			_1: {ctor: '[]'}
		}
	},
	{ctor: '[]'});
var _gicentre$elm_vega$ViewCompositionTests$columns3 = A2(
	_gicentre$elm_vega$ViewCompositionTests$genderChart,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _gicentre$elm_vega$ViewCompositionTests$columns4 = A2(
	_gicentre$elm_vega$ViewCompositionTests$genderChart,
	{
		ctor: '::',
		_0: _gicentre$elm_vega$VegaLite$hdTitleFontSize(20),
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$hdTitlePadding(-27),
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$hdLabelPadding(40),
					_1: {ctor: '[]'}
				}
			}
		}
	...
	{ctor: '[]'});
var _gicentre$elm_vega$ViewCompositionTests$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'columns1', _1: _gicentre$elm_vega$ViewCompositionTests$columns1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'columns2', _1: _gicentre$elm_vega$ViewCompositionTests$columns2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'columns3', _1: _gicentre$elm_vega$ViewCompositionTests$columns3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'columns4', _1: _gicentre$elm_vega$ViewCompositionTests$columns4},
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _gicentre$elm_vega$ViewCompositionTests$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$ViewCompositionTests$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$ViewCompositionTests$mySpecs,
			_1: _gicentre$elm_vega$ViewCompositionTests$elmToJS(_gicentre$elm_vega$ViewCompositionTests$mySpecs)
		},
		update: F2(
			function (_p3, model) {
...
var Elm = {};
Elm['ViewCompositionTests'] = Elm['ViewCompositionTests'] || {};
if (typeof _gicentre$elm_vega$ViewCompositionTests$main !== 'undefined') {
    _gicentre$elm_vega$ViewCompositionTests$main(Elm['ViewCompositionTests'], 'ViewCompositionTests', undefined);
}
