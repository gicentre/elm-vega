...
var _gicentre$elm_vega$TrailTests$trail1 = function () {
...
var _gicentre$elm_vega$TrailTests$sourceExample = _gicentre$elm_vega$TrailTests$trail1;
var _gicentre$elm_vega$TrailTests$view = function (spec) {
	return A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Json_Encode$encode, 2, _gicentre$elm_vega$TrailTests$sourceExample)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _gicentre$elm_vega$TrailTests$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'trail1', _1: _gicentre$elm_vega$TrailTests$trail1},
		_1: {ctor: '[]'}
	});
var _gicentre$elm_vega$TrailTests$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$TrailTests$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$TrailTests$mySpecs,
			_1: _gicentre$elm_vega$TrailTests$elmToJS(_gicentre$elm_vega$TrailTests$mySpecs)
		},
		view: _gicentre$elm_vega$TrailTests$view,
		update: F2(
			function (_p1, model) {
...
var Elm = {};
Elm['TrailTests'] = Elm['TrailTests'] || {};
if (typeof _gicentre$elm_vega$TrailTests$main !== 'undefined') {
    _gicentre$elm_vega$TrailTests$main(Elm['TrailTests'], 'TrailTests', undefined);
}
