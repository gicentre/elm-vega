...
var _gicentre$elm_vega$DataTests$bin1 = function () {
	var enc = function (_p0) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('bin_start'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pBinned,
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$pAxis(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$axTickStep(2),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pName('bin_end'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
							_1: {ctor: '[]'}
...
var _gicentre$elm_vega$DataTests$sourceExample = _gicentre$elm_vega$DataTests$bin1;
...
var _gicentre$elm_vega$DataTests$sample1 = function () {
	...
	var trans = function (_p3) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(_gicentre$elm_vega$VegaLite$sample, 200, _p3));
	};
...
var _gicentre$elm_vega$DataTests$imputeData = function (_p4) {
	return A2(
		_gicentre$elm_vega$VegaLite$dataFromColumns,
		{ctor: '[]'},
		A3(
...
var _gicentre$elm_vega$DataTests$impute1 = function () {
			...
			A3(
							...
							_0: _gicentre$elm_vega$VegaLite$pScale(
								{
									...
									_0: _gicentre$elm_vega$VegaLite$scNice(
										_gicentre$elm_vega$VegaLite$scNiceTickCount(1)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$mName('c'),
							_1: {
								ctor: '::',
	...
	var trans = function (_p6) {
		return _gicentre$elm_vega$VegaLite$transform(
			A4(
				_gicentre$elm_vega$VegaLite$impute,
				'b',
				'a',
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$imValue(
						_gicentre$elm_vega$VegaLite$num(0)),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$imGroupBy(
							{
								ctor: '::',
								_0: 'c',
								_1: {ctor: '[]'}
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$DataTests$imputeData(
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: trans(
...
var _gicentre$elm_vega$DataTests$impute2 = function () {
	...
	var trans = function (_p8) {
		return _gicentre$elm_vega$VegaLite$transform(
			A4(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$imMethod(_gicentre$elm_vega$VegaLite$ImMean),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$imGroupBy(
							{
						...
						_1: {
							ctor: '::',
							_0: A2(
								_gicentre$elm_vega$VegaLite$imFrame,
...
var _gicentre$elm_vega$DataTests$impute3 = function () {
		...
		return _gicentre$elm_vega$VegaLite$transform(
			A4(
				...
				'a',
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$imValue(
						_gicentre$elm_vega$VegaLite$num(100)),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$imGroupBy(
							{
						...
						_1: {
							ctor: '::',
							_0: A3(_gicentre$elm_vega$VegaLite$imKeyValSequence, 1, 4, 1),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _gicentre$elm_vega$DataTests$impute4 = function () {
				...
				A3(
					...
					_gicentre$elm_vega$VegaLite$Y,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$pImpute(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$imValue(
											_gicentre$elm_vega$VegaLite$num(0)),
...
var _gicentre$elm_vega$DataTests$impute5 = function () {
...
var _gicentre$elm_vega$DataTests$impute6 = function () {
...
var _gicentre$elm_vega$DataTests$impute7 = function () {
								...
								_0: _gicentre$elm_vega$VegaLite$pImpute(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$imKeyVals(
												_gicentre$elm_vega$VegaLite$nums(
													{
														ctor: '::',
														_0: 4,
...
var _gicentre$elm_vega$DataTests$impute8 = function () {
								...
								_0: _gicentre$elm_vega$VegaLite$pImpute(
									{
										...
										_1: {
											ctor: '::',
											_0: A3(_gicentre$elm_vega$VegaLite$imKeyValSequence, 4, 6, 1),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
...
var _gicentre$elm_vega$DataTests$fold1 = function () {
	var enc = function (_p16) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A2(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$fName('k'),
					_1: {
						ctor: '::',
				...
				A3(
					...
					A3(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pName('v'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
								_1: {ctor: '[]'}
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mName('country'),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mMType(_gicentre$elm_vega$VegaLite$Nominal),
									_1: {ctor: '[]'}
	...
	var trans = function (_p17) {
		return _gicentre$elm_vega$VegaLite$transform(
			A4(
				_gicentre$elm_vega$VegaLite$foldAs,
				{
					ctor: '::',
					_0: 'gold',
					_1: {
...
var _gicentre$elm_vega$DataTests$flatten1 = function () {
	var enc = function (_p19) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('quant'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {ctor: '[]'}
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$mName('key'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mMType(_gicentre$elm_vega$VegaLite$Nominal),
								_1: {ctor: '[]'}
	...
	var trans = function (_p20) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				_gicentre$elm_vega$VegaLite$flattenAs,
				{
					ctor: '::',
					_0: 'foo',
					_1: {
...
var _gicentre$elm_vega$DataTests$geodata2 = function () {
			...
			_0: A2(
				...
				_gicentre$elm_vega$VegaLite$geoPolygon(
					{
						...
						_0: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: -3, _1: 52},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 4, _1: 52},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 4, _1: 45},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: -3, _1: 45},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: -3, _1: 52},
											_1: {ctor: '[]'}
					...
					}),
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'Region',
						_1: _gicentre$elm_vega$VegaLite$str('Southsville')
					},
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
						...
						}),
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'Region',
							_1: _gicentre$elm_vega$VegaLite$str('Northerton')
						},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$jsonProperty('features'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$projection(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$prType(_gicentre$elm_vega$VegaLite$Orthographic),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$encoding(
									A2(
										...
										{
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$mName('properties.Region'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$mMType(_gicentre$elm_vega$VegaLite$Nominal),
												_1: {
...
var _gicentre$elm_vega$DataTests$geodata1 = _gicentre$elm_vega$VegaLite$toVegaLite(
	{
		ctor: '::',
			...
			_0: _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'val',
							_1: _elm_lang$core$Json_Encode$float(10)
						},
						_1: {ctor: '[]'}
					}
				}),
				...
				_0: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'cat',
							_1: _elm_lang$core$Json_Encode$string('b')
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'val',
								_1: _elm_lang$core$Json_Encode$float(18)
							},
							_1: {ctor: '[]'}
						}
					}),
					...
					_0: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'val',
									_1: _elm_lang$core$Json_Encode$float(12)
								},
								_1: {ctor: '[]'}
							}
						}),
...
var _gicentre$elm_vega$DataTests$data8 = _gicentre$elm_vega$DataTests$dataSource('myData1');
var _gicentre$elm_vega$DataTests$data9 = _gicentre$elm_vega$DataTests$dataSource('myData2');
var _gicentre$elm_vega$DataTests$data10 = _gicentre$elm_vega$DataTests$dataSource('myData3');
...
var _gicentre$elm_vega$DataTests$data3 = function () {
	var json = _elm_lang$core$Json_Encode$list(
		{
			ctor: '::',
			_0: _elm_lang$core$Json_Encode$object(
...
var _gicentre$elm_vega$DataTests$data4 = _gicentre$elm_vega$DataTests$showData(
	A2(
		_gicentre$elm_vega$VegaLite$dataFromUrl,
		'data/dataTest.csv',
		{ctor: '[]'}));
var _gicentre$elm_vega$DataTests$data5 = _gicentre$elm_vega$DataTests$showData(
	A2(
		_gicentre$elm_vega$VegaLite$dataFromUrl,
		'data/dataTest.tsv',
		{ctor: '[]'}));
var _gicentre$elm_vega$DataTests$data6 = _gicentre$elm_vega$DataTests$showData(
	A2(
		_gicentre$elm_vega$VegaLite$dataFromUrl,
		'data/dataTest.csv',
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$dsv(
				_elm_lang$core$Native_Utils.chr(',')),
			_1: {ctor: '[]'}
		}));
var _gicentre$elm_vega$DataTests$data7 = _gicentre$elm_vega$DataTests$showData(
	A2(
		_gicentre$elm_vega$VegaLite$dataFromUrl,
		'data/dataTest.json',
		{ctor: '[]'}));
var _gicentre$elm_vega$DataTests$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'data1', _1: _gicentre$elm_vega$DataTests$data1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'data2', _1: _gicentre$elm_vega$DataTests$data2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'data3', _1: _gicentre$elm_vega$DataTests$data3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'data4', _1: _gicentre$elm_vega$DataTests$data4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'data5', _1: _gicentre$elm_vega$DataTests$data5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'data6', _1: _gicentre$elm_vega$DataTests$data6},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'data7', _1: _gicentre$elm_vega$DataTests$data7},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'data8', _1: _gicentre$elm_vega$DataTests$data8},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'data9', _1: _gicentre$elm_vega$DataTests$data9},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'data10', _1: _gicentre$elm_vega$DataTests$data10},
											_1: {
												ctor: '::',
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'flatten1', _1: _gicentre$elm_vega$DataTests$flatten1},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'fold1', _1: _gicentre$elm_vega$DataTests$fold1},
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'impute1', _1: _gicentre$elm_vega$DataTests$impute1},
																			_1: {
																				ctor: '::',
																				_0: {ctor: '_Tuple2', _0: 'impute2', _1: _gicentre$elm_vega$DataTests$impute2},
																				_1: {
																					ctor: '::',
																					_0: {ctor: '_Tuple2', _0: 'impute3', _1: _gicentre$elm_vega$DataTests$impute3},
																					_1: {
																						ctor: '::',
																						_0: {ctor: '_Tuple2', _0: 'impute4', _1: _gicentre$elm_vega$DataTests$impute4},
																						_1: {
																							ctor: '::',
																							_0: {ctor: '_Tuple2', _0: 'impute5', _1: _gicentre$elm_vega$DataTests$impute5},
																							_1: {
																								ctor: '::',
																								_0: {ctor: '_Tuple2', _0: 'impute6', _1: _gicentre$elm_vega$DataTests$impute6},
																								_1: {
																									ctor: '::',
																									_0: {ctor: '_Tuple2', _0: 'impute7', _1: _gicentre$elm_vega$DataTests$impute7},
																									_1: {
																										ctor: '::',
																										_0: {ctor: '_Tuple2', _0: 'impute8', _1: _gicentre$elm_vega$DataTests$impute8},
																										_1: {
																											ctor: '::',
																											_0: {ctor: '_Tuple2', _0: 'sample1', _1: _gicentre$elm_vega$DataTests$sample1},
																											_1: {
																												ctor: '::',
																												_0: {ctor: '_Tuple2', _0: 'bin1', _1: _gicentre$elm_vega$DataTests$bin1},
																												_1: {ctor: '[]'}
																											}
																										}
																									}
...
var _gicentre$elm_vega$DataTests$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$DataTests$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$DataTests$mySpecs,
			_1: _gicentre$elm_vega$DataTests$elmToJS(_gicentre$elm_vega$DataTests$mySpecs)
		},
...
var Elm = {};
Elm['DataTests'] = Elm['DataTests'] || {};
if (typeof _gicentre$elm_vega$DataTests$main !== 'undefined') {
    _gicentre$elm_vega$DataTests$main(Elm['DataTests'], 'DataTests', undefined);
}
