...
var _gicentre$elm_vega$CompositeTests$eBar = function (ext) {
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$errorbar(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$maExtent(ext),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$maTicks(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$maStroke('blue'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _gicentre$elm_vega$CompositeTests$errorbar1 = _gicentre$elm_vega$CompositeTests$eBar(_gicentre$elm_vega$VegaLite$ExCI);
var _gicentre$elm_vega$CompositeTests$errorbar2 = _gicentre$elm_vega$CompositeTests$eBar(_gicentre$elm_vega$VegaLite$ExStdev);
var _gicentre$elm_vega$CompositeTests$eBand = function (ext) {
	var label = function () {
		var _p1 = ext;
		switch (_p1.ctor) {
			case 'ExCI':
					...
					_gicentre$elm_vega$VegaLite$Y,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$pTitle(
										A2(_elm_lang$core$Basics_ops['++'], 'Miles per Gallon ', label)),
									_1: {ctor: '[]'}
								}
							}
						}
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$errorband(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$maExtent(ext),
						_1: {
...
var _gicentre$elm_vega$CompositeTests$errorband1 = _gicentre$elm_vega$CompositeTests$eBand(_gicentre$elm_vega$VegaLite$ExCI);
var _gicentre$elm_vega$CompositeTests$errorband2 = _gicentre$elm_vega$CompositeTests$eBand(_gicentre$elm_vega$VegaLite$ExStdev);
var _gicentre$elm_vega$CompositeTests$bPlot = function (ext) {
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$boxplot(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$maExtent(ext),
						_1: {ctor: '[]'}
...
var _gicentre$elm_vega$CompositeTests$boxplot1 = _gicentre$elm_vega$CompositeTests$bPlot(_gicentre$elm_vega$VegaLite$ExRange);
var _gicentre$elm_vega$CompositeTests$boxplot2 = _gicentre$elm_vega$CompositeTests$bPlot(
	_gicentre$elm_vega$VegaLite$iqrScale(2));
var _gicentre$elm_vega$CompositeTests$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'boxplot1', _1: _gicentre$elm_vega$CompositeTests$boxplot1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'boxplot2', _1: _gicentre$elm_vega$CompositeTests$boxplot2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'errorband1', _1: _gicentre$elm_vega$CompositeTests$errorband1},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'errorband2', _1: _gicentre$elm_vega$CompositeTests$errorband2},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'errorbar1', _1: _gicentre$elm_vega$CompositeTests$errorbar1},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'errorbar2', _1: _gicentre$elm_vega$CompositeTests$errorbar2},
							_1: {ctor: '[]'}
						}
					}
				}
...
var _gicentre$elm_vega$CompositeTests$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$CompositeTests$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$CompositeTests$mySpecs,
			_1: _gicentre$elm_vega$CompositeTests$elmToJS(_gicentre$elm_vega$CompositeTests$mySpecs)
		},
		update: F2(
			function (_p4, model) {
...
var Elm = {};
Elm['CompositeTests'] = Elm['CompositeTests'] || {};
if (typeof _gicentre$elm_vega$CompositeTests$main !== 'undefined') {
    _gicentre$elm_vega$CompositeTests$main(Elm['CompositeTests'], 'CompositeTests', undefined);
}
