...
var _gicentre$elm_vega$GalleryInteraction$interaction8 = function () {
	...
	var desc = _gicentre$elm_vega$VegaLite$description('Displays tooltips for all stock prices of the hovered time');
...
var _gicentre$elm_vega$GalleryInteraction$interaction6 = function () {
	...
	var trans = function (_p16) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(_gicentre$elm_vega$VegaLite$calculateAs, 'year(datum.Year)', 'Year', _p16));
	};
...
var _gicentre$elm_vega$GalleryInteraction$interaction3 = function () {
	...
	var specBackground = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
	...
	var specHighlight = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$area(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$maColor('goldenrod'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
	...
	var des = _gicentre$elm_vega$VegaLite$description('Area chart with rectangular brush');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryInteraction$interaction1 = function () {
				...
				A3(
					...
					A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$tName('Name'),
								_1: {
									ctor: '::',
	...
	var trans = function (_p27) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(_gicentre$elm_vega$VegaLite$calculateAs, '\'https://www.google.com/search?q=\' + datum.Name', 'url', _p27));
	};
	var des = _gicentre$elm_vega$VegaLite$description('Scatterplot with external links and tooltips');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryInteraction$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
...
var _gicentre$elm_vega$GalleryInteraction$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
