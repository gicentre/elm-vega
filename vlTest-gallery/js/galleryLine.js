...
var _gicentre$elm_vega$GalleryLine$line11 = function () {
...
var _gicentre$elm_vega$GalleryLine$line10 = function () {
		...
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				...
				A3(
					...
					'scaled_date',
					A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.aggregated.CO2', 'CO2', _p5))));
	};
		...
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				...
				A3(
					...
					'datum.aggregated.scaled_date',
					'scaled_date',
					A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.aggregated.CO2', 'CO2', _p7))));
	};
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'floor(datum.year / 10)',
						'decade',
						A3(_gicentre$elm_vega$VegaLite$calculateAs, '(datum.year % 10) + (datum.month / 12)', 'scaled_date', _p10)))));
	};
...
var _gicentre$elm_vega$GalleryLine$line9 = function () {
	...
	var des = _gicentre$elm_vega$VegaLite$description('Line chart with markers and invalid values.');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryLine$line8 = function () {
			...
			A3(
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$mName('price'),
							_1: {
								ctor: '::',
	...
	var des = _gicentre$elm_vega$VegaLite$description('Stock prices of five tech companies over time double encoding price with vertical position and line thickness.');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$trail(
						{ctor: '[]'}),
					_1: {
						ctor: '::',
						_0: enc(
...
var _gicentre$elm_vega$GalleryLine$line7 = function () {
	...
	var des = _gicentre$elm_vega$VegaLite$description('A connected scatterplot can be created by customizing line order and adding point marker in the line mark definition.');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
			_1: {
				...
				_0: A2(
					_gicentre$elm_vega$VegaLite$dataFromUrl,
					'https://vega.github.io/vega-lite/data/driving.json',
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: enc(
...
var _gicentre$elm_vega$GalleryLine$line6 = function () {
	var enc = function (_p15) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
	...
	var des = _gicentre$elm_vega$VegaLite$description('Google\'s stock price over time (smoothed with monotonic interpolation).');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryLine$line5 = function () {
	var enc = function (_p17) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
...
var _gicentre$elm_vega$GalleryLine$line4 = function () {
	var enc = function (_p19) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				...
				_0: A2(
					_gicentre$elm_vega$VegaLite$dataFromUrl,
					'https://vega.github.io/vega-lite/data/barley.json',
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$line(
...
var _gicentre$elm_vega$GalleryLine$line3 = function () {
...
var _gicentre$elm_vega$GalleryLine$line2 = function () {
...
var _gicentre$elm_vega$GalleryLine$line1 = function () {
...
var _gicentre$elm_vega$GalleryLine$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'line1', _1: _gicentre$elm_vega$GalleryLine$line1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'line2', _1: _gicentre$elm_vega$GalleryLine$line2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'line3', _1: _gicentre$elm_vega$GalleryLine$line3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'line4', _1: _gicentre$elm_vega$GalleryLine$line4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'line5', _1: _gicentre$elm_vega$GalleryLine$line5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'line6', _1: _gicentre$elm_vega$GalleryLine$line6},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'line7', _1: _gicentre$elm_vega$GalleryLine$line7},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'line8', _1: _gicentre$elm_vega$GalleryLine$line8},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'line9', _1: _gicentre$elm_vega$GalleryLine$line9},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'line10', _1: _gicentre$elm_vega$GalleryLine$line10},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'line11', _1: _gicentre$elm_vega$GalleryLine$line11},
												_1: {ctor: '[]'}
											}
										}
									}
...
var _gicentre$elm_vega$GalleryLine$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryLine$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryLine$mySpecs,
			_1: _gicentre$elm_vega$GalleryLine$elmToJS(_gicentre$elm_vega$GalleryLine$mySpecs)
		},
		update: F2(
			function (_p25, model) {
...
var Elm = {};
Elm['GalleryLine'] = Elm['GalleryLine'] || {};
if (typeof _gicentre$elm_vega$GalleryLine$main !== 'undefined') {
    _gicentre$elm_vega$GalleryLine$main(Elm['GalleryLine'], 'GalleryLine', undefined);
}
