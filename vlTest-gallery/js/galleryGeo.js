...
var _gicentre$elm_vega$GalleryGeo$geo9 = function () {
	var trans = function (_p0) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(_gicentre$elm_vega$VegaLite$calculateAs, 'indexof (datum.name,\' \') > 0  ? substring(datum.name,0,indexof(datum.name, \' \')) : datum.name', 'bLabel', _p0));
	};
	var labelEnc = function (_p1) {
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$description('Geographic position of London underground lines'),
			_1: {
				ctor: '::',
...
var _gicentre$elm_vega$GalleryGeo$geo8 = function () {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_gicentre$elm_vega$VegaLite$dataFromUrl,
							'https://vega.github.io/vega-lite/data/income.json',
							{ctor: '[]'}),
						_1: {
							ctor: '::',
	...
	var trans = function (_p5) {
		return _gicentre$elm_vega$VegaLite$transform(
			A5(
				...
				A2(
					_gicentre$elm_vega$VegaLite$dataFromUrl,
					'https://vega.github.io/vega-lite/data/airports.csv',
					{ctor: '[]'}),
				'iata',
				{
					ctor: '::',
...
var _gicentre$elm_vega$GalleryGeo$geo6 = function () {
	...
	var overlaySpec = _gicentre$elm_vega$VegaLite$asSpec(
		{
			...
			_0: A2(
				_gicentre$elm_vega$VegaLite$dataFromUrl,
				'https://vega.github.io/vega-lite/data/us-state-capitals.json',
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$textMark(
	...
	var des = _gicentre$elm_vega$VegaLite$description('US state capitals overlayed on map of the US');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
	...
	var spec = _gicentre$elm_vega$VegaLite$asSpec(
		{
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						_gicentre$elm_vega$VegaLite$dataFromUrl,
						'https://vega.github.io/vega-lite/data/population_engineers_hurricanes.csv',
						{ctor: '[]'}),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$transform(
						...
						A3(
							...
							A5(
								...
								A3(
									...
									'datum.latitude',
									'dest_latitude',
									A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.longitude', 'dest_longitude', _p11))))))));
	};
	var flightsSpec = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$VegaLite$dataFromUrl,
				'https://vega.github.io/vega-lite/data/flights-airport.csv',
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: trans(
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								_gicentre$elm_vega$VegaLite$dataFromUrl,
								'https://vega.github.io/vega-lite/data/zipcodes.csv',
								{ctor: '[]'}),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$transform(
...
var _gicentre$elm_vega$GalleryGeo$geo1 = _gicentre$elm_vega$VegaLite$toVegaLite(
	{
		ctor: '::',
						...
						_1: {
							...
							_0: _gicentre$elm_vega$VegaLite$transform(
								A5(
									...
									A2(
										_gicentre$elm_vega$VegaLite$dataFromUrl,
										'https://vega.github.io/vega-lite/data/unemployment.tsv',
										{ctor: '[]'}),
									'id',
									{
										ctor: '::',
...
var _gicentre$elm_vega$GalleryGeo$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'geo8', _1: _gicentre$elm_vega$GalleryGeo$geo8},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'geo9', _1: _gicentre$elm_vega$GalleryGeo$geo9},
										_1: {ctor: '[]'}
									}
								}
							}
...
var _gicentre$elm_vega$GalleryGeo$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryGeo$mySpecs,
			_1: _gicentre$elm_vega$GalleryGeo$elmToJS(_gicentre$elm_vega$GalleryGeo$mySpecs)
		},
		update: F2(
			function (_p15, model) {
