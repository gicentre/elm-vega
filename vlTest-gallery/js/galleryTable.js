...
var _gicentre$elm_vega$GalleryTable$table5 = function () {
...
var _gicentre$elm_vega$GalleryTable$table4 = function () {
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				...
				_0: A2(
					_gicentre$elm_vega$VegaLite$dataFromUrl,
					'https://vega.github.io/vega-lite/data/github.csv',
					{ctor: '[]'}),
				_1: {
					ctor: '::',
...
var _gicentre$elm_vega$GalleryTable$table3 = function () {
...
var _gicentre$elm_vega$GalleryTable$table2 = function () {
			...
			A3(
				...
				_gicentre$elm_vega$VegaLite$X,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pTimeUnit(_gicentre$elm_vega$VegaLite$Date),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$pAxis(
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$axFormat('%e'),
												_1: {ctor: '[]'}
											}
										}
									}),
				...
				A3(
							...
							_1: {
								...
								_1: {
									...
									_0: _gicentre$elm_vega$VegaLite$pAxis(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$axTitle('Month'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$mName('temp'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mMType(_gicentre$elm_vega$VegaLite$Quantitative),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mAggregate(_gicentre$elm_vega$VegaLite$Max),
									_1: {
										ctor: '::',
		...
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				...
				_gicentre$elm_vega$VegaLite$coView(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$vicoStrokeWidth(0),
						_1: {ctor: '[]'}
					}),
				A2(
					_gicentre$elm_vega$VegaLite$configuration,
					_gicentre$elm_vega$VegaLite$coScale(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$sacoRangeStep(
								_elm_lang$core$Maybe$Just(13)),
							_1: {ctor: '[]'}
						}),
					A2(
						_gicentre$elm_vega$VegaLite$configuration,
	...
	var des = _gicentre$elm_vega$VegaLite$description('Annual weather \'heatmap\'');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
			_1: {
				...
				_1: {
					...
					_0: A2(
						_gicentre$elm_vega$VegaLite$dataFromUrl,
						'https://vega.github.io/vega-lite/data/seattle-temps.csv',
						{ctor: '[]'}),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$rect(
...
var _gicentre$elm_vega$GalleryTable$table1 = function () {
...
var _gicentre$elm_vega$GalleryTable$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'table1', _1: _gicentre$elm_vega$GalleryTable$table1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'table2', _1: _gicentre$elm_vega$GalleryTable$table2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'table3', _1: _gicentre$elm_vega$GalleryTable$table3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'table4', _1: _gicentre$elm_vega$GalleryTable$table4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'table5', _1: _gicentre$elm_vega$GalleryTable$table5},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _gicentre$elm_vega$GalleryTable$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryTable$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryTable$mySpecs,
			_1: _gicentre$elm_vega$GalleryTable$elmToJS(_gicentre$elm_vega$GalleryTable$mySpecs)
		},
		update: F2(
			function (_p10, model) {
...
var Elm = {};
Elm['GalleryTable'] = Elm['GalleryTable'] || {};
if (typeof _gicentre$elm_vega$GalleryTable$main !== 'undefined') {
    _gicentre$elm_vega$GalleryTable$main(Elm['GalleryTable'], 'GalleryTable', undefined);
}
