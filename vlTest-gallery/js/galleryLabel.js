...
var _gicentre$elm_vega$GalleryLabel$label7 = function () {
	var encPopulation = function (_p0) {
...
var _gicentre$elm_vega$GalleryLabel$label6 = function () {
	var encMean = function (_p4) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
...
var _gicentre$elm_vega$GalleryLabel$label5 = function () {
	var encLine = function (_p6) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$Y,
...
var _gicentre$elm_vega$GalleryLabel$label4 = function () {
	var encText = function (_p8) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
	...
	var thresholdData = function (_p10) {
		return A2(
	...
	var trans = function (_p12) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				...
				A3(_gicentre$elm_vega$VegaLite$calculateAs, '300', 'baseline', _p12)));
	};
...
var _gicentre$elm_vega$GalleryLabel$label3 = function () {
	...
	var transTextMax = function (_p17) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				...
				A3(
					...
					'scaled_date',
					A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.aggregated.CO2', 'CO2', _p17))));
	};
	...
	var transTextMin = function (_p19) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				_gicentre$elm_vega$VegaLite$aggregate,
				{
				...
				A3(
					...
					'datum.aggregated.scaled_date',
					'scaled_date',
					A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.aggregated.CO2', 'CO2', _p19))));
	};
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'floor(datum.year / 10)',
						'decade',
						A3(_gicentre$elm_vega$VegaLite$calculateAs, '(datum.year % 10) + (datum.month / 12)', 'scaled_date', _p22)))));
	};
...
var _gicentre$elm_vega$GalleryLabel$label2 = function () {
	var config = function (_p23) {
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				_gicentre$elm_vega$VegaLite$configuration,
...
var _gicentre$elm_vega$GalleryLabel$label1 = function () {
	var config = function (_p27) {
		return _gicentre$elm_vega$VegaLite$configure(
			A2(
				_gicentre$elm_vega$VegaLite$configuration,
				A2(
...
var _gicentre$elm_vega$GalleryLabel$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'label1', _1: _gicentre$elm_vega$GalleryLabel$label1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'label2', _1: _gicentre$elm_vega$GalleryLabel$label2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'label3', _1: _gicentre$elm_vega$GalleryLabel$label3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'label4', _1: _gicentre$elm_vega$GalleryLabel$label4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'label5', _1: _gicentre$elm_vega$GalleryLabel$label5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'label6', _1: _gicentre$elm_vega$GalleryLabel$label6},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'label7', _1: _gicentre$elm_vega$GalleryLabel$label7},
								_1: {ctor: '[]'}
							}
						}
					}
...
var _gicentre$elm_vega$GalleryLabel$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryLabel$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryLabel$mySpecs,
			_1: _gicentre$elm_vega$GalleryLabel$elmToJS(_gicentre$elm_vega$GalleryLabel$mySpecs)
		},
		update: F2(
			function (_p30, model) {
...
var Elm = {};
Elm['GalleryLabel'] = Elm['GalleryLabel'] || {};
if (typeof _gicentre$elm_vega$GalleryLabel$main !== 'undefined') {
    _gicentre$elm_vega$GalleryLabel$main(Elm['GalleryLabel'], 'GalleryLabel', undefined);
}
