...
var _gicentre$elm_vega$GalleryMulti$multi5 = function () {
	var trans2 = function (_p0) {
			...
			A4(
				...
				_gicentre$elm_vega$VegaLite$Multi,
				{
					...
					_0: _gicentre$elm_vega$VegaLite$seEncodings(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$ChColor,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
	...
	var weatherColors = _gicentre$elm_vega$VegaLite$categoricalDomainMap(
		{
			ctor: '::',
			...
			A3(
				...
				_gicentre$elm_vega$VegaLite$X,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pTimeUnit(_gicentre$elm_vega$VegaLite$MonthDate),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$pAxis(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$axTitle('Date'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$axFormat('%b'),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
							...
							_1: {
								...
								_1: {
									...
									_0: _gicentre$elm_vega$VegaLite$pAxis(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$axTitle('Maximum Daily Temperature (C)'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
					...
					A2(
						_gicentre$elm_vega$VegaLite$color,
						{
							...
							_0: A3(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mStr('#cfdebe'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mName('precipitation'),
								_1: {
									ctor: '::',
		...
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pName('weather'),
						_1: {
							ctor: '::',
					...
					A2(
						_gicentre$elm_vega$VegaLite$color,
						{
							...
							_0: A3(
								_gicentre$elm_vega$VegaLite$mSelectionCondition,
								_gicentre$elm_vega$VegaLite$selectionName('myClick'),
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mName('weather'),
									_1: {
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mStr('#acbf98'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
	...
	var trans1 = function (_p4) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				_gicentre$elm_vega$VegaLite$filter,
				_gicentre$elm_vega$VegaLite$fiSelection('myClick'),
				_p4));
	};
	var sel1 = function (_p5) {
		return _gicentre$elm_vega$VegaLite$selection(
			A4(
				_gicentre$elm_vega$VegaLite$select,
				'myBrush',
	...
	var des = _gicentre$elm_vega$VegaLite$description('A dashboard with cross-highlighting');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$title('Seattle Weather, 2012-2015'),
			_1: {
				ctor: '::',
				_0: des,
				_1: {
...
var _gicentre$elm_vega$GalleryMulti$multi4 = function () {
	var res = function (_p6) {
...
var _gicentre$elm_vega$GalleryMulti$multi3 = function () {
	...
	var des = _gicentre$elm_vega$VegaLite$description('Scatterplot matrix');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryMulti$multi2 = function () {
	var encPosition = function (_p16) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
	...
	var trans = function (_p19) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(_gicentre$elm_vega$VegaLite$calculateAs, 'hours(datum.date)', 'time', _p19));
	};
	var des = _gicentre$elm_vega$VegaLite$description('Cross-filter.');
	var spec = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryMulti$multi1 = function () {
	var enc2 = function (_p20) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
	...
	var des = _gicentre$elm_vega$VegaLite$description('Overview and detail.');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryMulti$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'multi1', _1: _gicentre$elm_vega$GalleryMulti$multi1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'multi2', _1: _gicentre$elm_vega$GalleryMulti$multi2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'multi3', _1: _gicentre$elm_vega$GalleryMulti$multi3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'multi4', _1: _gicentre$elm_vega$GalleryMulti$multi4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'multi5', _1: _gicentre$elm_vega$GalleryMulti$multi5},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _gicentre$elm_vega$GalleryMulti$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryMulti$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryMulti$mySpecs,
			_1: _gicentre$elm_vega$GalleryMulti$elmToJS(_gicentre$elm_vega$GalleryMulti$mySpecs)
		},
		update: F2(
			function (_p23, model) {
...
var Elm = {};
Elm['GalleryMulti'] = Elm['GalleryMulti'] || {};
if (typeof _gicentre$elm_vega$GalleryMulti$main !== 'undefined') {
    _gicentre$elm_vega$GalleryMulti$main(Elm['GalleryMulti'], 'GalleryMulti', undefined);
}
