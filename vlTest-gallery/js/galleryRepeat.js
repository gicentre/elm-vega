...
var _gicentre$elm_vega$GalleryRepeat$repeat5 = function () {
	var enc2_2 = function (_p0) {
	...
	var spec2_2 = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$width(60),
			_1: {
				ctor: '::',
	...
	var spec2_1 = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
	...
	var spec2 = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$spacing(15),
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$bounds(_gicentre$elm_vega$VegaLite$Flush),
				_1: {
					ctor: '::',
	...
	var des = _gicentre$elm_vega$VegaLite$description('Marginal histograms show the counts along the x and y dimension');
...
var _gicentre$elm_vega$GalleryRepeat$repeat4 = function () {
...
var _gicentre$elm_vega$GalleryRepeat$repeat3 = function () {
	...
	var des = _gicentre$elm_vega$VegaLite$description('Horizontally repeated charts that show the histograms of different parameters of cars in different countries');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryRepeat$repeat2 = function () {
	var enc2 = function (_p8) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('temp_min'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {
	...
	var trans = function (_p10) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				...
				_gicentre$elm_vega$VegaLite$fiExpr('datum.location === \'Seattle\''),
				_p10));
	};
	var desc = _gicentre$elm_vega$VegaLite$description('Two vertically concatenated charts that show a histogram of precipitation in Seattle and the relationship between min and max temperature');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: desc,
			_1: {
				...
				_1: {
					...
					_0: A2(
						_gicentre$elm_vega$VegaLite$dataFromUrl,
						'https://vega.github.io/vega-lite/data/weather.csv',
						{ctor: '[]'}),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$vConcat(
...
var _gicentre$elm_vega$GalleryRepeat$repeat1 = function () {
...
var _gicentre$elm_vega$GalleryRepeat$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'repeat1', _1: _gicentre$elm_vega$GalleryRepeat$repeat1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'repeat2', _1: _gicentre$elm_vega$GalleryRepeat$repeat2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'repeat3', _1: _gicentre$elm_vega$GalleryRepeat$repeat3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'repeat4', _1: _gicentre$elm_vega$GalleryRepeat$repeat4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'repeat5', _1: _gicentre$elm_vega$GalleryRepeat$repeat5},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _gicentre$elm_vega$GalleryRepeat$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryRepeat$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryRepeat$mySpecs,
			_1: _gicentre$elm_vega$GalleryRepeat$elmToJS(_gicentre$elm_vega$GalleryRepeat$mySpecs)
		},
		update: F2(
			function (_p13, model) {
...
var Elm = {};
Elm['GalleryRepeat'] = Elm['GalleryRepeat'] || {};
if (typeof _gicentre$elm_vega$GalleryRepeat$main !== 'undefined') {
    _gicentre$elm_vega$GalleryRepeat$main(Elm['GalleryRepeat'], 'GalleryRepeat', undefined);
}
