...
var _gicentre$elm_vega$GalleryScatter$scatter11 = function () {
				...
				A3(
					...
					A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$tName('OriginInitial'),
								_1: {
									ctor: '::',
	...
	var trans = function (_p1) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.Origin[0]', 'OriginInitial', _p1));
	};
	var des = _gicentre$elm_vega$VegaLite$description('A scatterplot showing horsepower and miles per gallon with country of origin double encoded by colour and text symbol.');
...
var _gicentre$elm_vega$GalleryScatter$scatter10 = function () {
...
var _gicentre$elm_vega$GalleryScatter$scatter9 = function () {
	var sel = function (_p4) {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_gicentre$elm_vega$VegaLite$dataFromUrl,
							'https://vega.github.io/vega-lite/data/gapminder-health-income.csv',
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$circle(
...
var _gicentre$elm_vega$GalleryScatter$scatter8 = function () {
...
var _gicentre$elm_vega$GalleryScatter$scatter7 = function () {
						...
						_gicentre$elm_vega$VegaLite$color,
						{
							...
							_0: A2(
								_gicentre$elm_vega$VegaLite$mDataCondition,
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: _gicentre$elm_vega$VegaLite$expr('datum.IMDB_Rating === null || datum.Rotten_Tomatoes_Rating === null'),
										_1: {
											ctor: '::',
...
var _gicentre$elm_vega$GalleryScatter$scatter6 = function () {
...
var _gicentre$elm_vega$GalleryScatter$scatter5 = function () {
...
var _gicentre$elm_vega$GalleryScatter$scatter4 = function () {
	...
	var des = _gicentre$elm_vega$VegaLite$description('A scatterplot showing horsepower and miles per gallon with country of origin double encoded by colour and shape.');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryScatter$scatter3 = function () {
...
var _gicentre$elm_vega$GalleryScatter$scatter2 = function () {
	...
	var des = _gicentre$elm_vega$VegaLite$description('Shows the distribution of a single variable (precipitation) using tick marks.');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryScatter$scatter1 = function () {
			...
			_1: {
				...
				_1: {
					...
					_0: _gicentre$elm_vega$VegaLite$point(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$maTooltip(_gicentre$elm_vega$VegaLite$TTData),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _gicentre$elm_vega$GalleryScatter$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'scatter1', _1: _gicentre$elm_vega$GalleryScatter$scatter1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'scatter2', _1: _gicentre$elm_vega$GalleryScatter$scatter2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'scatter3', _1: _gicentre$elm_vega$GalleryScatter$scatter3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'scatter4', _1: _gicentre$elm_vega$GalleryScatter$scatter4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'scatter5', _1: _gicentre$elm_vega$GalleryScatter$scatter5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'scatter6', _1: _gicentre$elm_vega$GalleryScatter$scatter6},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'scatter7', _1: _gicentre$elm_vega$GalleryScatter$scatter7},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'scatter8', _1: _gicentre$elm_vega$GalleryScatter$scatter8},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'scatter9', _1: _gicentre$elm_vega$GalleryScatter$scatter9},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'scatter10', _1: _gicentre$elm_vega$GalleryScatter$scatter10},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'scatter11', _1: _gicentre$elm_vega$GalleryScatter$scatter11},
												_1: {ctor: '[]'}
											}
										}
									}
...
var _gicentre$elm_vega$GalleryScatter$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
