	...
	switch (_p13.ctor) {
		...
		case 'SCClamp':
			return {
				ctor: '_Tuple2',
				_0: 'clamp',
				_1: _elm_lang$core$Json_Encode$bool(_p13._0)
			};
		case 'SCMaxBandSize':
			return {
				ctor: '_Tuple2',
	...
	switch (_p21.ctor) {
		case 'PType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$projectionLabel(_p21._0))
			};
		case 'PClipAngle':
			var _p22 = _p21._0;
			if (_p22.ctor === 'Just') {
		...
		case 'PCenter':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$float(_p21._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$float(_p21._1),
							_1: {ctor: '[]'}
						}
					})
			};
		...
		case 'PLobes':
			return {
				ctor: '_Tuple2',
				_0: 'lobes',
				_1: _elm_lang$core$Json_Encode$int(_p21._0)
			};
		case 'PParallel':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$VegaLite$paddingSpec = function (pad) {
	var _p24 = pad;
	if (_p24.ctor === 'PSize') {
		return _elm_lang$core$Json_Encode$float(_p24._0);
	} else {
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'top',
						_1: _elm_lang$core$Json_Encode$float(_p24._1)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'right',
							_1: _elm_lang$core$Json_Encode$float(_p24._2)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bottom',
								_1: _elm_lang$core$Json_Encode$float(_p24._3)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_0: 'interval',
						_1: _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$VegaLite$timeUnitLabel(_p27._0))
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'step',
							_1: _elm_lang$core$Json_Encode$int(_p27._1)
						},
						_1: {ctor: '[]'}
					}
				});
						...
						A2(
							...
							function (_p41) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p42._0,
									_1: _gicentre$elm_vega$VegaLite$dataTypeSpec(_p42._1)
								};
							},
							_p40._0))
				},
	...
	switch (_p44.ctor) {
		...
		case 'Orient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$legendOrientLabel(_p44._0))
			};
		case 'Offset':
			return {
				ctor: '_Tuple2',
		...
		case 'GradientLabelBaseline':
			return {
				...
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p44._0))
			};
		...
		case 'LeLabelAlign':
			return {
				...
				_0: 'labelAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$hAlignLabel(_p44._0))
			};
		...
		case 'SymbolType':
			return {
				...
				_0: 'symbolType',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$symbolLabel(_p44._0))
			};
		case 'SymbolSize':
			return {
				ctor: '_Tuple2',
		...
		case 'LeTitleFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'titleFontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p44._0)
			};
		case 'LeTitleLimit':
			return {
				ctor: '_Tuple2',
	...
	switch (_p45.ctor) {
		...
		case 'MInterpolate':
			return {
				...
				_0: 'interpolate',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$markInterpolationLabel(_p45._0))
			};
		case 'MTension':
			return {
				ctor: '_Tuple2',
		...
		case 'MOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$markOrientationLabel(_p45._0))
			};
		case 'MShape':
			return {
				ctor: '_Tuple2',
				_0: 'shape',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$symbolLabel(_p45._0))
			};
		case 'MSize':
			return {
				ctor: '_Tuple2',
		...
		case 'MAlign':
			return {
				...
				_0: 'align',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$hAlignLabel(_p45._0))
			};
		case 'MBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'baseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p45._0))
			};
		case 'MdX':
			return {
				ctor: '_Tuple2',
		...
		case 'MFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p45._0)
			};
		case 'MRadius':
			return {
				ctor: '_Tuple2',
	...
	switch (_p49.ctor) {
		...
		case 'DTMonth':
			return {
				...
				_0: 'month',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$monthNameLabel(_p49._0))
			};
		case 'DTDate':
			return {
				ctor: '_Tuple2',
		...
		case 'DTDay':
			return {
				...
				_0: 'day',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$dayLabel(_p49._0))
			};
		case 'DTHours':
			return {
				ctor: '_Tuple2',
	...
	switch (_p51.ctor) {
		...
		case 'LOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$legendOrientLabel(_p51._0))
			};
		case 'LPadding':
			return {
				ctor: '_Tuple2',
	...
	switch (_p56.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$scaleLabel(_p56._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$VegaLite$scaleDomainSpec(_p56._0)
			};
		case 'SRange':
			var _p57 = _p56._0;
			switch (_p57.ctor) {
		...
		case 'SScheme':
			return A2(_gicentre$elm_vega$VegaLite$schemeProperty, _p56._0, _p56._1);
		case 'SPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$VegaLite$cInterpolateSpec(_p56._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$VegaLite$scaleNiceSpec(_p56._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					A2(
						...
						function (_p61) {
							...
							return {
								ctor: '_Tuple2',
								_0: _gicentre$elm_vega$VegaLite$channelLabel(_p62._0),
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$resolutionLabel(_p62._1))
							};
						},
						_p60._0))
			};
				...
				_1: _elm_lang$core$Json_Encode$object(
					A2(
						...
						function (_p63) {
							...
							return {
								ctor: '_Tuple2',
								_0: _gicentre$elm_vega$VegaLite$channelLabel(_p64._0),
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$resolutionLabel(_p64._1))
							};
						},
						_p60._0))
			};
				...
				_1: _elm_lang$core$Json_Encode$object(
					A2(
						...
						function (_p65) {
							...
							return {
								ctor: '_Tuple2',
								_0: _gicentre$elm_vega$VegaLite$channelLabel(_p66._0),
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$resolutionLabel(_p66._1))
							};
						},
						_p60._0))
			};
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$inputProperty, _p67._1)
					})
			};
		case 'ICheckbox':
			return {
	...
	switch (_p68.ctor) {
					...
					A2(
						...
						function (_p69) {
							return _elm_lang$core$Json_Encode$string(
								_gicentre$elm_vega$VegaLite$channelLabel(_p69));
						},
						_p68._0))
			};
		case 'On':
		...
		case 'ResolveSelections':
			return {
				...
				_0: 'resolve',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$selectionResolutionLabel(_p68._0))
			};
		case 'SelectionMark':
			return {
				ctor: '_Tuple2',
				_0: 'mark',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$selectionMarkProperty, _p68._0))
			};
		case 'BindScales':
			return {
				ctor: '_Tuple2',
		...
		case 'Bind':
			return {
				...
				_0: 'bind',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$bindingSpec, _p68._0))
			};
		case 'Nearest':
			return {
				ctor: '_Tuple2',
	...
	switch (_p73.ctor) {
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$overlapStrategyLabel(_p73._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'AxOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$sideLabel(_p73._0))
			};
		case 'AxOffset':
			return {
				ctor: '_Tuple2',
		...
		case 'AxTitleAlign':
			return {
				...
				_0: 'titleAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$hAlignLabel(_p73._0))
			};
		case 'AxTitleAngle':
			return {
				ctor: '_Tuple2',
	...
	switch (_p74.ctor) {
		...
		case 'TitleBaseline':
			return {
				...
				_0: 'titleBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p74._0))
			};
		case 'TitleColor':
			return {
				ctor: '_Tuple2',
		...
		case 'TitleFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'titleFontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p74._0)
			};
		case 'TitleFontSize':
			return {
				ctor: '_Tuple2',
	...
	switch (_p77.ctor) {
		...
		case 'Op':
			return {
				...
				_0: 'op',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$operationLabel(_p77._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: 'repeat',
							_1: _elm_lang$core$Json_Encode$string(
								_gicentre$elm_vega$VegaLite$arrangementLabel(_p77._0))
						},
						_1: {ctor: '[]'}
					})
			};
	...
	switch (_p79.ctor) {
		case 'TAnchor':
			return {
				...
				_0: 'anchor',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$anchorLabel(_p79._0))
			};
		case 'TAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'TBaseline':
			return {
				...
				_0: 'baseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p79._0))
			};
		case 'TColor':
			return {
				ctor: '_Tuple2',
		...
		case 'TFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p79._0)
			};
		case 'TLimit':
			return {
				ctor: '_Tuple2',
	...
	switch (_p80.ctor) {
		...
		case 'FieldTitle':
			return {
				...
				_0: 'fieldTitle',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$fieldTitleLabel(_p80._0))
			};
		case 'RemoveInvalid':
			return _p80._0 ? {
				ctor: '_Tuple2',
		...
		case 'Padding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _gicentre$elm_vega$VegaLite$paddingSpec(_p80._0)
			};
		case 'TimeFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'Axis':
			return {
				...
				_0: 'axis',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$axisConfigProperty, _p80._0))
			};
		case 'AxisX':
			return {
				ctor: '_Tuple2',
		...
		case 'Legend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$legendConfigProperty, _p80._0))
			};
		case 'MarkStyle':
			return {
				ctor: '_Tuple2',
				_0: 'mark',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$markProperty, _p80._0))
			};
		case 'Projection':
			return {
				ctor: '_Tuple2',
				_0: 'projection',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$projectionProperty, _p80._0))
			};
		case 'AreaStyle':
			return {
				ctor: '_Tuple2',
		...
		case 'TitleStyle':
			return {
				...
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$titleConfigSpec, _p80._0))
			};
		case 'NamedStyle':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: _p80._0,
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$markProperty, _p80._1))
						},
						_1: {ctor: '[]'}
					})
			};
		case 'Scale':
			return {
				...
				_0: 'scale',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$scaleConfigProperty, _p80._0))
			};
		case 'Stack':
			return _gicentre$elm_vega$VegaLite$stackProperty(_p80._0);
		case 'Range':
			return {
				ctor: '_Tuple2',
				_0: 'range',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$rangeConfigProperty, _p80._0))
			};
		case 'SelectionStyle':
			var selProp = function (_p81) {
				...
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$VegaLite$selectionLabel(_p82._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$selectionProperty, _p82._1))
				};
			};
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: 'view',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$viewConfigProperty, _p80._0))
			};
	}
};
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p85) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$VegaLite$vlPropertyLabel(_p86._0),
						_1: _p86._1
					};
				},
				spec)
...
var _gicentre$elm_vega$VegaLite$lookupAs = F4(
	function (key1, _p87, key2, asName) {
		var _p88 = _p87;
		return F2(
			function (x, y) {
				return {ctor: '::', _0: x, _1: y};
...
var _gicentre$elm_vega$VegaLite$lookup = F4(
	function (key1, _p89, key2, fields) {
		var _p90 = _p89;
		return F2(
			function (x, y) {
				return {ctor: '::', _0: x, _1: y};
...
var _gicentre$elm_vega$VegaLite$filter = function (f) {
	...
	switch (_p91.ctor) {
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'equal',
									_1: _gicentre$elm_vega$VegaLite$dataValueSpec(_p91._1)
								},
								_1: {ctor: '[]'}
							}
						})
		...
		case 'FRange':
			var values = function () {
				var _p92 = _p91._1;
				if (_p92.ctor === 'NumberRange') {
					return _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$float(_p92._0),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$float(_p92._1),
								_1: {ctor: '[]'}
							}
						});
				} else {
					return _elm_lang$core$Json_Encode$list(
						{
							...
							_0: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$dateTimeProperty, _p92._0)),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$object(
									A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$dateTimeProperty, _p92._1)),
								_1: {ctor: '[]'}
							}
						});
				}
		...
		default:
			var values = function () {
				...
				switch (_p93.ctor) {
					...
					default:
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p93._0));
				}
			}();
			return F2(
				function (x, y) {
			...
			A2(
				...
				function (_p94) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p95._0,
						_1: _gicentre$elm_vega$VegaLite$dataValueSpec(_p95._1)
					};
				},
				row)));
};
...
var _gicentre$elm_vega$VegaLite$facetChannelProperty = function (fMap) {
	...
	switch (_p98.ctor) {
		...
		case 'FBin':
			return _gicentre$elm_vega$VegaLite$bin(_p98._0);
		case 'FAggregate':
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
		...
		default:
			return {
				...
				_0: 'header',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$headerProperty, _p98._0))
			};
	}
};
...
var _gicentre$elm_vega$VegaLite$facetMappingProperty = function (fMap) {
	...
	if (_p99.ctor === 'RowBy') {
		return {
			...
			_0: 'row',
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$facetChannelProperty, _p99._0))
		};
	} else {
		return {
			ctor: '_Tuple2',
	...
	switch (_p102.ctor) {
		...
		default:
			...
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$sortProperty, _p104))
			};
	}
};
	...
	switch (_p105.ctor) {
		...
		case 'PScale':
			return {
				...
				_0: 'scale',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$scaleProperty, _p105._0))
			};
		case 'PAxis':
			var _p108 = _p105._0;
			return _elm_lang$core$Native_Utils.eq(
	...
	return _elm_lang$core$Json_Encode$object(
		A2(
			...
			function (_p110) {
				...
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$VegaLite$vlPropertyLabel(_p111._0),
					_1: _p111._1
				};
			},
			specs));
		...
		switch (_p114) {
			case 'aggregate':
				var _p115 = A2(
					...
					A2(_elm_lang$core$Json_Encode$encode, 0, _p122));
			...
			case 'bin':
				var _p116 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p122));
				if (((((_p116.ctor === 'Ok') && (_p116._0.ctor === '::')) && (_p116._0._1.ctor === '::')) && (_p116._0._1._1.ctor === '::')) && (_p116._0._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'bin', _1: _p116._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'field', _1: _p116._0._1._0},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'as', _1: _p116._0._1._1._0},
									_1: {ctor: '[]'}
								}
							}
						});
			...
			case 'calculate':
				...
				if ((((_p117.ctor === 'Ok') && (_p117._0.ctor === '::')) && (_p117._0._1.ctor === '::')) && (_p117._0._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'calculate', _1: _p117._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'as', _1: _p117._0._1._0},
								_1: {ctor: '[]'}
							}
						});
				} else {
			...
			case 'lookup':
				var _p118 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p122));
				if ((((((_p118.ctor === 'Ok') && (_p118._0.ctor === '::')) && (_p118._0._1.ctor === '::')) && (_p118._0._1._1.ctor === '::')) && (_p118._0._1._1._1.ctor === '::')) && (_p118._0._1._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'lookup', _1: _p118._0._0},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									...
									_1: _elm_lang$core$Json_Encode$object(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'data', _1: _p118._0._1._0},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'key', _1: _p118._0._1._1._0},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'fields', _1: _p118._0._1._1._1._0},
													_1: {ctor: '[]'}
												}
											}
										})
			...
			case 'lookupAs':
				var _p119 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p122));
				if ((((((_p119.ctor === 'Ok') && (_p119._0.ctor === '::')) && (_p119._0._1.ctor === '::')) && (_p119._0._1._1.ctor === '::')) && (_p119._0._1._1._1.ctor === '::')) && (_p119._0._1._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'lookup', _1: _p119._0._0},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									...
									_1: _elm_lang$core$Json_Encode$object(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'data', _1: _p119._0._1._0},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'key', _1: _p119._0._1._1._0},
												_1: {ctor: '[]'}
											}
										})
								},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'as', _1: _p119._0._1._1._1._0},
									_1: {ctor: '[]'}
								}
							}
						});
			...
			case 'timeUnit':
				var _p120 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p122));
				if (((((_p120.ctor === 'Ok') && (_p120._0.ctor === '::')) && (_p120._0._1.ctor === '::')) && (_p120._0._1._1.ctor === '::')) && (_p120._0._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'timeUnit', _1: _p120._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'field', _1: _p120._0._1._0},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'as', _1: _p120._0._1._1._0},
									_1: {ctor: '[]'}
								}
							}
						});
			...
			default:
				return _elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p121, _1: _p122},
						_1: {ctor: '[]'}
					});
		}
	};
...
var _gicentre$elm_vega$VegaLite$categoricalDomainMap = function (scaleDomainPairs) {
	var _p124 = _elm_lang$core$List$unzip(scaleDomainPairs);
	var domain = _p124._0;
	var range = _p124._1;
	return {
		ctor: '::',
