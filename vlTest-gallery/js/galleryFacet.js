...
var _gicentre$elm_vega$GalleryFacet$facet7 = function () {
...
var _gicentre$elm_vega$GalleryFacet$facet6 = function () {
	...
	var des = _gicentre$elm_vega$VegaLite$description('The Trellis display by Becker et al. helped establish small multiples as a \'powerful mechanism for understanding interactions in studies of how a response depends on explanatory variables\'');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryFacet$facet5 = function () {
	...
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				...
				_0: A2(
					_gicentre$elm_vega$VegaLite$dataFromUrl,
					'https://vega.github.io/vega-lite/data/anscombe.json',
					{ctor: '[]'}),
				_1: {
					ctor: '::',
...
var _gicentre$elm_vega$GalleryFacet$facet4 = function () {
...
var _gicentre$elm_vega$GalleryFacet$facet3 = function () {
...
var _gicentre$elm_vega$GalleryFacet$facet2 = function () {
...
var _gicentre$elm_vega$GalleryFacet$facet1 = function () {
	...
	var trans = function (_p8) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				...
				A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.sex == 2 ? \'Female\' : \'Male\'', 'gender', _p8)));
	};
...
var _gicentre$elm_vega$GalleryFacet$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'facet1', _1: _gicentre$elm_vega$GalleryFacet$facet1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'facet2', _1: _gicentre$elm_vega$GalleryFacet$facet2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'facet3', _1: _gicentre$elm_vega$GalleryFacet$facet3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'facet4', _1: _gicentre$elm_vega$GalleryFacet$facet4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'facet5', _1: _gicentre$elm_vega$GalleryFacet$facet5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'facet6', _1: _gicentre$elm_vega$GalleryFacet$facet6},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'facet7', _1: _gicentre$elm_vega$GalleryFacet$facet7},
								_1: {ctor: '[]'}
							}
						}
					}
...
var _gicentre$elm_vega$GalleryFacet$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryFacet$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryFacet$mySpecs,
			_1: _gicentre$elm_vega$GalleryFacet$elmToJS(_gicentre$elm_vega$GalleryFacet$mySpecs)
		},
		update: F2(
			function (_p9, model) {
...
var Elm = {};
Elm['GalleryFacet'] = Elm['GalleryFacet'] || {};
if (typeof _gicentre$elm_vega$GalleryFacet$main !== 'undefined') {
    _gicentre$elm_vega$GalleryFacet$main(Elm['GalleryFacet'], 'GalleryFacet', undefined);
}
