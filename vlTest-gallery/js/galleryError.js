...
var _gicentre$elm_vega$GalleryError$error4 = function () {
	var encRect = function (_p0) {
		...
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				...
				A3(
					...
					'upper',
					A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.mean_MPG-datum.dev_MPG', 'lower', _p2))));
	};
...
var _gicentre$elm_vega$GalleryError$error3 = function () {
	var encLine = function (_p4) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$Y,
...
var _gicentre$elm_vega$GalleryError$error2 = function () {
	var encStdevs = function (_p7) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
		...
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				...
				A3(
					...
					'lower',
					A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.mean+datum.stdev', 'upper', _p10))));
	};
	var des = _gicentre$elm_vega$VegaLite$description('Error bars showing standard deviations');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryError$error1 = function () {
	var encCIs = function (_p11) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
...
var _gicentre$elm_vega$GalleryError$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'error1', _1: _gicentre$elm_vega$GalleryError$error1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'error2', _1: _gicentre$elm_vega$GalleryError$error2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'error3', _1: _gicentre$elm_vega$GalleryError$error3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'error4', _1: _gicentre$elm_vega$GalleryError$error4},
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _gicentre$elm_vega$GalleryError$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryError$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryError$mySpecs,
			_1: _gicentre$elm_vega$GalleryError$elmToJS(_gicentre$elm_vega$GalleryError$mySpecs)
		},
		update: F2(
			function (_p14, model) {
...
var Elm = {};
Elm['GalleryError'] = Elm['GalleryError'] || {};
if (typeof _gicentre$elm_vega$GalleryError$main !== 'undefined') {
    _gicentre$elm_vega$GalleryError$main(Elm['GalleryError'], 'GalleryError', undefined);
}
