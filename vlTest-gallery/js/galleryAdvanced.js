	...
	function (sName, sps) {
		var spSpec = function (sp) {
			...
			switch (_p11) {
				case 'offset':
					var _p12 = sp;
					if (_p12.ctor === 'StOffset') {
						return _gicentre$elm_vega$VegaLite$stackOffsetSpec(_p12._0);
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				case 'sort':
					...
					if (_p13.ctor === 'StSort') {
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$sortFieldSpec, _p13._0));
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				default:
	...
	function (wpName, wps) {
		var wpSpec = function (wp) {
			...
			switch (_p15) {
						...
						if (_p16._0.ctor === 'Just') {
							if (_p16._1.ctor === 'Just') {
								return _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$int(_p16._0._0),
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$int(_p16._1._0),
											_1: {ctor: '[]'}
										}
									});
							} else {
				...
				case 'ignorePeers':
					var _p17 = wp;
					if (_p17.ctor === 'WIgnorePeers') {
						return _elm_lang$core$Json_Encode$bool(_p17._0);
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				case 'groupby':
					var _p18 = wp;
					if (_p18.ctor === 'WGroupBy') {
						return _elm_lang$core$Json_Encode$list(
				...
				case 'sort':
					...
					if (_p19.ctor === 'WSort') {
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$sortFieldSpec, _p19._0));
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				default:
	...
	switch (_p23.ctor) {
		...
		case 'SMStrokeDash':
			return {
				...
				_0: 'strokeDash',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p23._0))
			};
		default:
			return {
				ctor: '_Tuple2',
						...
						_1: {
							...
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$float(_p25._0),
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$float(_p25._1._0),
											_1: {ctor: '[]'}
										}
									})
							},
...
var _gicentre$elm_vega$VegaLite$scaleNiceSpec = function (ni) {
	...
	switch (_p26.ctor) {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_0: 'interval',
						_1: _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$VegaLite$timeUnitLabel(_p26._0))
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'step',
							_1: _elm_lang$core$Json_Encode$int(_p26._1)
						},
						_1: {ctor: '[]'}
					}
				});
		...
		default:
			return _elm_lang$core$Json_Encode$int(_p26._0);
	}
};
	...
	switch (_p28.ctor) {
		...
		case 'SCClamp':
			return {
				ctor: '_Tuple2',
				_0: 'clamp',
				_1: _elm_lang$core$Json_Encode$bool(_p28._0)
			};
		case 'SCMaxBandSize':
			return {
				ctor: '_Tuple2',
		...
		case 'SCRangeStep':
			...
			if (_p29.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: 'rangeStep',
					_1: _elm_lang$core$Json_Encode$float(_p29._0)
				};
			} else {
	...
	switch (_p35.ctor) {
		case 'PType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$projectionLabel(_p35._0))
			};
		case 'PClipAngle':
			var _p36 = _p35._0;
			if (_p36.ctor === 'Just') {
		...
		case 'PCenter':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$float(_p35._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$float(_p35._1),
							_1: {ctor: '[]'}
						}
					})
			};
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'top',
						_1: _elm_lang$core$Json_Encode$float(_p38._1)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'right',
							_1: _elm_lang$core$Json_Encode$float(_p38._2)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bottom',
								_1: _elm_lang$core$Json_Encode$float(_p38._3)
							},
							_1: {ctor: '[]'}
						}
					}
	...
	switch (_p41.ctor) {
		case 'WAggregateOp':
			return {
				...
				_0: 'op',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$operationLabel(_p41._0))
			};
		case 'WOp':
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$wOperationLabel(_p41._0))
			};
		case 'WParam':
			return {
				ctor: '_Tuple2',
				_0: 'param',
				_1: _elm_lang$core$Json_Encode$int(_p41._0)
			};
		default:
			return {
				ctor: '_Tuple2',
					...
					return _elm_lang$core$Json_Encode$list(
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$float(_p52._1),
								_1: {ctor: '[]'}
							}
						});
				},
					...
					_1: {
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								{
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$float(_p53._0),
									_1: {
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$float(_p53._1),
										_1: {ctor: '[]'}
									}
								})
						},
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_0: 'coordinates',
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, toCoords, _p53._0))
						},
						_1: {ctor: '[]'}
					}
				});
	...
	switch (_p55.ctor) {
		...
		case 'Orient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$legendOrientLabel(_p55._0))
			};
		case 'Offset':
			return {
				ctor: '_Tuple2',
		...
		case 'GradientLabelBaseline':
			return {
				...
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p55._0))
			};
		...
		case 'LeLabelAlign':
			return {
				...
				_0: 'labelAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$hAlignLabel(_p55._0))
			};
		...
		case 'SymbolType':
			return {
				...
				_0: 'symbolType',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$symbolLabel(_p55._0))
			};
		case 'SymbolSize':
			return {
				ctor: '_Tuple2',
		...
		case 'LeTitleFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'titleFontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p55._0)
			};
		case 'LeTitleLimit':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$VegaLite$extentSpec = function (ext) {
	...
	switch (_p57.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$float(_p57._0);
	}
};
	...
	switch (_p59.ctor) {
		case 'DTYear':
			return {
				ctor: '_Tuple2',
				_0: 'year',
				_1: _elm_lang$core$Json_Encode$int(_p59._0)
			};
		case 'DTQuarter':
			return {
				ctor: '_Tuple2',
		...
		case 'DTMonth':
			return {
				...
				_0: 'month',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$monthNameLabel(_p59._0))
			};
		case 'DTDate':
			return {
				ctor: '_Tuple2',
		...
		case 'DTDay':
			return {
				...
				_0: 'day',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$dayLabel(_p59._0))
			};
		case 'DTHours':
			return {
				ctor: '_Tuple2',
	...
	switch (_p60.ctor) {
		...
		case 'LOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$legendOrientLabel(_p60._0))
			};
		case 'LPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'LTitle':
			var _p62 = _p60._0;
			return _elm_lang$core$Native_Utils.eq(_p62, '') ? {ctor: '_Tuple2', _0: 'title', _1: _elm_lang$core$Json_Encode$null} : {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$string(_p62)
			};
		case 'LValues':
			var list = function () {
				var _p63 = _p60._0;
				switch (_p63.ctor) {
					case 'LNumbers':
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p63._0));
					case 'LDateTimes':
						return _elm_lang$core$Json_Encode$list(
							A2(
								_elm_lang$core$List$map,
...
var _gicentre$elm_vega$VegaLite$dataValuesSpecs = function (dvs) {
	...
	switch (_p65.ctor) {
		case 'Numbers':
			return A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p65._0);
		case 'Strings':
			return A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p65._0);
		case 'DateTimes':
			return A2(
				_elm_lang$core$List$map,
				function (dts) {
				...
				_p65._0);
		default:
			return A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p65._0);
	}
};
var _gicentre$elm_vega$VegaLite$dataValueSpec = function (val) {
	...
	switch (_p66.ctor) {
		case 'Number':
			return _elm_lang$core$Json_Encode$float(_p66._0);
		case 'Str':
			return _elm_lang$core$Json_Encode$string(_p66._0);
		case 'Boolean':
			return _elm_lang$core$Json_Encode$bool(_p66._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$dateTimeProperty, _p66._0));
	}
};
	...
	switch (_p67.ctor) {
				...
				if (_p67._1.ctor === 'Just') {
					return {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$int(_p67._0._0),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$int(_p67._1._0),
									_1: {ctor: '[]'}
								}
							})
					};
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'stop',
								_1: _elm_lang$core$Json_Encode$float(_p67._1)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _elm_lang$core$Json_Encode$float(_p67._2)
								},
								_1: {ctor: '[]'}
							}
						}
		...
		case 'ImMethod':
			return {
				...
				_0: 'method',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$imMethodLabel(_p67._0))
			};
		case 'ImNewValue':
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _gicentre$elm_vega$VegaLite$dataValueSpec(_p67._0)
			};
		default:
			return A2(
				_elm_lang$core$Debug$log,
	...
	function (ipName, ips) {
		var ipSpec = function (ip) {
			...
			switch (_p68) {
				case 'frame':
					var _p69 = ip;
					if (_p69.ctor === 'ImFrame') {
						if (_p69._0.ctor === 'Just') {
							if (_p69._1.ctor === 'Just') {
								return _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$int(_p69._0._0),
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$int(_p69._1._0),
											_1: {ctor: '[]'}
										}
									});
							} else {
				...
				case 'keyVals':
					var _p70 = ip;
					if (_p70.ctor === 'ImKeyVals') {
						return _elm_lang$core$Json_Encode$list(
							_gicentre$elm_vega$VegaLite$dataValuesSpecs(_p70._0));
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				case 'keyValSequence':
					var _p71 = ip;
					if (_p71.ctor === 'ImKeyValSequence') {
						return _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: {
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'stop',
										_1: _elm_lang$core$Json_Encode$float(_p71._1)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'step',
											_1: _elm_lang$core$Json_Encode$float(_p71._2)
										},
										_1: {ctor: '[]'}
									}
								}
				...
				case 'groupby':
					var _p72 = ip;
					if (_p72.ctor === 'ImGroupBy') {
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p72._0));
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				case 'method':
					var _p73 = ip;
					if (_p73.ctor === 'ImMethod') {
						return _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$VegaLite$imMethodLabel(_p73._0));
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				case 'value':
					var _p74 = ip;
					if (_p74.ctor === 'ImNewValue') {
						return _gicentre$elm_vega$VegaLite$dataValueSpec(_p74._0);
					} else {
						return _elm_lang$core$Json_Encode$null;
					}
				default:
...
var _gicentre$elm_vega$VegaLite$dataTypeSpec = function (dType) {
	...
	switch (_p76.ctor) {
		...
		case 'FoDate':
			var _p77 = _p76._0;
			return _elm_lang$core$Native_Utils.eq(_p77, '') ? _elm_lang$core$Json_Encode$string('date') : _elm_lang$core$Json_Encode$string(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'date:\'',
					A2(_elm_lang$core$Basics_ops['++'], _p77, '\'')));
		default:
			var _p78 = _p76._0;
			return _elm_lang$core$Native_Utils.eq(_p78, '') ? _elm_lang$core$Json_Encode$string('utc') : _elm_lang$core$Json_Encode$string(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'utc:\'',
					A2(_elm_lang$core$Basics_ops['++'], _p78, '\'')));
	}
};
var _gicentre$elm_vega$VegaLite$formatProperty = function (fmt) {
	...
	switch (_p79.ctor) {
		case 'JSON':
			var _p80 = _p79._0;
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$String$trim(_p80),
				'') ? {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
			...
			return {
				...
				_1: {
					...
					_0: {
						...
						_0: 'delimiter',
						_1: _elm_lang$core$Json_Encode$string(
							_elm_lang$core$String$fromChar(_p79._0))
					},
					_1: {ctor: '[]'}
				}
			};
						...
						A2(
							...
							function (_p81) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p82._0,
									_1: _gicentre$elm_vega$VegaLite$dataTypeSpec(_p82._1)
								};
							},
							_p83))
				},
	...
	switch (_p87.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$scaleLabel(_p87._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$VegaLite$scaleDomainSpec(_p87._0)
			};
		case 'SRange':
			var _p88 = _p87._0;
			switch (_p88.ctor) {
		...
		case 'SScheme':
			return A2(_gicentre$elm_vega$VegaLite$schemeProperty, _p87._0, _p87._1);
		case 'SPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
		...
		case 'SRangeStep':
			...
			if (_p89.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: 'rangeStep',
					_1: _elm_lang$core$Json_Encode$float(_p89._0)
				};
			} else {
				return {ctor: '_Tuple2', _0: 'rangeStep', _1: _elm_lang$core$Json_Encode$null};
			}
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$VegaLite$cInterpolateSpec(_p87._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$VegaLite$scaleNiceSpec(_p87._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					A2(
						...
						function (_p92) {
							...
							return {
								ctor: '_Tuple2',
								_0: _gicentre$elm_vega$VegaLite$channelLabel(_p93._0),
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$resolutionLabel(_p93._1))
							};
						},
						_p91._0))
			};
				...
				_1: _elm_lang$core$Json_Encode$object(
					A2(
						...
						function (_p94) {
							...
							return {
								ctor: '_Tuple2',
								_0: _gicentre$elm_vega$VegaLite$channelLabel(_p95._0),
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$resolutionLabel(_p95._1))
							};
						},
						_p91._0))
			};
				...
				_1: _elm_lang$core$Json_Encode$object(
					A2(
						...
						function (_p96) {
							...
							return {
								ctor: '_Tuple2',
								_0: _gicentre$elm_vega$VegaLite$channelLabel(_p97._0),
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$resolutionLabel(_p97._1))
							};
						},
						_p91._0))
			};
...
var _gicentre$elm_vega$VegaLite$booleanOpSpec = function (bo) {
	...
	switch (_p99.ctor) {
		case 'Expr':
			return _elm_lang$core$Json_Encode$string(_p99._0);
		case 'SelectionName':
			return _elm_lang$core$Json_Encode$string(_p99._0);
		case 'Selection':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$booleanOpSpec(_p99._0),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$booleanOpSpec(_p99._1),
									_1: {ctor: '[]'}
								}
							})
					},
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'not',
						_1: _gicentre$elm_vega$VegaLite$booleanOpSpec(_p99._0)
					},
					_1: {ctor: '[]'}
				});
	}
	...
	switch (_p100.ctor) {
		...
		case 'Base':
			return {
				ctor: '_Tuple2',
				_0: 'base',
				_1: _elm_lang$core$Json_Encode$float(_p100._0)
			};
		case 'Step':
			return {
				ctor: '_Tuple2',
		...
		case 'Extent':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$float(_p100._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$float(_p100._1),
							_1: {ctor: '[]'}
						}
					})
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _elm_lang$core$Json_Encode$bool(_p100._0)
			};
	}
};
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$inputProperty, _p101._1)
					})
			};
		case 'ICheckbox':
			return {
	...
	switch (_p102.ctor) {
		case 'Fields':
			return {
				...
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p102._0))
			};
		case 'Encodings':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$list(
					A2(
						...
						function (_p103) {
							return _elm_lang$core$Json_Encode$string(
								_gicentre$elm_vega$VegaLite$channelLabel(_p103));
						},
						_p102._0))
			};
		case 'On':
		...
		case 'ResolveSelections':
			return {
				...
				_0: 'resolve',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$selectionResolutionLabel(_p102._0))
			};
		case 'SelectionMark':
			return {
				ctor: '_Tuple2',
				_0: 'mark',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$selectionMarkProperty, _p102._0))
			};
		case 'BindScales':
			return {
				ctor: '_Tuple2',
		...
		case 'Bind':
			return {
				...
				_0: 'bind',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$bindingSpec, _p102._0))
			};
		case 'Nearest':
			return {
				ctor: '_Tuple2',
				_0: 'nearest',
				_1: _elm_lang$core$Json_Encode$bool(_p102._0)
			};
		case 'Toggle':
			return {
				ctor: '_Tuple2',
		...
		case 'Translate':
			var _p104 = _p102._0;
			return _elm_lang$core$Native_Utils.eq(_p104, '') ? {
				ctor: '_Tuple2',
				_0: 'translate',
		...
		default:
			var _p105 = _p102._0;
			return _elm_lang$core$Native_Utils.eq(_p105, '') ? {
				ctor: '_Tuple2',
				_0: 'zoom',
				_1: _elm_lang$core$Json_Encode$bool(false)
			} : {
	...
	switch (_p106.ctor) {
		...
		case 'DImpute':
			return {
				...
				_0: 'impute',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$imputeProperty, _p106._0))
			};
		case 'DTimeUnit':
			return {
				ctor: '_Tuple2',
	...
	switch (_p107.ctor) {
		case 'AxBandPosition':
			return {
				ctor: '_Tuple2',
				_0: 'bandPosition',
				_1: _elm_lang$core$Json_Encode$float(_p107._0)
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelAlign':
			return {
				...
				_0: 'labelAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$hAlignLabel(_p107._0))
			};
		case 'AxLabelBaseline':
			return {
				...
				_0: 'labelBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p107._0))
			};
		case 'AxLabelBound':
			var _p108 = _p107._0;
			if (_p108.ctor === 'Just') {
				if (_p108._0 === 1) {
					...
					return {
						ctor: '_Tuple2',
						_0: 'labelBound',
						_1: _elm_lang$core$Json_Encode$float(_p108._0)
					};
				}
			} else {
				return {
		...
		case 'AxLabelFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'labelFontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p107._0)
			};
		case 'AxLabelLimit':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$overlapStrategyLabel(_p107._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'AxOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$sideLabel(_p107._0))
			};
		case 'AxOffset':
			return {
				ctor: '_Tuple2',
		...
		case 'AxValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p107._0))
			};
		case 'AxDates':
			return {
				ctor: '_Tuple2',
	...
	switch (_p110.ctor) {
		...
		case 'LabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$overlapStrategyLabel(_p110._0))
			};
		case 'LabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'TitleAlign':
			return {
				...
				_0: 'titleAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$hAlignLabel(_p110._0))
			};
		case 'TitleAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'TitleBaseline':
			return {
				...
				_0: 'titleBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p110._0))
			};
		case 'TitleColor':
			return {
				ctor: '_Tuple2',
		...
		case 'TitleFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'titleFontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p110._0)
			};
		case 'TitleFontSize':
			return {
				ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								...
								_0: 'repeat',
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$arrangementLabel(_p113._0))
							},
							_1: {ctor: '[]'}
						})
				},
		...
		case 'HmType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$measurementLabel(_p113._0))
				},
				_1: {ctor: '[]'}
			};
		case 'HBin':
			return {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$bin(_p113._0),
				_1: {ctor: '[]'}
			};
		case 'HBinned':
			return {
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$hyperlinkChannelProperty, _p113._1)
						})
				},
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$hyperlinkChannelProperty, _p113._2)
			};
		case 'HDataCondition':
			return {
				ctor: '::',
		...
		case 'HTimeUnit':
			return {
				...
				_0: {
					...
					_0: 'timeUnit',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$timeUnitLabel(_p113._0))
				},
				_1: {ctor: '[]'}
			};
		case 'HAggregate':
			return {
				...
				_0: {
					...
					_0: 'aggregate',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$operationLabel(_p113._0))
				},
				_1: {ctor: '[]'}
			};
		default:
		...
		case 'MScale':
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: {
					...
					_0: 'scale',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$scaleProperty, _p115))
				},
				_1: {ctor: '[]'}
			};
		case 'MLegend':
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: {
					...
					_0: 'legend',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$legendProperty, _p116))
				},
				_1: {ctor: '[]'}
			};
		case 'MBin':
		...
		case 'MImpute':
			return {
				...
				_0: {
					...
					_0: 'impute',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$imputeProperty, _p114._0))
				},
				_1: {ctor: '[]'}
			};
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$markChannelProperty, _p114._1)
						})
				},
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$markChannelProperty, _p114._2)
			};
		case 'MDataCondition':
			var testClause = function (_p117) {
				var _p118 = _p117;
				return _elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'test',
							_1: _gicentre$elm_vega$VegaLite$booleanOpSpec(_p118._0)
						},
						_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$markChannelProperty, _p118._1)
					});
			};
			return {
				ctor: '::',
				_0: {
					...
					_0: 'condition',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, testClause, _p114._0))
				},
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$markChannelProperty, _p114._1)
			};
		case 'MTimeUnit':
			...
			return {
				...
				_1: {
					...
					_0: {
						...
						_0: 'op',
						_1: _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$VegaLite$operationLabel(_p119._1))
					},
					_1: {ctor: '[]'}
				}
			};
...
var _gicentre$elm_vega$VegaLite$orderChannelProperty = function (oDef) {
	...
	switch (_p120.ctor) {
		...
		case 'OBin':
			return _gicentre$elm_vega$VegaLite$bin(_p120._0);
		case 'OAggregate':
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
		...
		default:
						...
						switch (_p121._0.ctor) {
							...
							case 'CustomSort':
								return {
									...
									_0: 'sort',
									_1: _elm_lang$core$Json_Encode$list(
										_gicentre$elm_vega$VegaLite$dataValuesSpecs(_p121._0._0))
								};
							default:
								break _v105_4;
						}
			...
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$sortProperty, _p122))
			};
	}
};
	...
	switch (_p123.ctor) {
		...
		case 'PScale':
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'scale',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$scaleProperty, _p126))
			};
		case 'PAxis':
			var _p127 = _p123._0;
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'axis',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$axisProperty, _p127))
			};
		case 'PStack':
			return _gicentre$elm_vega$VegaLite$stackOffset(_p123._0);
		case 'PRepeat':
			return {
				ctor: '_Tuple2',
				_0: 'field',
		...
		default:
			return {
				...
				_0: 'impute',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$imputeProperty, _p123._0))
			};
	}
};
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								...
								_0: 'repeat',
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$VegaLite$arrangementLabel(_p128._0))
							},
							_1: {ctor: '[]'}
						})
				},
		...
		case 'TmType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$measurementLabel(_p128._0))
				},
				_1: {ctor: '[]'}
			};
		case 'TBin':
			return {
				ctor: '::',
				_0: _gicentre$elm_vega$VegaLite$bin(_p128._0),
				_1: {ctor: '[]'}
			};
		case 'TBinned':
			return {
		...
		case 'TAggregate':
			return {
				...
				_0: {
					...
					_0: 'aggregate',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$operationLabel(_p128._0))
				},
				_1: {ctor: '[]'}
			};
		case 'TTimeUnit':
			return {
				...
				_0: {
					...
					_0: 'timeUnit',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$timeUnitLabel(_p128._0))
				},
				_1: {ctor: '[]'}
			};
		case 'TTitle':
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'selection',
								_1: _gicentre$elm_vega$VegaLite$booleanOpSpec(_p128._0)
							},
							_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$textChannelProperty, _p128._1)
						})
				},
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$textChannelProperty, _p128._2)
			};
		default:
			var testClause = function (_p129) {
				var _p130 = _p129;
				return _elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'test',
							_1: _gicentre$elm_vega$VegaLite$booleanOpSpec(_p130._0)
						},
						_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$textChannelProperty, _p130._1)
					});
			};
			return {
				ctor: '::',
				_0: {
					...
					_0: 'condition',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, testClause, _p128._0))
				},
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$VegaLite$textChannelProperty, _p128._1)
			};
	}
	...
	switch (_p132.ctor) {
		...
		case 'HTitleAnchor':
			return {
				...
				_0: 'titleAnchor',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$anchorLabel(_p132._0))
			};
		case 'HTitleAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'HTitleBaseline':
			return {
				...
				_0: 'titleBaseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p132._0))
			};
		case 'HTitleColor':
			return {
				ctor: '_Tuple2',
	...
	switch (_p133.ctor) {
		...
		case 'FmType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$measurementLabel(_p133._0))
			};
		case 'FBin':
			return _gicentre$elm_vega$VegaLite$bin(_p133._0);
		case 'FAggregate':
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$operationLabel(_p133._0))
			};
		case 'FTimeUnit':
			return {
				ctor: '_Tuple2',
				_0: 'timeUnit',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$timeUnitLabel(_p133._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'header',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$headerProperty, _p133._0))
			};
	}
};
var _gicentre$elm_vega$VegaLite$facetMappingProperty = function (fMap) {
	...
	if (_p134.ctor === 'RowBy') {
		return {
			...
			_0: 'row',
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$facetChannelProperty, _p134._0))
		};
	} else {
		return {
			ctor: '_Tuple2',
	...
	switch (_p135.ctor) {
		case 'TAnchor':
			return {
				...
				_0: 'anchor',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$anchorLabel(_p135._0))
			};
		case 'TAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'TBaseline':
			return {
				...
				_0: 'baseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p135._0))
			};
		case 'TColor':
			return {
				ctor: '_Tuple2',
		...
		case 'TFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p135._0)
			};
		case 'TLimit':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$sideLabel(_p135._0))
			};
	}
};
	...
	while (true) {
		...
		if (_p136.ctor === '[]') {
			...
			if (_p136._0.ctor === '[]') {
				...
				var _p137 = _p136._1;
				var tails = A2(_elm_lang$core$List$filterMap, _elm_lang$core$List$tail, _p137);
				var heads = A2(_elm_lang$core$List$filterMap, _elm_lang$core$List$head, _p137);
				return {
					ctor: '::',
					_0: {ctor: '::', _0: _p136._0._0, _1: heads},
					_1: _gicentre$elm_vega$VegaLite$transpose(
						{ctor: '::', _0: _p136._0._1, _1: tails})
				};
			}
		}
	}
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						...
						_0: _elm_lang$core$Json_Encode$list(
							A2(
								...
								function (_p138) {
									var _p139 = _p138;
									return A2(winFieldDef, _p139._0, _p139._1);
								},
								wss)),
						_1: {
							ctor: '::',
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p140) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$VegaLite$vlPropertyLabel(_p141._0),
						_1: _p141._1
					};
				},
				spec)
	...
	switch (_p144.ctor) {
		case 'MFilled':
			return {
				ctor: '_Tuple2',
				_0: 'filled',
				_1: _elm_lang$core$Json_Encode$bool(_p144._0)
			};
		case 'MClip':
			return {
				ctor: '_Tuple2',
		...
		case 'MCursor':
			return {
				...
				_0: 'cursor',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$cursorLabel(_p144._0))
			};
		case 'MExtent':
			return {
				ctor: '_Tuple2',
				_0: 'extent',
				_1: _gicentre$elm_vega$VegaLite$extentSpec(_p144._0)
			};
		case 'MHRef':
			return {
				ctor: '_Tuple2',
		...
		case 'MStrokeCap':
			return {
				...
				_0: 'strokeCap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$strokeCapLabel(_p144._0))
			};
		case 'MStrokeJoin':
			return {
				ctor: '_Tuple2',
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$strokeJoinLabel(_p144._0))
			};
		...
		case 'MStrokeDash':
			return {
				...
				_0: 'strokeDash',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p144._0))
			};
		...
		case 'MStyle':
			return {
				...
				_0: 'style',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p144._0))
			};
		case 'MInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$markInterpolationLabel(_p144._0))
			};
		case 'MTension':
			return {
				ctor: '_Tuple2',
		...
		case 'MOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$markOrientationLabel(_p144._0))
			};
		case 'MShape':
			return {
				ctor: '_Tuple2',
				_0: 'shape',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$symbolLabel(_p144._0))
			};
		case 'MSize':
			return {
				ctor: '_Tuple2',
		...
		case 'MAlign':
			return {
				...
				_0: 'align',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$hAlignLabel(_p144._0))
			};
		case 'MBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'baseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$vAlignLabel(_p144._0))
			};
		case 'MdX':
			return {
				ctor: '_Tuple2',
		...
		case 'MFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeightSpec(_p144._0)
			};
		case 'MRadius':
			return {
				ctor: '_Tuple2',
		...
		case 'MRule':
			return {
				...
				_0: 'rule',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$markProperty, _p144._0))
			};
		case 'MBorders':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: 'content',
							_1: _elm_lang$core$Json_Encode$string(
								_gicentre$elm_vega$VegaLite$ttContentLabel(_p144._0))
						},
						_1: {ctor: '[]'}
					})
			};
		case 'MPoint':
			return {
				ctor: '_Tuple2',
				_0: 'point',
				_1: _gicentre$elm_vega$VegaLite$pointMarkerSpec(_p144._0)
			};
		case 'MLine':
			return {
				ctor: '_Tuple2',
				_0: 'line',
				_1: _gicentre$elm_vega$VegaLite$lineMarkerSpec(_p144._0)
			};
		case 'MXOffset':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$VegaLite$lineMarkerSpec = function (pm) {
	var _p145 = pm;
	if (_p145.ctor === 'LMNone') {
		return _elm_lang$core$Json_Encode$bool(false);
	} else {
		return _elm_lang$core$Json_Encode$object(
			A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$markProperty, _p145._0));
	}
};
var _gicentre$elm_vega$VegaLite$pointMarkerSpec = function (pm) {
	...
	switch (_p146.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$markProperty, _p146._0));
	}
};
var _gicentre$elm_vega$VegaLite$configProperty = function (configProp) {
	var _p147 = configProp;
	switch (_p147.ctor) {
		case 'Autosize':
			return {
				ctor: '_Tuple2',
				_0: 'autosize',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$autosizeProperty, _p147._0))
			};
		case 'Background':
			return {
				ctor: '_Tuple2',
		...
		case 'FieldTitle':
			return {
				...
				_0: 'fieldTitle',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$fieldTitleLabel(_p147._0))
			};
		case 'RemoveInvalid':
			return _p147._0 ? {
				ctor: '_Tuple2',
		...
		case 'Padding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _gicentre$elm_vega$VegaLite$paddingSpec(_p147._0)
			};
		case 'TimeFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'Axis':
			return {
				...
				_0: 'axis',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$axisConfigProperty, _p147._0))
			};
		case 'AxisX':
			return {
				ctor: '_Tuple2',
		...
		case 'Legend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$legendConfigProperty, _p147._0))
			};
		case 'MarkStyle':
			return {
				ctor: '_Tuple2',
				_0: 'mark',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$markProperty, _p147._0))
			};
		case 'Projection':
			return {
				ctor: '_Tuple2',
				_0: 'projection',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$projectionProperty, _p147._0))
			};
		case 'AreaStyle':
			return {
				ctor: '_Tuple2',
		...
		case 'TitleStyle':
			return {
				...
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$titleConfigSpec, _p147._0))
			};
		case 'NamedStyle':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: _p147._0,
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$markProperty, _p147._1))
						},
						_1: {ctor: '[]'}
					})
			};
		case 'Scale':
			return {
				...
				_0: 'scale',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$scaleConfigProperty, _p147._0))
			};
		case 'Stack':
			return _gicentre$elm_vega$VegaLite$stackOffset(_p147._0);
		case 'Range':
			return {
				ctor: '_Tuple2',
				_0: 'range',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$rangeConfigProperty, _p147._0))
			};
		case 'SelectionStyle':
			var selProp = function (_p148) {
				var _p149 = _p148;
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$VegaLite$selectionLabel(_p149._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$selectionProperty, _p149._1))
				};
			};
			return {
				ctor: '_Tuple2',
				_0: 'selection',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, selProp, _p147._0))
			};
		case 'View':
			return {
				ctor: '_Tuple2',
				_0: 'view',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$viewConfigProperty, _p147._0))
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$VegaLite$lookupAs = F4(
	function (key1, _p150, key2, asName) {
		var _p151 = _p150;
		return F2(
			function (x, y) {
				return {ctor: '::', _0: x, _1: y};
...
var _gicentre$elm_vega$VegaLite$lookup = F4(
	function (key1, _p152, key2, fields) {
		var _p153 = _p152;
		return F2(
			function (x, y) {
				return {ctor: '::', _0: x, _1: y};
								...
								A2(
									...
									function (_p154) {
										...
										return {
											ctor: '_Tuple2',
											_0: _p155._0,
											_1: _gicentre$elm_vega$VegaLite$dataValueSpec(_p155._1)
										};
									},
									properties))
						},
...
var _gicentre$elm_vega$VegaLite$filter = function (f) {
	...
	switch (_p156.ctor) {
		...
		case 'FCompose':
			return F2(
				...
				})(
				{
					ctor: '_Tuple2',
					_0: 'filter',
					_1: _gicentre$elm_vega$VegaLite$booleanOpSpec(_p156._0)
				});
		case 'FEqual':
			return F2(
				function (x, y) {
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'equal',
									_1: _gicentre$elm_vega$VegaLite$dataValueSpec(_p156._1)
								},
								_1: {ctor: '[]'}
							}
						})
		...
		case 'FRange':
			var values = function () {
				var _p157 = _p156._1;
				if (_p157.ctor === 'NumberRange') {
					return _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$float(_p157._0),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$float(_p157._1),
								_1: {ctor: '[]'}
							}
						});
				} else {
							...
							return _elm_lang$core$Json_Encode$list(
								{
									...
									_1: {
										...
										_0: _elm_lang$core$Json_Encode$object(
											A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$dateTimeProperty, _p157._1)),
										_1: {ctor: '[]'}
									}
								});
						}
							...
							return _elm_lang$core$Json_Encode$list(
								{
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$dateTimeProperty, _p157._0)),
									_1: {
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$null,
										_1: {ctor: '[]'}
		...
		default:
			var values = function () {
				...
				switch (_p158.ctor) {
					case 'Numbers':
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p158._0));
					case 'DateTimes':
						return _elm_lang$core$Json_Encode$list(
							A2(
								_elm_lang$core$List$map,
					...
					case 'Strings':
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p158._0));
					default:
						return _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p158._0));
				}
			}();
			return F2(
				function (x, y) {
			...
			A2(
				...
				function (_p159) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p160._0,
						_1: _gicentre$elm_vega$VegaLite$dataValueSpec(_p160._1)
					};
				},
				row)));
};
	...
	return _elm_lang$core$Json_Encode$object(
		A2(
			...
			function (_p162) {
				...
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$VegaLite$vlPropertyLabel(_p163._0),
					_1: _p163._1
				};
			},
			specs));
...
var _gicentre$elm_vega$VegaLite$categoricalDomainMap = function (scaleDomainPairs) {
	var _p166 = _elm_lang$core$List$unzip(scaleDomainPairs);
	var domain = _p166._0;
	var range = _p166._1;
	return {
		ctor: '::',
...
var _gicentre$elm_vega$VegaLite$domainRangeMap = F2(
	function (lowerMap, upperMap) {
		var _p167 = _elm_lang$core$List$unzip(
			{
				ctor: '::',
				_0: lowerMap,
				_1: {
		...
		switch (_p170) {
			case 'aggregate':
				var _p171 = A2(
					...
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if ((((_p171.ctor === 'Ok') && (_p171._0.ctor === '::')) && (_p171._0._1.ctor === '::')) && (_p171._0._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'aggregate', _1: _p171._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'groupby', _1: _p171._0._1._0},
								_1: {ctor: '[]'}
							}
						});
				} else {
			...
			case 'bin':
				var _p172 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if (((((_p172.ctor === 'Ok') && (_p172._0.ctor === '::')) && (_p172._0._1.ctor === '::')) && (_p172._0._1._1.ctor === '::')) && (_p172._0._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'bin', _1: _p172._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'field', _1: _p172._0._1._0},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'as', _1: _p172._0._1._1._0},
									_1: {ctor: '[]'}
								}
							}
						});
			...
			case 'calculate':
				...
				if ((((_p173.ctor === 'Ok') && (_p173._0.ctor === '::')) && (_p173._0._1.ctor === '::')) && (_p173._0._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'calculate', _1: _p173._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'as', _1: _p173._0._1._0},
								_1: {ctor: '[]'}
							}
						});
				} else {
			...
			case 'impute':
				var _p174 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if ((((((((((_p174.ctor === 'Ok') && (_p174._0.ctor === '::')) && (_p174._0._1.ctor === '::')) && (_p174._0._1._1.ctor === '::')) && (_p174._0._1._1._1.ctor === '::')) && (_p174._0._1._1._1._1.ctor === '::')) && (_p174._0._1._1._1._1._1.ctor === '::')) && (_p174._0._1._1._1._1._1._1.ctor === '::')) && (_p174._0._1._1._1._1._1._1._1.ctor === '::')) && (_p174._0._1._1._1._1._1._1._1._1.ctor === '[]')) {
					var _p180 = _p174._0._1._1._1._1._1._1._1._0;
					var _p179 = _p174._0._1._1._1._1._1._0;
					var _p178 = _p174._0._1._1._1._0;
					var _p177 = _p174._0._1._1._1._1._0;
					var _p176 = _p174._0._1._1._1._1._1._1._0;
					var _p175 = _p174._0._1._1._0;
					return _elm_lang$core$Json_Encode$object(
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'impute', _1: _p174._0._0},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'key', _1: _p174._0._1._0},
									_1: {ctor: '[]'}
								}
							},
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Native_Utils.eq(_p175, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'frame', _1: _p175},
									_1: {ctor: '[]'}
								},
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Native_Utils.eq(_p178, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'keyvals', _1: _p178},
										_1: {ctor: '[]'}
									},
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Native_Utils.eq(_p177, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'keyvals', _1: _p177},
											_1: {ctor: '[]'}
										},
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Native_Utils.eq(_p179, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'method', _1: _p179},
												_1: {ctor: '[]'}
											},
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Native_Utils.eq(_p176, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'groupby', _1: _p176},
													_1: {ctor: '[]'}
												},
												_elm_lang$core$Native_Utils.eq(_p180, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'value', _1: _p180},
													_1: {ctor: '[]'}
												})))))));
				} else {
					return _elm_lang$core$Json_Encode$null;
			...
			case 'lookup':
				var _p181 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if ((((((_p181.ctor === 'Ok') && (_p181._0.ctor === '::')) && (_p181._0._1.ctor === '::')) && (_p181._0._1._1.ctor === '::')) && (_p181._0._1._1._1.ctor === '::')) && (_p181._0._1._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'lookup', _1: _p181._0._0},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									...
									_1: _elm_lang$core$Json_Encode$object(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'data', _1: _p181._0._1._0},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'key', _1: _p181._0._1._1._0},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'fields', _1: _p181._0._1._1._1._0},
													_1: {ctor: '[]'}
												}
											}
										})
			...
			case 'lookupAs':
				var _p182 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if ((((((_p182.ctor === 'Ok') && (_p182._0.ctor === '::')) && (_p182._0._1.ctor === '::')) && (_p182._0._1._1.ctor === '::')) && (_p182._0._1._1._1.ctor === '::')) && (_p182._0._1._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'lookup', _1: _p182._0._0},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									...
									_1: _elm_lang$core$Json_Encode$object(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'data', _1: _p182._0._1._0},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'key', _1: _p182._0._1._1._0},
												_1: {ctor: '[]'}
											}
										})
								},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'as', _1: _p182._0._1._1._1._0},
									_1: {ctor: '[]'}
								}
							}
						});
			...
			case 'flattenAs':
				var _p183 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if ((((_p183.ctor === 'Ok') && (_p183._0.ctor === '::')) && (_p183._0._1.ctor === '::')) && (_p183._0._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'flatten', _1: _p183._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'as', _1: _p183._0._1._0},
								_1: {ctor: '[]'}
							}
						});
				} else {
			...
			case 'foldAs':
				var _p184 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if (((((_p184.ctor === 'Ok') && (_p184._0.ctor === '::')) && (_p184._0._1.ctor === '::')) && (_p184._0._1._1.ctor === '::')) && (_p184._0._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'fold', _1: _p184._0._0},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
			...
			case 'stack':
				var _p185 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if ((((((((_p185.ctor === 'Ok') && (_p185._0.ctor === '::')) && (_p185._0._1.ctor === '::')) && (_p185._0._1._1.ctor === '::')) && (_p185._0._1._1._1.ctor === '::')) && (_p185._0._1._1._1._1.ctor === '::')) && (_p185._0._1._1._1._1._1.ctor === '::')) && (_p185._0._1._1._1._1._1._1.ctor === '[]')) {
					var _p187 = _p185._0._1._1._1._1._1._0;
					var _p186 = _p185._0._1._1._1._1._0;
					return _elm_lang$core$Json_Encode$object(
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'stack', _1: _p185._0._0},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'groupby', _1: _p185._0._1._0},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Native_Utils.eq(_p186, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'offset', _1: _p186},
									_1: {ctor: '[]'}
								},
								_elm_lang$core$Native_Utils.eq(_p187, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'sort', _1: _p187},
									_1: {ctor: '[]'}
								})));
				} else {
					return _elm_lang$core$Json_Encode$null;
			...
			case 'timeUnit':
				var _p188 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if (((((_p188.ctor === 'Ok') && (_p188._0.ctor === '::')) && (_p188._0._1.ctor === '::')) && (_p188._0._1._1.ctor === '::')) && (_p188._0._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'timeUnit', _1: _p188._0._0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'field', _1: _p188._0._1._0},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'as', _1: _p188._0._1._1._0},
									_1: {ctor: '[]'}
								}
							}
						});
			...
			case 'window':
				var _p189 = A2(
					...
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$value),
					A2(_elm_lang$core$Json_Encode$encode, 0, _p195));
				if (((((((_p189.ctor === 'Ok') && (_p189._0.ctor === '::')) && (_p189._0._1.ctor === '::')) && (_p189._0._1._1.ctor === '::')) && (_p189._0._1._1._1.ctor === '::')) && (_p189._0._1._1._1._1.ctor === '::')) && (_p189._0._1._1._1._1._1.ctor === '[]')) {
					var _p193 = _p189._0._1._1._1._1._0;
					var _p192 = _p189._0._1._1._0;
					var _p191 = _p189._0._1._1._1._0;
					var _p190 = _p189._0._1._0;
					return _elm_lang$core$Json_Encode$object(
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'window', _1: _p189._0._0},
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Native_Utils.eq(_p190, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'frame', _1: _p190},
									_1: {ctor: '[]'}
								},
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Native_Utils.eq(_p192, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'ignorePeers', _1: _p192},
										_1: {ctor: '[]'}
									},
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Native_Utils.eq(_p191, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'groupby', _1: _p191},
											_1: {ctor: '[]'}
										},
										_elm_lang$core$Native_Utils.eq(_p193, _elm_lang$core$Json_Encode$null) ? {ctor: '[]'} : {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'sort', _1: _p193},
											_1: {ctor: '[]'}
										})))));
				} else {
					return _elm_lang$core$Json_Encode$null;
			...
			default:
				return _elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p194, _1: _p195},
						_1: {ctor: '[]'}
					});
		}
	};
...
var _gicentre$elm_vega$VegaLite$datasets = function (namedData) {
	var extract = function (data) {
		...
		if ((((_p197.ctor === 'Ok') && (_p197._0.ctor === '::')) && (_p197._0._0.ctor === '_Tuple2')) && (_p197._0._1.ctor === '[]')) {
			return _p197._0._0._1;
		} else {
			return data;
		}
	};
...
var _gicentre$elm_vega$VegaLite$dataName = F2(
	function (name, data) {
		var extract = function (d) {
			...
			if ((((_p202.ctor === 'Ok') && (_p202._0.ctor === '::')) && (_p202._0._0.ctor === '_Tuple2')) && (_p202._0._1.ctor === '[]')) {
				return {ctor: '_Tuple2', _0: _p202._0._0._0, _1: _p202._0._0._1};
			} else {
				return A2(
					_elm_lang$core$Debug$log,
		...
		var spec = function (_p203) {
			var _p204 = _p203;
			return extract(_p204._1);
		}(data);
		return {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$VegaLite$VLData,
...
var _gicentre$elm_vega$GalleryAdvanced$advanced7 = function () {
	var enc = function (_p0) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('group'),
					_1: {
						ctor: '::',
		...
		return _gicentre$elm_vega$VegaLite$transform(
			A5(
				...
				A2(
					...
					'https://vega.github.io/vega-lite/data/lookup_people.csv',
					{ctor: '[]'}),
				'name',
				{
					ctor: '::',
	...
	var des = _gicentre$elm_vega$VegaLite$description('Using the lookup transform to combine data');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			...
			_1: {
				...
				_0: A2(
					_gicentre$elm_vega$VegaLite$dataFromUrl,
					'https://vega.github.io/vega-lite/data/lookup_groups.csv',
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: trans(
...
var _gicentre$elm_vega$GalleryAdvanced$advanced6 = function () {
	var enc5 = function (_p2) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$Y,
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('center'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {ctor: '[]'}
				...
				A2(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$tName('text_amount'),
						_1: {
							ctor: '::',
						...
						_gicentre$elm_vega$VegaLite$color,
						{
							...
							_0: A2(
								_gicentre$elm_vega$VegaLite$mDataCondition,
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: _gicentre$elm_vega$VegaLite$expr('datum.label === \'Begin\' || datum.label === \'End\''),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$mStr('#725a30'),
											_1: {ctor: '[]'}
										}
									},
									_1: {ctor: '[]'}
	...
	var spec5 = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: enc5(
				{ctor: '[]'}),
				...
				_0: _gicentre$elm_vega$VegaLite$textMark(
					{
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$maFontWeight(_gicentre$elm_vega$VegaLite$Bold),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
	...
	var enc4 = function (_p3) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('sum_dec'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {ctor: '[]'}
				...
				A2(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$tName('sum_dec'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$tMType(_gicentre$elm_vega$VegaLite$Nominal),
							_1: {ctor: '[]'}
	...
	var spec4 = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: enc4(
				{ctor: '[]'}),
			_1: {
				...
				_0: _gicentre$elm_vega$VegaLite$textMark(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$maDy(8),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$maColor('#404040'),
									_1: {ctor: '[]'}
								}
							}
						}
	...
	var enc3 = function (_p4) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('sum_inc'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {ctor: '[]'}
				...
				A2(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$tName('sum_inc'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$tMType(_gicentre$elm_vega$VegaLite$Nominal),
							_1: {ctor: '[]'}
	...
	var spec3 = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: enc3(
				{ctor: '[]'}),
	...
	var enc2 = function (_p5) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('lead'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Ordinal),
						_1: {ctor: '[]'}
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pName('sum'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
							_1: {ctor: '[]'}
				...
				_0: _gicentre$elm_vega$VegaLite$rule(
					{
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$maOpacity(1),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$maStrokeWidth(2),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$maXOffset(-22.5),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$maX2Offset(22.5),
										_1: {ctor: '[]'}
									}
								}
							}
	...
	var enc1 = function (_p6) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('previous_sum'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pTitle('Amount'),
							_1: {ctor: '[]'}
						}
					}
				},
							...
							_0: A2(
								_gicentre$elm_vega$VegaLite$mDataCondition,
								{
									...
									_0: {
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$VegaLite$mStr('#f7e0b6'),
											_1: {ctor: '[]'}
										}
									},
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: _gicentre$elm_vega$VegaLite$expr('datum.sum < datum.previous_sum'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$VegaLite$mStr('#f78a64'),
												_1: {ctor: '[]'}
											}
										},
										_1: {ctor: '[]'}
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mStr('#93c4aa'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
	...
	var spec1 = _gicentre$elm_vega$VegaLite$asSpec(
		{
			...
			_1: {
				...
				_0: _gicentre$elm_vega$VegaLite$bar(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$maSize(45),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
				...
				_gicentre$elm_vega$VegaLite$X,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$pTitle('Months'),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			A3(
				_gicentre$elm_vega$VegaLite$window,
				{
					...
					_0: {
						...
						_0: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$wiAggregateOp(_gicentre$elm_vega$VegaLite$Sum),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$wiField('amount'),
								_1: {ctor: '[]'}
							}
						},
						_1: 'sum'
				...
				A3(
					_gicentre$elm_vega$VegaLite$window,
					{
						...
						_0: {
							...
							_0: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$wiOp(_gicentre$elm_vega$VegaLite$Lead),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$wiField('label'),
									_1: {ctor: '[]'}
								}
							},
							_1: 'lead'
								...
								A3(
									...
									A3(
										...
										A3(
											...
											'sum_dec',
											A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.sum > datum.previous_sum ? datum.sum : \'\'', 'sum_inc', _p8))))))))));
	};
	...
	var des = _gicentre$elm_vega$VegaLite$description('Waterfall chart of monthly profit and loss');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$height(450),
					_1: {
						ctor: '::',
						_0: data(
							{ctor: '[]'}),
...
var _gicentre$elm_vega$GalleryAdvanced$advanced5 = function () {
	var teamColours = _gicentre$elm_vega$VegaLite$categoricalDomainMap(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Germany', _1: 'black'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Mexico', _1: '#127153'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'South Korea', _1: '#c91a3c'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Sweden', _1: '#0c71ab'},
						_1: {ctor: '[]'}
					}
				}
			}
	...
	var enc = function (_p10) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('matchday'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Ordinal),
						_1: {ctor: '[]'}
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$mName('team'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mMType(_gicentre$elm_vega$VegaLite$Nominal),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mScale(teamColours),
									_1: {ctor: '[]'}
								}
							}
						},
	...
	var trans = function (_p11) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$wiSort(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$wiDescending('point'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$wiDescending('diff'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
	...
	var des = _gicentre$elm_vega$VegaLite$description('Line chart showing ranks over time for thw World Cup 2018 Group F teams');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: des,
...
var _gicentre$elm_vega$GalleryAdvanced$advanced4 = function () {
	var enc = function (_p13) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('Release_Date'),
					_1: {
						ctor: '::',
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pName('RatingDelta'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
							_1: {
								...
								_0: _gicentre$elm_vega$VegaLite$pAxis(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$axTitle('Residual'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
	...
	var trans = function (_p14) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				_gicentre$elm_vega$VegaLite$filter,
				_gicentre$elm_vega$VegaLite$fiExpr('datum.IMDB_Rating != null'),
				A2(
					_gicentre$elm_vega$VegaLite$filter,
					A2(
						_gicentre$elm_vega$VegaLite$fiRange,
						'Release_Date',
						A2(
							_gicentre$elm_vega$VegaLite$dtRange,
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$dtYear(2019),
								_1: {ctor: '[]'}
							})),
					A3(
						_gicentre$elm_vega$VegaLite$window,
						{
							...
							_0: {
								...
								_0: {
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$wiAggregateOp(_gicentre$elm_vega$VegaLite$Mean),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$wiField('IMDB_Rating'),
										_1: {ctor: '[]'}
									}
								},
								_1: 'AverageRating'
						...
						{
							ctor: '::',
							_0: A2(_gicentre$elm_vega$VegaLite$wiFrame, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing),
							_1: {ctor: '[]'}
						},
						A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.IMDB_Rating - datum.AverageRating', 'RatingDelta', _p14)))));
	};
	var data = A2(
		_gicentre$elm_vega$VegaLite$dataFromUrl,
			...
			_0: _gicentre$elm_vega$VegaLite$parse(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'Release_Date',
						_1: _gicentre$elm_vega$VegaLite$foDate('%d-%b-%y')
					},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
	var desc = _gicentre$elm_vega$VegaLite$description('A scatterplot showing each movie in the database and the difference from the average movie rating.');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: desc,
					...
					_1: {
						...
						_1: {
							...
							_0: _gicentre$elm_vega$VegaLite$point(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$maStrokeWidth(0.3),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$maOpacity(0.3),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _gicentre$elm_vega$GalleryAdvanced$advanced3 = function () {
	var tickEnc = function (_p15) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('AverageYearRating'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {ctor: '[]'}
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pName('Title'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Ordinal),
							_1: {ctor: '[]'}
	...
	var tickSpec = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _gicentre$elm_vega$VegaLite$pAxis(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$axTitle('IMDB Rating'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
	...
	var trans = function (_p17) {
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				...
				_gicentre$elm_vega$VegaLite$fiExpr('datum.IMDB_Rating != null'),
				A4(
					_gicentre$elm_vega$VegaLite$timeUnitAs,
					_gicentre$elm_vega$VegaLite$Year,
					'Release_Date',
					'year',
					A3(
						_gicentre$elm_vega$VegaLite$window,
						...
						A2(
							_gicentre$elm_vega$VegaLite$filter,
							_gicentre$elm_vega$VegaLite$fiExpr('(datum.IMDB_Rating - datum.AverageYearRating) > 2.5'),
							_p17)))));
	};
	var data = A2(
		_gicentre$elm_vega$VegaLite$dataFromUrl,
	...
	var desc = _gicentre$elm_vega$VegaLite$description('Calculation of difference from annual average');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: desc,
...
var _gicentre$elm_vega$GalleryAdvanced$advanced2 = function () {
	var ruleEnc = function (_p18) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				_gicentre$elm_vega$VegaLite$position,
				_gicentre$elm_vega$VegaLite$X,
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('AverageRating'),
					_1: {
						ctor: '::',
	...
	var ruleSpec = _gicentre$elm_vega$VegaLite$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$VegaLite$rule(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$maColor('red'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
		...
		return _gicentre$elm_vega$VegaLite$transform(
			A2(
				...
				A3(
					...
					A2(
						_gicentre$elm_vega$VegaLite$filter,
						_gicentre$elm_vega$VegaLite$fiExpr('(datum.IMDB_Rating - datum.AverageRating) > 2.5'),
						_p20))));
	};
	var data = A2(
		_gicentre$elm_vega$VegaLite$dataFromUrl,
		'https://vega.github.io/vega-lite/data/movies.json',
		{ctor: '[]'});
	var desc = _gicentre$elm_vega$VegaLite$description('Calculation of difference from average');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: desc,
...
var _gicentre$elm_vega$GalleryAdvanced$advanced1 = function () {
	var enc = function (_p21) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('PercentOfTotal'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Quantitative),
						_1: {
							...
							_0: _gicentre$elm_vega$VegaLite$pAxis(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$axTitle('% of total time'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pName('Activity'),
						_1: {
							ctor: '::',
	...
	var trans = function (_p22) {
		return _gicentre$elm_vega$VegaLite$transform(
			A3(
				_gicentre$elm_vega$VegaLite$window,
				{
					...
					_0: {
						...
						_0: {
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$wiField('Time'),
								_1: {ctor: '[]'}
							}
						},
						_1: 'TotalTime'
				...
				A3(_gicentre$elm_vega$VegaLite$calculateAs, 'datum.Time/datum.TotalTime * 100', 'PercentOfTotal', _p22)));
	};
	var data = function (_p23) {
		return A2(
			_gicentre$elm_vega$VegaLite$dataFromColumns,
			{ctor: '[]'},
			A3(
	...
	var desc = _gicentre$elm_vega$VegaLite$description('Calculation of percentage of total');
	return _gicentre$elm_vega$VegaLite$toVegaLite(
		{
			ctor: '::',
			_0: desc,
...
var _gicentre$elm_vega$GalleryAdvanced$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'advanced1', _1: _gicentre$elm_vega$GalleryAdvanced$advanced1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'advanced2', _1: _gicentre$elm_vega$GalleryAdvanced$advanced2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'advanced3', _1: _gicentre$elm_vega$GalleryAdvanced$advanced3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'advanced4', _1: _gicentre$elm_vega$GalleryAdvanced$advanced4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'advanced5', _1: _gicentre$elm_vega$GalleryAdvanced$advanced5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'advanced6', _1: _gicentre$elm_vega$GalleryAdvanced$advanced6},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'advanced7', _1: _gicentre$elm_vega$GalleryAdvanced$advanced7},
								_1: {ctor: '[]'}
							}
						}
					}
...
var _gicentre$elm_vega$GalleryAdvanced$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryAdvanced$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryAdvanced$mySpecs,
			_1: _gicentre$elm_vega$GalleryAdvanced$elmToJS(_gicentre$elm_vega$GalleryAdvanced$mySpecs)
		},
		update: F2(
			function (_p24, model) {
...
var Elm = {};
Elm['GalleryAdvanced'] = Elm['GalleryAdvanced'] || {};
if (typeof _gicentre$elm_vega$GalleryAdvanced$main !== 'undefined') {
    _gicentre$elm_vega$GalleryAdvanced$main(Elm['GalleryAdvanced'], 'GalleryAdvanced', undefined);
}
