	...
	var enc = function (_p16) {
		return _gicentre$elm_vega$VegaLite$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$VegaLite$pName('color'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$VegaLite$pMType(_gicentre$elm_vega$VegaLite$Nominal),
						_1: {ctor: '[]'}
				...
				A3(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$VegaLite$mName('color'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$VegaLite$mMType(_gicentre$elm_vega$VegaLite$Nominal),
								_1: {
...
var _gicentre$elm_vega$GalleryBar$bar5 = function () {
...
var _gicentre$elm_vega$GalleryBar$mySpecs = _gicentre$elm_vega$VegaLite$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'bar1', _1: _gicentre$elm_vega$GalleryBar$bar1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'bar2', _1: _gicentre$elm_vega$GalleryBar$bar2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'bar3', _1: _gicentre$elm_vega$GalleryBar$bar3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'bar4', _1: _gicentre$elm_vega$GalleryBar$bar4},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'bar5', _1: _gicentre$elm_vega$GalleryBar$bar5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'bar6', _1: _gicentre$elm_vega$GalleryBar$bar6},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'bar7', _1: _gicentre$elm_vega$GalleryBar$bar7},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'bar8', _1: _gicentre$elm_vega$GalleryBar$bar8},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'bar9', _1: _gicentre$elm_vega$GalleryBar$bar9},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'bar10', _1: _gicentre$elm_vega$GalleryBar$bar10},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'bar11', _1: _gicentre$elm_vega$GalleryBar$bar11},
												_1: {
													ctor: '::',
...
var _gicentre$elm_vega$GalleryBar$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
