...
{-| Similar to [align](#align) but with independent alignments for rows (first parameter)
and columns (second parameter).
-}
...
any channels to which this is to be added.
-}
...
is a list of any channels to which this should be added.
-}
...
type. The second parameter is a list of encoding channels to which this should be added.
-}
...
an axis or legend title is defined, it will override any title defined
here.
-}
...
to define the channel. The second parameter is a list of any channels to
which this is to be added.
-}
...
{-| Discretize a series of numeric values into bins when encoding with a position
channel.
-}
...
encoding if none of the expressions are evaluated as true.
-}
...
that define the channel. The second parameter is a list of any channels to
which this is to be added.
-}
