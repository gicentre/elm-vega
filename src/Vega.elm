...
[symWedge](#symWedge), [symArrow](#symArrow), [symDiamond](#symDiamond),
[symTriangleUp](#symTriangleUp), [symTriangleDown](#symTriangleDown),
[symTriangleLeft](#symTriangleLeft), [symTriangleRight](#symTriangleRight),
[symPath](#symPath) and [symSignal](#symSignal).
-}
type Symbol
    = SymCircle
    | SymSquare
