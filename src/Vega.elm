...
See the
[Vega density](https://vega.github.io/vega/docs/transforms/density/) and
[KDE transform](https://vega.github.io/vega/docs/transforms/kde/) documentation.
...
[bnSpan](#bnSpan), [bnStep](#bnStep), [bnSteps](#bnSteps), [bnNums](#bnNums),
...
[cfGroup](#cfGroup), [cfEventHandling](#cfEventHandling), [cfMark](#cfMark),
...
{-| Generated by [kd2Weight](#kd2Weight), [kd2CellSize](#kd2CellSize),
[kd2Bandwidth](#kd2Bandwidth), [kd2Counts](#kd2Counts) and [kd2As](#kd2As).
-}
type Kde2Property
    = Kd2Weight Field
    | Kd2CellSize Num
...
[maFill](#maFill), [maFillOpacity](#maFillOpacity), [maStroke](#maStroke),
...
[millisecond](#millisecond) and [tuSignal](#tuSignal).
-}
type TimeUnit
    = Year
    | Quarter
...
[tiColor](#tiColor), [tiDx](#tiDx), [tiDy](#tiDy), [tiEncodeElements](#tiEncodeElements),
[tiFont](#tiFont), [tiFontSize](#tiFontSize), [tiFontStyle](#tiFontStyle),
[tiFontWeight](#tiFontWeight), [tiFrame](#tiFrame), [tiLimit](#tiLimit),
[tiLineHeight](#tiLineHeight), [tiOffset](#tiOffset), [tiSubtitle](#tiSubtitle),
...
[trIsocontour](#trIsocontour), [trJoinAggregate](#trJoinAggregate), [trKde](#trKde),
[trKde2d](#trKde2d), [trLinkPath](#trLinkPath), [trLookup](#trLookup), [trNest](#trNest),
[trPack](#trPack), [trPartition](#trPartition), [trPie](#trPie), [trPivot](#trPivot),
[trProject](#trProject), [trResolveFilter](#trResolveFilter), [trSample](#trSample),
[trSequence](#trSequence), [trStack](#trStack), [trStratify](#trStratify),
[trTree](#trTree), [trTreeLinks](#trTreeLinks), [trTreemap](#trTreemap),
[trVoronoi](#trVoronoi), [trWindow](#trWindow) and [trWordCloud](#trWordCloud).
-}
type Transform
...
{-| The name to give the output bins field from a dotbin transformation. If not
...
{-| Scale the output isocontour coordinates by the given factor. Useful for scaling
...
{-| Provide an array of explicit contour levels for an isocontour transformation.
...
{-| Whether or not a 2d KDE transform should genreate smoothed counts (true) or
...
{-| Whether or not a KDE transform should genreate smoothed counts (true) or
probability estimates (false, default).
-}
...
{- The id of an image or canvas object that may be displayed as an image mark.
   Useful for handling dynamically generated images within a specification.
...
{-| Quantile values to compute scaled as probabilties in the range (0, 1). For example,
...
are the width and height oover which to perform the estimation. The next two parameters
...
list of optional temporal binning properties.
-}
...
{-| Indicate time unit is to specified as a year.
-}
year : TimeUnit
year =
    Year
...
configProperty cp =
    case cp of
        ...
        CfGroup mps ->
            ( "group", JE.object (List.map groupMarkProperty mps) )
...
groupMarkProperty : MarkProperty -> LabelledSpec
