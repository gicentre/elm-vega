module Vega
    exposing
        ...
        , ScaleProperty
        , ScaleRange(RCategory, RDiverging, RHeatmap, RHeight, ROrdinal, RRamp, RSymbol, RWidth)
...
options (`RWidth`, `RHeight` etc.), scale ranges can be generated by [raNums](#raNums),
