...
var author$project$GalleryRadial$elmToJS = _Platform_outgoingPort('elmToJS', elm$core$Basics$identity);
...
var author$project$Vega$PiEndAngle = function (a) {
	return {$: 2, a: a};
};
var author$project$Vega$piEndAngle = author$project$Vega$PiEndAngle;
var author$project$Vega$PiField = function (a) {
	return {$: 0, a: a};
};
var author$project$Vega$piField = author$project$Vega$PiField;
var author$project$Vega$PiSort = function (a) {
	return {$: 3, a: a};
};
var author$project$Vega$piSort = author$project$Vega$PiSort;
var author$project$Vega$PiStartAngle = function (a) {
	return {$: 1, a: a};
};
var author$project$Vega$piStartAngle = author$project$Vega$PiStartAngle;
...
var author$project$Vega$TPie = function (a) {
	return {$: 34, a: a};
};
var author$project$Vega$trPie = author$project$Vega$TPie;
									...
									[
										...
										_List_fromArray(
											[
												author$project$Vega$vField(
												author$project$Vega$field('data')),
												author$project$Vega$vScale('rScale')
											])),
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$Vega$maTheta(
									_List_fromArray(
										[
											author$project$Vega$vSignal('(datum.startAngle + datum.endAngle)/2')
										])),
									author$project$Vega$maFill(
									_List_fromArray(
										[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$json$Json$Encode$encode, 2, author$project$GalleryRadial$sourceExample))
					]))
			]));
};
...
var author$project$GalleryRadial$main = elm$browser$Browser$element(
	{
		aC: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$GalleryRadial$mySpecs,
				author$project$GalleryRadial$elmToJS(author$project$GalleryRadial$mySpecs))),
		aJ: elm$core$Basics$always(elm$core$Platform$Sub$none),
		aL: F2(
			function (_n0, model) {
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}),
		aN: author$project$GalleryRadial$view
	});
_Platform_export({'GalleryRadial':{'init':author$project$GalleryRadial$main(
