...
var author$project$Vega$ScBinLinear = {$: 13};
var author$project$Vega$scBinLinear = author$project$Vega$ScBinLinear;
		...
		A2(
			...
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							author$project$Vega$scType(author$project$Vega$scBinLinear),
							author$project$Vega$scRange(
							...
							author$project$Vega$scDomain(
							author$project$Vega$doNums(
								author$project$Vega$numSignal('binDomain'))),
							author$project$Vega$scRound(author$project$Vega$true)
						]))),
			A2(
				author$project$Vega$scale,
