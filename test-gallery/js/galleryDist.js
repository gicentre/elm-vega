...
var $author$project$Vega$MYC = function (a) {
	return {$: 6, a: a};
};
var $author$project$Vega$maYC = $author$project$Vega$MYC;
...
var $author$project$GalleryDist$boxplot1 = function () {
	var si = A2(
								...
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScale'),
											$author$project$Vega$vField(
											$author$project$Vega$field('median'))
										]))
								]))
						]))
				])));
...
var $author$project$Vega$ICField = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$icField = $author$project$Vega$ICField;
var $author$project$Vega$ICLevels = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$icLevels = $author$project$Vega$ICLevels;
var $author$project$Vega$ICResolve = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$icResolve = $author$project$Vega$ICResolve;
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siValue(
						$author$project$Vega$vStr('shares')),
						$author$project$Vega$siBind(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$icField(
								$author$project$Vega$field('grid')),
								$author$project$Vega$icResolve(
								$author$project$Vega$resolveSignal('resolve')),
								$author$project$Vega$icLevels(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$daSource('density')
						])))
			]));
	var ax = A2(
		$elm$core$Basics$composeL,
...
var $author$project$GalleryDist$contour2 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$GalleryDist$density1 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
							...
							$author$project$Vega$iRange(
								_List_fromArray(
									[
										...
										$author$project$Vega$inStep(0.001)
									])))
						]))),
			A2(
				$author$project$Vega$signal,
...
var $author$project$Vega$DBStep = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vega$dbStep = $author$project$Vega$DBStep;
...
var $author$project$Vega$text = 10;
var $author$project$Vega$TDotBin = F2(
	function (a, b) {
		return {$: 9, a: a, b: b};
	});
var $author$project$Vega$trDotBin = $author$project$Vega$TDotBin;
...
var $author$project$GalleryDist$dotbin1 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										$author$project$Vega$siUpdate('log(11.4)')
									]))),
						A2(
							$author$project$Vega$signal,
							'sd',
							_List_fromArray(
								[
									$author$project$Vega$siUpdate('0.2')
								]))),
					A2(
						$author$project$Vega$signal,
						'step',
						_List_fromArray(
							[
								$author$project$Vega$siUpdate('1.25 * sqrt(20 / quantiles)')
							]))),
				A2(
					$author$project$Vega$signal,
					'size',
					_List_fromArray(
						[
							$author$project$Vega$siUpdate('scale(\'xScale\', step) - scale(\'xScale\', 0)')
						]))),
			A2(
				$author$project$Vega$signal,
				'area',
				_List_fromArray(
					[
						$author$project$Vega$siUpdate('size*size')
					]))),
		A2(
			$author$project$Vega$signal,
			'select',
			_List_fromArray(
				[
					$author$project$Vega$siInit('quantileLogNormal(0.05, mean, sd)'),
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$str('click, [mousedown, window:mouseup] > mousemove'))
								]),
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('clamp(invert(\'xScale\', x()), 0.0001, 30)')
								])),
							A2(
							$author$project$Vega$evHandler,
							_List_fromArray(
								[
									$author$project$Vega$esSelector(
									$author$project$Vega$str('dblclick'))
								]),
							_List_fromArray(
								[
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$scRange($author$project$Vega$raHeight),
					$author$project$Vega$scDomain(
					$author$project$Vega$doSignal('[0, height / size]'))
				])));
	var mk = A2(
		$elm$core$Basics$composeL,
		A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Vega$srData(
									$author$project$Vega$str('quantiles'))
								])),
							$author$project$Vega$mEncode(
							_List_fromArray(
								[
										...
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vScale('xScale'),
													$author$project$Vega$vField(
													$author$project$Vega$field('bin'))
												])),
											$author$project$Vega$maY(
											_List_fromArray(
												[
													$author$project$Vega$vScale('yScale'),
													$author$project$Vega$vSignal('datum.y0 + 0.5')
												])),
											$author$project$Vega$maSize(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('area')
												]))
										])),
									$author$project$Vega$enUpdate(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vSignal('datum.bin < select ? \'firebrick\' : \'steelblue\'')
												]))
										]))
								]))
						]))),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vScale('xScale'),
												$author$project$Vega$vSignal('select')
											])),
										$author$project$Vega$maY(
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$author$project$Vega$vSignal('select ? \'#ccc\': \'transparent\'')
											]))
									]))
							]))
					]))),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('format(cumulativeLogNormal(select, mean, sd), \'.1%\')')
										])),
									$author$project$Vega$maFill(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('select ? \'#000\': \'transparent\'')
										]))
								]))
						]))
				])));
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$numSignal('0.5 / quantiles'),
						$author$project$Vega$num(1),
						$author$project$Vega$numSignal('1 / quantiles'),
						'p'),
						A2($author$project$Vega$trFormula, 'quantileLogNormal(datum.p, mean, sd)', 'value'),
						A2(
						$author$project$Vega$trDotBin,
						$author$project$Vega$field('value'),
						_List_fromArray(
							[
								$author$project$Vega$dbStep(
								$author$project$Vega$numSignal('step'))
							])),
				...
				A2($author$project$Vega$data, 'quantiles', _List_Nil))
			]));
	var ax = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$axes,
...
var $author$project$Vega$BnAnchor = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$GalleryDist$histo1 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$iRange(
						_List_fromArray(
							[
								$author$project$Vega$inMin(-0.001),
								$author$project$Vega$inMax(0.4),
								$author$project$Vega$inStep(0.001)
							])))
				])));
	var sc = A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('binned'),
								$author$project$Vega$daField(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$srData(
								$author$project$Vega$str('binned'))
							])),
						$author$project$Vega$mEncode(
						_List_fromArray(
							[
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Vega$vOffset(
												$author$project$Vega$vSignal('binStep > 0.02 ? -0.5 : 0'))
											])),
										$author$project$Vega$maY(
										_List_fromArray(
											[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$bnAnchor(
								$author$project$Vega$numSignal('binOffset')),
								$author$project$Vega$bnStep(
								$author$project$Vega$numSignal('binStep')),
								$author$project$Vega$bnNice($author$project$Vega$false)
							])),
						$author$project$Vega$trAggregate(
						_List_fromArray(
							[
...
var $author$project$Vega$AResize = {$: 7};
var $author$project$Vega$asResize = $author$project$Vega$AResize;
...
var $author$project$Vega$bsSignal = $author$project$Vega$BnsSignal;
var $author$project$Vega$RaValues = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$raValues = $author$project$Vega$RaValues;
var $author$project$Vega$SBins = function (a) {
	return {$: 7, a: a};
};
var $author$project$Vega$scBins = $author$project$Vega$SBins;
var $author$project$Vega$VNull = {$: 20};
var $author$project$Vega$vNull = $author$project$Vega$VNull;
var $author$project$GalleryDist$histo2 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$siUpdate('sequence(bins.start, bins.stop + bins.step, bins.step)')
						]))),
			A2(
				$author$project$Vega$signal,
				'nullGap',
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('(width - nullGap) / binDomain.length')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Vega$raValues(
								_List_fromArray(
									[
										$author$project$Vega$vSignal('barStep + nullGap'),
										$author$project$Vega$vSignal('width')
									]))),
							$author$project$Vega$scDomain(
							$author$project$Vega$doNums(
								$author$project$Vega$numSignal('[bins.start, bins.stop]'))),
							$author$project$Vega$scBins(
							$author$project$Vega$bsSignal('bins')),
							$author$project$Vega$scRound($author$project$Vega$true)
						]))),
			A2(
				$author$project$Vega$scale,
					...
					[
						...
						$author$project$Vega$raValues(
							_List_fromArray(
								[
									$author$project$Vega$vNum(0),
									$author$project$Vega$vSignal('barStep')
								]))),
						$author$project$Vega$scRound($author$project$Vega$true),
						$author$project$Vega$scDomain(
						$author$project$Vega$doStrs(
							...
							[
								...
								_List_fromArray(
									[
										_List_fromArray(
										[
											$author$project$Vega$daDataset('counts'),
											$author$project$Vega$daField(
											$author$project$Vega$field('count'))
										]),
										_List_fromArray(
										[
											$author$project$Vega$daDataset('nulls'),
											$author$project$Vega$daField(
											$author$project$Vega$field('count'))
										])
									]))
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$srData(
								$author$project$Vega$str('counts'))
							])),
						$author$project$Vega$mEncode(
						_List_fromArray(
							[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScaleNull'),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$bnSignal('bins'),
	...
	var ax = A2(
		...
		A2(
			...
			A3($author$project$Vega$axis, 'xScaleNull', $author$project$Vega$siBottom, _List_Nil)),
		A3(
			$author$project$Vega$axis,
			'yScale',
			$author$project$Vega$siLeft,
	...
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				...
				$author$project$Vega$autosize(
				_List_fromArray(
					[$author$project$Vega$asFit, $author$project$Vega$asResize])),
				ds,
				si(_List_Nil),
				sc(_List_Nil),
				ax(_List_Nil),
...
var $author$project$Vega$QuStep = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$quStep = $author$project$Vega$QuStep;
var $author$project$Vega$strSignal = $author$project$Vega$StrSignal;
var $author$project$Vega$TQuantile = F2(
	function (a, b) {
		return {$: 41, a: a, b: b};
	});
var $author$project$Vega$trQuantile = $author$project$Vega$TQuantile;
var $author$project$GalleryDist$quantile1 = function () {
	var si2 = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$signals,
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('plotWidth')
				])));
	var si1 = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$signals,
								...
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScale'),
											$author$project$Vega$vField(
											$author$project$Vega$field('qnormal'))
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
								...
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScale'),
											$author$project$Vega$vField(
											$author$project$Vega$field('quniform'))
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$daUrl(
						$author$project$Vega$strSignal('url'))
					])),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						A2(
						$author$project$Vega$trQuantile,
						$author$project$Vega$field('u'),
						_List_fromArray(
							[
								$author$project$Vega$quStep(
								$author$project$Vega$numSignal('1 / (numQuantiles + 1)'))
							])),
						A2($author$project$Vega$trFormula, 'quantileUniform(datum.prob)', 'quniform'),
						A2($author$project$Vega$trFormula, 'quantileNormal(datum.prob)', 'qnormal')
					]),
				A2(
					$author$project$Vega$data,
					'quantiles',
			...
			A3(
				...
				_List_fromArray(
					[
						$author$project$Vega$axGrid($author$project$Vega$true),
						$author$project$Vega$axTitle(
						$author$project$Vega$str('Theoretical Normal Quantiles'))
					]))),
		A3(
			$author$project$Vega$axis,
			'yScale',
			...
			A3(
				...
				_List_fromArray(
					[
						$author$project$Vega$axGrid($author$project$Vega$true),
						$author$project$Vega$axTitle(
						$author$project$Vega$str('Theoretical Uniform Quantiles'))
					]))),
		A3(
			$author$project$Vega$axis,
			'yScale',
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$vNum(10)),
					$author$project$Vega$axTitle(
					$author$project$Vega$str('Empirical Data Quantiles'))
				])));
	var mk = A2(
		$elm$core$Basics$composeL,
		A2(
...
var $author$project$Vega$lsAs = $author$project$Vega$LsAs;
var $author$project$Vega$LsBandwidth = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vega$lsBandwidth = $author$project$Vega$LsBandwidth;
var $author$project$Vega$LsGroupBy = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$lsGroupBy = $author$project$Vega$LsGroupBy;
...
var $author$project$Vega$TLoess = F3(
	function (a, b, c) {
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Vega$numSignal('bandwidth')),
								A2($author$project$Vega$lsAs, 'u', 'v')
							]))
					]),
				A2(
					$author$project$Vega$data,
...
var $author$project$GalleryDist$scatter1 = function () {
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScale'),
											$author$project$Vega$vSignal('(datum.hp0 + datum.hp1) / 2')
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
											$author$project$Vega$vScale('yScale'),
											$author$project$Vega$vSignal('(datum.mpg0 + datum.mpg1) / 2')
										])),
									$author$project$Vega$maSize(
									_List_fromArray(
										[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$trBin,
						$author$project$Vega$field('Horsepower'),
						$author$project$Vega$numSignal('hp_extent'),
						_List_fromArray(
							[
								$author$project$Vega$bnMaxBins(
								$author$project$Vega$num(10)),
								A2($author$project$Vega$bnAs, 'hp0', 'hp1')
							])),
						A2(
						$author$project$Vega$trExtentAsSignal,
						$author$project$Vega$field('Miles_per_Gallon'),
						...
						$author$project$Vega$trBin,
						$author$project$Vega$field('Miles_per_Gallon'),
						$author$project$Vega$numSignal('mpg_extent'),
						_List_fromArray(
							[
								$author$project$Vega$bnMaxBins(
								$author$project$Vega$num(10)),
								A2($author$project$Vega$bnAs, 'mpg0', 'mpg1')
							])),
						$author$project$Vega$trAggregate(
						_List_fromArray(
							[
...
var $author$project$GalleryDist$wheat1 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siValue(
						$author$project$Vega$vNum(0.075)),
						$author$project$Vega$siBind(
						$author$project$Vega$iRange(
							_List_fromArray(
								[
									$author$project$Vega$inMin(-0.001),
									$author$project$Vega$inMax(0.2),
									$author$project$Vega$inStep(0.001)
								])))
					]))),
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('extent[1] * (1 + symbolDiameter)')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
					...
					$author$project$Vega$doNums(
						$author$project$Vega$numList(
							_List_fromArray(
								[
									$author$project$Vega$num(0),
									$author$project$Vega$numSignal('extent[1]')
								]))))
				])));
	var mk = A2(
		$elm$core$Basics$composeL,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('symbolDiameter * symbolDiameter')
										])),
									$author$project$Vega$maStroke(
									_List_fromArray(
										[
			...
			A3(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$vSignal('sequence(bins.start, bins.stop + bins.step, bins.step)')),
						$author$project$Vega$axDomain($author$project$Vega$false),
						$author$project$Vega$axTicks($author$project$Vega$false),
						$author$project$Vega$axLabels($author$project$Vega$false),
						$author$project$Vega$axGrid($author$project$Vega$true),
...
var $author$project$GalleryDist$window1 = function () {
	var ti = A2(
		$author$project$Vega$title,
		$author$project$Vega$strSignal('\'Top Directors by \' + label[op] + \' Worldwide Gross\''),
		_List_fromArray(
			[
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siValue(
						$author$project$Vega$vStr('average')),
						$author$project$Vega$siBind(
						$author$project$Vega$iSelect(
							_List_fromArray(
								[
					...
					$author$project$Vega$vObject(
						_List_fromArray(
							[
								...
								$author$project$Vega$keyValue,
								'median',
								$author$project$Vega$vStr('Median')),
								A2(
								$author$project$Vega$keyValue,
								'sum',
								$author$project$Vega$vStr('Total'))
							])))
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('directors'),
									$author$project$Vega$daField(
									$author$project$Vega$field('Gross'))
								]))),
						$author$project$Vega$scNice($author$project$Vega$niTrue)
					]))),
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('directors'))
						])),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$opSignal('op')
									])),
								$author$project$Vega$agFields(
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								A2($author$project$Vega$wnOperation, $author$project$Vega$woRowNumber, 'rank')
							]),
						_List_fromArray(
							[
						...
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.rank <= k'))
					]),
				A2(
					$author$project$Vega$data,
					'directors',
	...
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				$author$project$Vega$width(500),
				$author$project$Vega$height(410),
				$author$project$Vega$padding(5),
				$author$project$Vega$autosize(
				_List_fromArray(
					[$author$project$Vega$asFit])),
				ti,
				ds,
				si(_List_Nil),
				sc(_List_Nil),
...
var $author$project$GalleryDist$window2 = function () {
	var ti = A2(
		$author$project$Vega$title,
		$author$project$Vega$strSignal('\'Top Directors by \' + label[op] + \' Worldwide Gross\''),
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$field('rank')
									]))
							])),
						A2($author$project$Vega$trFormula, 'datum.rank < k ? datum.Director : \'All Others\'', 'Category'),
						$author$project$Vega$trAggregate(
						_List_fromArray(
							[
								$author$project$Vega$agGroupBy(
...
var $author$project$GalleryDist$mySpecs = $author$project$Vega$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('histo1', $author$project$GalleryDist$histo1),
			_Utils_Tuple2('histo2', $author$project$GalleryDist$histo2),
			_Utils_Tuple2('density1', $author$project$GalleryDist$density1),
			_Utils_Tuple2('boxplot1', $author$project$GalleryDist$boxplot1),
			_Utils_Tuple2('violinplot1', $author$project$GalleryDist$violinplot1),
			_Utils_Tuple2('window1', $author$project$GalleryDist$window1),
			...
			_Utils_Tuple2('contour2', $author$project$GalleryDist$contour2),
			_Utils_Tuple2('wheat1', $author$project$GalleryDist$wheat1),
			_Utils_Tuple2('dotbin1', $author$project$GalleryDist$dotbin1),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$GalleryDist$sourceExample))
					]))
			]));
};
var $author$project$GalleryDist$main = $elm$browser$Browser$element(
	{
		...
		aL: $author$project$GalleryDist$view
	});
