...
var $author$project$GalleryLineArea$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$GalleryLineArea$areaChart1 = function () {
	var table = A2(
...
var $author$project$GalleryLineArea$areaChart2 = function () {
	var table = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$GalleryLineArea$areaChart3 = function () {
	var table = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
		...
		A2(
			...
			A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$evUpdate('1 + (layers % 4)')
											]))
									])),
								$author$project$Vega$siBind(
								$author$project$Vega$iSelect(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$siUpdate('floor(200 / layers)')
						]))),
			A2(
				$author$project$Vega$signal,
				'vheight',
				_List_fromArray(
					[
						$author$project$Vega$siUpdate('height * layers')
					]))),
		A2(
			$author$project$Vega$signal,
			'opacity',
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('pow(layers, -2/3)')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$raValues(
						_List_fromArray(
							[
								$author$project$Vega$vSignal('vheight'),
								$author$project$Vega$vNum(0)
							]))),
					$author$project$Vega$scNice($author$project$Vega$niTrue),
					$author$project$Vega$scZero($author$project$Vega$true),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('layer_indices'))
						])),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
	...
	var layerData = A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Vega$expr('datum.data < layers')),
				A2($author$project$Vega$trFormula, 'datum.data * -height', 'offset')
			]),
		A2(
...
var $author$project$Vega$ETicks = 1;
var $author$project$Vega$aeTicks = 1;
...
var $author$project$Vega$ArgMax = {$: 0};
var $author$project$Vega$opArgMax = $author$project$Vega$ArgMax;
...
var $author$project$GalleryLineArea$areaChart4 = function () {
	var table = A2(
		$author$project$Vega$transform,
		_List_fromArray(
			[
				$author$project$Vega$trFilter(
				$author$project$Vega$expr('(sex === \'all\' || datum.sex === sex) && (!query || test(regexp(query,\'i\'), datum.job))')),
				$author$project$Vega$trStack(
				_List_fromArray(
					[
						$author$project$Vega$stGroupBy(
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								$author$project$Vega$field('sex'),
								$author$project$Vega$descend)
							])),
						$author$project$Vega$stField(
						$author$project$Vega$field('perc'))
					]))
			]),
		A2(
			$author$project$Vega$data,
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$str('https://vega.github.io/vega/data/jobs.json'))
				])));
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$esMark($author$project$Vega$area),
							...
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('datum.job')
								])),
							A2(
							$author$project$Vega$evHandler,
							_List_fromArray(
					...
					$author$project$Vega$iText(
						_List_fromArray(
							[
								$author$project$Vega$inPlaceholder('search'),
								$author$project$Vega$inAutocomplete(false)
							])))
				])));
	var series = A2(
		$author$project$Vega$transform,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[$author$project$Vega$opSum, $author$project$Vega$opArgMax])),
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$daSource('jobs')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
										...
										_List_fromArray(
											[
												...
												$author$project$Vega$doData(
													_List_fromArray(
														[
															$author$project$Vega$daDataset('jobs'),
															$author$project$Vega$daField(
															$author$project$Vega$field('year'))
														])))
											]))),
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$doData(
										_List_fromArray(
											[
												$author$project$Vega$daDataset('series'),
												$author$project$Vega$daField(
												$author$project$Vega$field('sum'))
											]))),
									$author$project$Vega$scRange(
								...
								$author$project$Vega$doData(
									_List_fromArray(
										[
											$author$project$Vega$daDataset('series'),
											$author$project$Vega$daField(
											$author$project$Vega$field('argmax.perc'))
										])))
							]))),
				A2(
					$author$project$Vega$scale,
					...
					_List_fromArray(
						[
							$author$project$Vega$scType($author$project$Vega$scQuantile),
							$author$project$Vega$scRange(
							$author$project$Vega$raNums(
								_List_fromArray(
									[0, 0, 0, 0, 0, 0.1, 0.2, 0.4, 0.7, 1.0]))),
							$author$project$Vega$scDomain(
							$author$project$Vega$doData(
								_List_fromArray(
									[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('alphaScale'),
											$author$project$Vega$vField(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('argmax.year')),
											$author$project$Vega$vScale('xScale')
										])),
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('argmax.year')),
											$author$project$Vega$vScale('offsetScale')
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('scale(\'yScale\', 0.5 * (datum.argmax.y0 + datum.argmax.y1))')
										])),
									$author$project$Vega$maFill(
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('argmax.perc')),
											$author$project$Vega$vScale('opacityScale')
										])),
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('argmax.perc')),
											$author$project$Vega$vScale('fontScale'),
...
var $author$project$GalleryLineArea$lineChart1 = function () {
	var table = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				$author$project$Vega$vNums(
					_List_fromArray(
						[28, 20, 43, 35, 81, 10, 19, 15, 52, 48, 24, 28, 87, 66, 17, 27, 68, 16, 49, 25])))),
		A2(
			$author$project$Vega$dataColumn,
			'c',
			$author$project$Vega$vNums(
...
var $author$project$GalleryLineArea$mySpecs = $author$project$Vega$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('lineChart1', $author$project$GalleryLineArea$lineChart1),
			_Utils_Tuple2('areaChart1', $author$project$GalleryLineArea$areaChart1),
			_Utils_Tuple2('areaChart2', $author$project$GalleryLineArea$areaChart2),
			_Utils_Tuple2('areaChart3', $author$project$GalleryLineArea$areaChart3),
			_Utils_Tuple2('areaChart4', $author$project$GalleryLineArea$areaChart4)
		]));
...
var $author$project$GalleryLineArea$sourceExample = $author$project$GalleryLineArea$areaChart4;
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$GalleryLineArea$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$GalleryLineArea$sourceExample))
					]))
			]));
};
var $author$project$GalleryLineArea$main = $elm$browser$Browser$element(
	{
		aA: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$GalleryLineArea$mySpecs,
				$author$project$GalleryLineArea$elmToJS($author$project$GalleryLineArea$mySpecs))),
		aI: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		aK: F2(
			function (_v0, model) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}),
		aL: $author$project$GalleryLineArea$view
	});
_Platform_export({'GalleryLineArea':{'init':$author$project$GalleryLineArea$main(
