...
var $author$project$GalleryTree$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$GalleryTree$dPath = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.1/data/';
...
var $author$project$Vega$LPOrient = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$lpOrient = $author$project$Vega$LPOrient;
...
var $author$project$Vega$TTreeLinks = {$: 53};
...
var $author$project$GalleryTree$tree1 = function () {
	var si = A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siValue(
					$author$project$Vega$vStr('diagonal')),
					$author$project$Vega$siBind(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('datum.children ? -7 : 7')
										])),
									$author$project$Vega$maAlign(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('datum.children ? \'right\' : \'left\'')
										])),
									$author$project$Vega$maOpacity(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('labels ? 1 : 0')
										]))
								]))
						]))
				])));
						...
						_List_fromArray(
							[
								...
								$author$project$Vega$numSignals(
									_List_fromArray(
										['height', 'width-100']))),
								A4($author$project$Vega$teAs, 'y', 'x', 'depth', 'children')
							]))
					]),
				A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Vega$str($author$project$GalleryTree$dPath + 'flare.json'))
						]))),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$lpOrient($author$project$Vega$orHorizontal),
								$author$project$Vega$lpShape(
								$author$project$Vega$lsSignal('links'))
							]))
					]),
				A2(
					$author$project$Vega$data,
	...
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				...
				$author$project$Vega$height(1600),
...
var $author$project$Vega$Radial = {$: 2};
var $author$project$Vega$orRadial = $author$project$Vega$Radial;
...
var $author$project$GalleryTree$tree2 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vSignal('originX')
												])),
											$author$project$Vega$maY(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('originY')
												])),
											$author$project$Vega$maPath(
											_List_fromArray(
												[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('(datum.leftside ? -1 : 1) * 6')
										])),
					...
					[
						...
						_List_fromArray(
							[
								...
								A4($author$project$Vega$teAs, 'alpha', 'radius', 'depth', 'children')
							])),
						A2($author$project$Vega$trFormula, '(rotate + extent * datum.alpha + 270) % 360', 'angle'),
						A2($author$project$Vega$trFormula, 'PI * datum.angle / 180', 'radians'),
						A2($author$project$Vega$trFormula, 'inrange(datum.angle, [90, 270])', 'leftside'),
						A2($author$project$Vega$trFormula, 'originX + datum.radius * cos(datum.radians)', 'x'),
						A2($author$project$Vega$trFormula, 'originY + datum.radius * sin(datum.radians)', 'y')
					]),
				A2(
					$author$project$Vega$data,
					'tree',
					...
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$lpShape(
								$author$project$Vega$lsSignal('links')),
								$author$project$Vega$lpOrient($author$project$Vega$orRadial),
								$author$project$Vega$lpSourceX(
								$author$project$Vega$field('source.radians')),
								$author$project$Vega$lpSourceY(
								$author$project$Vega$field('source.radius')),
								$author$project$Vega$lpTargetX(
								$author$project$Vega$field('target.radians')),
								$author$project$Vega$lpTargetY(
								$author$project$Vega$field('target.radius'))
							]))
					]),
				A2(
					$author$project$Vega$data,
...
var $author$project$Vega$TmField = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$tmField = $author$project$Vega$TmField;
var $author$project$Vega$TmMethod = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$tmMethod = $author$project$Vega$TmMethod;
var $author$project$Vega$TmRatio = function (a) {
	return {$: 10, a: a};
};
var $author$project$Vega$tmRatio = $author$project$Vega$TmRatio;
var $author$project$Vega$TmRound = function (a) {
	return {$: 11, a: a};
};
var $author$project$Vega$tmRound = $author$project$Vega$TmRound;
var $author$project$Vega$TmSignal = function (a) {
	return {$: 6, a: a};
};
var $author$project$Vega$tmSignal = $author$project$Vega$TmSignal;
var $author$project$Vega$TmSize = function (a) {
	return {$: 12, a: a};
};
var $author$project$Vega$tmSize = $author$project$Vega$TmSize;
var $author$project$Vega$TmSort = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vega$tmSort = $author$project$Vega$TmSort;
var $author$project$Vega$TFilter = function (a) {
	return {$: 12, a: a};
};
var $author$project$Vega$trFilter = $author$project$Vega$TFilter;
var $author$project$Vega$TTreemap = function (a) {
	return {$: 54, a: a};
};
var $author$project$Vega$trTreemap = $author$project$Vega$TTreemap;
...
var $author$project$GalleryTree$tree3 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siValue(
						$author$project$Vega$vStr('squarify')),
						$author$project$Vega$siBind(
						$author$project$Vega$iSelect(
							_List_fromArray(
								[
									...
									$author$project$Vega$vStrs(
										_List_fromArray(
											['squarify', 'resquarify', 'binary', 'slicedice'])))
								])))
					]))),
		A2(
			$author$project$Vega$signal,
			...
			_List_fromArray(
				[
					$author$project$Vega$siValue(
					$author$project$Vega$vNum(1.6)),
					$author$project$Vega$siBind(
					$author$project$Vega$iRange(
						_List_fromArray(
							[
								$author$project$Vega$inMin(0.2),
								$author$project$Vega$inMax(5),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('opacity'),
											$author$project$Vega$vField(
											$author$project$Vega$field('depth'))
										]))
								])),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('0.5 * (datum.x0 + datum.x1)')
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
											$author$project$Vega$vSignal('0.5 * (datum.y0 + datum.y1)')
										]))
								]))
						]))
				])));
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$field('id'),
						$author$project$Vega$field('parent')),
						$author$project$Vega$trTreemap(
						_List_fromArray(
							[
								$author$project$Vega$tmField(
								$author$project$Vega$field('size')),
								$author$project$Vega$tmSort(
								_List_fromArray(
									[
										_Utils_Tuple2(
								...
								$author$project$Vega$tmRound($author$project$Vega$true),
								$author$project$Vega$tmMethod(
								$author$project$Vega$tmSignal('layout')),
								$author$project$Vega$tmRatio(
								$author$project$Vega$numSignal('aspectRatio')),
								$author$project$Vega$tmSize(
								$author$project$Vega$numSignals(
									_List_fromArray(
										['width', 'height'])))
							]))
	...
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				...
				$author$project$Vega$padding(2.5),
				$author$project$Vega$autosize(
				_List_fromArray(
					[$author$project$Vega$asNone])),
				ds,
...
var $author$project$GalleryTree$tree4 = function () {
	var sc = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$scales,
		A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('datum.name + (datum.size ? \', \' + datum.size + \' bytes\' : \'\')')
										]))
								])),
							$author$project$Vega$enUpdate(
							_List_fromArray(
...
var $author$project$Vega$PtAs = F6(
	function (a, b, c, d, e, f) {
		return {$: 5, a: a, b: b, c: c, d: d, e: e, f: f};
	});
var $author$project$Vega$ptAs = $author$project$Vega$PtAs;
var $author$project$Vega$PtField = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$ptField = $author$project$Vega$PtField;
var $author$project$Vega$PtSize = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$ptSize = $author$project$Vega$PtSize;
var $author$project$Vega$PtSort = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vega$ptSort = $author$project$Vega$PtSort;
var $author$project$Vega$TPartition = function (a) {
	return {$: 39, a: a};
};
var $author$project$Vega$trPartition = $author$project$Vega$TPartition;
var $author$project$GalleryTree$tree5 = function () {
	var sc = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$scales,
		A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$author$project$Vega$raScheme,
						$author$project$Vega$str('tableau20'),
						_List_Nil))
				])));
	var mk = A2(
		$elm$core$Basics$composeL,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('a0'))
										])),
									$author$project$Vega$maEndAngle(
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('a1'))
										])),
									$author$project$Vega$maInnerRadius(
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('r0'))
										])),
									$author$project$Vega$maOuterRadius(
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('r1'))
										])),
									$author$project$Vega$maStroke(
									_List_fromArray(
										[$author$project$Vega$white])),
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$field('id'),
						$author$project$Vega$field('parent')),
						$author$project$Vega$trPartition(
						_List_fromArray(
							[
								$author$project$Vega$ptField(
								$author$project$Vega$field('size')),
								$author$project$Vega$ptSort(
								_List_fromArray(
									[
										_Utils_Tuple2(
										$author$project$Vega$field('value'),
								...
								$author$project$Vega$ptSize(
								$author$project$Vega$numSignals(
									_List_fromArray(
										['2 * PI', 'width / 2']))),
								A6($author$project$Vega$ptAs, 'a0', 'r0', 'a1', 'r1', 'depth', 'children')
							]))
					]),
				A2(
					$author$project$Vega$data,
...
var $author$project$GalleryTree$mySpecs = $author$project$Vega$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('tree1', $author$project$GalleryTree$tree1),
			_Utils_Tuple2('tree2', $author$project$GalleryTree$tree2),
			_Utils_Tuple2('tree3', $author$project$GalleryTree$tree3),
			_Utils_Tuple2('tree4', $author$project$GalleryTree$tree4),
			_Utils_Tuple2('tree5', $author$project$GalleryTree$tree5)
		]));
...
var $author$project$GalleryTree$sourceExample = $author$project$GalleryTree$tree4;
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$GalleryTree$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$GalleryTree$sourceExample))
					]))
			]));
};
var $author$project$GalleryTree$main = $elm$browser$Browser$element(
	{
		aA: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$GalleryTree$mySpecs,
				$author$project$GalleryTree$elmToJS($author$project$GalleryTree$mySpecs))),
		aI: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		aK: F2(
			function (_v0, model) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}),
		aL: $author$project$GalleryTree$view
	});
_Platform_export({'GalleryTree':{'init':$author$project$GalleryTree$main(
