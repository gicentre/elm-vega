...
var $author$project$GalleryBar$barChart1 = function () {
	var table = A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScale'),
											$author$project$Vega$vSignal('tooltip.category'),
											$author$project$Vega$vBand(
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('yScale'),
											$author$project$Vega$vSignal('tooltip.amount'),
...
var $author$project$GalleryBar$barChart4 = function () {
	var table = A2(
		...
		A2(
			...
			$author$project$Vega$vNums(
				_List_fromArray(
					[0.1, 0.6, 0.9, 0.4, 0.7, 0.2, 1.1, 0.8, 0.6, 0.1, 0.2, 0.7]))));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('table'),
								$author$project$Vega$daField(
								$author$project$Vega$field('position'))
							]))),
					$author$project$Vega$scRange(
					A2(
						$author$project$Vega$raScheme,
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('facet'),
								$author$project$Vega$daField(
								$author$project$Vega$field('position'))
							])))
				])));
	var nestedMk = A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$mName('bars'),
						$author$project$Vega$mFrom(
						_List_fromArray(
							[
								$author$project$Vega$srData(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vScale('pos'),
												$author$project$Vega$vField(
												$author$project$Vega$field('position'))
											])),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('datum.value'))
										]))
								]))
						]))
				])));
...
var $author$project$GalleryBar$barChart5 = function () {
	var trTable = A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$field('a')
							]))
					])),
				A2($author$project$Vega$trFormula, 'rangeStep * bandspace(datum.count, innerPadding, outerPadding)', 'span'),
				$author$project$Vega$trStack(
				_List_fromArray(
					[
						$author$project$Vega$stField(
						$author$project$Vega$field('span'))
					])),
				A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$daSource('tuples')
				])));
	var table = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				$elm$core$Basics$composeL,
				A2($author$project$Vega$dataFromColumns, 'tuples', _List_Nil),
				A2(
					$author$project$Vega$dataColumn,
					'a',
					$author$project$Vega$vNums(
	...
	var si = A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('trellisExtent[1]')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('tuples'),
									$author$project$Vega$daField(
									$author$project$Vega$field('c'))
								]))),
						$author$project$Vega$scNice($author$project$Vega$niTrue),
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('trellis'),
								$author$project$Vega$daField(
								$author$project$Vega$field('a'))
							])))
				])));
	var nestedSc = A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$scType($author$project$Vega$scBand),
					$author$project$Vega$scPaddingInner(
					$author$project$Vega$numSignal('innerPadding')),
					$author$project$Vega$scPaddingOuter(
					$author$project$Vega$numSignal('outerPadding')),
					$author$project$Vega$scRound($author$project$Vega$true),
					$author$project$Vega$scDomain(
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('faceted_tuples'),
								$author$project$Vega$daField(
								$author$project$Vega$field('b'))
							]))),
					$author$project$Vega$scRange(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('faceted_tuples'))
						])),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('trellis')),
							A3(
							$author$project$Vega$srFacet,
							$author$project$Vega$str('tuples'),
							'faceted_tuples',
							_List_fromArray(
								[
									$author$project$Vega$faGroupBy(
	...
	var ax = A2(
		...
		A3(
			...
			_List_fromArray(
				[
					$author$project$Vega$axDomain($author$project$Vega$true)
				])));
	var agTable = A2(
		$author$project$Vega$transform,
		_List_fromArray(
...
var $author$project$GalleryBar$Female = 1;
var $author$project$GalleryBar$Male = 0;
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('ageGroups'),
									$author$project$Vega$daField(
									$author$project$Vega$field('age'))
								])))
					]))),
		A2(
			$author$project$Vega$scale,
	...
	var si = A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siUpdate('2 * chartWidth + chartPad')
					]))),
		A2(
			$author$project$Vega$signal,
			'year',
			_List_fromArray(
				[
					...
					$author$project$Vega$iRange(
						_List_fromArray(
							[
								$author$project$Vega$inMin(1850),
								$author$project$Vega$inMax(2000),
								$author$project$Vega$inStep(10)
							])))
				])));
	var sc = function (gender) {
		var range = function () {
			if (gender === 1) {
				return $author$project$Vega$scRange(
					$author$project$Vega$raValues(
						_List_fromArray(
							[
								$author$project$Vega$vSignal('chartWidth'),
								$author$project$Vega$vNum(0)
							])));
			} else {
				return $author$project$Vega$scRange(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('population'),
									$author$project$Vega$daField(
									$author$project$Vega$field('people'))
								])))
					])));
	};
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$srData(
								$author$project$Vega$str(genderField))
							])),
						$author$project$Vega$mEncode(
						_List_fromArray(
							[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$str('https://vega.github.io/vega/data/population.json'))
					])),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						...
						$author$project$Vega$expr('datum.year == year'))
					]),
				A2(
					$author$project$Vega$data,
					'popYear',
					_List_fromArray(
						[
							$author$project$Vega$daSource('population')
						]))),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.sex == 1'))
					]),
				A2(
					$author$project$Vega$data,
					'males',
					_List_fromArray(
						[
							$author$project$Vega$daSource('popYear')
						]))),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.sex == 2'))
					]),
				A2(
					$author$project$Vega$data,
					'females',
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Vega$srData(
									$author$project$Vega$str('ageGroups'))
								])),
							$author$project$Vega$mEncode(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vSignal('chartWidth + chartPad / 2')
												])),
											$author$project$Vega$maY(
											_List_fromArray(
												[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('chartWidth + chartPad')
										])),
									$author$project$Vega$maHeight(
									_List_fromArray(
										[
...
var $author$project$GalleryBar$mySpecs = $author$project$Vega$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('barChart1', $author$project$GalleryBar$barChart1),
...
var $author$project$GalleryBar$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$GalleryBar$sourceExample))
					]))
			]));
};
var $author$project$GalleryBar$main = $elm$browser$Browser$element(
	{
		...
		aL: $author$project$GalleryBar$view
	});
