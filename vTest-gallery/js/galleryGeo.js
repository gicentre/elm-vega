...
var _gicentre$elm_vega$GalleryGeo$geo8 = function (inData) {
	var mk = function (_p0) {
					...
					_0: _gicentre$elm_vega$Vega$mFrom(
						{
							...
							_0: _gicentre$elm_vega$Vega$srData(
								_gicentre$elm_vega$Vega$str('contours')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
							...
							_0: _gicentre$elm_vega$Vega$mTransform(
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$gpField(
												_gicentre$elm_vega$Vega$field('datum')),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
	...
	var sc = function (_p1) {
		return _gicentre$elm_vega$Vega$scales(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$scType(_gicentre$elm_vega$Vega$ScSequential),
					_1: {
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$scRange(_gicentre$elm_vega$Vega$RaHeatmap),
							_1: {ctor: '[]'}
						}
					}
				},
	...
	var pr = function (_p2) {
		return _gicentre$elm_vega$Vega$projections(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$prType(
						_gicentre$elm_vega$Vega$prCustom(
							_gicentre$elm_vega$Vega$str('identity'))),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$prScale(
							_gicentre$elm_vega$Vega$numSignal('width / volcano.width')),
						_1: {ctor: '[]'}
					}
				},
				_p2));
						...
						_gicentre$elm_vega$Vega$vObject(
							{
								...
								_0: A2(
									...
									'width',
									_gicentre$elm_vega$Vega$vNum(87)),
								_1: {
									ctor: '::',
									_0: A2(
										_gicentre$elm_vega$Vega$keyValue,
										'height',
										_gicentre$elm_vega$Vega$vNum(61)),
									_1: {
										ctor: '::',
										_0: A2(
											_gicentre$elm_vega$Vega$keyValue,
											'values',
											_gicentre$elm_vega$Vega$vNums(inData)),
										_1: {ctor: '[]'}
									}
								}
							})),
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					ctor: '::',
					_0: A3(
						_gicentre$elm_vega$Vega$trContour,
						_gicentre$elm_vega$Vega$numSignal('volcano.width'),
						_gicentre$elm_vega$Vega$numSignal('volcano.height'),
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$cnValues(
								_gicentre$elm_vega$Vega$numSignal('volcano.values')),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$cnSmooth(
									_gicentre$elm_vega$Vega$booSignal('smooth')),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$cnThresholds(
										_gicentre$elm_vega$Vega$numSignal('sequence(90,195,5)')),
									_1: {ctor: '[]'}
								}
							}
						}),
	...
	return _gicentre$elm_vega$Vega$toVega(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$width(960),
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$height(673),
				_1: {
					ctor: '::',
...
var _gicentre$elm_vega$GalleryGeo$sourceExample = _gicentre$elm_vega$GalleryGeo$geo8;
var _gicentre$elm_vega$GalleryGeo$view = function (model) {
	return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								2,
								_gicentre$elm_vega$GalleryGeo$sourceExample(model.input))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _gicentre$elm_vega$GalleryGeo$geo6 = function () {
	var mk = function (_p4) {
		return _gicentre$elm_vega$Vega$marks(
			A3(
				_gicentre$elm_vega$Vega$mark,
						...
						_0: _gicentre$elm_vega$Vega$mFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$srData(
									_gicentre$elm_vega$Vega$str('world')),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
				...
				A3(
					...
					A3(
						...
						'myScale',
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$siValue(
								_gicentre$elm_vega$Vega$vNum(150)),
							_1: {
								ctor: '::',
...
var _gicentre$elm_vega$GalleryGeo$geo5 = function () {
	var lo = _gicentre$elm_vega$Vega$layout(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$loColumns(
				...
				'projections',
				{
					...
					_0: _gicentre$elm_vega$Vega$daValue(
						_gicentre$elm_vega$Vega$vStrs(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$projectionLabel(_gicentre$elm_vega$Vega$AzimuthalEquidistant),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$projectionLabel(_gicentre$elm_vega$Vega$ConicConformal),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$projectionLabel(_gicentre$elm_vega$Vega$Gnomonic),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$projectionLabel(_gicentre$elm_vega$Vega$Mercator),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$projectionLabel(_gicentre$elm_vega$Vega$Stereographic),
												_1: {
													ctor: '::',
													_0: 'airy',
													_1: {
							...
							A2(
								_gicentre$elm_vega$Vega$dataRow,
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'type',
										_1: _gicentre$elm_vega$Vega$vStr('Sphere')
									},
									_1: {ctor: '[]'}
								},
								{ctor: '[]'})),
					...
					_gicentre$elm_vega$Vega$Shape,
					{
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$mClip(
								_gicentre$elm_vega$Vega$clSphere(
											...
											_0: _gicentre$elm_vega$Vega$enEnter(
												{
													...
													_1: {
														...
														_0: _gicentre$elm_vega$Vega$maStroke(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vStr('#888'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
								...
								_0: _gicentre$elm_vega$Vega$mFrom(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$srData(
											_gicentre$elm_vega$Vega$str('labelOffsets')),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
														...
														_0: _gicentre$elm_vega$Vega$maDx(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vField(
																	_gicentre$elm_vega$Vega$field('dx')),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$maDy(
																{
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vField(
																		_gicentre$elm_vega$Vega$field('dy')),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																...
																_1: {
																	...
																	_0: _gicentre$elm_vega$Vega$maY(
																		{
																			ctor: '::',
																			_0: _gicentre$elm_vega$Vega$vNum(mapHeight - 5),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																			...
																			_1: {
																				...
																				_1: {
																					...
																					_0: _gicentre$elm_vega$Vega$maText(
																						{
																							ctor: '::',
																							_0: _gicentre$elm_vega$Vega$vSignal('parent.data'),
																							_1: {ctor: '[]'}
																						}),
																					_1: {ctor: '[]'}
																				}
		...
		return _gicentre$elm_vega$Vega$projections(
			A3(
				...
				'myProjection',
				{
					...
					_0: _gicentre$elm_vega$Vega$prType(
						_gicentre$elm_vega$Vega$prCustom(
							_gicentre$elm_vega$Vega$strSignal('parent.data'))),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$prScale(
							_gicentre$elm_vega$Vega$num(projScale)),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$prTranslate(
								_gicentre$elm_vega$Vega$nums(
					...
					_0: _gicentre$elm_vega$Vega$mFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$srData(
								_gicentre$elm_vega$Vega$str('projections')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								_0: _gicentre$elm_vega$Vega$enEnter(
									{
										...
										_0: _gicentre$elm_vega$Vega$maWidth(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$vNum(mapWidth),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$maHeight(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vNum(mapHeight),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$maGroupClip(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vBoo(true),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _gicentre$elm_vega$GalleryGeo$geo4 = function () {
							...
							_gicentre$elm_vega$Vega$raValues(
								{
									...
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$vSignal('quakeSize'),
										_1: {ctor: '[]'}
									}
								})),
						_1: {
...
var _gicentre$elm_vega$GalleryGeo$geo2 = function () {
	var mk = function (_p14) {
		return _gicentre$elm_vega$Vega$marks(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$mName('circles'),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$mFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$srData(
									_gicentre$elm_vega$Vega$str('obesity')),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
									...
									_0: _gicentre$elm_vega$Vega$enEnter(
										{
											...
											_0: _gicentre$elm_vega$Vega$maSize(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vScale('sizeScale'),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$field('rate')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
															...
															_0: _gicentre$elm_vega$Vega$maX(
																{
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vField(
																		_gicentre$elm_vega$Vega$field('myCentroid[0]')),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$maY(
																	{
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$vField(
																			_gicentre$elm_vega$Vega$field('myCentroid[1]')),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$maTooltip(
																		{
																			ctor: '::',
																			_0: _gicentre$elm_vega$Vega$vSignal('\'Obesity Rate: \' + format(datum.rate, \'.1%\')'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
								...
								_0: _gicentre$elm_vega$Vega$mTransform(
									{
										...
										_0: _gicentre$elm_vega$Vega$trForce(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$fsStatic(_gicentre$elm_vega$Vega$true),
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$fsForces(
														{
															...
															_0: A2(
																...
																_gicentre$elm_vega$Vega$numExpr(
																	_gicentre$elm_vega$Vega$expr('1 + sqrt(datum.size) / 2')),
																{ctor: '[]'}),
															_1: {
																ctor: '::',
																_0: A2(
																	_gicentre$elm_vega$Vega$foX,
																	_gicentre$elm_vega$Vega$field('datum.myCentroid[0]'),
																	{ctor: '[]'}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_gicentre$elm_vega$Vega$foY,
																		_gicentre$elm_vega$Vega$field('datum.myCentroid[1]'),
																		{ctor: '[]'}),
																	_1: {ctor: '[]'}
																}
															}
							...
							_0: _gicentre$elm_vega$Vega$mFrom(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$srData(
										_gicentre$elm_vega$Vega$str('circles')),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: _gicentre$elm_vega$Vega$maFontSize(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vNum(13),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
																...
																_0: _gicentre$elm_vega$Vega$maText(
																	{
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$vField(
																			_gicentre$elm_vega$Vega$field('datum.state')),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
			...
			A2(
				_gicentre$elm_vega$Vega$legend,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$leType(_gicentre$elm_vega$Vega$LSymbol),
							_1: {
								ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: _gicentre$elm_vega$Vega$leClipHeight(
												_gicentre$elm_vega$Vega$num(16)),
											_1: {ctor: '[]'}
										}
									}
								}
				...
				'sizeScale',
				{
					...
					_0: _gicentre$elm_vega$Vega$scDomain(
						_gicentre$elm_vega$Vega$doData(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$daDataset('obesity'),
								_1: {
									ctor: '::',
					...
					'cScale',
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$scRange(_gicentre$elm_vega$Vega$RaRamp),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			A3(
				...
				'myProjection',
				{
					...
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$prScale(
							_gicentre$elm_vega$Vega$num(1100)),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$prTranslate(
								_gicentre$elm_vega$Vega$numSignals(
				...
				_0: A2(
					_gicentre$elm_vega$Vega$transform,
					{
						...
						_0: A4(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$field('id'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$trFilter(
								_gicentre$elm_vega$Vega$expr('datum.geo')),
							_1: {
								ctor: '::',
								_0: A2(_gicentre$elm_vega$Vega$trFormula, 'geoCentroid(\'myProjection\', datum.geo)', 'myCentroid'),
								_1: {ctor: '[]'}
							}
						}
					},
	...
	return _gicentre$elm_vega$Vega$toVega(
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$height(520),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$autosize(
							{
...
var _gicentre$elm_vega$GalleryGeo$geo1 = function () {
					...
					_0: _gicentre$elm_vega$Vega$mFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$srData(
								_gicentre$elm_vega$Vega$str('counties')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								_0: _gicentre$elm_vega$Vega$enEnter(
									{
										...
										_0: _gicentre$elm_vega$Vega$maTooltip(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$vSignal('format(datum.rate, \'0.1%\')'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$scRange(
								A2(
									...
									_gicentre$elm_vega$Vega$str('blues-9'),
									{ctor: '[]'})),
							_1: {ctor: '[]'}
						}
					}
				...
				_0: A2(
					_gicentre$elm_vega$Vega$transform,
					{
						...
						_0: A4(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$luValues(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$field('rate'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$trFilter(
								_gicentre$elm_vega$Vega$expr('datum.rate != null')),
							_1: {ctor: '[]'}
						}
					},
					A2(
...
var _gicentre$elm_vega$GalleryGeo$standardProjections = _gicentre$elm_vega$Vega$vStrs(
	A2(
		_elm_lang$core$List$map,
		_gicentre$elm_vega$Vega$projectionLabel,
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$Albers,
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$AlbersUsa,
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$AzimuthalEqualArea,
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$AzimuthalEquidistant,
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$ConicConformal,
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$ConicEqualArea,
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$ConicEquidistant,
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$Equirectangular,
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$Gnomonic,
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$Mercator,
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$Orthographic,
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$Stereographic,
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$TransverseMercator,
															_1: {ctor: '[]'}
														}
													}
												}
...
var _gicentre$elm_vega$GalleryGeo$geo3 = function () {
	var enc = _gicentre$elm_vega$Vega$encode(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$enUpdate(
				{
					...
					_0: _gicentre$elm_vega$Vega$maFill(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$vSignal('background'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
								...
								_0: _gicentre$elm_vega$Vega$enUpdate(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$maStrokeDash(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vSignal('[+graticuleDash, +graticuleDash]'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$maStroke(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vSignal('invert ? \'#444\' : \'#ddd\''),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
									...
									_0: _gicentre$elm_vega$Vega$enUpdate(
										{
											...
											_0: _gicentre$elm_vega$Vega$maStrokeWidth(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vSignal('+borderWidth'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$maStroke(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vSignal('invert ? \'#777\' : \'#bbb\''),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$maFill(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vSignal('invert ? \'#fff\' : \'#000\''),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
										...
										_0: _gicentre$elm_vega$Vega$enHover(
											{
												...
												_0: _gicentre$elm_vega$Vega$maStrokeWidth(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vSignal('+borderWidth + 1'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
		...
		return _gicentre$elm_vega$Vega$projections(
			A3(
				...
				'myProjection',
				{
					...
					_0: _gicentre$elm_vega$Vega$prType(
						_gicentre$elm_vega$Vega$prCustom(
							_gicentre$elm_vega$Vega$strSignal('pType'))),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$prScale(
				...
				'pType',
				{
					...
					_0: _gicentre$elm_vega$Vega$siValue(
						_gicentre$elm_vega$Vega$vStr(
							_gicentre$elm_vega$Vega$projectionLabel(_gicentre$elm_vega$Vega$Mercator))),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$siBind(
							_gicentre$elm_vega$Vega$iSelect(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$inOptions(_gicentre$elm_vega$GalleryGeo$standardProjections),
									_1: {ctor: '[]'}
								})),
						_1: {ctor: '[]'}
					}
								...
								_1: {
									...
									_0: _gicentre$elm_vega$Vega$siBind(
										_gicentre$elm_vega$Vega$iRange(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$inMin(-90),
												_1: {
													ctor: '::',
													...
													A3(
														...
														A3(
															...
															'background',
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$siValue(
																	_gicentre$elm_vega$Vega$vStr('#ffffff')),
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$siBind(
																		_gicentre$elm_vega$Vega$iColor(
																			{ctor: '[]'})),
																	_1: {ctor: '[]'}
																}
															},
...
var _gicentre$elm_vega$GalleryGeo$geo7 = function () {
									...
									_0: _gicentre$elm_vega$Vega$enUpdate(
										{
											...
											_0: _gicentre$elm_vega$Vega$maFill(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vSignal('altColor'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: _gicentre$elm_vega$Vega$maFillOpacity(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vSignal('myOpacity'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
																		...
																		_0: _gicentre$elm_vega$Vega$maSize(
																			{
																				ctor: '::',
																				_0: _gicentre$elm_vega$Vega$vField(
																					_gicentre$elm_vega$Vega$field('area2')),
																				_1: {
																					ctor: '::',
																					_0: _gicentre$elm_vega$Vega$vMultiply(
																						_gicentre$elm_vega$Vega$vSignal('scaleFactor')),
																					_1: {ctor: '[]'}
																				}
																			}),
																		_1: {ctor: '[]'}
										...
										_0: _gicentre$elm_vega$Vega$enUpdate(
											{
												...
												_0: _gicentre$elm_vega$Vega$maFill(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vSignal('baseColor'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
																			...
																			_0: _gicentre$elm_vega$Vega$maSize(
																				{
																					ctor: '::',
																					_0: _gicentre$elm_vega$Vega$vField(
																						_gicentre$elm_vega$Vega$field('area1')),
																					_1: {
																						ctor: '::',
																						_0: _gicentre$elm_vega$Vega$vMultiply(
																							_gicentre$elm_vega$Vega$vSignal('scaleFactor')),
		...
		return _gicentre$elm_vega$Vega$projections(
			A3(
				...
				'projection1',
				{
					...
					_0: _gicentre$elm_vega$Vega$prType(
						_gicentre$elm_vega$Vega$prCustom(
							_gicentre$elm_vega$Vega$strSignal('baseProjection'))),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$prScale(
							_gicentre$elm_vega$Vega$num(150)),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$prRotate(
								_gicentre$elm_vega$Vega$nums(
				...
				A3(
					...
					'projection2',
					{
						...
						_0: _gicentre$elm_vega$Vega$prType(
							_gicentre$elm_vega$Vega$prCustom(
								_gicentre$elm_vega$Vega$strSignal('altProjection'))),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$prScale(
								_gicentre$elm_vega$Vega$num(150)),
		...
		return _gicentre$elm_vega$Vega$signals(
			A3(
				...
				'baseProjection',
				{
					...
					_0: _gicentre$elm_vega$Vega$siValue(
						_gicentre$elm_vega$Vega$vStr(
							_gicentre$elm_vega$Vega$projectionLabel(_gicentre$elm_vega$Vega$AzimuthalEqualArea))),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$siBind(
							_gicentre$elm_vega$Vega$iSelect(
				...
				A3(
					...
					A3(
						...
						'baseColor',
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$siValue(
								_gicentre$elm_vega$Vega$vStr('#bb8800')),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$siBind(
									_gicentre$elm_vega$Vega$iColor(
						...
						A3(
							...
							'altColor',
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$siValue(
									_gicentre$elm_vega$Vega$vStr('#0088bb')),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$siBind(
										_gicentre$elm_vega$Vega$iColor(
							...
							A3(
								...
								'myOpacity',
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$siValue(
										_gicentre$elm_vega$Vega$vNum(0.15)),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$siBind(
											_gicentre$elm_vega$Vega$iRange(
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$inStep(5.0e-2),
															_1: {ctor: '[]'}
														}
													}
												})),
										...
										_1: {
											...
											_0: _gicentre$elm_vega$Vega$siBind(
												_gicentre$elm_vega$Vega$iRange(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$inMin(5.0e-2),
														_1: {
															ctor: '::',
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_gicentre$elm_vega$Vega$trFormula, 'geoCentroid(\'projection1\', datum)', 'myCentroid'),
					_1: {
						ctor: '::',
						_0: A2(_gicentre$elm_vega$Vega$trFormula, 'geoArea(\'projection1\', datum)', 'area1'),
						_1: {
							ctor: '::',
							_0: A2(_gicentre$elm_vega$Vega$trFormula, 'geoArea(\'projection2\', datum)', 'area2'),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _gicentre$elm_vega$GalleryGeo$mySpecs = function (inData) {
	return _gicentre$elm_vega$Vega$combineSpecs(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'geo1', _1: _gicentre$elm_vega$GalleryGeo$geo1},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'geo2', _1: _gicentre$elm_vega$GalleryGeo$geo2},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'geo3', _1: _gicentre$elm_vega$GalleryGeo$geo3},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'geo4', _1: _gicentre$elm_vega$GalleryGeo$geo4},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'geo5', _1: _gicentre$elm_vega$GalleryGeo$geo5},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'geo6', _1: _gicentre$elm_vega$GalleryGeo$geo6},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'geo7', _1: _gicentre$elm_vega$GalleryGeo$geo7},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'geo8',
											_1: _gicentre$elm_vega$GalleryGeo$geo8(inData)
										},
										_1: {ctor: '[]'}
									}
								}
...
var _gicentre$elm_vega$GalleryGeo$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryGeo$update = F2(
	function (msg, model) {
		var _p28 = msg;
		if (_p28._0.ctor === 'Ok') {
			var dataVals = A2(
				...
				A2(_elm_lang$core$String$split, ',', _p28._0._0));
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{input: dataVals}),
				_1: _gicentre$elm_vega$GalleryGeo$elmToJS(
					_gicentre$elm_vega$GalleryGeo$mySpecs(dataVals))
			};
		} else {
			return A2(
				_elm_lang$core$Debug$log,
...
var _gicentre$elm_vega$GalleryGeo$Model = F2(
	function (a, b) {
		return {input: a, spec: b};
	});
var _gicentre$elm_vega$GalleryGeo$FileRead = function (a) {
	return {ctor: 'FileRead', _0: a};
};
var _gicentre$elm_vega$GalleryGeo$init = function (filename) {
	return {
		ctor: '_Tuple2',
		_0: A2(
			_gicentre$elm_vega$GalleryGeo$Model,
			{ctor: '[]'},
			_gicentre$elm_vega$GalleryGeo$mySpecs(
				{ctor: '[]'})),
		_1: function (_p29) {
			return A2(
				_elm_lang$http$Http$send,
				_gicentre$elm_vega$GalleryGeo$FileRead,
				_elm_lang$http$Http$getString(_p29));
		}(filename)
	};
};
var _gicentre$elm_vega$GalleryGeo$main = _elm_lang$html$Html$program(
	{
		init: _gicentre$elm_vega$GalleryGeo$init('data/volcanoData.txt'),
		view: _gicentre$elm_vega$GalleryGeo$view,
		update: _gicentre$elm_vega$GalleryGeo$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['GalleryGeo'] = Elm['GalleryGeo'] || {};
if (typeof _gicentre$elm_vega$GalleryGeo$main !== 'undefined') {
    _gicentre$elm_vega$GalleryGeo$main(Elm['GalleryGeo'], 'GalleryGeo', undefined);
}
