	...
	function (msg, model) {
		...
		if (_p29._0.ctor === 'Ok') {
			var dataVals = A2(
				...
				A2(_elm_lang$core$String$split, ',', _p29._0._0));
			return {
				ctor: '_Tuple2',
	...
	return {
		...
		_1: function (_p30) {
			return A2(
				...
				_elm_lang$http$Http$getString(_p30));
		}(filename)
	};
};
