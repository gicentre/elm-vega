		...
		default:
			return {
				...
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$opLabel(_p11._0))
			};
	}
};
...
var _gicentre$elm_vega$Vega$foDataTypeSpec = function (dType) {
	...
	switch (_p15.ctor) {
		...
		case 'FoDate':
			var _p16 = _p15._0;
			return _elm_lang$core$Native_Utils.eq(_p16, '') ? _elm_lang$core$Json_Encode$string('date') : _elm_lang$core$Json_Encode$string(
				A2(
		...
		default:
			var _p17 = _p15._0;
			return _elm_lang$core$Native_Utils.eq(_p17, '') ? _elm_lang$core$Json_Encode$string('utc') : _elm_lang$core$Json_Encode$string(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'utc:\'',
						...
						A2(
							...
							function (_p19) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p20._0,
									_1: _gicentre$elm_vega$Vega$foDataTypeSpec(_p20._1)
								};
							},
							_p18._0))
				},
	...
	switch (_p21.ctor) {
		...
		default:
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p21._0))
			};
	}
};
var _gicentre$elm_vega$Vega$sourceProperty = function (src) {
	...
	if (_p22.ctor === 'SData') {
		...
		return {
			...
			_0: 'facet',
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$facetProperty, _p22._0))
		};
	}
};
...
var _gicentre$elm_vega$Vega$signalReferenceProperty = function (signal) {
	...
	if (_p23.ctor === 'SName') {
		...
		return {
			ctor: '_Tuple2',
			_0: 'signal',
			_1: _gicentre$elm_vega$Vega$expressionSpec(_p23._0)
		};
	}
};
var _gicentre$elm_vega$Vega$fieldValueSpec = function (fVal) {
	...
	switch (_p24.ctor) {
		case 'FName':
			return _elm_lang$core$Json_Encode$string(_p24._0);
		case 'FSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'datum',
						_1: _gicentre$elm_vega$Vega$fieldValueSpec(_p24._0)
					},
					_1: {ctor: '[]'}
				});
		case 'FGroup':
...
var _gicentre$elm_vega$Vega$signalStrSpec = function (sigStr) {
	var _p26 = sigStr;
	if (_p26.ctor === 'SigStr') {
		return _elm_lang$core$Json_Encode$string(_p26._0);
	} else {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
		...
		case 'TrTrigger':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'trigger',
					_1: _gicentre$elm_vega$Vega$expressionSpec(_p27._0)
				},
				_1: {ctor: '[]'}
			};
		case 'TrInsert':
			...
			return {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'values',
						_1: _gicentre$elm_vega$Vega$expressionSpec(_p27._1)
					},
					_1: {ctor: '[]'}
				}
			};
...
var _gicentre$elm_vega$Vega$eventHandlerSpec = function (ehs) {
	var eventHandler = function (eh) {
		...
		switch (_p28.ctor) {
			...
			case 'EUpdate':
				var _p29 = _p28._0;
				return _elm_lang$core$Native_Utils.eq(_p29, '') ? {
					ctor: '_Tuple2',
					_0: 'update',
					_1: _elm_lang$core$Json_Encode$string('{}')
				} : {
					ctor: '_Tuple2',
					_0: 'update',
					_1: _elm_lang$core$Json_Encode$string(_p29)
				};
			case 'EEncode':
				return {
					ctor: '_Tuple2',
	...
	switch (_p30.ctor) {
		case 'Booleans':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p30._0));
		case 'DateTimes':
			return _elm_lang$core$Json_Encode$list(
		...
		default:
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataValues, _p30._0));
	}
};
	...
	switch (_p31.ctor) {
		...
		case 'InOptions':
			return {
				ctor: '_Tuple2',
				_0: 'options',
				_1: _gicentre$elm_vega$Vega$dataValues(_p31._0)
			};
		case 'InPlaceholder':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$dataValue = function (val) {
	...
	switch (_p32.ctor) {
		...
		case 'Boolean':
			return _elm_lang$core$Json_Encode$bool(_p32._0);
		case 'Empty':
			return _elm_lang$core$Json_Encode$object(
				{ctor: '[]'});
		default:
	...
	switch (_p34.ctor) {
		...
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$colorProperty(_p34._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _gicentre$elm_vega$Vega$fieldValueSpec(_p34._0);
		case 'VScale':
			return _gicentre$elm_vega$Vega$fieldValueSpec(_p34._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'VExponent':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$valueProperty(_p34._0),
					_1: {ctor: '[]'}
				});
		case 'VMultiply':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'round',
						_1: _elm_lang$core$Json_Encode$bool(_p34._0)
					},
					_1: {ctor: '[]'}
				});
		case 'VNumber':
		...
		case 'VObject':
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p34._0));
		case 'VString':
...
var _gicentre$elm_vega$Vega$valueProperty = function (val) {
	...
	switch (_p36.ctor) {
		case 'VSignal':
			return _gicentre$elm_vega$Vega$signalReferenceProperty(_p36._0);
		case 'VColor':
			return _gicentre$elm_vega$Vega$colorProperty(_p36._0);
		case 'VField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _gicentre$elm_vega$Vega$fieldValueSpec(_p36._0)
			};
		case 'VScale':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$valRef = function (vs) {
	var _p37 = vs;
	if (((_p37.ctor === '::') && (_p37._0.ctor === 'VIfElse')) && (_p37._1.ctor === '[]')) {
		return _elm_lang$core$Json_Encode$list(
			{
				ctor: '::',
				_0: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'test',
							_1: _elm_lang$core$Json_Encode$string(_p37._0._0)
						},
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p37._0._1)
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p37._0._2)),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _gicentre$elm_vega$Vega$bindingProperty = function (bnd) {
	...
	switch (_p38.ctor) {
		case 'IRange':
			return A2(bSpec, 'range', _p38._0);
		case 'ICheckbox':
			return A2(bSpec, 'checkbox', _p38._0);
		case 'IRadio':
			return A2(bSpec, 'radio', _p38._0);
		case 'ISelect':
			return A2(bSpec, 'select', _p38._0);
		case 'IText':
			return A2(bSpec, 'text', _p38._0);
		case 'INumber':
			return A2(bSpec, 'number', _p38._0);
		case 'IDate':
			return A2(bSpec, 'date', _p38._0);
		case 'ITime':
			return A2(bSpec, 'time', _p38._0);
		case 'IMonth':
			return A2(bSpec, 'month', _p38._0);
		case 'IWeek':
			return A2(bSpec, 'week', _p38._0);
		case 'IDateTimeLocal':
			return A2(bSpec, 'datetimelocal', _p38._0);
		case 'ITel':
			return A2(bSpec, 'tel', _p38._0);
		default:
			return A2(bSpec, 'color', _p38._0);
	}
};
var _gicentre$elm_vega$Vega$signalProperty = function (sigProp) {
	...
	switch (_p39.ctor) {
		...
		case 'SiBind':
			return _gicentre$elm_vega$Vega$bindingProperty(_p39._0);
		case 'SiDescription':
			return {
				ctor: '_Tuple2',
				_0: 'description',
		...
		case 'SiOn':
			return {
				...
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$eventHandlerSpec, _p39._0))
			};
		case 'SiReact':
			return {
				ctor: '_Tuple2',
		...
		case 'SiValue':
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _gicentre$elm_vega$Vega$dataValue(_p39._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _gicentre$elm_vega$Vega$dataValues(_p39._0)
			};
	}
};
	...
	switch (_p40.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$sideLabel(_p40._0))
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$overlapStrategyLabel(_p40._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p45) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$Vega$vPropertyLabel(_p46._0),
						_1: _p46._1
					};
				},
				spec)
	...
	switch (_p49.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _gicentre$elm_vega$Vega$valRef(_p49._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		case 'MStrokeJoin':
			return {
				...
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$strokeJoinLabel(_p49._0))
			};
	...
	switch (_p50.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p50._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p50._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p50._1))
			};
	}
};
			...
			A2(
				...
				function (_p56) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p57._0,
						_1: _gicentre$elm_vega$Vega$dataValue(_p57._1)
					};
				},
				row)));
};
	...
	if (_p60.ctor === 'FieldName') {
		...
		return _gicentre$elm_vega$Vega$signalStrSpec(
			_gicentre$elm_vega$Vega$SigStrRef(
				_gicentre$elm_vega$Vega$SName(_p60._0)));
	}
};
...
var _gicentre$elm_vega$Vega$comparatorProperty = function (comp) {
	...
	if (_p62.ctor === 'CoField') {
		...
		return {
			...
			_0: 'order',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$orderSpec, _p62._0))
		};
	}
};
	...
	switch (_p63.ctor) {
		...
		case 'PaSize':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$signalNumSpec(_p63._0),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$signalNumSpec(_p63._1),
							_1: {ctor: '[]'}
						}
					})
			};
		...
		case 'PaPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _gicentre$elm_vega$Vega$signalNumSpec(_p63._0)
			};
		default:
			return {
				ctor: '_Tuple2',
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Vega$markLabel(_p65._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
		...
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p65._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$sourceProperty(_p65._0),
							_1: {ctor: '[]'}
						})
				},
				_1: {ctor: '[]'}
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$comparatorProperty, _p65._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
		...
		default:
			return A2(
				...
				function (_p66) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$Vega$vPropertyLabel(_p67._0),
						_1: _p67._1
					};
				},
				_p65._0);
	...
	switch (_p69.ctor) {
		...
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _gicentre$elm_vega$Vega$stackOffsetSpec(_p69._0)
			};
		default:
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$stackProperty, _p70._0)
				});
		case 'TForce':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'parentKey',
								_1: _gicentre$elm_vega$Vega$fieldSpec(_p70._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$packProperty, _p70._0)
				});
		case 'TPartition':
			return _elm_lang$core$Json_Encode$object(
				{
	...
	switch (_p71.ctor) {
		...
		case 'DReferences':
			return {
				...
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p71._0))
			};
		default:
			var _p72 = _p71._0;
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sortProperty, _p72))
			};
	}
};
var _gicentre$elm_vega$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p73.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p73._0));
	}
};
	...
	switch (_p74.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$scaleLabel(_p74._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$Vega$scaleDomainSpec(_p74._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
			...
			switch (_p75.ctor) {
				...
				case 'RSignal':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p75._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SScheme(_p75._0),
									_1: _p75._1
								}))
					};
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$dataRefProperty(_p75._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
				...
				default:
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$Vega$rangeDefaultLabel(_p75._0))
					};
			}
		case 'SPadding':
			return {
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$Vega$interpolateSpec(_p74._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$Vega$niceSpec(_p74._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$TFormula = {ctor: 'TFormula'};
var _gicentre$elm_vega$Vega$TFold = {ctor: 'TFold'};
var _gicentre$elm_vega$Vega$TFilter = {ctor: 'TFilter'};
var _gicentre$elm_vega$Vega$TExtent = {ctor: 'TExtent'};
...
var _gicentre$elm_vega$Vega$TAggregate = {ctor: 'TAggregate'};
...
var _gicentre$elm_vega$Gallery$stackExample = function () {
	var mk = function (_p0) {
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Rect,
				{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						_gicentre$elm_vega$Vega$SData('table')),
					_1: {
						ctor: '::',
										...
										_0: _gicentre$elm_vega$Vega$MFill(
											{
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$VField(
														_gicentre$elm_vega$Vega$FName('key')),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
			...
			A3(
				...
				'offset',
				{
					...
					_0: _gicentre$elm_vega$Vega$SiValue(
						_gicentre$elm_vega$Vega$Str('zero')),
					_1: {
						ctor: '::',
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$SiValue(_gicentre$elm_vega$Vega$Null),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SiBind(
					...
					A3(
						...
						'sortOrder',
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SiValue(
								_gicentre$elm_vega$Vega$Str('ascending')),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SiBind(
									_gicentre$elm_vega$Vega$IRadio(
									...
									_0: _gicentre$elm_vega$Vega$SiOn(
										{
											...
											_0: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$EEvents('mousedown![!event.shiftKey]'),
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$EUpdate('{key: invert(\'xscale\', x()), value: ~~(1 + 9 * random())}'),
													_1: {ctor: '[]'}
												}
											},
											_1: {ctor: '[]'}
										...
										_0: _gicentre$elm_vega$Vega$SiOn(
											{
												...
												_0: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$EEvents('rect:mousedown![event.shiftKey]'),
													_1: {
														ctor: '::',
			...
			_0: A2(
				_gicentre$elm_vega$Vega$on,
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$TrInsert('add'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$TrRemove('rem'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
						...
						_0: _gicentre$elm_vega$Vega$TStack(
							{
								...
								_0: _gicentre$elm_vega$Vega$StField(
									_gicentre$elm_vega$Vega$FieldName('value')),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$StGroupBy(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$FieldName('key'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$StOffset(
											_gicentre$elm_vega$Vega$OffsetSignal('offset')),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$StSort(
												{
													...
													_0: _gicentre$elm_vega$Vega$CoField(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$FieldSignal('sortField'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$CoOrder(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$OrderSignal('sortOrder'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
...
var _gicentre$elm_vega$Gallery$packExample = function () {
	var mk = function (_p4) {
		return _gicentre$elm_vega$Vega$marks(
			A3(
				_gicentre$elm_vega$Vega$mark,
				_gicentre$elm_vega$Vega$Symbol,
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$MFrom(
						_gicentre$elm_vega$Vega$SData('tree')),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$MEncode(
							{
													...
													_0: _gicentre$elm_vega$Vega$MSize(
														{
															...
															_0: _gicentre$elm_vega$Vega$VSignal(
																_gicentre$elm_vega$Vega$SExpr('4*datum.r*datum.r')),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					ctor: '::',
					_0: A2(
						_gicentre$elm_vega$Vega$TStratify,
						_gicentre$elm_vega$Vega$FieldName('id'),
						_gicentre$elm_vega$Vega$FieldName('parent')),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$TPack(
							{
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$PaPadding(
										_gicentre$elm_vega$Vega$SigNumRef(
											_gicentre$elm_vega$Vega$SName('padding between circles'))),
									_1: {
										ctor: '::',
										_0: A2(_gicentre$elm_vega$Vega$PaSize, _gicentre$elm_vega$Vega$sigWidth, _gicentre$elm_vega$Vega$sigHeight),
										_1: {ctor: '[]'}
									}
								}
							}),
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Rect,
				{
					...
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$MFrom(
							_gicentre$elm_vega$Vega$SData('facet')),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$MEncode(
								{
				...
				A3(
					...
					_gicentre$elm_vega$Vega$Text,
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$MFrom(
							_gicentre$elm_vega$Vega$SData('bars')),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$MEncode(
								{
...
var _gicentre$elm_vega$Gallery$sourceExample = _gicentre$elm_vega$Gallery$barChart3;
...
var _gicentre$elm_vega$Gallery$mySpecs = _gicentre$elm_vega$Vega$combineSpecs(
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'packExample', _1: _gicentre$elm_vega$Gallery$packExample},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'stackExample', _1: _gicentre$elm_vega$Gallery$stackExample},
						_1: {ctor: '[]'}
					}
				}
			}
