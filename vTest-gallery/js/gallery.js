		...
		default:
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$float(_p5._0),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$float(_p5._1),
							_1: {ctor: '[]'}
						}
					})
			};
...
var _gicentre$elm_vega$Vega$paddingSpec = function (pad) {
	var _p8 = pad;
	if (_p8.ctor === 'PSize') {
		return _elm_lang$core$Json_Encode$float(_p8._0);
	} else {
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'top',
						_1: _elm_lang$core$Json_Encode$float(_p8._1)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'right',
							_1: _elm_lang$core$Json_Encode$float(_p8._2)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bottom',
								_1: _elm_lang$core$Json_Encode$float(_p8._3)
							},
							_1: {ctor: '[]'}
						}
					}
	...
	switch (_p11.ctor) {
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _gicentre$elm_vega$Vega$opSpec(_p11._0)
			};
	}
};
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$Vega$timeUnitLabel(_p12._0))
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'step',
							_1: _elm_lang$core$Json_Encode$int(_p12._1)
						},
						_1: {ctor: '[]'}
					}
				});
		case 'IsNice':
			return _elm_lang$core$Json_Encode$bool(_p12._0);
		default:
...
var _gicentre$elm_vega$Vega$foDataTypeSpec = function (dType) {
	...
	switch (_p16.ctor) {
		...
		case 'FoDate':
			var _p17 = _p16._0;
			return _elm_lang$core$Native_Utils.eq(_p17, '') ? _elm_lang$core$Json_Encode$string('date') : _elm_lang$core$Json_Encode$string(
				A2(
		...
		default:
			var _p18 = _p16._0;
			return _elm_lang$core$Native_Utils.eq(_p18, '') ? _elm_lang$core$Json_Encode$string('utc') : _elm_lang$core$Json_Encode$string(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'utc:\'',
						...
						A2(
							...
							function (_p20) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p21._0,
									_1: _gicentre$elm_vega$Vega$foDataTypeSpec(_p21._1)
								};
							},
							_p19._0))
				},
...
var _gicentre$elm_vega$Vega$sourceProperty = function (src) {
	...
	if (_p23.ctor === 'SData') {
		...
		return {
			...
			_0: 'facet',
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$facetProperty, _p23._0))
		};
	}
};
...
var _gicentre$elm_vega$Vega$signalReferenceProperty = function (signal) {
	var _p24 = signal;
	if (_p24.ctor === 'SName') {
		return {
			ctor: '_Tuple2',
		...
		return {
			ctor: '_Tuple2',
			_0: 'signal',
			_1: _gicentre$elm_vega$Vega$expressionSpec(_p24._0)
		};
	}
};
var _gicentre$elm_vega$Vega$fieldValueSpec = function (fVal) {
	...
	switch (_p25.ctor) {
		case 'FName':
			return _elm_lang$core$Json_Encode$string(_p25._0);
		case 'FSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'datum',
						_1: _gicentre$elm_vega$Vega$fieldValueSpec(_p25._0)
					},
					_1: {ctor: '[]'}
				});
		case 'FGroup':
...
var _gicentre$elm_vega$Vega$signalBoolSpec = function (sigBool) {
	var _p26 = sigBool;
	if (_p26.ctor === 'SigBool') {
		return _elm_lang$core$Json_Encode$bool(_p26._0);
	} else {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
...
var _gicentre$elm_vega$Vega$signalNumSpec = function (sigNum) {
	var _p27 = sigNum;
	if (_p27.ctor === 'SigNum') {
		return _elm_lang$core$Json_Encode$float(_p27._0);
	} else {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
...
var _gicentre$elm_vega$Vega$eventHandlerSpec = function (ehs) {
	var eventHandler = function (eh) {
		...
		switch (_p31.ctor) {
			...
			case 'EUpdate':
				var _p32 = _p31._0;
				return _elm_lang$core$Native_Utils.eq(_p32, '') ? {
					ctor: '_Tuple2',
					_0: 'update',
					_1: _elm_lang$core$Json_Encode$string('{}')
				} : {
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: 'force',
					_1: _elm_lang$core$Json_Encode$bool(_p31._0)
				};
		}
	};
	return _elm_lang$core$Json_Encode$object(
...
var _gicentre$elm_vega$Vega$dataValues = function (vals) {
	var _p33 = vals;
	switch (_p33.ctor) {
		case 'Booleans':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$bool, _p33._0));
		case 'DateTimes':
			return _elm_lang$core$Json_Encode$list(
		...
		default:
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataValues, _p33._0));
	}
};
	...
	switch (_p34.ctor) {
		...
		case 'InOptions':
			return {
				ctor: '_Tuple2',
				_0: 'options',
				_1: _gicentre$elm_vega$Vega$dataValues(_p34._0)
			};
		case 'InPlaceholder':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$dataValue = function (val) {
	...
	switch (_p35.ctor) {
		...
		case 'Boolean':
			return _elm_lang$core$Json_Encode$bool(_p35._0);
		case 'Empty':
			return _elm_lang$core$Json_Encode$object(
				{ctor: '[]'});
		default:
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'g',
								_1: _elm_lang$core$Json_Encode$float(_p36._1)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'b',
									_1: _elm_lang$core$Json_Encode$float(_p36._2)
								},
								_1: {ctor: '[]'}
							}
						}
	...
	switch (_p37.ctor) {
		...
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$colorProperty(_p37._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _gicentre$elm_vega$Vega$fieldValueSpec(_p37._0);
		case 'VScale':
			return _gicentre$elm_vega$Vega$fieldValueSpec(_p37._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'VExponent':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$valueProperty(_p37._0),
					_1: {ctor: '[]'}
				});
		case 'VMultiply':
			return _elm_lang$core$Json_Encode$object(
		...
		case 'VObject':
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p37._0));
		case 'VString':
			return _elm_lang$core$Json_Encode$string(_p37._0);
		case 'VBool':
			return _elm_lang$core$Json_Encode$bool(_p37._0);
		case 'VNull':
			return _elm_lang$core$Json_Encode$null;
		default:
			return _elm_lang$core$Json_Encode$null;
...
var _gicentre$elm_vega$Vega$valueProperty = function (val) {
	var evaluate = function (val) {
		var _p38 = val;
		if (_p38.ctor === 'VNumber') {
			return _elm_lang$core$Json_Encode$float(_p38._0);
		} else {
			return _gicentre$elm_vega$Vega$valueSpec(val);
		}
	};
	var _p39 = val;
	switch (_p39.ctor) {
		case 'VSignal':
			return _gicentre$elm_vega$Vega$signalReferenceProperty(_p39._0);
		case 'VColor':
			return _gicentre$elm_vega$Vega$colorProperty(_p39._0);
		case 'VField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _gicentre$elm_vega$Vega$fieldValueSpec(_p39._0)
			};
		case 'VScale':
			return {
				ctor: '_Tuple2',
		...
		case 'VObject':
			return {
				...
				_0: 'value',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p39._0))
			};
		case 'VString':
			return {
				ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									...
									_0: 'if',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p39._1))
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_0: 'else',
										_1: _elm_lang$core$Json_Encode$object(
											A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p39._2))
									},
									_1: {ctor: '[]'}
								}
							}
	...
	switch (_p40.ctor) {
		case 'DFormat':
			return {
				...
				_0: 'format',
				_1: _elm_lang$core$Json_Encode$object(
					_gicentre$elm_vega$Vega$formatProperty(_p40._0))
			};
		case 'DSource':
			return {
				ctor: '_Tuple2',
		...
		case 'DOn':
			return {
				ctor: '_Tuple2',
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(_p40._0)
			};
		case 'DUrl':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'values',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p40._0)
			};
	}
};
var _gicentre$elm_vega$Vega$valRef = function (vs) {
	var _p41 = vs;
	if (((_p41.ctor === '::') && (_p41._0.ctor === 'VIfElse')) && (_p41._1.ctor === '[]')) {
		return _elm_lang$core$Json_Encode$list(
			{
				ctor: '::',
				_0: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'test',
							_1: _elm_lang$core$Json_Encode$string(_p41._0._0)
						},
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p41._0._1)
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueProperty, _p41._0._2)),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _gicentre$elm_vega$Vega$bindingProperty = function (bnd) {
	...
	switch (_p42.ctor) {
		case 'IRange':
			return A2(bSpec, 'range', _p42._0);
		case 'ICheckbox':
			return A2(bSpec, 'checkbox', _p42._0);
		case 'IRadio':
			return A2(bSpec, 'radio', _p42._0);
		case 'ISelect':
			return A2(bSpec, 'select', _p42._0);
		case 'IText':
			return A2(bSpec, 'text', _p42._0);
		case 'INumber':
			return A2(bSpec, 'number', _p42._0);
		case 'IDate':
			return A2(bSpec, 'date', _p42._0);
		case 'ITime':
			return A2(bSpec, 'time', _p42._0);
		case 'IMonth':
			return A2(bSpec, 'month', _p42._0);
		case 'IWeek':
			return A2(bSpec, 'week', _p42._0);
		case 'IDateTimeLocal':
			return A2(bSpec, 'datetimelocal', _p42._0);
		case 'ITel':
			return A2(bSpec, 'tel', _p42._0);
		default:
			return A2(bSpec, 'color', _p42._0);
	}
};
var _gicentre$elm_vega$Vega$signalProperty = function (sigProp) {
	...
	switch (_p43.ctor) {
		...
		case 'SiBind':
			return _gicentre$elm_vega$Vega$bindingProperty(_p43._0);
		case 'SiDescription':
			return {
				ctor: '_Tuple2',
				_0: 'description',
		...
		case 'SiUpdate':
			return {
				ctor: '_Tuple2',
				_0: 'update',
				_1: _gicentre$elm_vega$Vega$expressionSpec(_p43._0)
			};
		case 'SiOn':
			return {
				ctor: '_Tuple2',
				_0: 'on',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$eventHandlerSpec, _p43._0))
			};
		case 'SiReact':
			return {
				ctor: '_Tuple2',
		...
		case 'SiValue':
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _gicentre$elm_vega$Vega$dataValue(_p43._0)
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'value',
				_1: _gicentre$elm_vega$Vega$dataValues(_p43._0)
			};
	}
};
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p47) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$Vega$vPropertyLabel(_p48._0),
						_1: _p48._1
					};
				},
				spec)
	...
	switch (_p51.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _gicentre$elm_vega$Vega$valRef(_p51._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		case 'MStrokeJoin':
			return {
				...
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$strokeJoinLabel(_p51._0))
			};
	...
	switch (_p52.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p52._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p52._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p52._1))
			};
	}
};
	...
	switch (_p53.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$sideLabel(_p53._0))
			};
		case 'AxFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'AxEncode':
			var enc = function (_p54) {
				...
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$Vega$axisElementLabel(_p55._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p55._1))
				};
			};
			return {
				ctor: '_Tuple2',
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, enc, _p53._0))
			};
		case 'AxGrid':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$overlapStrategyLabel(_p53._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'AxValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p53._0))
			};
		default:
			return {
				ctor: '_Tuple2',
			...
			A2(
				...
				function (_p63) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p64._0,
						_1: _gicentre$elm_vega$Vega$dataValue(_p64._1)
					};
				},
				row)));
};
					...
					A2(
						...
						function (dv) {
							return {
								ctor: '_Tuple2',
								_0: colName,
								_1: _gicentre$elm_vega$Vega$dataValues(dv)
							};
						},
						_p65._0));
		}
...
var _gicentre$elm_vega$Vega$Null = {ctor: 'Null'};
...
var _gicentre$elm_vega$Vega$DataValues = function (a) {
...
var _gicentre$elm_vega$Vega$FieldSignal = function (a) {
	return {ctor: 'FieldSignal', _0: a};
};
var _gicentre$elm_vega$Vega$FieldName = function (a) {
...
var _gicentre$elm_vega$Vega$DData = function (a) {
...
var _gicentre$elm_vega$Vega$SExpr = function (a) {
	return {ctor: 'SExpr', _0: a};
};
var _gicentre$elm_vega$Vega$SName = function (a) {
	return {ctor: 'SName', _0: a};
};
var _gicentre$elm_vega$Vega$sigHeight = _gicentre$elm_vega$Vega$SigNumRef(
	_gicentre$elm_vega$Vega$SName('height'));
var _gicentre$elm_vega$Vega$sigPadding = _gicentre$elm_vega$Vega$SigNumRef(
	_gicentre$elm_vega$Vega$SName('padding'));
var _gicentre$elm_vega$Vega$sigWidth = _gicentre$elm_vega$Vega$SigNumRef(
	_gicentre$elm_vega$Vega$SName('width'));
var _gicentre$elm_vega$Vega$fieldSpec = function (f) {
	var _p67 = f;
	if (_p67.ctor === 'FieldName') {
		return _elm_lang$core$Json_Encode$string(_p67._0);
	} else {
		return _gicentre$elm_vega$Vega$signalStrSpec(
			_gicentre$elm_vega$Vega$SigStrRef(
				_gicentre$elm_vega$Vega$SName(_p67._0)));
	}
};
	...
	switch (_p69.ctor) {
		...
		case 'PiStartAngle':
			return {
				ctor: '_Tuple2',
				_0: 'startAngle',
				_1: _gicentre$elm_vega$Vega$signalNumSpec(_p69._0)
			};
		case 'PiEndAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'PiSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _gicentre$elm_vega$Vega$signalBoolSpec(_p69._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$orderSpec = function (order) {
	...
	switch (_p70.ctor) {
		...
		default:
			return _gicentre$elm_vega$Vega$signalStrSpec(
				_gicentre$elm_vega$Vega$SigStrRef(
					_gicentre$elm_vega$Vega$SName(_p70._0)));
	}
};
var _gicentre$elm_vega$Vega$comparatorProperty = function (comp) {
	var _p71 = comp;
	if (_p71.ctor === 'CoField') {
		return {
			ctor: '_Tuple2',
			_0: 'field',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p71._0))
		};
	} else {
		return {
			ctor: '_Tuple2',
			_0: 'order',
			_1: _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$orderSpec, _p71._0))
		};
	}
};
	...
	switch (_p72.ctor) {
		case 'PaField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _gicentre$elm_vega$Vega$fieldSpec(_p72._0)
			};
		case 'PaSort':
			return {
				ctor: '_Tuple2',
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$comparatorProperty, _p72._0))
			};
		case 'PaSize':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$signalNumSpec(_p72._0),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$signalNumSpec(_p72._1),
							_1: {ctor: '[]'}
						}
					})
			};
		case 'PaRadius':
			...
			if (_p73.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: 'radius',
					_1: _gicentre$elm_vega$Vega$fieldSpec(_p73._0)
				};
			} else {
		...
		case 'PaPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _gicentre$elm_vega$Vega$signalNumSpec(_p72._0)
			};
		default:
			return {
				ctor: '_Tuple2',
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Vega$markLabel(_p74._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
		...
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sourceProperty, _p74._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
		...
		case 'MOn':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'on',
					_1: _elm_lang$core$Json_Encode$list(_p74._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MRole':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$comparatorProperty, _p74._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
...
var _gicentre$elm_vega$Vega$stackOffsetSpec = function (off) {
	...
	switch (_p77.ctor) {
		...
		default:
			return _gicentre$elm_vega$Vega$signalStrSpec(
				_gicentre$elm_vega$Vega$SigStrRef(
					_gicentre$elm_vega$Vega$SName(_p77._0)));
	}
};
	...
	switch (_p78.ctor) {
		...
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _gicentre$elm_vega$Vega$stackOffsetSpec(_p78._0)
			};
		default:
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$aggregateProperty, _p79._0)
				});
		case 'TBin':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'signal',
								_1: _elm_lang$core$Json_Encode$string(_p79._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$exprProperty(_p79._0),
						_1: {ctor: '[]'}
					}
				});
		case 'TFold':
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'expr',
							_1: _gicentre$elm_vega$Vega$expressionSpec(_p79._0)
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'initonly',
									_1: _gicentre$elm_vega$Vega$formulaUpdateSpec(_p79._2)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$pieProperty, _p79._0)
				});
		case 'TStack':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$stackProperty, _p79._0)
				});
		case 'TForce':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'parentKey',
								_1: _gicentre$elm_vega$Vega$fieldSpec(_p79._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$packProperty, _p79._0)
				});
		case 'TPartition':
			return _elm_lang$core$Json_Encode$object(
				{
...
var _gicentre$elm_vega$Vega$SiValues = function (a) {
	...
	switch (_p80.ctor) {
		...
		case 'DFields':
			return {
				...
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p80._0))
			};
		case 'DReferences':
			return {
				ctor: '_Tuple2',
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p80._0))
			};
		default:
			var _p81 = _p80._0;
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sortProperty, _p81))
			};
	}
};
	...
	switch (_p82.ctor) {
		...
		case 'DSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p82._0),
					_1: {ctor: '[]'}
				});
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p82._0));
	}
};
	...
	switch (_p83.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$scaleLabel(_p83._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$Vega$scaleDomainSpec(_p83._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
			...
			switch (_p84.ctor) {
					...
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SScheme(_p84._0),
									_1: _p84._1
								}))
					};
				case 'RData':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$dataRefProperty(_p84._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RStep':
				...
				default:
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$Vega$rangeDefaultLabel(_p84._0))
					};
			}
		case 'SPadding':
			return {
		...
		case 'SPaddingInner':
			return {
				ctor: '_Tuple2',
				_0: 'paddingInner',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p83._0)
			};
		case 'SPaddingOuter':
			return {
				ctor: '_Tuple2',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$Vega$interpolateSpec(_p83._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$Vega$niceSpec(_p83._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$scaleProperty, sProps)
				}));
	});
var _gicentre$elm_vega$Vega$SFacet = function (a) {
...
var _gicentre$elm_vega$Vega$VString = function (a) {
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Arc,
				{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SData('table'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
														...
														_1: {
															...
															_1: {
																...
																_0: _gicentre$elm_vega$Vega$MStroke(
																	{
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$VString('#fff'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
									...
									_0: _gicentre$elm_vega$Vega$Update(
										{
											...
											_0: _gicentre$elm_vega$Vega$MFill(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$VString('#ccc'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
										...
										_0: _gicentre$elm_vega$Vega$Hover(
											{
												...
												_0: _gicentre$elm_vega$Vega$MFill(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$VString('pink'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
														...
														_0: _gicentre$elm_vega$Vega$MTheta(
															{
																...
																_0: _gicentre$elm_vega$Vega$VSignal(
																	_gicentre$elm_vega$Vega$SExpr('(datum.startAngle + datum.endAngle)/2')),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$MFill(
																{
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$VString('#000'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$MAlign(
																	{
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$VString(
				...
				'rScale',
				{
					...
					_1: {
						...
						_0: _gicentre$elm_vega$Vega$SDomain(
							_gicentre$elm_vega$Vega$DData(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$DDataset('table'),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$DField('data'),
										_1: {ctor: '[]'}
									}
								})),
						_1: {
					...
					_0: _gicentre$elm_vega$Vega$TPie(
						{
							...
							_0: _gicentre$elm_vega$Vega$PiField(
								_gicentre$elm_vega$Vega$FieldName('data')),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
											...
											_0: _gicentre$elm_vega$Vega$MX(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$VSignal(
														_gicentre$elm_vega$Vega$SExpr('width / 2')),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$MY(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$VSignal(
															_gicentre$elm_vega$Vega$SExpr('height / 2')),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
													...
													_0: _gicentre$elm_vega$Vega$MPadAngle(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$VSignal(
																_gicentre$elm_vega$Vega$SExpr('PI * padAngle / 180')),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$MInnerRadius(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$VSignal(
																	_gicentre$elm_vega$Vega$SName('innerRadius')),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
																...
																_0: _gicentre$elm_vega$Vega$MCornerRadius(
																	{
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$VSignal(
																			_gicentre$elm_vega$Vega$SName('cornerRadius')),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
			...
			A3(
				...
				'startAngle',
				{
					...
					_0: _gicentre$elm_vega$Vega$SiValue(
						_gicentre$elm_vega$Vega$Number(0)),
					_1: {
						ctor: '::',
				...
				A3(
					...
					'endAngle',
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$SiValue(
							_gicentre$elm_vega$Vega$Number(360)),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SiBind(
								_gicentre$elm_vega$Vega$IRange(
					...
					_0: _gicentre$elm_vega$Vega$TPie(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$PiField(
								_gicentre$elm_vega$Vega$FieldName('field')),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$PiStartAngle(
									_gicentre$elm_vega$Vega$SigNumRef(
										_gicentre$elm_vega$Vega$SExpr('PI * startAngle / 180'))),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$PiEndAngle(
										_gicentre$elm_vega$Vega$SigNumRef(
											_gicentre$elm_vega$Vega$SExpr('PI * endAngle / 180'))),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$PiSort(
											_gicentre$elm_vega$Vega$SigBoolRef(
												_gicentre$elm_vega$Vega$SName('sort'))),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _gicentre$elm_vega$Gallery$sourceExample = _gicentre$elm_vega$Gallery$circularChart1;
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Area,
				{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SData('facet'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Group,
				{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SData('series'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SFacet(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$FaData('jobs'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$FaName('facet'),
											_1: {
												ctor: '::',
														...
														_0: _gicentre$elm_vega$Vega$MY(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$VSignal(
																	_gicentre$elm_vega$Vega$SExpr('scale(\'yScale\', 0.5 * (datum.argmax.y0 + datum.argmax.y1))')),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
	...
	var ax = function (_p8) {
		return _gicentre$elm_vega$Vega$axes(
			A4(
				...
				'xScale',
				_gicentre$elm_vega$Vega$Bottom,
				{
					ctor: '::',
										...
										_gicentre$elm_vega$Vega$DData(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$DField('year'),
													_1: {ctor: '[]'}
												}
											})),
									_1: {ctor: '[]'}
											...
											_gicentre$elm_vega$Vega$DData(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$DField('y1'),
														_1: {ctor: '[]'}
													}
												})),
										_1: {ctor: '[]'}
					...
					A3(
						...
						'cScale',
						{
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SDomain(
									_gicentre$elm_vega$Vega$DStrings(
										{
											ctor: '::',
											_0: 'men',
											_1: {
											...
											_gicentre$elm_vega$Vega$DData(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$DField('sum'),
														_1: {ctor: '[]'}
													}
												})),
										_1: {
														...
														_gicentre$elm_vega$Vega$DData(
															{
																...
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$DField('argmax.perc'),
																	_1: {ctor: '[]'}
																}
															})),
													_1: {ctor: '[]'}
		...
		return _gicentre$elm_vega$Vega$signals(
			A3(
				...
				'sex',
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$SiValue(
						_gicentre$elm_vega$Vega$Str('all')),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$SiBind(
			...
			_0: _gicentre$elm_vega$Vega$TAggregate(
				{
					...
					_0: _gicentre$elm_vega$Vega$AgGroupBy(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$FieldName('job'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$FieldName('sex'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: _gicentre$elm_vega$Vega$AgFields(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$FieldName('perc'),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$FieldName('perc'),
									_1: {ctor: '[]'}
				...
				_0: _gicentre$elm_vega$Vega$TStack(
					{
						...
						_0: _gicentre$elm_vega$Vega$StGroupBy(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$FieldName('year'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: _gicentre$elm_vega$Vega$StField(
									_gicentre$elm_vega$Vega$FieldName('perc')),
								_1: {ctor: '[]'}
							}
						}
					}),
										...
										_1: {
											...
											_1: {
												...
												_0: _gicentre$elm_vega$Vega$MFill(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$VString('steelblue'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
													...
													_0: _gicentre$elm_vega$Vega$MFillOpacity(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$VSignal(
																_gicentre$elm_vega$Vega$SName('opacity')),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Group,
				{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SData('layer_indices'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
										...
										_gicentre$elm_vega$Vega$DData(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$DField('x'),
													_1: {ctor: '[]'}
												}
											})),
									_1: {ctor: '[]'}
						...
						_1: {
								...
								_gicentre$elm_vega$Vega$RValues(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$VSignal(
											_gicentre$elm_vega$Vega$SName('vheight')),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$VNumber(0),
											_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: _gicentre$elm_vega$Vega$SNice(
									_gicentre$elm_vega$Vega$IsNice(true)),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SZero(true),
									_1: {
											...
											_gicentre$elm_vega$Vega$DData(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$DField('y'),
														_1: {ctor: '[]'}
													}
												})),
										_1: {ctor: '[]'}
		...
		return _gicentre$elm_vega$Vega$signals(
			A3(
				...
				'layers',
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$SiValue(
						_gicentre$elm_vega$Vega$Number(2)),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$SiOn(
							{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						{
							...
							_0: _gicentre$elm_vega$Vega$SFacet(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$FaData('table'),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$FaName('series'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$FaGroupBy(
												{
										...
										_gicentre$elm_vega$Vega$DData(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$DField('c'),
													_1: {ctor: '[]'}
												}
											})),
									_1: {ctor: '[]'}
					...
					_0: _gicentre$elm_vega$Vega$TStack(
						{
							...
							_0: _gicentre$elm_vega$Vega$StGroupBy(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$FieldName('x'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$StSort(
									{
										...
										_0: _gicentre$elm_vega$Vega$CoField(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$FieldName('c'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$StField(
										_gicentre$elm_vega$Vega$FieldName('y')),
									_1: {ctor: '[]'}
								}
							}
						}),
											...
											_0: _gicentre$elm_vega$Vega$MInterpolate(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$VSignal(
														_gicentre$elm_vega$Vega$SName('interpolate')),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
									...
									_gicentre$elm_vega$Vega$DData(
										{
											...
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$DField('u'),
												_1: {ctor: '[]'}
											}
										})),
								_1: {ctor: '[]'}
											...
											_gicentre$elm_vega$Vega$DData(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$DField('v'),
														_1: {ctor: '[]'}
													}
												})),
										_1: {ctor: '[]'}
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Rect,
				{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SData('faceted_tuples'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
										...
										_0: _gicentre$elm_vega$Vega$Hover(
											{
												...
												_0: _gicentre$elm_vega$Vega$MStroke(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$VString('firebrick'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
				...
				'yScale',
				{
					...
					_1: {
						...
						_0: _gicentre$elm_vega$Vega$SPaddingInner(
							_gicentre$elm_vega$Vega$VSignal(
								_gicentre$elm_vega$Vega$SName('innerPadding'))),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SPaddingOuter(
								_gicentre$elm_vega$Vega$VSignal(
									_gicentre$elm_vega$Vega$SName('outerPadding'))),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SRound(true),
								_1: {
										...
										_gicentre$elm_vega$Vega$DData(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$DField('b'),
													_1: {ctor: '[]'}
												}
											})),
									_1: {
										...
										_0: _gicentre$elm_vega$Vega$SRange(
											_gicentre$elm_vega$Vega$RStep(
												_gicentre$elm_vega$Vega$VSignal(
													_gicentre$elm_vega$Vega$SName('rangeStep')))),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			A3(
				...
				_gicentre$elm_vega$Vega$Group,
				{
					...
					_0: _gicentre$elm_vega$Vega$MFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SData('trellis'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SFacet(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$FaName('faceted_tuples'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$FaData('tuples'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$FaGroupBy(
													{
									...
									_gicentre$elm_vega$Vega$DData(
										{
											...
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$DField('a'),
												_1: {ctor: '[]'}
											}
										})),
								_1: {ctor: '[]'}
		...
		return _gicentre$elm_vega$Vega$signals(
			A3(
				...
				'rangeStep',
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$SiValue(
						_gicentre$elm_vega$Vega$Number(20)),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$SiBind(
							_gicentre$elm_vega$Vega$IRange(
				...
				A3(
					...
					'innerPadding',
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$SiValue(
							_gicentre$elm_vega$Vega$Number(0.1)),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SiBind(
								_gicentre$elm_vega$Vega$IRange(
					...
					A3(
						...
						'outerPadding',
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$SiValue(
								_gicentre$elm_vega$Vega$Number(0.2)),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SiBind(
									_gicentre$elm_vega$Vega$IRange(
			...
			_0: _gicentre$elm_vega$Vega$TAggregate(
				{
					...
					_0: _gicentre$elm_vega$Vega$AgGroupBy(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$FieldName('a'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
					...
					_0: _gicentre$elm_vega$Vega$TStack(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$StField(
								_gicentre$elm_vega$Vega$FieldName('span')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_gicentre$elm_vega$Vega$TExtentAsSignal,
							_gicentre$elm_vega$Vega$FieldName('y1'),
							'trellisExtent'),
						_1: {ctor: '[]'}
					}
				}
					...
					_0: _gicentre$elm_vega$Vega$AgGroupBy(
						{
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$FieldName('b'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
				...
				A3(
					...
					_gicentre$elm_vega$Vega$Text,
					{
						...
						_0: _gicentre$elm_vega$Vega$MFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SData('bars'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$MFill(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$VString('white'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
								...
								_gicentre$elm_vega$Vega$DData(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$DField('position'),
											_1: {ctor: '[]'}
										}
									})),
							_1: {ctor: '[]'}
							...
							_gicentre$elm_vega$Vega$DData(
								{
									...
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$DField('category'),
										_1: {ctor: '[]'}
									}
								})),
						_1: {
								...
								_gicentre$elm_vega$Vega$DData(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$DField('value'),
											_1: {ctor: '[]'}
										}
									})),
							_1: {
										...
										_0: _gicentre$elm_vega$Vega$Hover(
											{
												...
												_0: _gicentre$elm_vega$Vega$MFill(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$VString('red'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
										...
										_1: {
											...
											_1: {
												...
												_0: _gicentre$elm_vega$Vega$MFill(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$VString('#333'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
											...
											_0: _gicentre$elm_vega$Vega$MX(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$VSignal(
															_gicentre$elm_vega$Vega$SName('tooltip.category')),
														_1: {
															ctor: '::',
												...
												_0: _gicentre$elm_vega$Vega$MY(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$VSignal(
																_gicentre$elm_vega$Vega$SName('tooltip.amount')),
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$VOffset(
														...
														_0: _gicentre$elm_vega$Vega$MFillOpacity(
															{
																ctor: '::',
																_0: A3(
																	_gicentre$elm_vega$Vega$VIfElse,
																	'datum === tooltip',
																	{
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$VNumber(0),
							...
							_gicentre$elm_vega$Vega$DData(
								{
									...
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$DField('amount'),
										_1: {ctor: '[]'}
									}
								})),
						_1: {
	...
	var si = function (_p56) {
		return _gicentre$elm_vega$Vega$signals(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$SiValue(_gicentre$elm_vega$Vega$Empty),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$SiOn(
							{
...
var _gicentre$elm_vega$Gallery$dv = F2(
	function (label, num) {
		return {
			ctor: '_Tuple2',
			_0: label,
			_1: _gicentre$elm_vega$Vega$Number(num)
		};
	});
				...
				A3(
					...
					_gicentre$elm_vega$Vega$Rect,
					{
						...
						_0: _gicentre$elm_vega$Vega$MFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SData(genderField),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
					...
					_gicentre$elm_vega$Vega$RValues(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$VSignal(
								_gicentre$elm_vega$Vega$SName('chartWidth')),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$VNumber(0),
								_1: {ctor: '[]'}
										...
										_gicentre$elm_vega$Vega$DData(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$DField('people'),
													_1: {ctor: '[]'}
												}
											})),
									_1: {ctor: '[]'}
				...
				_gicentre$elm_vega$Vega$Text,
				{
					...
					_1: {
						...
						_0: _gicentre$elm_vega$Vega$MFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SData('ageGroups'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
											...
											_0: _gicentre$elm_vega$Vega$MX(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$VSignal(
														_gicentre$elm_vega$Vega$SExpr('chartWidth + chartPad / 2')),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
											...
											_0: _gicentre$elm_vega$Vega$MX(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$VSignal(
														_gicentre$elm_vega$Vega$SExpr('chartWidth + chartPad')),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
									...
									_gicentre$elm_vega$Vega$DData(
										{
											...
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$DField('age'),
												_1: {ctor: '[]'}
											}
										})),
								_1: {ctor: '[]'}
		...
		return _gicentre$elm_vega$Vega$signals(
			A3(
				...
				'chartWidth',
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$SiValue(
						_gicentre$elm_vega$Vega$Number(300)),
					_1: {ctor: '[]'}
				},
				A3(
					_gicentre$elm_vega$Vega$signal,
					...
					A3(
						...
						A3(
							...
							'year',
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$SiValue(
									_gicentre$elm_vega$Vega$Number(2000)),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SiBind(
										_gicentre$elm_vega$Vega$IRange(
									...
									_0: _gicentre$elm_vega$Vega$TAggregate(
										{
											...
											_0: _gicentre$elm_vega$Vega$AgGroupBy(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$FieldName('age'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
