...
var _gicentre$elm_vega$GalleryScatter$scatterplot5 = function () {
	var le = function (_p0) {
							...
							_gicentre$elm_vega$Vega$raValues(
								{
									...
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$vSignal('cellHeight'),
										_1: {ctor: '[]'}
									}
								})),
						_1: {
								...
								_1: {
									...
									_0: _gicentre$elm_vega$Vega$scDomain(
										_gicentre$elm_vega$Vega$doData(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$daDataset('barley'),
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$daField(
														_gicentre$elm_vega$Vega$field('variety')),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$daSort(
															{
																...
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$soOp(_gicentre$elm_vega$Vega$Median),
																	_1: {
																		ctor: '::',
					...
					_0: _gicentre$elm_vega$Vega$mFrom(
						{
							...
							_0: _gicentre$elm_vega$Vega$srData(
								_gicentre$elm_vega$Vega$str('sites')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
										...
										_0: _gicentre$elm_vega$Vega$maX(
											{
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$vField(
														_gicentre$elm_vega$Vega$field('yield')),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
									...
									_0: _gicentre$elm_vega$Vega$enEnter(
										{
											...
											_0: _gicentre$elm_vega$Vega$maY(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vScale('gScale'),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$field('site')),
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vOffset(
																_gicentre$elm_vega$Vega$vSignal('offset')),
															_1: {ctor: '[]'}
														}
													}
												}),
						...
						_0: _gicentre$elm_vega$Vega$mFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$srData(
									_gicentre$elm_vega$Vega$str('site')),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$maFontSize(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vNum(11),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
															...
															_0: _gicentre$elm_vega$Vega$maText(
																{
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vField(
																		_gicentre$elm_vega$Vega$field('datum.site')),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
			...
			A3(
				...
				A3(
					...
					A3(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$siUpdate('6 * (offset + cellHeight)'),
							_1: {ctor: '[]'}
						},
						_p7))));
	};
...
var _gicentre$elm_vega$GalleryScatter$sourceExample = _gicentre$elm_vega$GalleryScatter$scatterplot5;
												...
												_0: _gicentre$elm_vega$Vega$maX(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vField(
																_gicentre$elm_vega$Vega$field('mean')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
								...
								_gicentre$elm_vega$Vega$doData(
									{
										...
										_1: {
											...
											_0: _gicentre$elm_vega$Vega$daFields(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$field('stdev0'),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$field('stdev1'),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A2(
					_gicentre$elm_vega$Vega$transform,
					{
						...
						_0: _gicentre$elm_vega$Vega$trAggregate(
							{
								...
								_0: _gicentre$elm_vega$Vega$agGroupBy(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$field('variety'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: A2(_gicentre$elm_vega$Vega$trFormula, 'datum.mean - datum.stdev', 'stdev0'),
							_1: {
								ctor: '::',
								_0: A2(_gicentre$elm_vega$Vega$trFormula, 'datum.mean + datum.stdev', 'stdev1'),
								_1: {
									ctor: '::',
									_0: A2(_gicentre$elm_vega$Vega$trFormula, 'datum.mean - datum.stderr', 'stderr0'),
									_1: {
										ctor: '::',
										_0: A2(_gicentre$elm_vega$Vega$trFormula, 'datum.mean + datum.stderr', 'stderr1'),
										_1: {ctor: '[]'}
									}
								}
							}
											...
											_0: _gicentre$elm_vega$Vega$maX(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$field('miles')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
												...
												_0: _gicentre$elm_vega$Vega$maY(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vField(
																_gicentre$elm_vega$Vega$field('gas')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
												...
												_1: {
													...
													_1: {
														...
														_0: _gicentre$elm_vega$Vega$maDx(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vScale('dx'),
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vField(
																		_gicentre$elm_vega$Vega$field('side')),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {
															...
															_0: _gicentre$elm_vega$Vega$maDy(
																{
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vScale('dy'),
																	_1: {
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$vField(
																			_gicentre$elm_vega$Vega$field('side')),
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: _gicentre$elm_vega$Vega$maBaseline(
																				{
																					ctor: '::',
																					_0: _gicentre$elm_vega$Vega$vScale('baseScale'),
																					_1: {
																						ctor: '::',
																						_0: _gicentre$elm_vega$Vega$vField(
																							_gicentre$elm_vega$Vega$field('side')),
											...
											_0: _gicentre$elm_vega$Vega$maTooltip(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vField(
														_gicentre$elm_vega$Vega$field('tooltip')),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_gicentre$elm_vega$Vega$trFormula, 'datum.Title + \' (\' + (year(datum.Release_Date) || \'?\') + \')\'', 'tooltip'),
					_1: {ctor: '[]'}
				},
				A2(
					_gicentre$elm_vega$Vega$data,
													...
													_0: _gicentre$elm_vega$Vega$maSize(
														{
															...
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vField(
																	_gicentre$elm_vega$Vega$field('Acceleration')),
																_1: {ctor: '[]'}
															}
														}),
													_1: {ctor: '[]'}
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'scatterplot5', _1: _gicentre$elm_vega$GalleryScatter$scatterplot5},
						_1: {ctor: '[]'}
					}
				}
			}
