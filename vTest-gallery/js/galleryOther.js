	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_1: {
						ctor: '::',
						_0: A3(_gicentre$elm_vega$Vega$trFormula, '[-45, 0, 45][~~(random() * 3)]', 'angle', _gicentre$elm_vega$Vega$InitOnly),
						_1: {
							ctor: '::',
							_0: A3(_gicentre$elm_vega$Vega$trFormula, 'if(datum.text==\'VEGA\', 600, 300)', 'weight', _gicentre$elm_vega$Vega$InitOnly),
							_1: {ctor: '[]'}
						}
					}
				},
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_1: {
						ctor: '::',
						_0: A3(_gicentre$elm_vega$Vega$trFormula, 'isNumber(datum.year) ? datum.year : year(datum.Year)', 'Year', _gicentre$elm_vega$Vega$InitOnly),
						_1: {ctor: '[]'}
					}
				},
				A2(
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_1: {
						ctor: '::',
						_0: A3(_gicentre$elm_vega$Vega$trFormula, 'datetime(year(datum.date), month(datum.date), date(datum.date))', 'day', _gicentre$elm_vega$Vega$InitOnly),
						_1: {
							ctor: '::',
							_0: A3(_gicentre$elm_vega$Vega$trFormula, '(datum.temp - 32) / 1.8', 'celsius', _gicentre$elm_vega$Vega$InitOnly),
							_1: {ctor: '[]'}
						}
					}
				},
