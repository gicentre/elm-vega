														...
														_0: _gicentre$elm_vega$Vega$maCursor(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vStr(
																	_gicentre$elm_vega$Vega$cursorLabel(_gicentre$elm_vega$Vega$CEWResize)),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
			...
			_0: A2(
				...
				_gicentre$elm_vega$Vega$AxAll,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$axTickColor('#888'),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$axLabelFont('Monaco, Courier New'),
								_1: {ctor: '[]'}
							}
						}
					}
	...
	var cf = _gicentre$elm_vega$Vega$config(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$axTickColor('#ccc'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
