	...
	switch (_p143.ctor) {
		...
		case 'TAlign':
			return {
				ctor: '_Tuple2',
				_0: 'align',
				_1: _gicentre$elm_vega$Vega$hAlignSpec(_p143._0)
			};
		case 'TAnchor':
			return {
				ctor: '_Tuple2',
			...
			var stepProp = function () {
				...
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'step',
						_1: _gicentre$elm_vega$Vega$numSpec(_p169)
					},
					_1: {ctor: '[]'}
				};
			}();
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Vega$markLabel(_p176._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _gicentre$elm_vega$Vega$clipSpec(_p176._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
		...
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p176._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sourceProperty, _p176._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'interactive',
					_1: _gicentre$elm_vega$Vega$booSpec(_p176._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MKey':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'key',
					_1: _gicentre$elm_vega$Vega$fieldSpec(_p176._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MName':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						_gicentre$elm_vega$Vega$comparatorProperties(_p176._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$transformSpec, _p176._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
		...
		case 'MGroup':
			return A2(
				...
				function (_p177) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$Vega$vPropertyLabel(_p178._0),
						_1: _p178._1
					};
				},
				_p176._0);
		default:
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'zindex',
					_1: _gicentre$elm_vega$Vega$numSpec(_p176._0)
				},
				_1: {ctor: '[]'}
			};
	}
		...
		case 'Proj':
			return A2(
				...
				A2(
					...
					_gicentre$elm_vega$Vega$strString(_p182._0)),
				'');
		default:
			return A2(
				_elm_lang$core$Debug$log,
...
var _gicentre$elm_vega$Vega$projectionSpec = function (proj) {
	...
	switch (_p183.ctor) {
		case 'Proj':
			return _gicentre$elm_vega$Vega$strSpec(_p183._0);
		case 'ProjectionSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p183._0),
					_1: {ctor: '[]'}
				});
		default:
			return _elm_lang$core$Json_Encode$string(
	...
	switch (_p184.ctor) {
		case 'PrType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _gicentre$elm_vega$Vega$projectionSpec(_p184._0)
			};
		case 'PrClipAngle':
			var _p186 = _p184._0;
			var _p185 = _p186;
			if ((_p185.ctor === 'Num') && (_p185._0 === 0)) {
				...
				return {
					ctor: '_Tuple2',
					_0: 'clipAngle',
					_1: _gicentre$elm_vega$Vega$numSpec(_p186)
				};
			}
		case 'PrClipExtent':
			var _p188 = _p184._0;
		...
		case 'PrScale':
			return {
				ctor: '_Tuple2',
				_0: 'scale',
				_1: _gicentre$elm_vega$Vega$numSpec(_p184._0)
			};
		case 'PrTranslate':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'translate', _p184._0);
		case 'PrCenter':
			return {
				ctor: '_Tuple2',
				_0: 'center',
				...
				switch (_p189.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'rotate',
							_1: _gicentre$elm_vega$Vega$numSpec(
								_gicentre$elm_vega$Vega$NumSignal(_p189._0))
						};
					case 'NumSignals':
						if ((_p189._0.ctor === '::') && (_p189._0._1.ctor === '::')) {
							if (_p189._0._1._1.ctor === '[]') {
				...
				switch (_p192.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'extent',
							_1: _gicentre$elm_vega$Vega$numSpec(
								_gicentre$elm_vega$Vega$NumSignal(_p192._0))
						};
					case 'NumSignals':
						if (((((_p192._0.ctor === '::') && (_p192._0._1.ctor === '::')) && (_p192._0._1._1.ctor === '::')) && (_p192._0._1._1._1.ctor === '::')) && (_p192._0._1._1._1._1.ctor === '[]')) {
							return {
		...
		case 'PrSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p184._0);
		case 'PrCoefficient':
			return {
				ctor: '_Tuple2',
				_0: 'coefficient',
...
var _gicentre$elm_vega$Vega$TAlign = function (a) {
	return {ctor: 'TAlign', _0: a};
};
var _gicentre$elm_vega$Vega$tiAlign = _gicentre$elm_vega$Vega$TAlign;
...
var _gicentre$elm_vega$Vega$TSequenceAs = F4(
	function (a, b, c, d) {
		return {ctor: 'TSequenceAs', _0: a, _1: b, _2: c, _3: d};
	});
var _gicentre$elm_vega$Vega$trSequenceAs = _gicentre$elm_vega$Vega$TSequenceAs;
...
var _gicentre$elm_vega$Vega$strokeJoinValue = function (jn) {
	...
	switch (_p198.ctor) {
		...
		default:
			return _gicentre$elm_vega$Vega$vSignal(_p198._0);
	}
};
...
var _gicentre$elm_vega$Vega$textDirectionValue = function (dir) {
	...
	switch (_p199.ctor) {
		...
		default:
			return _gicentre$elm_vega$Vega$vSignal(_p199._0);
	}
};
	...
	switch (_p200.ctor) {
		case 'CfAutosize':
			return {
				...
				_0: 'autosize',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$autosizeProperty, _p200._0))
			};
		case 'CfBackground':
			return {
				ctor: '_Tuple2',
				_0: 'background',
				_1: _gicentre$elm_vega$Vega$strSpec(_p200._0)
			};
		case 'CfGroup':
			return {
				ctor: '_Tuple2',
				_0: 'group',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p200._0))
			};
		case 'CfEvents':
			var _p201 = _p200._1;
			var listSpec = _elm_lang$core$Native_Utils.eq(
				...
				A2(
					...
					_p201));
			var filterLabel = _elm_lang$core$Native_Utils.eq(_p200._0, _gicentre$elm_vega$Vega$Allow) ? 'allow' : 'prevent';
			return {
				ctor: '_Tuple2',
				_0: 'events',
				_1: _elm_lang$core$Json_Encode$object(
		...
		case 'CfMark':
			return {
				ctor: '_Tuple2',
				_0: _gicentre$elm_vega$Vega$markLabel(_p200._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p200._1))
			};
		case 'CfMarks':
			return {
				ctor: '_Tuple2',
		...
		case 'CfAxis':
			return {
				ctor: '_Tuple2',
				_0: _gicentre$elm_vega$Vega$axTypeLabel(_p200._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$axisProperty, _p200._1))
			};
		case 'CfLegend':
			return {
				ctor: '_Tuple2',
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$legendProperty, _p200._0))
			};
		case 'CfTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$titleProperty, _p200._0))
			};
		default:
			var _p205 = _p200._1;
			var _p204 = _p200._0;
...
var _gicentre$elm_vega$Vega$dataRefProperty = function (dataRef) {
	var nestedSpec = function (dRef2) {
		...
		if (((_p206.ctor === '::') && (_p206._0.ctor === 'DValues')) && (_p206._1.ctor === '[]')) {
			return _gicentre$elm_vega$Vega$valueSpec(_p206._0._0);
		} else {
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p207.ctor) {
		...
		case 'DField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _gicentre$elm_vega$Vega$fieldSpec(_p207._0)
			};
		case 'DFields':
			return {
				ctor: '_Tuple2',
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p207._0))
			};
		case 'DValues':
			return {
				ctor: '_Tuple2',
				_0: 'values',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p207._0)
			};
		case 'DSignal':
			return {
				ctor: '_Tuple2',
		...
		default:
			...
			return (_elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sortProperty, _p208))
			};
	}
};
var _gicentre$elm_vega$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p209.ctor) {
		case 'DoNums':
			return _gicentre$elm_vega$Vega$numSpec(_p209._0);
		case 'DoStrs':
			return _gicentre$elm_vega$Vega$strSpec(_p209._0);
		default:
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p210.ctor) {
		case 'SType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _gicentre$elm_vega$Vega$scaleSpec(_p210._0)
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$Vega$scaleDomainSpec(_p210._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
				_0: 'domainMax',
				_1: _gicentre$elm_vega$Vega$numSpec(_p210._0)
			};
		case 'SDomainMin':
			return {
				ctor: '_Tuple2',
		...
		case 'SDomainRaw':
			return {
				ctor: '_Tuple2',
				_0: 'domainRaw',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p210._0)
			};
		case 'SRange':
			var _p211 = _p210._0;
			switch (_p211.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p211._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p211._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SScheme(_p211._0),
									_1: _p211._1
								}))
					};
				case 'RData':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$object(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p211._0))
					};
				case 'RStep':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _gicentre$elm_vega$Vega$valueSpec(_p211._0)
								},
								_1: {ctor: '[]'}
							})
					};
		...
		case 'SRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _gicentre$elm_vega$Vega$booSpec(_p210._0)
			};
		case 'SClamp':
			return {
				ctor: '_Tuple2',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$Vega$interpolateSpec(_p210._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$Vega$niceSpec(_p210._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
					...
					'states',
					{
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$daFormat(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$topojsonFeature(
										_gicentre$elm_vega$Vega$str('states')),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
				...
				'edges',
				{
					...
					_1: {
						...
						_0: _gicentre$elm_vega$Vega$daFormat(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$jsonProperty(
												...
												_0: _gicentre$elm_vega$Vega$enUpdate(
													{
														...
														_1: {
															...
															_0: _gicentre$elm_vega$Vega$maCursor(
																{
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$cursorValue(_gicentre$elm_vega$Vega$CPointer),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
