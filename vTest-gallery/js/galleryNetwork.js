	...
	switch (_p4.ctor) {
		...
		default:
			return A2(
				...
				'utc',
				_gicentre$elm_vega$Vega$timeUnitLabel(_p4._0));
	}
};
...
var _gicentre$elm_vega$Vega$projectionLabel = function (pr) {
	...
	switch (_p15.ctor) {
		...
		default:
			return _gicentre$elm_vega$Vega$strString(_p15._0);
	}
};
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$string(
							_gicentre$elm_vega$Vega$timeUnitLabel(_p21._0))
					},
					_1: {
						ctor: '::',
						_0: {
						...
						A2(
							...
							function (_p35) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p36._0,
									_1: _gicentre$elm_vega$Vega$foDataTypeSpec(_p36._1)
								};
							},
							_p34._0))
				},
		...
		case 'TgTrigger':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'trigger',
					_1: _gicentre$elm_vega$Vega$expressionSpec(_p37._0)
				},
				_1: {ctor: '[]'}
			};
		case 'TgInsert':
			...
			return {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'values',
						_1: _gicentre$elm_vega$Vega$expressionSpec(_p37._1)
					},
					_1: {ctor: '[]'}
				}
			};
...
var _gicentre$elm_vega$Vega$exprProperty = function (expr) {
	...
	if (_p38.ctor === 'ExField') {
		...
		return {
			ctor: '_Tuple2',
			_0: 'expr',
			_1: _gicentre$elm_vega$Vega$expressionSpec(_p38._0)
		};
	}
};
var _gicentre$elm_vega$Vega$numSpec = function (num) {
	...
	switch (_p39.ctor) {
		...
		case 'NumList':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$numSpec, _p39._0));
		default:
	...
	switch (_p42.ctor) {
		...
		case 'StrSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p42._0),
					_1: {ctor: '[]'}
				});
		case 'StrSignals':
			return _elm_lang$core$Json_Encode$list(
	...
	switch (_p44.ctor) {
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _gicentre$elm_vega$Vega$opSpec(_p44._0)
			};
	}
};
	...
	switch (_p49.ctor) {
		case 'CPPattern':
			return {
				ctor: '_Tuple2',
				_0: 'pattern',
				_1: _gicentre$elm_vega$Vega$strSpec(_p49._0)
			};
		case 'CPCase':
			return {
				ctor: '_Tuple2',
				_0: 'case',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$caseLabel(_p49._0))
			};
		case 'CPStopwords':
			return {
				ctor: '_Tuple2',
	...
	switch (_p51.ctor) {
		case 'LAlign':
			return {
				ctor: '_Tuple2',
				_0: 'align',
				_1: _gicentre$elm_vega$Vega$gridAlignSpec(_p51._0)
			};
		case 'LBounds':
			return {
				ctor: '_Tuple2',
				_0: 'bounds',
				_1: _gicentre$elm_vega$Vega$boundsCalculationSpec(_p51._0)
			};
		case 'LColumns':
			return {
				ctor: '_Tuple2',
				_0: 'columns',
				_1: _gicentre$elm_vega$Vega$numSpec(_p51._0)
			};
		case 'LPadding':
			return {
				ctor: '_Tuple2',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'col',
								_1: _gicentre$elm_vega$Vega$numSpec(_p51._1)
							},
							_1: {ctor: '[]'}
						}
					})
	...
	switch (_p52.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$exprProperty(_p52._0),
					_1: {ctor: '[]'}
				});
	}
};
var _gicentre$elm_vega$Vega$clipSpec = function (clip) {
	...
	switch (_p53.ctor) {
		case 'ClEnabled':
			return _gicentre$elm_vega$Vega$booSpec(_p53._0);
		case 'ClPath':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'path',
						_1: _gicentre$elm_vega$Vega$strSpec(_p53._0)
					},
					_1: {ctor: '[]'}
				});
		default:
		...
		switch (_p54.ctor) {
			case 'ESSource':
				return {
					...
					_0: 'source',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Vega$eventSourceLabel(_p54._0))
				};
			case 'ESType':
				return {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Vega$eventTypeLabel(_p54._0))
				};
			case 'ESBetween':
				return {
					ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$eventStreamObjectSpec(_p54._0),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$eventStreamObjectSpec(_p54._1),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'ESConsume':
				return {
					ctor: '_Tuple2',
					_0: 'consume',
					_1: _gicentre$elm_vega$Vega$booSpec(_p54._0)
				};
			case 'ESFilter':
				var _p56 = _p54._0;
				var _p55 = _p56;
			...
			case 'ESMark':
				return {
					...
					_0: 'marktype',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Vega$markLabel(_p54._0))
				};
			case 'ESThrottle':
				return {
					ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$eventStreamSpec = function (es) {
	...
	switch (_p57.ctor) {
		case 'ESSelector':
			return _gicentre$elm_vega$Vega$strSpec(_p57._0);
		case 'ESObject':
			return _gicentre$elm_vega$Vega$eventStreamObjectSpec(_p57._0);
		case 'ESSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_0: 'merge',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$eventStreamSpec, _p57._0))
					},
					_1: {ctor: '[]'}
				});
	}
		...
		switch (_p58.ctor) {
			case 'EEvents':
				...
				if ((_p59.ctor === '::') && (_p59._1.ctor === '[]')) {
					return {
						ctor: '_Tuple2',
						_0: 'events',
						_1: _gicentre$elm_vega$Vega$eventStreamSpec(_p59._0)
					};
				} else {
					return {
						ctor: '_Tuple2',
						_0: 'events',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$eventStreamSpec, _p60))
					};
				}
			case 'EUpdate':
				var _p61 = _p58._0;
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: 'force',
					_1: _gicentre$elm_vega$Vega$booSpec(_p58._0)
				};
		}
	};
	return _elm_lang$core$Json_Encode$object(
	...
	switch (_p62.ctor) {
			...
			switch (_p63.ctor) {
				case 'Num':
					return {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$numSpec(_p64),
								_1: {ctor: '[]'}
							})
					};
				case 'NumSignal':
				...
				default:
					return {
						ctor: '_Tuple2',
						_0: 'steps',
						_1: _gicentre$elm_vega$Vega$numSpec(_p64)
					};
			}
		case 'BnMinStep':
			return {
		...
		case 'BnNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$Vega$booSpec(_p62._0)
			};
		case 'BnSignal':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$autosizeProperty = function (asCfg) {
	...
	switch (_p67.ctor) {
		...
		default:
			return _gicentre$elm_vega$Vega$signalReferenceProperty(_p67._0);
	}
};
	...
	switch (_p68.ctor) {
		...
		default:
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p68._0),
					_1: {ctor: '[]'}
				});
	}
};
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: A2(
				...
				function (_p69) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$Vega$vPropertyLabel(_p70._0),
						_1: _p70._1
					};
				},
				spec)
...
var _gicentre$elm_vega$Vega$dirLabelx = function (dir) {
	var _p71 = dir;
		...
		switch (_p73.ctor) {
			...
			case 'NumSignal':
				return {
					...
					_1: _gicentre$elm_vega$Vega$numSpec(
						_gicentre$elm_vega$Vega$NumSignal(_p73._0))
				};
			case 'NumSignals':
				var _p75 = _p73._0;
				return _elm_lang$core$Native_Utils.eq(
					...
					_0: name,
					_1: _gicentre$elm_vega$Vega$numSpec(
						_gicentre$elm_vega$Vega$NumSignals(_p75))
				} : A2(
					_elm_lang$core$Debug$log,
					A2(
						_elm_lang$core$Basics_ops['++'],
			...
			case 'NumList':
				...
				return _elm_lang$core$Native_Utils.eq(
					...
					_0: name,
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$numSpec, _p76))
				} : A2(
					_elm_lang$core$Debug$log,
					A2(
						_elm_lang$core$Basics_ops['++'],
...
var _gicentre$elm_vega$Vega$densityProperty = function (dnp) {
	...
	switch (_p77.ctor) {
		case 'DnExtent':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extent', _p77._0);
		case 'DnMethod':
			var _p78 = _p77._0;
			switch (_p78.ctor) {
				case 'PDF':
	...
	switch (_p79.ctor) {
		case 'SScheme':
			return {
				ctor: '_Tuple2',
				_0: 'scheme',
				_1: _gicentre$elm_vega$Vega$strSpec(_p79._0)
			};
		case 'SCount':
			return {
				ctor: '_Tuple2',
				_0: 'count',
				_1: _gicentre$elm_vega$Vega$numSpec(_p79._0)
			};
		default:
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extent', _p79._0);
	}
};
	...
	switch (_p80.ctor) {
		case 'PrType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _gicentre$elm_vega$Vega$projectionSpec(_p80._0)
			};
		case 'PrClipAngle':
			var _p82 = _p80._0;
			var _p81 = _p82;
				...
				switch (_p83.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'clipExtent',
							_1: _gicentre$elm_vega$Vega$numSpec(
								_gicentre$elm_vega$Vega$NumSignal(_p83._0))
						};
					case 'NumSignals':
						if (((((_p83._0.ctor === '::') && (_p83._0._1.ctor === '::')) && (_p83._0._1._1.ctor === '::')) && (_p83._0._1._1._1.ctor === '::')) && (_p83._0._1._1._1._1.ctor === '[]')) {
							return {
		...
		case 'PrTranslate':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'translate', _p80._0);
		case 'PrCenter':
			return {
				ctor: '_Tuple2',
				_0: 'center',
				...
				switch (_p85.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'rotate',
							_1: _gicentre$elm_vega$Vega$numSpec(
								_gicentre$elm_vega$Vega$NumSignal(_p85._0))
						};
					case 'NumSignals':
						if ((_p85._0.ctor === '::') && (_p85._0._1.ctor === '::')) {
							if (_p85._0._1._1.ctor === '[]') {
		...
		case 'PrSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p80._0);
		case 'PrCoefficient':
			return {
				ctor: '_Tuple2',
				_0: 'coefficient',
		...
		case 'FExpr':
			return _gicentre$elm_vega$Vega$strSpec(
				_gicentre$elm_vega$Vega$strExpr(
					_gicentre$elm_vega$Vega$expr(_p90._0)));
		case 'FSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p90._0),
					_1: {ctor: '[]'}
				});
		case 'FDatum':
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p91.ctor) {
		case 'AgGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p91._0))
			};
		case 'AgFields':
			return {
				ctor: '_Tuple2',
		...
		case 'AgOps':
			return {
				...
				_0: 'ops',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$opSpec, _p91._0))
			};
		case 'AgAs':
			return {
				ctor: '_Tuple2',
		...
		case 'AgCross':
			return {
				ctor: '_Tuple2',
				_0: 'cross',
				_1: _gicentre$elm_vega$Vega$booSpec(_p91._0)
			};
		case 'AgDrop':
			return {
				ctor: '_Tuple2',
		...
		case 'CnValues':
			...
			if (_p94.ctor === 'Num') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'values',
					_1: _gicentre$elm_vega$Vega$numSpec(_p95)
				};
			}
		case 'CnX':
			return {
		...
		case 'CnThresholds':
			...
			if (_p96.ctor === 'Num') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'thresholds',
					_1: _gicentre$elm_vega$Vega$numSpec(_p97)
				};
			}
		case 'CnCount':
			return {
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'stdev',
								_1: _gicentre$elm_vega$Vega$numSpec(_p98._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Native_Utils.eq(_p100, '') ? _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'field',
							_1: _gicentre$elm_vega$Vega$fieldSpec(_p101)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bandwidth',
								_1: _gicentre$elm_vega$Vega$numSpec(_p99)
							},
							_1: {ctor: '[]'}
						}
					}
	...
	switch (_p103.ctor) {
		...
		case 'FaData':
			return {
				ctor: '_Tuple2',
				_0: 'data',
				_1: _gicentre$elm_vega$Vega$strSpec(_p103._0)
			};
		case 'FaField':
			return {
				ctor: '_Tuple2',
		...
		case 'FaGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p103._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$aggregateProperty, _p103._0))
			};
	}
};
		...
		return {
			...
			_1: _elm_lang$core$Json_Encode$object(
				A2(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$FaData(_p104._0),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$FaName(_p104._1),
							_1: _p104._2
						}
					}))
		};
	...
	switch (_p105.ctor) {
		...
		case 'FpCx':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _gicentre$elm_vega$Vega$numSpec(_p105._0)
			};
		case 'FpCy':
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$forceProperty, _p106._0)
				});
		case 'FCollide':
			return _elm_lang$core$Json_Encode$object(
				{
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$forceProperty, _p106._1)
					}
				});
		default:
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p107.ctor) {
		case 'FsStatic':
			return {
				ctor: '_Tuple2',
				_0: 'static',
				_1: _gicentre$elm_vega$Vega$booSpec(_p107._0)
			};
		case 'FsRestart':
			return {
				ctor: '_Tuple2',
		...
		case 'FsIterations':
			return {
				ctor: '_Tuple2',
				_0: 'iterations',
				_1: _gicentre$elm_vega$Vega$numSpec(_p107._0)
			};
		case 'FsAlpha':
			return {
				ctor: '_Tuple2',
		...
		case 'FsForces':
			return {
				...
				_0: 'forces',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$forceSpec, _p107._0))
			};
		default:
			return {
				ctor: '_Tuple2',
		...
		case 'GjFields':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$fieldSpec(_p108._0),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$fieldSpec(_p108._1),
							_1: {ctor: '[]'}
						}
					})
			};
...
var _gicentre$elm_vega$Vega$graticuleProperty = function (grProp) {
	...
	switch (_p110.ctor) {
		...
		case 'GrExtentMajor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extentMajor', _p110._0);
		case 'GrExtentMinor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extentMinor', _p110._0);
		case 'GrExtent':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extentr', _p110._0);
		case 'GrStepMajor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'stepMajor', _p110._0);
		case 'GrStepMinor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'stepMinor', _p110._0);
		case 'GrStep':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'step', _p110._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'precision',
	...
	switch (_p111.ctor) {
		case 'JAGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p111._0))
			};
		case 'JAFields':
			return {
				ctor: '_Tuple2',
		...
		case 'JAOps':
			return {
				...
				_0: 'ops',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$opSpec, _p111._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p112.ctor) {
		...
		case 'LPOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _gicentre$elm_vega$Vega$orientationSpec(_p112._0)
			};
		case 'LPShape':
			return {
				ctor: '_Tuple2',
				_0: 'shape',
				_1: _gicentre$elm_vega$Vega$linkShapeSpec(_p112._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p113.ctor) {
		...
		case 'PaSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_gicentre$elm_vega$Vega$comparatorProperties(_p113._0))
			};
		case 'PaSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p113._0);
		case 'PaRadius':
			var _p114 = _p113._0;
			if (_p114.ctor === 'Just') {
				return {
	...
	switch (_p115.ctor) {
		...
		case 'PtRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _gicentre$elm_vega$Vega$booSpec(_p115._0)
			};
		case 'PtSize':
	...
	switch (_p117.ctor) {
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _gicentre$elm_vega$Vega$opSpec(_p117._0)
			};
	}
};
	...
	switch (_p118.ctor) {
		...
		case 'StOffset':
			return {
				ctor: '_Tuple2',
				_0: 'offset',
				_1: _gicentre$elm_vega$Vega$stackOffsetSpec(_p118._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p119.ctor) {
		...
		case 'TmMethod':
			return {
				ctor: '_Tuple2',
				_0: 'method',
				_1: _gicentre$elm_vega$Vega$tmMethodSpec(_p119._0)
			};
		case 'TmPadding':
			return {
				ctor: '_Tuple2',
	...
	switch (_p120.ctor) {
		...
		case 'TeMethod':
			return {
				ctor: '_Tuple2',
				_0: 'method',
				_1: _gicentre$elm_vega$Vega$teMethodSpec(_p120._0)
			};
		case 'TeSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p120._0);
		case 'TeNodeSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'nodeSize', _p120._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'as',
	...
	switch (_p121.ctor) {
		...
		case 'VSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p121._0),
					_1: {ctor: '[]'}
				});
		case 'VColor':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$colorProperty(_p121._0),
					_1: {ctor: '[]'}
				});
		case 'VField':
			return _gicentre$elm_vega$Vega$fieldSpec(_p121._0);
		case 'VScale':
			return _gicentre$elm_vega$Vega$fieldSpec(_p121._0);
		case 'VBand':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'exponent',
						_1: _gicentre$elm_vega$Vega$valueSpec(_p121._0)
					},
					_1: {ctor: '[]'}
				});
		case 'VMultiply':
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: _p121._0,
						_1: _gicentre$elm_vega$Vega$valueSpec(_p121._1)
					},
					_1: {ctor: '[]'}
				});
		case 'VObject':
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p121._0));
		case 'Values':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p121._0));
		case 'VBoo':
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'g',
								_1: _elm_lang$core$Json_Encode$object(
									A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p122._1))
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_0: 'b',
									_1: _elm_lang$core$Json_Encode$object(
										A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p122._2))
								},
								_1: {ctor: '[]'}
							}
						}
	...
	switch (_p123.ctor) {
		...
		default:
			return {
				...
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p123._1)
			};
	}
};
	...
	switch (_p126.ctor) {
		case 'DaFormat':
			return {
				...
				_0: 'format',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$formatProperty, _p126._0))
			};
		case 'DaSource':
			return {
				ctor: '_Tuple2',
	...
	switch (_p127.ctor) {
		...
		case 'ImMethod':
			return {
				...
				_0: 'method',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$imputeMethodLabel(_p127._0))
			};
		case 'ImGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p127._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				...
				return F2(
					...
					})(
					{
						...
						_0: {
							...
							_0: colName,
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p132._0))
						},
						_1: {ctor: '[]'}
					});
			case 'Values':
				return F2(
					...
					})(
					{
						...
						_0: {
							...
							_0: colName,
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p132._0))
						},
						_1: {ctor: '[]'}
					});
			default:
					...
					_0: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p135)
						}),
					_1: {ctor: '[]'}
				}));
	} else {
	...
	switch (_p139.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _gicentre$elm_vega$Vega$valRef(_p139._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: _p139._0,
				_1: _gicentre$elm_vega$Vega$valRef(_p139._1)
			};
	}
};
	...
	switch (_p140.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p140._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p140._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p140._1))
			};
	}
};
	...
	switch (_p141.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$sideLabel(_p141._0))
			};
		case 'AxBandPosition':
			return {
				ctor: '_Tuple2',
				_0: 'bandPosition',
				_1: _gicentre$elm_vega$Vega$numSpec(_p141._0)
			};
		case 'AxDomain':
			return {
				ctor: '_Tuple2',
		...
		case 'AxEncode':
			var enc = function (_p142) {
				...
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$Vega$axisElementLabel(_p143._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p143._1))
				};
			};
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelAlign':
			return {
				ctor: '_Tuple2',
				_0: 'labelAlign',
				_1: _gicentre$elm_vega$Vega$hAlignSpec(_p141._0)
			};
		case 'AxLabelAngle':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'labelBaseline',
				_1: _gicentre$elm_vega$Vega$vAlignSpec(_p141._0)
			};
		case 'AxLabelBound':
			var _p145 = _p141._0;
			var _p144 = _p145;
			if (_p144.ctor === 'NumNull') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'labelBound',
					_1: _gicentre$elm_vega$Vega$numSpec(_p145)
				};
			}
		case 'AxLabelColor':
			return {
		...
		case 'AxLabelFlush':
			...
			if (_p146.ctor === 'NumNull') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'labelFlush',
					_1: _gicentre$elm_vega$Vega$numSpec(_p147)
				};
			}
		...
		case 'AxLabelFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'labelFontWeight',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p141._0)
			};
		case 'AxLabelLimit':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$overlapStrategyLabel(_p141._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
	...
	switch (_p149.ctor) {
		...
		case 'LeDirection':
			return {
				ctor: '_Tuple2',
				_0: 'direction',
				_1: _gicentre$elm_vega$Vega$orientationSpec(_p149._0)
			};
		case 'LeOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _gicentre$elm_vega$Vega$legendOrientSpec(_p149._0)
			};
		case 'LeFill':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelAlign':
			return {
				ctor: '_Tuple2',
				_0: 'labelAlign',
				_1: _gicentre$elm_vega$Vega$hAlignSpec(_p149._0)
			};
		case 'LeLabelBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'labelBaseline',
				_1: _gicentre$elm_vega$Vega$vAlignSpec(_p149._0)
			};
		case 'LeLabelColor':
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$pivotProperty, _p161._2)
						}
					}
				});
		case 'TProject':
...
var _gicentre$elm_vega$Vega$orientationValue = function (orient) {
	...
	switch (_p185.ctor) {
		...
		default:
			return _gicentre$elm_vega$Vega$vSignal(_p185._0);
	}
};
	...
	switch (_p188.ctor) {
		case 'CfAutosize':
			return {
				...
				_0: 'autosize',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$autosizeProperty, _p188._0))
			};
		case 'CfBackground':
			return {
				ctor: '_Tuple2',
				_0: 'background',
				_1: _gicentre$elm_vega$Vega$strSpec(_p188._0)
			};
		case 'CfGroup':
			return {
				ctor: '_Tuple2',
				_0: 'group',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p188._0))
			};
		case 'CfEvents':
			var _p189 = _p188._1;
			var listSpec = _elm_lang$core$Native_Utils.eq(
				...
				A2(
					...
					_p189));
			var filterLabel = _elm_lang$core$Native_Utils.eq(_p188._0, _gicentre$elm_vega$Vega$Allow) ? 'allow' : 'prevent';
			return {
				ctor: '_Tuple2',
				_0: 'events',
				_1: _elm_lang$core$Json_Encode$object(
		...
		case 'CfMark':
			return {
				ctor: '_Tuple2',
				_0: _gicentre$elm_vega$Vega$markLabel(_p188._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p188._1))
			};
		case 'CfMarks':
			return {
				ctor: '_Tuple2',
		...
		case 'CfAxis':
			return {
				ctor: '_Tuple2',
				_0: _gicentre$elm_vega$Vega$axTypeLabel(_p188._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$axisProperty, _p188._1))
			};
		case 'CfLegend':
			return {
				ctor: '_Tuple2',
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$legendProperty, _p188._0))
			};
		case 'CfTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$titleProperty, _p188._0))
			};
		default:
			var _p193 = _p188._1;
			var _p192 = _p188._0;
				...
				switch (_p190.ctor) {
					...
					case 'RSignal':
						return _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p190._0),
								_1: {ctor: '[]'}
							});
					case 'RScheme':
						return _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SScheme(_p190._0),
									_1: _p190._1
								}));
					default:
						return A2(
...
var _gicentre$elm_vega$Vega$dataRefProperty = function (dataRef) {
	var nestedSpec = function (dRef2) {
		...
		if (((_p194.ctor === '::') && (_p194._0.ctor === 'DValues')) && (_p194._1.ctor === '[]')) {
			return _gicentre$elm_vega$Vega$valueSpec(_p194._0._0);
		} else {
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p195.ctor) {
		...
		case 'DField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _gicentre$elm_vega$Vega$fieldSpec(_p195._0)
			};
		case 'DFields':
			return {
				ctor: '_Tuple2',
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p195._0))
			};
		case 'DValues':
			return {
				ctor: '_Tuple2',
		...
		default:
			...
			return (_elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sortProperty, _p196))
			};
	}
};
var _gicentre$elm_vega$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p197.ctor) {
		case 'DoNums':
			return _gicentre$elm_vega$Vega$numSpec(_p197._0);
		case 'DoStrs':
			return _gicentre$elm_vega$Vega$strSpec(_p197._0);
		default:
			return _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p197._0));
	}
};
	...
	switch (_p198.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$scaleLabel(_p198._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$Vega$scaleDomainSpec(_p198._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
				_0: 'domainMax',
				_1: _gicentre$elm_vega$Vega$numSpec(_p198._0)
			};
		case 'SDomainMin':
			return {
				ctor: '_Tuple2',
			...
			switch (_p199.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p199._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p199._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SScheme(_p199._0),
									_1: _p199._1
								}))
					};
				case 'RData':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$object(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p199._0))
					};
				case 'RStep':
					return {
						ctor: '_Tuple2',
		...
		case 'SRound':
			return {
				ctor: '_Tuple2',
				_0: 'round',
				_1: _gicentre$elm_vega$Vega$booSpec(_p198._0)
			};
		case 'SClamp':
			return {
				ctor: '_Tuple2',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$Vega$interpolateSpec(_p198._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$Vega$niceSpec(_p198._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
