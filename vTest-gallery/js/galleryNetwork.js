		...
		switch (_p76.ctor) {
			...
			case 'NumSignal':
				return {
					...
					_1: _gicentre$elm_vega$Vega$numSpec(
						_gicentre$elm_vega$Vega$NumSignal(_p76._0))
				};
			case 'NumSignals':
				var _p78 = _p76._0;
				return _elm_lang$core$Native_Utils.eq(
					...
					_0: name,
					_1: _gicentre$elm_vega$Vega$numSpec(
						_gicentre$elm_vega$Vega$NumSignals(_p78))
				} : A2(
					_elm_lang$core$Debug$log,
					A2(
						_elm_lang$core$Basics_ops['++'],
			...
			case 'NumList':
				...
				return _elm_lang$core$Native_Utils.eq(
					...
					_0: name,
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$numSpec, _p79))
				} : A2(
					_elm_lang$core$Debug$log,
					A2(
						_elm_lang$core$Basics_ops['++'],
...
var _gicentre$elm_vega$Vega$densityProperty = function (dnp) {
	...
	switch (_p80.ctor) {
		case 'DnExtent':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extent', _p80._0);
		case 'DnMethod':
			var _p81 = _p80._0;
			if (_p81.ctor === 'PDF') {
				return {
	...
	switch (_p82.ctor) {
		case 'SScheme':
			return {
				ctor: '_Tuple2',
				_0: 'scheme',
				_1: _gicentre$elm_vega$Vega$strSpec(_p82._0)
			};
		case 'SCount':
			return {
				ctor: '_Tuple2',
		...
		default:
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extent', _p82._0);
	}
};
	...
	switch (_p83.ctor) {
		case 'PrType':
			return {
				ctor: '_Tuple2',
				_0: 'type',
				_1: _gicentre$elm_vega$Vega$projectionSpec(_p83._0)
			};
		case 'PrClipAngle':
			var _p85 = _p83._0;
			var _p84 = _p85;
			if ((_p84.ctor === 'Num') && (_p84._0 === 0)) {
				...
				return {
					ctor: '_Tuple2',
					_0: 'clipAngle',
					_1: _gicentre$elm_vega$Vega$numSpec(_p85)
				};
			}
		case 'PrClipExtent':
			var _p87 = _p83._0;
				...
				switch (_p86.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'clipExtent',
							_1: _gicentre$elm_vega$Vega$numSpec(
								_gicentre$elm_vega$Vega$NumSignal(_p86._0))
						};
					case 'NumSignals':
						if (((((_p86._0.ctor === '::') && (_p86._0._1.ctor === '::')) && (_p86._0._1._1.ctor === '::')) && (_p86._0._1._1._1.ctor === '::')) && (_p86._0._1._1._1._1.ctor === '[]')) {
							return {
		...
		case 'PrTranslate':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'translate', _p83._0);
		case 'PrCenter':
			return {
				ctor: '_Tuple2',
				_0: 'center',
				...
				switch (_p88.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'rotate',
							_1: _gicentre$elm_vega$Vega$numSpec(
								_gicentre$elm_vega$Vega$NumSignal(_p88._0))
						};
					case 'NumSignals':
						if ((_p88._0.ctor === '::') && (_p88._0._1.ctor === '::')) {
							if (_p88._0._1._1.ctor === '[]') {
				...
				switch (_p91.ctor) {
					...
					case 'NumSignal':
						return {
							...
							_0: 'extent',
							_1: _gicentre$elm_vega$Vega$numSpec(
								_gicentre$elm_vega$Vega$NumSignal(_p91._0))
						};
					case 'NumSignals':
						if (((((_p91._0.ctor === '::') && (_p91._0._1.ctor === '::')) && (_p91._0._1._1.ctor === '::')) && (_p91._0._1._1._1.ctor === '::')) && (_p91._0._1._1._1._1.ctor === '[]')) {
							return {
		...
		case 'PrSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p83._0);
		case 'PrCoefficient':
			return {
				ctor: '_Tuple2',
				_0: 'coefficient',
		...
		case 'FExpr':
			return _gicentre$elm_vega$Vega$strSpec(
				_gicentre$elm_vega$Vega$strExpr(
					_gicentre$elm_vega$Vega$expr(_p93._0)));
		case 'FSignal':
			return _elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p93._0),
					_1: {ctor: '[]'}
				});
		case 'FDatum':
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p94.ctor) {
		case 'AgGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p94._0))
			};
		case 'AgFields':
			return {
				ctor: '_Tuple2',
		...
		case 'AgOps':
			return {
				...
				_0: 'ops',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$opSpec, _p94._0))
			};
		case 'AgAs':
			return {
				ctor: '_Tuple2',
	...
	switch (_p95.ctor) {
		...
		default:
			return {
				...
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$aggregateProperty, _p95._0))
			};
	}
};
		...
		return {
			...
			_1: _elm_lang$core$Json_Encode$object(
				A2(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$FaData(_p96._0),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$FaName(_p96._1),
							_1: _p96._2
						}
					}))
		};
	...
	switch (_p98.ctor) {
		case 'CnValues':
			...
			if (_p99.ctor === 'Num') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'values',
					_1: _gicentre$elm_vega$Vega$numSpec(_p100)
				};
			}
		case 'CnX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _gicentre$elm_vega$Vega$fieldSpec(_p98._0)
			};
		case 'CnY':
			return {
				ctor: '_Tuple2',
		...
		case 'CnCellSize':
			return {
				ctor: '_Tuple2',
				_0: 'cellSize',
				_1: _gicentre$elm_vega$Vega$numSpec(_p98._0)
			};
		case 'CnBandwidth':
			return {
				ctor: '_Tuple2',
		...
		case 'CnSmooth':
			return {
				ctor: '_Tuple2',
				_0: 'smooth',
				_1: _gicentre$elm_vega$Vega$booSpec(_p98._0)
			};
		case 'CnThresholds':
			var _p102 = _p98._0;
			var _p101 = _p102;
			if (_p101.ctor === 'Num') {
				...
				return {
					ctor: '_Tuple2',
					_0: 'thresholds',
					_1: _gicentre$elm_vega$Vega$numSpec(_p102)
				};
			}
		case 'CnCount':
			return {
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'stdev',
								_1: _gicentre$elm_vega$Vega$numSpec(_p103._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Native_Utils.eq(_p105, '') ? _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'field',
							_1: _gicentre$elm_vega$Vega$fieldSpec(_p106)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bandwidth',
								_1: _gicentre$elm_vega$Vega$numSpec(_p104)
							},
							_1: {ctor: '[]'}
						}
					}
	...
	switch (_p108.ctor) {
		case 'FpX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _gicentre$elm_vega$Vega$fieldSpec(_p108._0)
			};
		case 'FpY':
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$forceProperty, _p109._0)
				});
		case 'FCollide':
			return _elm_lang$core$Json_Encode$object(
				{
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$forceProperty, _p109._1)
					}
				});
		default:
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p110.ctor) {
		...
		case 'FsForces':
			return {
				...
				_0: 'forces',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$forceSpec, _p110._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p111.ctor) {
		case 'GjFields':
			return {
				...
				_1: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$fieldSpec(_p111._0),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$fieldSpec(_p111._1),
							_1: {ctor: '[]'}
						}
					})
			};
		case 'GjFeature':
			return {
				ctor: '_Tuple2',
				_0: 'geojson',
				_1: _gicentre$elm_vega$Vega$fieldSpec(_p111._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p112.ctor) {
		...
		case 'GePointRadius':
			return {
				ctor: '_Tuple2',
				_0: 'pointRadius',
				_1: _gicentre$elm_vega$Vega$numSpec(_p112._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$graticuleProperty = function (grProp) {
	...
	switch (_p113.ctor) {
		...
		case 'GrExtentMajor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extentMajor', _p113._0);
		case 'GrExtentMinor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extentMinor', _p113._0);
		case 'GrExtent':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'extentr', _p113._0);
		case 'GrStepMajor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'stepMajor', _p113._0);
		case 'GrStepMinor':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'stepMinor', _p113._0);
		case 'GrStep':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'step', _p113._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'precision',
	...
	switch (_p114.ctor) {
		...
		case 'JAOps':
			return {
				...
				_0: 'ops',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$opSpec, _p114._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p115.ctor) {
		...
		case 'LPOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _gicentre$elm_vega$Vega$strSpec(_p115._0)
			};
		case 'LPShape':
			return {
				ctor: '_Tuple2',
	...
	switch (_p116.ctor) {
		...
		case 'PaSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_gicentre$elm_vega$Vega$comparatorProperties(_p116._0))
			};
		case 'PaSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p116._0);
		case 'PaRadius':
			var _p117 = _p116._0;
			if (_p117.ctor === 'Just') {
				return {
		...
		case 'PaPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
				_1: _gicentre$elm_vega$Vega$numSpec(_p116._0)
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p118.ctor) {
		...
		case 'PtSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_gicentre$elm_vega$Vega$comparatorProperties(_p118._0))
			};
		case 'PtPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'PtSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p118._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'as',
	...
	switch (_p120.ctor) {
		case 'PiGroupBy':
			return {
				...
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p120._0))
			};
		case 'PiLimit':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: 'op',
				_1: _gicentre$elm_vega$Vega$opSpec(_p120._0)
			};
	}
};
				...
				return F2(
					...
					})(
					{
						...
						_0: {
							...
							_0: colName,
							_1: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p135._0))
						},
						_1: {ctor: '[]'}
					});
			case 'Values':
				return F2(
					...
					})(
					{
						...
						_0: {
							...
							_0: colName,
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p135._0))
						},
						_1: {ctor: '[]'}
					});
			default:
					...
					_0: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p138)
						}),
					_1: {ctor: '[]'}
				}));
	} else {
						...
						_0: _elm_lang$core$Json_Encode$object(
							{
								...
								_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Vega$valueProperties, _p141)
							}),
						_1: {ctor: '[]'}
					});
				ex = _v115;
	...
	switch (_p142.ctor) {
		case 'MX':
			return {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _gicentre$elm_vega$Vega$valRef(_p142._0)
			};
		case 'MY':
			return {
				ctor: '_Tuple2',
		...
		case 'MStrokeJoin':
			return {
				...
				_0: 'strokeJoin',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$strokeJoinLabel(_p142._0))
			};
		...
		case 'MFont':
			return {
				ctor: '_Tuple2',
				_0: 'font',
				_1: _gicentre$elm_vega$Vega$strSpec(_p142._0)
			};
		case 'MFontSize':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				ctor: '_Tuple2',
				_0: _p142._0,
				_1: _gicentre$elm_vega$Vega$valRef(_p142._1)
			};
	}
};
	...
	switch (_p143.ctor) {
		case 'Enter':
			return {
				...
				_0: 'enter',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p143._0))
			};
		case 'Update':
			return {
				ctor: '_Tuple2',
		...
		default:
			return {
				...
				_0: _p143._0,
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p143._1))
			};
	}
};
	...
	switch (_p144.ctor) {
		...
		case 'AxSide':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$sideLabel(_p144._0))
			};
		case 'AxBandPosition':
			return {
				ctor: '_Tuple2',
		...
		case 'AxEncode':
			var enc = function (_p145) {
				...
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$Vega$axisElementLabel(_p146._0),
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p146._1))
				};
			};
			return {
				ctor: '_Tuple2',
		...
		case 'AxGridDash':
			return {
				ctor: '_Tuple2',
				_0: 'gridDash',
				_1: _gicentre$elm_vega$Vega$valRef(_p144._0)
			};
		case 'AxGridOpacity':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'labelFontWeight',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p144._0)
			};
		case 'AxLabelLimit':
			return {
				ctor: '_Tuple2',
		...
		case 'AxLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$overlapStrategyLabel(_p144._0))
			};
		case 'AxLabelPadding':
			return {
				ctor: '_Tuple2',
		...
		case 'AxTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _gicentre$elm_vega$Vega$strSpec(_p144._0)
			};
		case 'AxTitleAlign':
			return {
				ctor: '_Tuple2',
	...
	switch (_p149.ctor) {
		case 'EnLegend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p149._0))
			};
		case 'EnTitle':
			return {
				ctor: '_Tuple2',
	...
	switch (_p150.ctor) {
		case 'LeType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$legendTypeLabel(_p150._0))
			};
		case 'LeDirection':
			return {
				ctor: '_Tuple2',
				_0: 'direction',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$markOrientationLabel(_p150._0))
			};
		case 'LeOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$legendOrientLabel(_p150._0))
			};
		case 'LeFill':
			return {
				ctor: '_Tuple2',
		...
		case 'LeEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$legendEncodingProperty, _p150._0))
			};
		case 'LeFormat':
			return {
				ctor: '_Tuple2',
		...
		case 'LeGridAlign':
			return {
				ctor: '_Tuple2',
				_0: 'gridAlign',
				_1: _gicentre$elm_vega$Vega$gridAlignSpec(_p150._0)
			};
		case 'LeClipHeight':
			return {
				ctor: '_Tuple2',
		...
		case 'LeLabelAlign':
			return {
				...
				_0: 'labelAlign',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$hAlignLabel(_p150._0))
			};
		...
		case 'LeLabelOverlap':
			return {
				...
				_0: 'labelOverlap',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$overlapStrategyLabel(_p150._0))
			};
		...
		case 'LeSymbolType':
			return {
				...
				_0: 'symbolType',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$symbolLabel(_p150._0))
			};
		case 'LeTickCount':
			return {
				ctor: '_Tuple2',
		...
		case 'LeValues':
			return {
				...
				_0: 'values',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p150._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p151.ctor) {
		case 'TText':
			return {
				ctor: '_Tuple2',
				_0: 'text',
				_1: _gicentre$elm_vega$Vega$strSpec(_p151._0)
			};
		case 'TOrient':
			return {
				ctor: '_Tuple2',
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$sideLabel(_p151._0))
			};
		case 'TAnchor':
			return {
				ctor: '_Tuple2',
				_0: 'anchor',
				_1: _gicentre$elm_vega$Vega$anchorSpec(_p151._0)
			};
		case 'TAngle':
			return {
				ctor: '_Tuple2',
				_0: 'angle',
				_1: _gicentre$elm_vega$Vega$numSpec(_p151._0)
			};
		case 'TBaseline':
			return {
				ctor: '_Tuple2',
				_0: 'baseline',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$vAlignLabel(_p151._0))
			};
		case 'TColor':
			return {
				ctor: '_Tuple2',
		...
		case 'TEncode':
			return {
				...
				_0: 'encode',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p151._0))
			};
		case 'TFont':
			return {
				ctor: '_Tuple2',
		...
		case 'TFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p151._0)
			};
		case 'TFrame':
			return {
				ctor: '_Tuple2',
				_0: 'fame',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$titleFrameLabel(_p151._0))
			};
		case 'TInteractive':
			return {
				ctor: '_Tuple2',
				_0: 'interactive',
				_1: _gicentre$elm_vega$Vega$booSpec(_p151._0)
			};
		case 'TLimit':
			return {
				ctor: '_Tuple2',
...
var _gicentre$elm_vega$Vega$windowOperationProperties = function (wos) {
	...
	var windowFieldSpec = function (wo) {
		...
		if (_p153.ctor === 'WnOperation') {
			...
			var _p155 = _p153._2;
			if (_p155.ctor === 'Just') {
				return _gicentre$elm_vega$Vega$fieldSpec(_p155._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		}
	...
	var windowParamSpec = function (wo) {
		...
		if (_p156.ctor === 'WnOperation') {
			...
			var _p158 = _p156._1;
			if (_p158.ctor === 'Just') {
				return _gicentre$elm_vega$Vega$numSpec(_p158._0);
			} else {
				return _elm_lang$core$Json_Encode$null;
			}
		}
	...
	var windowOpSpec = function (wo) {
		...
		if (_p159.ctor === 'WnOperation') {
			return _gicentre$elm_vega$Vega$wOperationSpec(_p159._0);
		} else {
			return _gicentre$elm_vega$Vega$opSpec(_p159._0);
		}
	};
	return {
		ctor: '::',
	...
	switch (_p160.ctor) {
		case 'WnSort':
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					_gicentre$elm_vega$Vega$comparatorProperties(_p160._0))
			};
		case 'WnGroupBy':
			return {
				ctor: '_Tuple2',
				_0: 'groupby',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p160._0))
			};
		case 'WnFrame':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'frame', _p160._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'ignorePeers',
				_1: _gicentre$elm_vega$Vega$booSpec(_p160._0)
			};
	}
};
	...
	switch (_p161.ctor) {
		case 'WcFont':
			return {
				ctor: '_Tuple2',
				_0: 'font',
				_1: _gicentre$elm_vega$Vega$strSpec(_p161._0)
			};
		case 'WcFontStyle':
			return {
				ctor: '_Tuple2',
		...
		case 'WcFontSizeRange':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'fontSizeRange', _p161._0);
		case 'WcPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
		...
		case 'WcSize':
			return A3(_gicentre$elm_vega$Vega$numArrayProperty, 2, 'size', _p161._0);
		case 'WcSpiral':
			return {
				ctor: '_Tuple2',
				_0: 'spiral',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$spiralLabel(_p161._0))
			};
		default:
			return {
				ctor: '_Tuple2',
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$aggregateProperty, _p162._0)
				});
		case 'TBin':
			var _p164 = _p162._1;
			var extSpec = function () {
				...
				if (_p163.ctor === 'Num') {
					...
					return _gicentre$elm_vega$Vega$numSpec(_p164);
				}
			}();
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'field',
							_1: _gicentre$elm_vega$Vega$fieldSpec(_p162._0)
						},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'extent', _1: extSpec},
							_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$binProperty, _p162._2)
						}
					}
				});
		case 'TCollect':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_0: 'sort',
							_1: _elm_lang$core$Json_Encode$object(
								_gicentre$elm_vega$Vega$comparatorProperties(_p162._0))
						},
						_1: {ctor: '[]'}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$countPatternProperty, _p162._1)
					}
				});
		case 'TCross':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$crossProperty, _p162._0)
				});
		case 'TCrossFilter':
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'distribution',
							_1: _gicentre$elm_vega$Vega$distributionSpec(_p162._0)
						},
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$densityProperty, _p162._1)
					}
				});
		case 'TExtent':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$exprProperty(_p162._0),
						_1: {ctor: '[]'}
					}
				});
		case 'TFlatten':
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'fields',
								_1: _gicentre$elm_vega$Vega$fieldSpec(_p167._0)
							},
							_1: {ctor: '[]'}
						}
					});
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'fields',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p168))
							},
							_1: {ctor: '[]'}
						}
					});
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'fields',
								_1: _gicentre$elm_vega$Vega$fieldSpec(_p169._0)
							},
							_1: {
								ctor: '::',
								_0: {
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_0: 'fields',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p170))
							},
							_1: {
								ctor: '::',
								_0: {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'expr',
							_1: _gicentre$elm_vega$Vega$expressionSpec(_p162._0)
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'initonly',
									_1: _gicentre$elm_vega$Vega$formulaUpdateSpec(_p162._2)
								},
								_1: {ctor: '[]'}
							}
						}
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'key',
								_1: _gicentre$elm_vega$Vega$fieldSpec(_p162._1)
							},
							_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$imputeProperty, _p162._2)
						}
					}
				});
		case 'TJoinAggregate':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$joinAggregateProperty, _p162._0)
				});
		case 'TLookup':
			return _elm_lang$core$Json_Encode$object(
				{
						...
						_1: {
							...
							_1: {
								...
								_0: {
									...
									_0: 'fields',
									_1: _elm_lang$core$Json_Encode$list(
										A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p162._2))
								},
								_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$lookupProperty, _p162._3)
							}
						}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$pivotProperty, _p162._2)
						}
					}
				});
		case 'TProject':
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'size',
							_1: _gicentre$elm_vega$Vega$numSpec(_p162._0)
						},
						_1: {ctor: '[]'}
					}
				});
			...
			var stepProp = function () {
				...
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'step',
						_1: _gicentre$elm_vega$Vega$numSpec(_p175)
					},
					_1: {ctor: '[]'}
				};
			}();
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'stop',
									_1: _gicentre$elm_vega$Vega$numSpec(_p162._1)
								},
								_1: {ctor: '[]'}
							}
						}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_gicentre$elm_vega$Vega$windowOperationProperties(_p162._0),
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$windowProperty, _p162._1))
				});
		case 'TContour':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$numSpec(_p162._0),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$numSpec(_p162._1),
										_1: {ctor: '[]'}
									}
								})
						},
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$contourProperty, _p162._2)
					}
				});
		case 'TGeoJson':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$geoJsonProperty, _p162._0)
				});
		case 'TGeoPath':
			var _p178 = _p162._0;
			var _p177 = _p162._1;
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$geoPathProperty, _p177)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$list(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$fieldSpec(_p162._1),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$fieldSpec(_p162._2),
											_1: {ctor: '[]'}
										}
									})
							},
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$geoPathProperty, _p180)
					});
			} else {
				return _elm_lang$core$Json_Encode$object(
					{
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$graticuleProperty, _p162._0)
				});
		case 'TLinkPath':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$linkPathProperty, _p162._0)
				});
		case 'TPie':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$pieProperty, _p162._0)
				});
		case 'TStack':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$stackProperty, _p162._0)
				});
		case 'TForce':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$forceSimulationProperty, _p162._0)
				});
		case 'TVoronoi':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$voronoiProperty, _p162._2)
						}
					}
				});
		case 'TWordcloud':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$wordcloudProperty, _p162._0)
				});
		case 'TNest':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'generate',
								_1: _gicentre$elm_vega$Vega$booSpec(_p162._1)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$packProperty, _p162._0)
				});
		case 'TPartition':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$partitionProperty, _p162._0)
				});
		case 'TTree':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$treeProperty, _p162._0)
				});
		case 'TTreemap':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_1: A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$treemapProperty, _p162._0)
				});
		default:
			return _elm_lang$core$Json_Encode$object(
				{
		...
		case 'MType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Vega$markLabel(_p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MClip':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'clip',
					_1: _gicentre$elm_vega$Vega$clipSpec(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MDescription':
		...
		case 'MEncode':
			return {
				...
				_0: {
					...
					_0: 'encode',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$encodingProperty, _p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MFrom':
			return {
				...
				_0: {
					...
					_0: 'from',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sourceProperty, _p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MInteractive':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'interactive',
					_1: _gicentre$elm_vega$Vega$booSpec(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MKey':
			return {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'key',
					_1: _gicentre$elm_vega$Vega$fieldSpec(_p182._0)
				},
				_1: {ctor: '[]'}
			};
		case 'MName':
		...
		case 'MSort':
			return {
				...
				_0: {
					...
					_0: 'sort',
					_1: _elm_lang$core$Json_Encode$object(
						_gicentre$elm_vega$Vega$comparatorProperties(_p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MTransform':
			return {
				...
				_0: {
					...
					_0: 'transform',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$transformSpec, _p182._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MStyle':
		...
		default:
			return A2(
				...
				function (_p183) {
					...
					return {
						ctor: '_Tuple2',
						_0: _gicentre$elm_vega$Vega$vPropertyLabel(_p184._0),
						_1: _p184._1
					};
				},
				_p182._0);
	...
	switch (_p185.ctor) {
		case 'CfAutosize':
			return {
				...
				_0: 'autosize',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$autosizeProperty, _p185._0))
			};
		case 'CfBackground':
			return {
				ctor: '_Tuple2',
				_0: 'background',
				_1: _gicentre$elm_vega$Vega$strSpec(_p185._0)
			};
		case 'CfGroup':
			return {
				ctor: '_Tuple2',
				_0: 'group',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p185._0))
			};
		case 'CfEvents':
			var _p186 = _p185._1;
			var listSpec = _elm_lang$core$Native_Utils.eq(
				...
				A2(
					...
					_p186));
			var filterLabel = _elm_lang$core$Native_Utils.eq(_p185._0, _gicentre$elm_vega$Vega$Allow) ? 'allow' : 'prevent';
			return {
				ctor: '_Tuple2',
				_0: 'events',
				_1: _elm_lang$core$Json_Encode$object(
		...
		case 'CfMark':
			return {
				ctor: '_Tuple2',
				_0: _gicentre$elm_vega$Vega$markLabel(_p185._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$markProperty, _p185._1))
			};
		case 'CfMarks':
			return {
				ctor: '_Tuple2',
		...
		case 'CfAxis':
			return {
				ctor: '_Tuple2',
				_0: _gicentre$elm_vega$Vega$axTypeLabel(_p185._0),
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$axisProperty, _p185._1))
			};
		case 'CfLegend':
			return {
				ctor: '_Tuple2',
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$legendProperty, _p185._0))
			};
		case 'CfTitle':
			return {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$titleProperty, _p185._0))
			};
		default:
			var _p190 = _p185._1;
			var _p189 = _p185._0;
				...
				switch (_p187.ctor) {
					...
					case 'RSignal':
						return _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p187._0),
								_1: {ctor: '[]'}
							});
					case 'RScheme':
						return _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SScheme(_p187._0),
									_1: _p187._1
								}));
					default:
						return A2(
...
var _gicentre$elm_vega$Vega$dataRefProperty = function (dataRef) {
	var nestedSpec = function (dRef2) {
		...
		if (((_p191.ctor === '::') && (_p191._0.ctor === 'DValues')) && (_p191._1.ctor === '[]')) {
			return _gicentre$elm_vega$Vega$valueSpec(_p191._0._0);
		} else {
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p192.ctor) {
		...
		case 'DField':
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _gicentre$elm_vega$Vega$fieldSpec(_p192._0)
			};
		case 'DFields':
			return {
				ctor: '_Tuple2',
				_0: 'fields',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$fieldSpec, _p192._0))
			};
		case 'DValues':
			return {
				ctor: '_Tuple2',
				_0: 'values',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p192._0)
			};
		case 'DSignal':
			return {
				ctor: '_Tuple2',
		...
		default:
			...
			return (_elm_lang$core$Native_Utils.eq(
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$sortProperty, _p193))
			};
	}
};
var _gicentre$elm_vega$Vega$scaleDomainSpec = function (sdType) {
	...
	switch (_p194.ctor) {
		case 'DoNums':
			return _gicentre$elm_vega$Vega$numSpec(_p194._0);
		case 'DoStrs':
			return _gicentre$elm_vega$Vega$strSpec(_p194._0);
		default:
			return _elm_lang$core$Json_Encode$object(
	...
	switch (_p195.ctor) {
		case 'SType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Vega$scaleLabel(_p195._0))
			};
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$Vega$scaleDomainSpec(_p195._0)
			};
		case 'SDomainMax':
			return {
				ctor: '_Tuple2',
		...
		case 'SDomainRaw':
			return {
				ctor: '_Tuple2',
				_0: 'domainRaw',
				_1: _gicentre$elm_vega$Vega$valueSpec(_p195._0)
			};
		case 'SRange':
			var _p196 = _p195._0;
			switch (_p196.ctor) {
				...
				case 'RValues':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$valueSpec, _p196._0))
					};
				case 'RSignal':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$signalReferenceProperty(_p196._0),
								_1: {ctor: '[]'}
							})
					};
				case 'RScheme':
					return {
						...
						_1: _elm_lang$core$Json_Encode$object(
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SScheme(_p196._0),
									_1: _p196._1
								}))
					};
				case 'RData':
					return {
						...
						_0: 'range',
						_1: _elm_lang$core$Json_Encode$object(
							A2(_elm_lang$core$List$map, _gicentre$elm_vega$Vega$dataRefProperty, _p196._0))
					};
				case 'RStep':
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'step',
									_1: _gicentre$elm_vega$Vega$valueSpec(_p196._0)
								},
								_1: {ctor: '[]'}
							})
					};
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$Vega$interpolateSpec(_p195._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$Vega$niceSpec(_p195._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
