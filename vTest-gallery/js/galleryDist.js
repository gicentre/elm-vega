...
var _gicentre$elm_vega$GalleryDist$wheat1 = function () {
	var mk = function (_p0) {
												...
												_0: _gicentre$elm_vega$Vega$maY(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vField(
																_gicentre$elm_vega$Vega$field('y0')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$maSize(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vSignal('symbolDiameter * symbolDiameter'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
			...
			A4(
				...
				_gicentre$elm_vega$Vega$SBottom,
				{
					...
					_0: _gicentre$elm_vega$Vega$axValues(
						_gicentre$elm_vega$Vega$vSignal('sequence(bins.start, bins.stop + bins.step, bins.step)')),
					_1: {
						ctor: '::',
										...
										_gicentre$elm_vega$Vega$numList(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$numSignal('extent[1]'),
													_1: {ctor: '[]'}
												}
											}))),
								_1: {ctor: '[]'}
				...
				A3(
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$siBind(
								_gicentre$elm_vega$Vega$iRange(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$inMin(-0.1),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$inMax(0.1),
											_1: {ctor: '[]'}
										}
									})),
							_1: {ctor: '[]'}
					...
					A3(
						...
						'binStep',
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$siValue(
								_gicentre$elm_vega$Vega$vNum(7.5e-2)),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$siBind(
									_gicentre$elm_vega$Vega$iRange(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$inMin(-1.0e-3),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$inMax(0.2),
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$inStep(1.0e-3),
													_1: {ctor: '[]'}
												}
											}
										})),
						...
						A3(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$siUpdate('extent[1] * (1 + symbolDiameter)'),
								_1: {ctor: '[]'}
							},
							_p3)))));
	};
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_0: A3(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$bnAnchor(
								_gicentre$elm_vega$Vega$numSignal('binOffset')),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$bnStep(
									_gicentre$elm_vega$Vega$numSignal('binStep')),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$bnNice(_gicentre$elm_vega$Vega$false),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$bnSignal('bins'),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
						...
						_0: _gicentre$elm_vega$Vega$trStack(
							{
								...
								_0: _gicentre$elm_vega$Vega$stGroupBy(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$field('bin0'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$stSort(
										{
											...
											_0: {
												ctor: '_Tuple2',
												_0: _gicentre$elm_vega$Vega$field('u'),
						...
						_1: {
							...
							_0: A2(
								...
								_gicentre$elm_vega$Vega$field('y1'),
								'extent'),
							_1: {ctor: '[]'}
						}
					}
...
var _gicentre$elm_vega$GalleryDist$contour1 = function () {
	var mk = function (_p4) {
		return _gicentre$elm_vega$Vega$marks(
			A3(
				_gicentre$elm_vega$Vega$mark,
												...
												_1: {
													...
													_1: {
														...
														_0: _gicentre$elm_vega$Vega$maSize(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vNum(4),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
		...
		return _gicentre$elm_vega$Vega$legends(
			A2(
				_gicentre$elm_vega$Vega$legend,
				{
					...
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$leType(_gicentre$elm_vega$Vega$LGradient),
						_1: {ctor: '[]'}
					}
				},
				_p5));
							...
							_1: {
								...
								_0: _gicentre$elm_vega$Vega$scDomain(
									_gicentre$elm_vega$Vega$doData(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$daDataset('contours'),
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$daField(
													_gicentre$elm_vega$Vega$field('value')),
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_0: _gicentre$elm_vega$Vega$trFilter(
						_gicentre$elm_vega$Vega$expr('datum[\'Horsepower\'] != null && datum[\'Miles_per_Gallon\'] != null')),
					_1: {ctor: '[]'}
				},
				A2(
					_gicentre$elm_vega$Vega$data,
				...
				_0: A2(
					_gicentre$elm_vega$Vega$transform,
					{
						...
						_0: A3(
							...
							_gicentre$elm_vega$Vega$numSignal('width'),
							_gicentre$elm_vega$Vega$numSignal('height'),
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$cnX(
									_gicentre$elm_vega$Vega$fExpr('scale(\'xScale\', datum.Horsepower)')),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$cnY(
										_gicentre$elm_vega$Vega$fExpr('scale(\'yScale\', datum.Miles_per_Gallon)')),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$cnCount(
											_gicentre$elm_vega$Vega$numSignal('count')),
										_1: {ctor: '[]'}
									}
								}
							}),
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$daSource('source'),
							_1: {ctor: '[]'}
						})),
				_1: {ctor: '[]'}
			}
	...
	var cf = _gicentre$elm_vega$Vega$config(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$Vega$cfScaleRange,
				_gicentre$elm_vega$Vega$RaHeatmap,
				A2(
					_gicentre$elm_vega$Vega$raScheme,
					_gicentre$elm_vega$Vega$str('greenblue'),
					{ctor: '[]'})),
			_1: {ctor: '[]'}
		});
	return _gicentre$elm_vega$Vega$toVega(
...
var _gicentre$elm_vega$GalleryDist$scatter1 = function () {
	var mk = function (_p9) {
		return _gicentre$elm_vega$Vega$marks(
			A3(
				_gicentre$elm_vega$Vega$mark,
											...
											_0: _gicentre$elm_vega$Vega$maX(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vSignal('(datum.hp0 + datum.hp1) / 2'),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
												...
												_0: _gicentre$elm_vega$Vega$maY(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vSignal('(datum.mpg0 + datum.mpg1) / 2'),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
													...
													_1: {
														...
														_0: _gicentre$elm_vega$Vega$maShape(
															{
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vStr('circle'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
					...
					_gicentre$elm_vega$Vega$transform,
					{
						...
						_1: {
							...
							_0: A3(
								_gicentre$elm_vega$Vega$trBin,
								_gicentre$elm_vega$Vega$field('Horsepower'),
								_gicentre$elm_vega$Vega$numSignal('hp_extent'),
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$bnMaxBins(
										_gicentre$elm_vega$Vega$num(10)),
									_1: {
										ctor: '::',
										_0: A2(_gicentre$elm_vega$Vega$bnAs, 'hp0', 'hp1'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_1: {
									...
									_0: A3(
										_gicentre$elm_vega$Vega$trBin,
										_gicentre$elm_vega$Vega$field('Miles_per_Gallon'),
										_gicentre$elm_vega$Vega$numSignal('mpg_extent'),
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$bnMaxBins(
												_gicentre$elm_vega$Vega$num(10)),
											_1: {
												ctor: '::',
												_0: A2(_gicentre$elm_vega$Vega$bnAs, 'mpg0', 'mpg1'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
...
var _gicentre$elm_vega$GalleryDist$window2 = function () {
					...
					_0: _gicentre$elm_vega$Vega$mFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$srData(
								_gicentre$elm_vega$Vega$str('directors')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
											...
											_0: _gicentre$elm_vega$Vega$maX2(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$field('Gross')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
												...
												_0: _gicentre$elm_vega$Vega$maY(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vField(
																_gicentre$elm_vega$Vega$field('Category')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$scDomain(
								_gicentre$elm_vega$Vega$doData(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$daDataset('directors'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$daField(
												_gicentre$elm_vega$Vega$field('Gross')),
											...
											_1: {
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$daSort(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$soOp(_gicentre$elm_vega$Vega$Max),
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$soByField(
																	_gicentre$elm_vega$Vega$str('Gross')),
																_1: {
																	ctor: '::',
	...
	var ti = A2(
		...
		_gicentre$elm_vega$Vega$strSignal('\'Top Directors by \' + label[op] + \' Worldwide Gross\''),
		{
			ctor: '::',
			...
			A3(
							...
							_gicentre$elm_vega$Vega$iRange(
								{
									...
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$inMax(30),
										_1: {
											ctor: '::',
				...
				A3(
					...
					'op',
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$siValue(
							_gicentre$elm_vega$Vega$vStr('average')),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$siBind(
								_gicentre$elm_vega$Vega$iSelect(
								...
								_gicentre$elm_vega$Vega$vObject(
									{
										...
										_1: {
											...
											_0: A2(
												_gicentre$elm_vega$Vega$keyValue,
												'median',
												_gicentre$elm_vega$Vega$vStr('Median')),
											_1: {
												ctor: '::',
												_0: A2(
													_gicentre$elm_vega$Vega$keyValue,
													'sum',
													_gicentre$elm_vega$Vega$vStr('Total')),
												_1: {ctor: '[]'}
											}
										}
									})),
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$trFilter(
						_gicentre$elm_vega$Vega$expr('datum.Director != null && datum.Worldwide_Gross != null')),
					_1: {ctor: '[]'}
				},
				A2(
					_gicentre$elm_vega$Vega$data,
					...
					_gicentre$elm_vega$Vega$transform,
					{
						...
						_0: _gicentre$elm_vega$Vega$trAggregate(
							{
								...
								_0: _gicentre$elm_vega$Vega$agGroupBy(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$field('Director'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$agOps(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$opSignal('op'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$agFields(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$field('Worldwide_Gross'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_gicentre$elm_vega$Vega$wnOperation, _gicentre$elm_vega$Vega$RowNumber, 'rank'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$wnSort(
										{
											...
											_0: {
												ctor: '_Tuple2',
												_0: _gicentre$elm_vega$Vega$field('Gross'),
					...
					_0: A2(
						_gicentre$elm_vega$Vega$transform,
						{
							...
							_0: A4(
								...
								'ranks',
								_gicentre$elm_vega$Vega$field('Director'),
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$field('Director'),
									_1: {ctor: '[]'}
								},
								{
									...
									_0: _gicentre$elm_vega$Vega$luValues(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$field('rank'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(_gicentre$elm_vega$Vega$trFormula, 'datum.rank < k ? datum.Director : \'All Others\'', 'Category'),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$trAggregate(
										{
											...
											_0: _gicentre$elm_vega$Vega$agGroupBy(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$field('Category'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
	...
	return _gicentre$elm_vega$Vega$toVega(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$height(410),
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$padding(5),
					_1: {
...
var _gicentre$elm_vega$GalleryDist$window1 = function () {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$trFilter(
									_gicentre$elm_vega$Vega$expr('datum.rank <= k')),
								_1: {ctor: '[]'}
							}
						}
					}
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$vField(
														_gicentre$elm_vega$Vega$fParent(
															_gicentre$elm_vega$Vega$field('organ'))),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
													...
													_0: _gicentre$elm_vega$Vega$maX(
														{
															...
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vField(
																	_gicentre$elm_vega$Vega$field('q1')),
																_1: {ctor: '[]'}
															}
														}),
													_1: {
														...
														_0: _gicentre$elm_vega$Vega$maX2(
															{
																...
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vField(
																		_gicentre$elm_vega$Vega$field('q3')),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {ctor: '[]'}
														...
														_0: _gicentre$elm_vega$Vega$maX(
															{
																...
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vField(
																		_gicentre$elm_vega$Vega$field('median')),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {ctor: '[]'}
								...
								_gicentre$elm_vega$Vega$doData(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$daField(
												_gicentre$elm_vega$Vega$field('density')),
											_1: {ctor: '[]'}
										}
									})),
							_1: {ctor: '[]'}
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_0: A3(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$fSignal('fields'),
							_1: {ctor: '[]'}
						},
						'organ',
						'value'),
	...
	var cf = _gicentre$elm_vega$Vega$config(
		{
			...
			_0: A2(
				...
				_gicentre$elm_vega$Vega$AxBand,
				{
					...
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$axTickExtra(_gicentre$elm_vega$Vega$true),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$axTickOffset(
								_gicentre$elm_vega$Vega$num(0)),
							_1: {ctor: '[]'}
						}
					}
												...
												_0: _gicentre$elm_vega$Vega$maX(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vField(
																_gicentre$elm_vega$Vega$field('min')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$maX2(
														{
															...
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vField(
																	_gicentre$elm_vega$Vega$field('max')),
																_1: {ctor: '[]'}
															}
														}),
													_1: {ctor: '[]'}
									...
									_0: _gicentre$elm_vega$Vega$enEnter(
										{
											...
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$maCornerRadius(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vNum(4),
														_1: {ctor: '[]'}
											...
											_1: {
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$maFill(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vSignal('scale(\'cScale\', \'Kernel Density Estimate\')'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
						...
						_0: _gicentre$elm_vega$Vega$mFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$srData(
									_gicentre$elm_vega$Vega$str('normal')),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$maStroke(
														{
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vSignal('scale(\'cScale\', \'Normal Estimate\')'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														...
														_0: _gicentre$elm_vega$Vega$maY(
															{
																...
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$vOffset(
																		_gicentre$elm_vega$Vega$vSignal('height')),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {
															...
															_1: {
																...
																_1: {
																	...
																	_0: _gicentre$elm_vega$Vega$maOpacity(
																		{
																			ctor: '::',
																			_0: _gicentre$elm_vega$Vega$vNum(0.4),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$scDomain(
								_gicentre$elm_vega$Vega$doData(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$daDataset('points'),
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$daField(
												_gicentre$elm_vega$Vega$field('u')),
												...
												_0: _gicentre$elm_vega$Vega$daReferences(
													{
														...
														_1: {
															...
															_0: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$daDataset('normal'),
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$daField(
																		_gicentre$elm_vega$Vega$field('density')),
				...
				A3(
					...
					A3(
						...
						'method',
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$siValue(
								_gicentre$elm_vega$Vega$vStr('pdf')),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$siBind(
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$daSource('points'),
							_1: {ctor: '[]'}
						})),
				_1: {
					ctor: '::',
							...
							_0: A2(
									...
									_gicentre$elm_vega$Vega$numSignal('bandWidth')),
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$dnMethodAsSignal('method'),
											_1: {ctor: '[]'}
										}
									}
								}),
						...
						_0: A2(
							_gicentre$elm_vega$Vega$transform,
							{
								...
								_0: A2(
									_gicentre$elm_vega$Vega$trDensity,
									A2(
										_gicentre$elm_vega$Vega$diNormal,
										_gicentre$elm_vega$Vega$numSignal('data(\'summary\')[0].mean'),
										_gicentre$elm_vega$Vega$numSignal('data(\'summary\')[0].stdev')),
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$dnExtent(
											_gicentre$elm_vega$Vega$numSignal('domain(\'xScale\')')),
	...
	return _gicentre$elm_vega$Vega$toVega(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$height(100),
				_1: {
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$padding(5),
					_1: {
					...
					_0: _gicentre$elm_vega$Vega$mFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$srData(
								_gicentre$elm_vega$Vega$str('counts')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
										...
										_0: _gicentre$elm_vega$Vega$maX(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vField(
														_gicentre$elm_vega$Vega$field('bin0')),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vOffset(
											...
											_0: _gicentre$elm_vega$Vega$maX2(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$field('bin1')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
						...
						_0: _gicentre$elm_vega$Vega$mFrom(
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$srData(
									_gicentre$elm_vega$Vega$str('nulls')),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
									...
									_0: _gicentre$elm_vega$Vega$enUpdate(
										{
											...
											_0: _gicentre$elm_vega$Vega$maX(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vScale('xScaleNull'),
													_1: {
														ctor: '::',
	...
	var sc = function (_p39) {
		return _gicentre$elm_vega$Vega$scales(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$scType(_gicentre$elm_vega$Vega$ScBinLinear),
					_1: {
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$scRange(
							_gicentre$elm_vega$Vega$raValues(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$vSignal('barStep + nullGap'),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$vSignal('width'),
										_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: _gicentre$elm_vega$Vega$scDomain(
								_gicentre$elm_vega$Vega$doNums(
									_gicentre$elm_vega$Vega$numSignal('binDomain'))),
							_1: {
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$scRound(_gicentre$elm_vega$Vega$true),
								_1: {ctor: '[]'}
								...
								_gicentre$elm_vega$Vega$raValues(
									{
										...
										_1: {
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$vSignal('barStep'),
											_1: {ctor: '[]'}
										}
									})),
							_1: {
														...
														_0: _gicentre$elm_vega$Vega$daReferences(
															{
																...
																_0: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$daDataset('counts'),
																	_1: {
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$daField(
																			_gicentre$elm_vega$Vega$field('count')),
																...
																_1: {
																	...
																	_0: {
																		ctor: '::',
																		_0: _gicentre$elm_vega$Vega$daDataset('nulls'),
																		_1: {
																			ctor: '::',
																			_0: _gicentre$elm_vega$Vega$daField(
																				_gicentre$elm_vega$Vega$field('count')),
		...
		return _gicentre$elm_vega$Vega$signals(
			A3(
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$siUpdate('sequence(bins.start, bins.stop + bins.step, bins.step)'),
						_1: {ctor: '[]'}
					},
					A3(
						_gicentre$elm_vega$Vega$signal,
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_0: A2(
						_gicentre$elm_vega$Vega$trExtentAsSignal,
						_gicentre$elm_vega$Vega$field('IMDB_Rating'),
						'extent'),
					_1: {
						ctor: '::',
						_0: A3(
							_gicentre$elm_vega$Vega$trBin,
							_gicentre$elm_vega$Vega$field('IMDB_Rating'),
							_gicentre$elm_vega$Vega$numSignal('extent'),
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$bnSignal('bins'),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$bnMaxBins(
										_gicentre$elm_vega$Vega$numSignal('maxBins')),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A2(
					_gicentre$elm_vega$Vega$transform,
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$trFilter(
							_gicentre$elm_vega$Vega$expr('datum[\'IMDB_Rating\'] != null')),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$trAggregate(
								{
									...
									_0: _gicentre$elm_vega$Vega$agGroupBy(
										{
											...
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$field('bin1'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$daSource('table'),
							_1: {ctor: '[]'}
						})),
				_1: {
					ctor: '::',
						...
						_0: _gicentre$elm_vega$Vega$autosize(
							{
								...
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$AResize,
									_1: {ctor: '[]'}
								}
							}),
						_1: {
					...
					_0: _gicentre$elm_vega$Vega$mFrom(
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$srData(
								_gicentre$elm_vega$Vega$str('binned')),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
											...
											_0: _gicentre$elm_vega$Vega$maX2(
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vOffset(
																_gicentre$elm_vega$Vega$vSignal('binStep > 0.02 ? -0.5 : 0')),
															_1: {ctor: '[]'}
														}
													}
												}),
								...
								_1: {
									...
									_0: _gicentre$elm_vega$Vega$scDomain(
										_gicentre$elm_vega$Vega$doData(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$daDataset('binned'),
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$daField(
														_gicentre$elm_vega$Vega$field('count')),
...
var _gicentre$elm_vega$GalleryDist$mySpecs = _gicentre$elm_vega$Vega$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'histo1', _1: _gicentre$elm_vega$GalleryDist$histo1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'histo2', _1: _gicentre$elm_vega$GalleryDist$histo2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'density1', _1: _gicentre$elm_vega$GalleryDist$density1},
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'window1', _1: _gicentre$elm_vega$GalleryDist$window1},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'window2', _1: _gicentre$elm_vega$GalleryDist$window2},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'scatter1', _1: _gicentre$elm_vega$GalleryDist$scatter1},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'contour1', _1: _gicentre$elm_vega$GalleryDist$contour1},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'wheat1', _1: _gicentre$elm_vega$GalleryDist$wheat1},
											_1: {ctor: '[]'}
										}
									}
								}
...
var _gicentre$elm_vega$GalleryDist$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$GalleryDist$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$GalleryDist$mySpecs,
			_1: _gicentre$elm_vega$GalleryDist$elmToJS(_gicentre$elm_vega$GalleryDist$mySpecs)
		},
...
var Elm = {};
Elm['GalleryDist'] = Elm['GalleryDist'] || {};
if (typeof _gicentre$elm_vega$GalleryDist$main !== 'undefined') {
    _gicentre$elm_vega$GalleryDist$main(Elm['GalleryDist'], 'GalleryDist', undefined);
}
