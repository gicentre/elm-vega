						...
						_0: _gicentre$elm_vega$Vega$trStack(
							{
								...
								_0: _gicentre$elm_vega$Vega$stGroupBy(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$str('bin0'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$stSort(
										{
											...
											_0: _gicentre$elm_vega$Vega$coField(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$str('u'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _gicentre$elm_vega$GalleryDist$sourceExample = _gicentre$elm_vega$GalleryDist$wheat1;
							...
							_gicentre$elm_vega$Vega$numSignal('height'),
							{
								...
								_0: _gicentre$elm_vega$Vega$cnX(
									_gicentre$elm_vega$Vega$strExpr(
										_gicentre$elm_vega$Vega$expr('scale(\'xScale\', datum.Horsepower)'))),
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$cnY(
										_gicentre$elm_vega$Vega$strExpr(
											_gicentre$elm_vega$Vega$expr('scale(\'yScale\', datum.Miles_per_Gallon)'))),
									_1: {
										ctor: '::',
													...
													_0: _gicentre$elm_vega$Vega$maSize(
														{
															...
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vField(
																	_gicentre$elm_vega$Vega$fName('count')),
																_1: {ctor: '[]'}
															}
														}),
													_1: {
										...
										_0: _gicentre$elm_vega$Vega$trAggregate(
											{
												...
												_0: _gicentre$elm_vega$Vega$agGroupBy(
													{
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$str('hp0'),
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$str('hp1'),
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$str('mpg0'),
																_1: {
																	ctor: '::',
																	_0: _gicentre$elm_vega$Vega$str('mpg1'),
																	_1: {ctor: '[]'}
																}
															}
														}
											...
											_0: _gicentre$elm_vega$Vega$maX2(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$fName('Gross')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
					...
					_gicentre$elm_vega$Vega$transform,
					{
						...
						_0: _gicentre$elm_vega$Vega$trAggregate(
							{
								...
								_0: _gicentre$elm_vega$Vega$agGroupBy(
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$str('Director'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: _gicentre$elm_vega$Vega$agFields(
											{
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$str('Worldwide_Gross'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A4(_gicentre$elm_vega$Vega$wnOperation, _gicentre$elm_vega$Vega$RowNumber, _elm_lang$core$Maybe$Nothing, _gicentre$elm_vega$Vega$strNull, 'rank'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$wnSort(
										{
											...
											_0: _gicentre$elm_vega$Vega$coField(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$str('Gross'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
					...
					_0: A2(
						_gicentre$elm_vega$Vega$transform,
						{
							...
							_0: A4(
								...
								'ranks',
								_gicentre$elm_vega$Vega$str('Director'),
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$str('Director'),
									_1: {ctor: '[]'}
								},
								{
									...
									_0: _gicentre$elm_vega$Vega$luValues(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$str('rank'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
									...
									_0: _gicentre$elm_vega$Vega$trAggregate(
										{
											...
											_0: _gicentre$elm_vega$Vega$agGroupBy(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$str('Category'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												...
												_0: _gicentre$elm_vega$Vega$maY(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vField(
																_gicentre$elm_vega$Vega$fName('Director')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
												...
												_0: _gicentre$elm_vega$Vega$maX(
													{
														...
														_1: {
															ctor: '::',
															_0: _gicentre$elm_vega$Vega$vField(
																_gicentre$elm_vega$Vega$fName('min')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
													...
													_0: _gicentre$elm_vega$Vega$maX2(
														{
															...
															_1: {
																ctor: '::',
																_0: _gicentre$elm_vega$Vega$vField(
																	_gicentre$elm_vega$Vega$fName('max')),
																_1: {ctor: '[]'}
															}
														}),
													_1: {ctor: '[]'}
											...
											_0: _gicentre$elm_vega$Vega$maY(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$fName('density')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
										...
										_0: _gicentre$elm_vega$Vega$maX(
											{
												...
												_1: {
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vField(
														_gicentre$elm_vega$Vega$fName('bin0')),
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vOffset(
											...
											_0: _gicentre$elm_vega$Vega$maX2(
												{
													...
													_1: {
														ctor: '::',
														_0: _gicentre$elm_vega$Vega$vField(
															_gicentre$elm_vega$Vega$fName('bin1')),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
											...
											_0: _gicentre$elm_vega$Vega$maX(
												{
													ctor: '::',
													_0: _gicentre$elm_vega$Vega$vScale(
														_gicentre$elm_vega$Vega$fName('xScaleNull')),
													_1: {
														ctor: '::',
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_0: A2(
						_gicentre$elm_vega$Vega$trExtentAsSignal,
						_gicentre$elm_vega$Vega$str('IMDB_Rating'),
						'extent'),
					_1: {
						ctor: '::',
						_0: A3(
									...
									_0: _gicentre$elm_vega$Vega$agGroupBy(
										{
											...
											_1: {
												ctor: '::',
												_0: _gicentre$elm_vega$Vega$str('bin1'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
							...
							_0: _gicentre$elm_vega$Vega$trAggregate(
								{
									...
									_0: _gicentre$elm_vega$Vega$agKey(
										_gicentre$elm_vega$Vega$str('bin0')),
									_1: {
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$agGroupBy(
											{
