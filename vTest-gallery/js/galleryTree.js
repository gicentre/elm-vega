				...
				_gicentre$elm_vega$Vega$transform,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A3(_gicentre$elm_vega$Vega$trFormula, 'PI * datum.angle / 180', 'radians', _gicentre$elm_vega$Vega$AlwaysUpdate),
								_1: {
									ctor: '::',
									_0: A3(_gicentre$elm_vega$Vega$trFormula, 'inrange(datum.angle, [90, 270])', 'leftside', _gicentre$elm_vega$Vega$AlwaysUpdate),
									_1: {
										ctor: '::',
										_0: A3(_gicentre$elm_vega$Vega$trFormula, 'originX + datum.radius * cos(datum.radians)', 'x', _gicentre$elm_vega$Vega$AlwaysUpdate),
										_1: {
											ctor: '::',
											_0: A3(_gicentre$elm_vega$Vega$trFormula, 'originY + datum.radius * sin(datum.radians)', 'y', _gicentre$elm_vega$Vega$AlwaysUpdate),
											_1: {ctor: '[]'}
										}
									}
								}
