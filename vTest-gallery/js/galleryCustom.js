	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A3(_gicentre$elm_vega$Vega$trFormula, 'hours(datum.date)', 'hour', _gicentre$elm_vega$Vega$InitOnly),
					_1: {
						ctor: '::',
						_0: A3(_gicentre$elm_vega$Vega$trFormula, 'datetime(year(datum.date), month(datum.date), date(datum.date))', 'date', _gicentre$elm_vega$Vega$InitOnly),
						_1: {ctor: '[]'}
					}
				},
				A2(
	...
	var ds = _gicentre$elm_vega$Vega$dataSource(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A3(_gicentre$elm_vega$Vega$trFormula, 'abs(datum.value)', 'abs', _gicentre$elm_vega$Vega$AlwaysUpdate),
					_1: {
						ctor: '::',
						_0: A3(_gicentre$elm_vega$Vega$trFormula, 'datum.value < 0 ? \'deficit\' : \'surplus\'', 'type', _gicentre$elm_vega$Vega$AlwaysUpdate),
						_1: {ctor: '[]'}
					}
				},
				A2(
						...
						_0: A2(
							_gicentre$elm_vega$Vega$transform,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A3(_gicentre$elm_vega$Vega$trFormula, 'datum.argmin.budgetYear', 'tooltipYear', _gicentre$elm_vega$Vega$AlwaysUpdate),
										_1: {ctor: '[]'}
									}
								}
							},
