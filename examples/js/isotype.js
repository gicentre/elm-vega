...
var _gicentre$elm_vega$Isotype$toRows = F2(
	function (country, animalFreqs) {
		var toRow = F2(
			function (animal, n) {
				return _gicentre$elm_vega$Eve$dataRow(
					{
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'country',
							_1: _gicentre$elm_vega$Eve$Str(country)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'animal',
								_1: _gicentre$elm_vega$Eve$Str(animal)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'col',
									_1: _gicentre$elm_vega$Eve$Number(
...
var _gicentre$elm_vega$Isotype$personGrid = function () {
	var enc = function (_p2) {
		return _gicentre$elm_vega$Eve$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Eve$PName('col'),
					_1: {
						ctor: '::',
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Eve$PName('row'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Eve$PmType(_gicentre$elm_vega$Eve$Ordinal),
							_1: {
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Eve$MPath(
								A2(
						...
						A2(
							_gicentre$elm_vega$Eve$color,
							{
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Eve$MString('rgb(194,81,64)'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Eve$MString('rgb(167,165,156)'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Eve$MNumber(90),
									_1: {ctor: '[]'}
								},
								_p2))))));
	};
	...
	var trans = function (_p4) {
		return _gicentre$elm_vega$Eve$transform(
			A3(
				_gicentre$elm_vega$Eve$calculate,
				'ceil (datum.id/10)',
				'col',
				A3(_gicentre$elm_vega$Eve$calculate, 'datum.id - datum.col*10', 'row', _p4)));
	};
	...
	return _gicentre$elm_vega$Eve$toVegaLite(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$height(400),
				_1: {
					ctor: '::',
					_0: data(
						{ctor: '[]'}),
...
var _gicentre$elm_vega$Isotype$livestock = function () {
		...
		return _gicentre$elm_vega$Eve$encoding(
			A3(
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Eve$PName('animal'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Eve$PmType(_gicentre$elm_vega$Eve$Ordinal),
							_1: {
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Eve$FName('country'),
							_1: {
								ctor: '::',
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Eve$MName('animal'),
								_1: {
									ctor: '::',
							...
							A2(
								...
								A2(
									...
									A2(
										...
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Eve$MNumber(200),
											_1: {ctor: '[]'}
										},
										_p6))))))));
	};
	var data = function (_p7) {
		return A2(
			_gicentre$elm_vega$Eve$dataFromRows,
			{ctor: '[]'},
			A3(
	...
	return _gicentre$elm_vega$Eve$toVegaLite(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$width(800),
			_1: {
				ctor: '::',
