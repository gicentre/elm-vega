...
var _gicentre$elm_vega$Isotype$toRows = F2(
	function (country, animalFreqs) {
		var toRow = F2(
			function (animal, n) {
				return _gicentre$elm_vega$Vega$dataRow(
					{
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'country',
							_1: _gicentre$elm_vega$Vega$Str(country)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'animal',
								_1: _gicentre$elm_vega$Vega$Str(animal)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'col',
									_1: _gicentre$elm_vega$Vega$Number(
	...
	var enc = function (_p2) {
		return _gicentre$elm_vega$Vega$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$PName('col'),
					_1: {
						ctor: '::',
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$PName('row'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$PmType(_gicentre$elm_vega$Vega$Ordinal),
							_1: {
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$MPath(
								A2(
						...
						A2(
							_gicentre$elm_vega$Vega$color,
							{
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$MString('rgb(194,81,64)'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _gicentre$elm_vega$Vega$MString('rgb(167,165,156)'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$MNumber(90),
									_1: {ctor: '[]'}
								},
								_p2))))));
	};
	...
	var trans = function (_p4) {
		return _gicentre$elm_vega$Vega$transform(
			A3(
				...
				'ceil (datum.id/10)',
				'col',
				A3(_gicentre$elm_vega$Vega$calculateAs, 'datum.id - datum.col*10', 'row', _p4)));
	};
		...
		return _gicentre$elm_vega$Vega$encoding(
			A3(
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$elm_vega$Vega$PName('animal'),
						_1: {
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$PmType(_gicentre$elm_vega$Vega$Ordinal),
							_1: {
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$elm_vega$Vega$FName('country'),
							_1: {
								ctor: '::',
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$MName('animal'),
								_1: {
									ctor: '::',
