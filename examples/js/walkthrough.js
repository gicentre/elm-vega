					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'equal',
									_1: _gicentre$elm_vega$Eve$datavalue(_p87._1)
								},
								_1: {ctor: '[]'}
							}
						})
					...
					return _elm_lang$core$Json_Encode$list(
						{
							...
							_0: _elm_lang$core$Json_Encode$object(
								A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$dateTimeProperty, _p88._0)),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$object(
									A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$dateTimeProperty, _p88._1)),
								_1: {ctor: '[]'}
							}
						});
				}
			...
			A2(
				...
				function (_p90) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p91._0,
						_1: _gicentre$elm_vega$Eve$datavalue(_p91._1)
					};
				},
				row)));
};
...
var _gicentre$elm_vega$Eve$calculate = F2(
	function (expr, label) {
		return F2(
			function (x, y) {
				return {ctor: '::', _0: x, _1: y};
	...
	switch (_p93.ctor) {
		...
		case 'DmType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$measurementLabel(_p93._0))
			};
		case 'DBin':
			return _gicentre$elm_vega$Eve$bin(_p93._0);
		case 'DTimeUnit':
			return {
				ctor: '_Tuple2',
				_0: 'timeUnit',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$timeUnitLabel(_p93._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$opLabel(_p93._0))
			};
	}
};
	...
	switch (_p94.ctor) {
		...
		case 'FmType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$measurementLabel(_p94._0))
			};
		case 'FBin':
			return _gicentre$elm_vega$Eve$bin(_p94._0);
		case 'FAggregate':
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$opLabel(_p94._0))
			};
		case 'FTimeUnit':
			return {
				ctor: '_Tuple2',
				_0: 'timeUnit',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$timeUnitLabel(_p94._0))
			};
		default:
			return {
				ctor: '_Tuple2',
				_0: 'header',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$headerProperty, _p94._0))
			};
	}
};
...
var _gicentre$elm_vega$Eve$facetMappingProperty = function (fMap) {
	...
	if (_p95.ctor === 'RowBy') {
		return {
			...
			_0: 'row',
			_1: _elm_lang$core$Json_Encode$object(
				A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$facetChannelProperty, _p95._0))
		};
	} else {
		return {
			ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								...
								_0: 'repeat',
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$Eve$arrangementLabel(_p96._0))
							},
							_1: {ctor: '[]'}
						})
				},
		...
		case 'MScale':
			return {
				...
				_0: {
					...
					_0: 'scale',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$scaleProperty, _p96._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MLegend':
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: {
					...
					_0: 'legend',
					_1: _elm_lang$core$Json_Encode$object(
						A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$legendProperty, _p97))
				},
				_1: {ctor: '[]'}
			};
		case 'MBin':
			return {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$bin(_p96._0),
				_1: {ctor: '[]'}
			};
		case 'MCondition':
			return {
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Eve$markChannelProperty, _p96._1)
						})
				},
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Eve$markChannelProperty, _p96._2)
			};
		case 'MTimeUnit':
			return {
				ctor: '::',
...
var _gicentre$elm_vega$Eve$orderChannelProperty = function (oDef) {
	...
	switch (_p98.ctor) {
		...
		case 'OBin':
			return _gicentre$elm_vega$Eve$bin(_p98._0);
		case 'OAggregate':
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
		...
		default:
			...
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$sortProperty, _p100))
			};
	}
};
	...
	switch (_p101.ctor) {
		...
		case 'PmType':
			return {
				...
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$measurementLabel(_p101._0))
			};
		case 'PBin':
			return _gicentre$elm_vega$Eve$bin(_p101._0);
		case 'PAggregate':
			return {
				ctor: '_Tuple2',
				_0: 'aggregate',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$opLabel(_p101._0))
			};
		case 'PTimeUnit':
			return {
				ctor: '_Tuple2',
				_0: 'timeUnit',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$Eve$timeUnitLabel(_p101._0))
			};
		case 'PSort':
			var _p103 = _p101._0;
			var _p102 = _p103;
			...
			return {
				...
				_0: 'sort',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$sortProperty, _p103))
			};
		case 'PScale':
			return {
				ctor: '_Tuple2',
				_0: 'scale',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$scaleProperty, _p101._0))
			};
		case 'PAxis':
			var _p104 = _p101._0;
			return _elm_lang$core$Native_Utils.eq(
				...
				_0: 'axis',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$Eve$axisProperty, _p104))
			};
		case 'PStack':
			return _gicentre$elm_vega$Eve$stackProperty(_p101._0);
		default:
			return {
				ctor: '_Tuple2',
				_0: 'field',
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_0: 'repeat',
							_1: _elm_lang$core$Json_Encode$string(
								_gicentre$elm_vega$Eve$arrangementLabel(_p101._0))
						},
						_1: {ctor: '[]'}
					})
			};
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								...
								_0: 'repeat',
								_1: _elm_lang$core$Json_Encode$string(
									_gicentre$elm_vega$Eve$arrangementLabel(_p105._0))
							},
							_1: {ctor: '[]'}
						})
				},
		...
		case 'TmType':
			return {
				...
				_0: {
					...
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Eve$measurementLabel(_p105._0))
				},
				_1: {ctor: '[]'}
			};
		case 'TBin':
			return {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$bin(_p105._0),
				_1: {ctor: '[]'}
			};
		case 'TAggregate':
			return {
				...
				_0: {
					...
					_0: 'aggregate',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Eve$opLabel(_p105._0))
				},
				_1: {ctor: '[]'}
			};
		case 'TTimeUnit':
			return {
				...
				_0: {
					...
					_0: 'timeUnit',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$Eve$timeUnitLabel(_p105._0))
				},
				_1: {ctor: '[]'}
			};
		case 'TFormat':
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Eve$textChannelProperty, _p105._1)
						})
				},
				_1: A2(_elm_lang$core$List$concatMap, _gicentre$elm_vega$Eve$textChannelProperty, _p105._2)
			};
	}
};
	...
	return _elm_lang$core$Json_Encode$object(
		A2(
			...
			function (_p106) {
				...
				return {
					ctor: '_Tuple2',
					_0: _gicentre$elm_vega$Eve$propertyLabel(_p107._0),
					_1: _p107._1
				};
			},
			specs));
...
var _gicentre$elm_vega$Walkthrough$crossFilter = function () {
	...
	var filterTrans = function (_p2) {
		return _gicentre$elm_vega$Eve$transform(
			A2(
				...
				_gicentre$elm_vega$Eve$FSelection('brush'),
				_p2));
	};
	...
	var hourTrans = function (_p4) {
		return _gicentre$elm_vega$Eve$transform(
			A3(_gicentre$elm_vega$Eve$calculate, 'hours(datum.date)', 'hour', _p4));
	};
	return _gicentre$elm_vega$Eve$toVegaLite(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$specification(
					_gicentre$elm_vega$Eve$asSpec(
						{
							ctor: '::',
							_0: A2(
							...
							_1: {
								...
								_1: {
									...
									_0: _gicentre$elm_vega$Eve$layer(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Eve$asSpec(
												{
													ctor: '::',
													_0: A2(
...
var _gicentre$elm_vega$Walkthrough$contextAndFocus = function () {
							...
							_0: _gicentre$elm_vega$Eve$PScale(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Eve$SDomain(
										_gicentre$elm_vega$Eve$DSelection('brush')),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
	...
	var specDetail = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$width(400),
			_1: {
				ctor: '::',
				_0: A2(
					_gicentre$elm_vega$Eve$mark,
	...
	var specContext = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$width(400),
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$height(80),
				_1: {
					ctor: '::',
					_0: sel(
						{ctor: '[]'}),
...
var _gicentre$elm_vega$Walkthrough$scatterProps = function () {
	...
	var trans = function (_p13) {
		return _gicentre$elm_vega$Eve$transform(
			A3(_gicentre$elm_vega$Eve$calculate, 'year(datum.Year)', 'Year', _p13));
	};
	return {
		ctor: '::',
		_0: A2(
	...
	var sel = function (_p17) {
		return _gicentre$elm_vega$Eve$selection(
			A4(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Eve$Empty,
					_1: {
						ctor: '::',
...
var _gicentre$elm_vega$Walkthrough$dashboard1 = function () {
	...
	var annotationSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$title('Annotation'),
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$width(200),
				_1: {
					ctor: '::',
					_0: A2(
						_gicentre$elm_vega$Eve$mark,
	...
	var barSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$title('Bar chart'),
			_1: {
				ctor: '::',
				_0: A2(
					_gicentre$elm_vega$Eve$mark,
	...
	var scatterSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$title('Scatterplot'),
			_1: {
				ctor: '::',
				_0: A2(
					_gicentre$elm_vega$Eve$mark,
	...
	var histoSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$title('Frequency histogram'),
			_1: {
				ctor: '::',
				_0: A2(
					_gicentre$elm_vega$Eve$mark,
...
var _gicentre$elm_vega$Walkthrough$barChartPair = function () {
	...
	var bar2Spec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$Eve$mark,
	...
	var bar1Spec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$Eve$mark,
...
var _gicentre$elm_vega$Walkthrough$barChartWithAverage = function () {
	...
	var avLineSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$Eve$mark,
...
var _gicentre$elm_vega$Walkthrough$weatherColors = _gicentre$elm_vega$Eve$categoricalDomainMap(
	{
		ctor: '::',
					...
					A2(
						_gicentre$elm_vega$Eve$color,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Eve$MScale(_gicentre$elm_vega$Walkthrough$weatherColors),
									_1: {ctor: '[]'}
								}
							}
						},
				...
				A3(
					...
					A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Eve$FName('weather'),
								_1: {
									ctor: '::',
...
var _gicentre$elm_vega$Walkthrough$dashboard2 = function () {
	...
	var layerSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$layer(
				{
	...
	var barsSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$repeat(
				{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$specification(layerSpec),
				_1: {ctor: '[]'}
			}
		});
	...
	var splomSpec = _gicentre$elm_vega$Eve$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$repeat(
				{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$specification(scatterSpec),
				_1: {ctor: '[]'}
			}
		});
...
var _gicentre$elm_vega$Walkthrough$stripPlot = _gicentre$elm_vega$Eve$toVegaLite(
	{
		ctor: '::',
		_0: A2(
			_gicentre$elm_vega$Eve$dataFromUrl,
