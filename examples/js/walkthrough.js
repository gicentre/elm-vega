...
var _gicentre$elm_vega$Walkthrough$crossFilter = function () {
	...
	var filterTrans = function (_p2) {
		return _gicentre$elm_vega$Vega$transform(
			A2(
				...
				_gicentre$elm_vega$Vega$FSelection('brush'),
				_p2));
	};
	...
	var hourTrans = function (_p4) {
		return _gicentre$elm_vega$Vega$transform(
			A3(_gicentre$elm_vega$Vega$calculateAs, 'hours(datum.date)', 'hour', _p4));
	};
	return _gicentre$elm_vega$Vega$toVegaLite(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$specification(
					_gicentre$elm_vega$Vega$asSpec(
						{
							ctor: '::',
							_0: A2(
							...
							_1: {
								...
								_1: {
									...
									_0: _gicentre$elm_vega$Vega$layer(
										{
											ctor: '::',
											_0: _gicentre$elm_vega$Vega$asSpec(
												{
													ctor: '::',
													_0: A2(
...
var _gicentre$elm_vega$Walkthrough$contextAndFocus = function () {
							...
							_0: _gicentre$elm_vega$Vega$PScale(
								{
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$SDomain(
										_gicentre$elm_vega$Vega$DSelection('brush')),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
	...
	var specDetail = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
	...
	var specContext = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$width(400),
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$height(80),
				_1: {
					ctor: '::',
					_0: sel(
						{ctor: '[]'}),
...
var _gicentre$elm_vega$Walkthrough$scatterProps = function () {
	...
	var trans = function (_p13) {
		return _gicentre$elm_vega$Vega$transform(
			A3(_gicentre$elm_vega$Vega$calculateAs, 'year(datum.Year)', 'Year', _p13));
	};
	return {
		ctor: '::',
		_0: A2(
	...
	var sel = function (_p17) {
		return _gicentre$elm_vega$Vega$selection(
			A4(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$Empty,
					_1: {
						ctor: '::',
...
var _gicentre$elm_vega$Walkthrough$dashboard1 = function () {
	...
	var annotationSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$title('Annotation'),
			_1: {
				ctor: '::',
	...
	var barSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$title('Bar chart'),
			_1: {
				ctor: '::',
				_0: A2(
					_gicentre$elm_vega$Vega$mark,
	...
	var scatterSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$title('Scatterplot'),
			_1: {
				ctor: '::',
				_0: A2(
					_gicentre$elm_vega$Vega$mark,
	...
	var histoSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$title('Frequency histogram'),
			_1: {
				ctor: '::',
				_0: A2(
					_gicentre$elm_vega$Vega$mark,
...
var _gicentre$elm_vega$Walkthrough$barChartPair = function () {
	...
	var bar2Spec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$Vega$mark,
	...
	var bar1Spec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$Vega$mark,
...
var _gicentre$elm_vega$Walkthrough$barChartWithAverage = function () {
	...
	var avLineSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: A2(
				_gicentre$elm_vega$Vega$mark,
...
var _gicentre$elm_vega$Walkthrough$weatherColors = _gicentre$elm_vega$Vega$categoricalDomainMap(
	{
		ctor: '::',
					...
					A2(
						_gicentre$elm_vega$Vega$color,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _gicentre$elm_vega$Vega$MScale(_gicentre$elm_vega$Walkthrough$weatherColors),
									_1: {ctor: '[]'}
								}
							}
						},
				...
				A3(
					...
					A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$elm_vega$Vega$FName('weather'),
								_1: {
									ctor: '::',
...
var _gicentre$elm_vega$Walkthrough$dashboard2 = function () {
	...
	var layerSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$layer(
				{
	...
	var barsSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$repeat(
				{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$specification(layerSpec),
				_1: {ctor: '[]'}
			}
		});
	...
	var splomSpec = _gicentre$elm_vega$Vega$asSpec(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$repeat(
				{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$specification(scatterSpec),
				_1: {ctor: '[]'}
			}
		});
...
var _gicentre$elm_vega$Walkthrough$stripPlot = _gicentre$elm_vega$Vega$toVegaLite(
	{
		ctor: '::',
		_0: A2(
			_gicentre$elm_vega$Vega$dataFromUrl,
