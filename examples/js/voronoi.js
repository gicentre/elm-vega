...
var author$project$Voronoi$elmToJS = _Platform_outgoingPort('elmToJS', elm$core$Basics$identity);
...
var author$project$Voronoi$voronoi = function () {
	var sc = A2(
...
var author$project$Voronoi$mySpecs = author$project$Vega$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('voronoi', author$project$Voronoi$voronoi)
		]));
...
var author$project$Voronoi$main = elm$core$Platform$worker(
	{
		at: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$Voronoi$mySpecs,
				author$project$Voronoi$elmToJS(author$project$Voronoi$mySpecs))),
