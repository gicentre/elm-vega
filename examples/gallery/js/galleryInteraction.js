...
var $author$project$Vega$AgDrop = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$agDrop = $author$project$Vega$AgDrop;
...
var $author$project$GalleryInteraction$dPath = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.9/data/';
...
var $author$project$Vega$TCrossFilterAsSignal = F2(
	function (a, b) {
		return {$: 7, a: a, b: b};
	});
var $author$project$Vega$trCrossFilterAsSignal = $author$project$Vega$TCrossFilterAsSignal;
var $author$project$Vega$TResolveFilter = F2(
	function (a, b) {
		return {$: 46, a: a, b: b};
	});
var $author$project$Vega$trResolveFilter = $author$project$Vega$TResolveFilter;
...
var $author$project$GalleryInteraction$interaction1 = function () {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$doSignal(core + 'Extent')),
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$siUpdate(core + 'Extent'),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$esSignal(core + 'Zoom')
										]),
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('[(' + (core + ('Range[0]+' + (core + ('Range[1])/2 - ' + (core + ('Zoom, (' + (core + ('Range[0]+' + (core + ('Range[1])/2 + ' + (core + 'Zoom]'))))))))))))
										])),
									A2(
									$author$project$Vega$evHandler,
									_List_fromArray(
										[
											...
											$author$project$Vega$str('@' + (core + (':dblclick!, @' + (core + 'Brush:dblclick!')))))
										]),
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('[' + (core + ('Extent[0], ' + (core + 'Extent[1]]'))))
										])),
									A2(
									$author$project$Vega$evHandler,
									_List_fromArray(
										[
											$author$project$Vega$esSelector(
											$author$project$Vega$str('[@' + (core + 'Brush:mousedown, window:mouseup] > window:mousemove!')))
										]),
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('[' + (core + ('Range[0] + invert(\'' + (core + ('Scale\', x()) - invert(\'' + (core + ('Scale\', xMove), ' + (core + ('Range[1] + invert(\'' + (core + ('Scale\', x()) - invert(\'' + (core + 'Scale\', xMove)]'))))))))))))
										])),
									A2(
									$author$project$Vega$evHandler,
									_List_fromArray(
										[
											$author$project$Vega$esSelector(
											$author$project$Vega$str('[@' + (core + ':mousedown, window:mouseup] > window:mousemove!')))
										]),
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('[min(' + (core + ('Anchor, invert(\'' + (core + ('Scale\', x())), max(' + (core + ('Anchor, invert(\'' + (core + 'Scale\', x()))]'))))))))
										]))
								]))
						])),
				A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$esSelector(
											$author$project$Vega$str('@' + (core + (':wheel!, @' + (core + 'Brush:wheel!')))))
										]),
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('0.5 * abs(span(' + (core + 'Range)) * pow(1.0005, event.deltaY * pow(16, event.deltaMode))'))
										]))
								]))
						]))),
			A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$esSelector(
										$author$project$Vega$str('@' + (core + ':mousedown!')))
									]),
								_List_fromArray(
									[
										$author$project$Vega$evUpdate('invert(\'' + (core + 'Scale\', x())'))
									]))
							]))
					])));
	};
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset(core + '-bins'),
						...
						$author$project$Vega$raValues(
							_List_fromArray(
								[
									$author$project$Vega$vSignal('chartHeight'),
									$author$project$Vega$vNum(0)
								])))
					])));
	};
	var mkGenerator = function (core) {
		var titleText = function () {
			switch (core) {
				case 'delay':
					return $author$project$Vega$vStr('Arrival Delay (min)');
				case 'time':
					return $author$project$Vega$vStr('Local Departure Time (hour)');
				default:
					return $author$project$Vega$vStr('Travel Distance (miles)');
			}
		}();
		return A2(
			$elm$core$Basics$composeL,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										$author$project$Vega$mName(core + 'Brush'),
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Vega$vStr('#fcfcfc')
															]))
													])),
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Vega$vSignal('scale(\'' + (core + ('Scale\', ' + (core + 'Range[0])'))))
															])),
														$author$project$Vega$maX2(
														_List_fromArray(
															[
																$author$project$Vega$vSignal('scale(\'' + (core + ('Scale\', ' + (core + 'Range[1])'))))
															]))
													]))
											]))
									]))),
								...
								[
									...
									_List_fromArray(
										[
											...
											$author$project$Vega$str(core + '-bins'))
										])),
									$author$project$Vega$mEncode(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Vega$vScale(core + 'Scale'),
															$author$project$Vega$vField(
															$author$project$Vega$field(core + '0'))
														])),
													$author$project$Vega$maX2(
													_List_fromArray(
														[
															$author$project$Vega$vScale(core + 'Scale'),
															$author$project$Vega$vField(
															$author$project$Vega$field(core + '1')),
	...
	var facetNames = _List_fromArray(
		['delay', 'time', 'distance']);
	var sc = function () {
		var layoutSc = A3(
			$author$project$Vega$scale,
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$doStrs(
						$author$project$Vega$strs(facetNames))),
					$author$project$Vega$scRange($author$project$Vega$raHeight)
				]),
			_List_Nil);
		return $author$project$Vega$scales(
			A3($elm$core$List$foldl, topScGenerator, layoutSc, facetNames));
	}();
	var si = function () {
		var sigs = A2(
			$elm$core$Basics$composeL,
								...
								A2(
									...
									A2(
										...
										A2(
											...
											_List_fromArray(
												[
													$author$project$Vega$siUpdate('(chartHeight + chartPadding) * 3')
												]))),
									A2(
										$author$project$Vega$signal,
										'delayExtent',
						...
						_List_fromArray(
							[
								...
								$author$project$Vega$iRange(
									_List_fromArray(
										[
											$author$project$Vega$inMin(0.25),
											$author$project$Vega$inMax(2),
											$author$project$Vega$inStep(0.25)
										])))
							]))),
				A2(
					$author$project$Vega$signal,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$esSelector(
										$author$project$Vega$str('window:mousemove'))
									]),
								_List_fromArray(
									[
										$author$project$Vega$evUpdate('x()')
									]))
							]))
					])));
		return $author$project$Vega$signals(
			A3(
				$elm$core$List$foldl,
				sigGenerator,
				sigs(_List_Nil),
	...
	var dsGenerator = function (core) {
		var filterMask = function () {
			switch (core) {
				case 'delay':
					return $author$project$Vega$num(1);
				case 'time':
					return $author$project$Vega$num(2);
				default:
					return $author$project$Vega$num(4);
			}
		}();
		return $author$project$Vega$dataSource(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$Vega$trResolveFilter, 'xFilter', filterMask),
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$field(core + '0')),
									$author$project$Vega$agDrop($author$project$Vega$false)
								]))
						]),
					A2(
						...
						_List_fromArray(
							[
								$author$project$Vega$daSource('flights')
							])))
				]));
	};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$numSignal('delayExtent'),
						_List_fromArray(
							[
								$author$project$Vega$bnStep(
								$author$project$Vega$numSignal('delayStep')),
								A2($author$project$Vega$bnAs, 'delay0', 'delay1')
							])),
						A3(
						$author$project$Vega$trBin,
						$author$project$Vega$field('time'),
						$author$project$Vega$numSignal('timeExtent'),
						_List_fromArray(
							[
								$author$project$Vega$bnStep(
								$author$project$Vega$numSignal('timeStep')),
								A2($author$project$Vega$bnAs, 'time0', 'time1')
							])),
						A3(
						$author$project$Vega$trBin,
						$author$project$Vega$field('distance'),
						$author$project$Vega$numSignal('distanceExtent'),
						_List_fromArray(
							[
								$author$project$Vega$bnStep(
								$author$project$Vega$numSignal('distanceStep')),
								A2($author$project$Vega$bnAs, 'distance0', 'distance1')
							])),
						A2(
						$author$project$Vega$trCrossFilterAsSignal,
						_List_fromArray(
							[
								_Utils_Tuple2(
								$author$project$Vega$field('delay'),
								$author$project$Vega$numSignal('delayRange')),
								_Utils_Tuple2(
								$author$project$Vega$field('time'),
								$author$project$Vega$numSignal('timeRange')),
								_Utils_Tuple2(
								$author$project$Vega$field('distance'),
								$author$project$Vega$numSignal('distanceRange'))
							]),
						'xFilter')
					]),
				A2(
	...
	var axGenerator = function (core) {
		return A2(
			...
			A3($author$project$Vega$axis, core + 'Scale', $author$project$Vega$siBottom, _List_Nil));
	};
	var groupGenerator = function (core) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$mName(core),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
							$author$project$Vega$enEnter(
					...
					_List_fromArray(
						[
							dsGenerator(core),
							A2(scGenerator, core, _List_Nil),
							A2(axGenerator, core, _List_Nil),
							A2(mkGenerator, core, _List_Nil)
						]))
				]));
	};
	var mk = $author$project$Vega$marks(
		A3($elm$core$List$foldl, groupGenerator, _List_Nil, facetNames));
...
var $author$project$Vega$SDomainRaw = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$scDomainRaw = $author$project$Vega$SDomainRaw;
...
var $author$project$Vega$SiPushOuter = {$: 8};
var $author$project$Vega$siPushOuter = $author$project$Vega$SiPushOuter;
...
var $author$project$GalleryInteraction$interaction2 = function () {
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$esSelector(
													$author$project$Vega$str('@overview:mousedown'))
												]),
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('[x(), x()]')
												])),
											A2(
											$author$project$Vega$evHandler,
											_List_fromArray(
												[
													$author$project$Vega$esSelector(
													$author$project$Vega$str('[@overview:mousedown, window:mouseup] > window:mousemove!'))
												]),
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('[brush[0], clamp(x(), 0, width)]')
												])),
											A2(
											$author$project$Vega$evHandler,
											_List_fromArray(
												[
													$author$project$Vega$esSignal('delta')
												]),
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('clampRange([anchor[0] + delta, anchor[1] + delta], 0, width)')
												]))
										]))
								]))),
					A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$esSelector(
												$author$project$Vega$str('@brush:mousedown'))
											]),
										_List_fromArray(
											[
												$author$project$Vega$evUpdate('slice(brush)')
											]))
									]))
							]))),
				A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$esSelector(
										$author$project$Vega$str('[@brush:mousedown, window:mouseup] > window:mousemove!'))
									]),
								_List_fromArray(
									[
										$author$project$Vega$evUpdate('x() - xDown')
									]))
							]))
					]))),
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siPushOuter,
					$author$project$Vega$siOn(
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$author$project$Vega$esSignal('brush')
								]),
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('span(brush) ? invert(\'xOverview\', brush) : null')
								]))
						]))
				])));
	var si = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$signals,
		A2($author$project$Vega$signal, 'detailDomain', _List_Nil));
	var sc2 = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('sp500'),
									$author$project$Vega$daField(
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('sp500'),
								$author$project$Vega$daField(
								$author$project$Vega$field('price'))
							]))),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$scDomainRaw(
						$author$project$Vega$vSignal('detailDomain'))
					]))),
		A2(
			$author$project$Vega$scale,
			'yDetail',
		...
		A2(
			...
			A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Vega$vScale('xOverview'),
														$author$project$Vega$vField(
														$author$project$Vega$field('date'))
													])),
												$author$project$Vega$maY(
												_List_fromArray(
													[
														$author$project$Vega$vScale('yOverview'),
														$author$project$Vega$vField(
														$author$project$Vega$field('price'))
													])),
												$author$project$Vega$maY2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$mName('brush'),
							$author$project$Vega$mEncode(
							_List_fromArray(
								[
									$author$project$Vega$enEnter(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vNum(70)
												])),
											$author$project$Vega$maFill(
											_List_fromArray(
												[
													$author$project$Vega$vStr('#333')
												])),
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vSignal('brush[0]')
												])),
											$author$project$Vega$maX2(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('brush[1]')
												]))
										]))
								]))
						]))),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xDetail'),
											$author$project$Vega$vField(
											$author$project$Vega$field('date'))
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
											$author$project$Vega$vScale('yDetail'),
											$author$project$Vega$vField(
											$author$project$Vega$field('price'))
										])),
									$author$project$Vega$maY2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$fGroup(
												$author$project$Vega$field('height')))
										])),
									$author$project$Vega$maWidth(
									_List_fromArray(
										[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('price', $author$project$Vega$foNum),
										_Utils_Tuple2(
										'date',
	...
	var ax2 = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$axes,
		A3($author$project$Vega$axis, 'xOverview', $author$project$Vega$siBottom, _List_Nil));
	var ax1 = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			$author$project$Vega$axes,
			A3($author$project$Vega$axis, 'xDetail', $author$project$Vega$siBottom, _List_Nil)),
		A3($author$project$Vega$axis, 'yDetail', $author$project$Vega$siLeft, _List_Nil));
	var mk = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$mName('detail'),
						$author$project$Vega$mEncode(
						_List_fromArray(
							[
								$author$project$Vega$enEnter(
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vNum(390)
											])),
										$author$project$Vega$maWidth(
										_List_fromArray(
											[
												$author$project$Vega$vNum(720)
											]))
									]))
							])),
						$author$project$Vega$mGroup(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$mName('overview'),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
							$author$project$Vega$enEnter(
	...
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				...
				$author$project$Vega$height(480),
				$author$project$Vega$padding(5),
				ds,
				si(_List_Nil),
				mk(_List_Nil)
...
var $author$project$Vega$AxMinExtent = function (a) {
	return {$: 43, a: a};
};
var $author$project$Vega$axMinExtent = $author$project$Vega$AxMinExtent;
var $author$project$Vega$AxOffset = function (a) {
	return {$: 45, a: a};
};
var $author$project$Vega$axOffset = $author$project$Vega$AxOffset;
var $author$project$Vega$AxPosition = function (a) {
	return {$: 46, a: a};
};
var $author$project$Vega$axPosition = $author$project$Vega$AxPosition;
var $author$project$Vega$AxTickColor = function (a) {
	return {$: 50, a: a};
};
var $author$project$Vega$axTickColor = $author$project$Vega$AxTickColor;
...
var $author$project$Vega$CrAs = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Vega$crAs = $author$project$Vega$CrAs;
...
var $author$project$Vega$FDatum = function (a) {
	return {$: 3, a: a};
};
var $author$project$Vega$fDatum = $author$project$Vega$FDatum;
...
var $author$project$Vega$vScaleField = $author$project$Vega$VScale;
												...
												A2(
													...
													A2(
														...
														A2(
															...
															_List_fromArray(
																[
																	$author$project$Vega$siUpdate('chartSize + chartPad')
																]))),
													A2(
														$author$project$Vega$signal,
														'width',
														_List_fromArray(
															[
																$author$project$Vega$siUpdate('chartStep * 4')
															]))),
												A2(
													$author$project$Vega$signal,
													'height',
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$author$project$Vega$esSelector(
																		$author$project$Vega$str('@cell:mousedown'))
																	]),
																_List_fromArray(
																	[
																		$author$project$Vega$evUpdate('group()')
																	])),
																A2(
																$author$project$Vega$evHandler,
																_List_fromArray(
																	[
																		$author$project$Vega$esSelector(
																		$author$project$Vega$str('@cell:mouseup'))
																	]),
																_List_fromArray(
																	[
																		$author$project$Vega$evUpdate('!span(brushX) && !span(brushY) ? null : cell')
																	]))
															]))
													]))),
										A2(
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$author$project$Vega$evUpdate('[x(cell), x(cell)]')
																])),
															A2(
															$author$project$Vega$evHandler,
															_List_fromArray(
																[
																	$author$project$Vega$esSelector(
																	$author$project$Vega$str('[@cell:mousedown, window:mouseup] > window:mousemove'))
																]),
															_List_fromArray(
																[
																	$author$project$Vega$evUpdate('[brushX[0], clamp(x(cell), 0, chartSize)]')
																])),
															A2(
															$author$project$Vega$evHandler,
															_List_fromArray(
															...
															_List_fromArray(
																[
																	$author$project$Vega$evUpdate('clampRange([anchorX[0] + delta[0], anchorX[1] + delta[0]], 0, chartSize)')
																]))
														]))
												]))),
									A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Vega$evUpdate('[y(cell), y(cell)]')
															])),
														A2(
														$author$project$Vega$evHandler,
														_List_fromArray(
														...
														_List_fromArray(
															[
																$author$project$Vega$evUpdate('[brushY[0], clamp(y(cell), 0, chartSize)]')
															])),
														A2(
														$author$project$Vega$evHandler,
														_List_fromArray(
														...
														_List_fromArray(
															[
																$author$project$Vega$evUpdate('clampRange([anchorY[0] + delta[1], anchorY[1] + delta[1]], 0, chartSize)')
															]))
													]))
											]))),
								A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Vega$evUpdate('[x(cell), y(cell)]')
														]))
												]))
										]))),
							A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Vega$evUpdate('slice(brushX)')
													]))
											]))
									]))),
						A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('slice(brushY)')
												]))
										]))
								]))),
					A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$evUpdate('[x(cell) - down[0], y(cell) - down[1]]')
											]))
									]))
							]))),
				A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$esSignal('brushX')
										]),
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('invert(cell.datum.x.data + \'X\', brushX)')
										]))
								]))
						]))),
			A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$esSignal('brushY')
									]),
								_List_fromArray(
									[
										$author$project$Vega$evUpdate('invert(cell.datum.y.data + \'Y\', brushY)')
									]))
							]))
					]))),
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('\'nwse-resize\'')
								])),
							A2(
							$author$project$Vega$evHandler,
							_List_fromArray(
								[
									$author$project$Vega$esSelector(
									$author$project$Vega$str('@brush:mousemove, [@brush:mousedown, window:mouseup] > window:mousemove!'))
								]),
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('\'move\'')
								])),
							A2(
							$author$project$Vega$evHandler,
							_List_fromArray(
								[
									$author$project$Vega$esSelector(
									$author$project$Vega$str('@brush:mouseout, window:mouseup'))
								]),
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('\'default\'')
								]))
						]))
				])));
	var scGenerator = F2(
		function (_var, dir) {
			var ra = (dir === 'X') ? $author$project$Vega$raValues(
				_List_fromArray(
					[
						$author$project$Vega$vNum(0),
						$author$project$Vega$vSignal('chartSize')
					])) : $author$project$Vega$raValues(
				_List_fromArray(
					[
						$author$project$Vega$vSignal('chartSize'),
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$scNice($author$project$Vega$niTrue),
						$author$project$Vega$scRange(ra),
						$author$project$Vega$scDomain(
						$author$project$Vega$doData(
							_List_fromArray(
								[
													...
													_List_fromArray(
														[
															...
															$author$project$Vega$doData(
																_List_fromArray(
																	[
																		$author$project$Vega$daDataset('fields'),
																		$author$project$Vega$daField(
																		$author$project$Vega$field('data'))
																	])))
														]))),
											A2(
												$author$project$Vega$scale,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScaleField(
											$author$project$Vega$fParent(
												$author$project$Vega$field('xScale'))),
											$author$project$Vega$vField(
											$author$project$Vega$fDatum(
												$author$project$Vega$fParent(
													$author$project$Vega$field('x.data'))))
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
											$author$project$Vega$vScaleField(
											$author$project$Vega$fParent(
												$author$project$Vega$field('yScale'))),
											$author$project$Vega$vField(
											$author$project$Vega$fDatum(
												$author$project$Vega$fParent(
													$author$project$Vega$field('y.data'))))
										])),
									$author$project$Vega$maFillOpacity(
									_List_fromArray(
										[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vSignal('cell ? 1 : 0')
												])),
											$author$project$Vega$maX(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('cell ? cell.x + brushX[0] : 0')
												])),
											$author$project$Vega$maX2(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('cell ? cell.x + brushX[1] : 0')
												])),
											$author$project$Vega$maY(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('cell ? cell.y + brushY[0] : 0')
												])),
											$author$project$Vega$maY2(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('cell ? cell.y + brushY[1] : 0')
												]))
										]))
								]))
						]))),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vScale('groupX'),
												$author$project$Vega$vField(
												$author$project$Vega$field('x.data'))
											])),
										$author$project$Vega$maY(
										_List_fromArray(
											[
												$author$project$Vega$vScale('groupY'),
												$author$project$Vega$vField(
												$author$project$Vega$field('y.data'))
											])),
										$author$project$Vega$maWidth(
		...
		$author$project$Vega$legend(
			_List_fromArray(
				[
					...
					$author$project$Vega$str('Species')),
	...
	var ds = $author$project$Vega$dataSource(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$trCross(
						_List_fromArray(
							[
								A2($author$project$Vega$crAs, 'x', 'y')
							])),
						A2($author$project$Vega$trFormula, 'datum.x.data + \'X\'', 'xScale'),
						A2($author$project$Vega$trFormula, 'datum.y.data + \'Y\'', 'yScale')
					]),
				A2(
					$author$project$Vega$data,
					'cross',
					_List_fromArray(
						[
							$author$project$Vega$daSource('fields')
						])))
			]));
	var cf = $author$project$Vega$config(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$axTickColor(
						$author$project$Vega$str('#ccc'))
					]))
			]));
	var ax = A2(
		$elm$core$Basics$composeL,
...
var $author$project$Vega$Custom = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
var $author$project$Vega$enCustom = function (name) {
	return $author$project$Vega$Custom(name);
};
...
var $author$project$Vega$TouchMove = 15;
var $author$project$Vega$etTouchMove = 15;
var $author$project$Vega$TouchStart = 16;
var $author$project$Vega$etTouchStart = 16;
var $author$project$Vega$Wheel = 17;
var $author$project$Vega$etWheel = 17;
var $author$project$Vega$EEncode = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$evEncode = $author$project$Vega$EEncode;
...
var $author$project$Vega$SiReact = function (a) {
	return {$: 6, a: a};
};
var $author$project$Vega$siReact = $author$project$Vega$SiReact;
		...
		A2(
			...
			A2(
																				...
																				_List_fromArray(
																					[
																						...
																						_List_fromArray(
																							[
																								$author$project$Vega$esSelector(
																								$author$project$Vega$str('*:mouseover'))
																							]),
																						_List_fromArray(
																							[
																								$author$project$Vega$evEncode('hover')
																							])),
																						A2(
																						$author$project$Vega$evHandler,
																						_List_fromArray(
																							[
																								$author$project$Vega$esSelector(
																								$author$project$Vega$str('*:mouseout'))
																							]),
																						_List_fromArray(
																							[
																								$author$project$Vega$evEncode('leave')
																							])),
																						A2(
																						$author$project$Vega$evHandler,
																						_List_fromArray(
																							[
																								$author$project$Vega$esSelector(
																								$author$project$Vega$str('*:mousedown'))
																							]),
																						_List_fromArray(
																							[
																								$author$project$Vega$evEncode('select')
																							])),
																						A2(
																						$author$project$Vega$evHandler,
																						_List_fromArray(
																							[
																								$author$project$Vega$esSelector(
																								$author$project$Vega$str('*:mousup'))
																							]),
																						_List_fromArray(
																							[
																								$author$project$Vega$evEncode('release')
																							]))
																					]))
																			]))),
																A2(
																	...
																	_List_fromArray(
																		[
																			$author$project$Vega$siUpdate('-(height + padding.bottom)')
																		]))),
															A2(
																$author$project$Vega$signal,
																'yOffset',
																_List_fromArray(
																	[
																		$author$project$Vega$siUpdate('-(width + padding.left)')
																	]))),
														A2(
															$author$project$Vega$signal,
															'xRange',
															_List_fromArray(
																[
																	$author$project$Vega$siUpdate('[0, width]')
																]))),
													A2(
														$author$project$Vega$signal,
														'yRange',
														_List_fromArray(
															[
																$author$project$Vega$siUpdate('[height, 0]')
															]))),
												A2(
													$author$project$Vega$signal,
													'down',
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			$author$project$Vega$esSelector(
																			$author$project$Vega$str('touchend'))
																		]),
																	_List_fromArray(
																		[
																	...
																	_List_fromArray(
																		[
																			$author$project$Vega$esSelector(
																			$author$project$Vega$str('mousedown, touchstart'))
																		]),
																	_List_fromArray(
																		[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$author$project$Vega$esSelector(
																		$author$project$Vega$str('mousedown, touchstart, touchend'))
																	]),
																_List_fromArray(
																	[
																		$author$project$Vega$evUpdate('slice(xDom)')
																	]))
															]))
													]))),
										A2(
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$author$project$Vega$evUpdate('slice(yDom)')
																]))
														]))
												]))),
									A2(
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$author$project$Vega$esType($author$project$Vega$etTouchMove),
																		$author$project$Vega$esConsume($author$project$Vega$true),
														...
														_List_fromArray(
															[
																$author$project$Vega$evUpdate('down ? [down[0]-x(), y()-down[1]] : [0,0]')
															]))
													]))
											]))),
								A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Vega$evUpdate('[invert(\'xScale\', x()), invert(\'yScale\', y())]')
														])),
													A2(
													$author$project$Vega$evHandler,
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$author$project$Vega$esType($author$project$Vega$etTouchStart),
																	$author$project$Vega$esFilter(
																	_List_fromArray(
													...
													_List_fromArray(
														[
															$author$project$Vega$evUpdate('[(xDom[0] + xDom[1]) / 2, (yDom[0] + yDom[1]) / 2]')
														]))
												]))
										]))),
							A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														$author$project$Vega$evUpdate('pow(1.001, event.deltaY * pow(16, event.deltaMode))')
													])),
												A2(
												$author$project$Vega$evHandler,
												_List_fromArray(
													[
														$author$project$Vega$esSignal('dist2')
													]),
												_List_fromArray(
													[
														$author$project$Vega$evForce($author$project$Vega$true),
														$author$project$Vega$evUpdate('dist1 / dist2')
													]))
											]))
									]))),
						A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('pinchDistance(event)')
												])),
											A2(
											$author$project$Vega$evHandler,
											_List_fromArray(
											...
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('dist2')
												]))
										]))
								]))),
					A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$siUpdate('slice(xExt)'),
							$author$project$Vega$siReact($author$project$Vega$false),
							$author$project$Vega$siOn(
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('[xCur[0] + span(xCur) * delta[0] / width, xCur[1] + span(xCur) * delta[0] / width]')
										])),
									A2(
									$author$project$Vega$evHandler,
									_List_fromArray(
										[
											$author$project$Vega$esSignal('zoom')
										]),
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('[anchor[0] + (xDom[0] - anchor[0]) * zoom, anchor[0] + (xDom[1] - anchor[0]) * zoom]')
										]))
								]))
						]))),
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siUpdate('slice(yExt)'),
						$author$project$Vega$siReact($author$project$Vega$false),
						$author$project$Vega$siOn(
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$evUpdate('[yCur[0] + span(yCur) * delta[1] / height, yCur[1] + span(yCur) * delta[1] / height]')
									])),
								A2(
								$author$project$Vega$evHandler,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$author$project$Vega$evUpdate('[anchor[1] + (yDom[0] - anchor[1]) * zoom, anchor[1] + (yDom[1] - anchor[1]) * zoom]')
									]))
							]))
					]))),
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('clamp(20 / span(xDom), 1, 1000)')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$scZero($author$project$Vega$false),
						$author$project$Vega$scDomain(
						$author$project$Vega$doSignal('xDom')),
						$author$project$Vega$scRange(
						$author$project$Vega$raSignal('xRange'))
					]))),
		A2(
			$author$project$Vega$scale,
			'yScale',
			_List_fromArray(
				[
					$author$project$Vega$scZero($author$project$Vega$false),
					$author$project$Vega$scDomain(
					$author$project$Vega$doSignal('yDom')),
					$author$project$Vega$scRange(
					$author$project$Vega$raSignal('yRange'))
				])));
	var mk = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$marks,
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$axTickColor(
						$author$project$Vega$str('#888')),
						$author$project$Vega$axLabelFont(
						$author$project$Vega$str('Monaco, Courier New'))
					]))
			]));
	var ax = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A3(
				...
				_List_fromArray(
					[
						$author$project$Vega$axOffset(
						$author$project$Vega$vSignal('xOffset'))
					]))),
		A3(
			$author$project$Vega$axis,
			'yScale',
			...
			_List_fromArray(
				[
					$author$project$Vega$axOffset(
					$author$project$Vega$vSignal('yOffset'))
				])));
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				...
				A4($author$project$Vega$paddings, 40, 10, 10, 20),
...
var $author$project$Vega$DaOn = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$daOn = $author$project$Vega$DaOn;
...
var $author$project$Vega$EnLabels = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$enLabels = $author$project$Vega$EnLabels;
...
var $author$project$Vega$line = 4;
var $author$project$Vega$Right = {$: 4};
var $author$project$Vega$loRight = $author$project$Vega$Right;
...
var $author$project$Vega$RaData = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$raData = $author$project$Vega$RaData;
var $author$project$Vega$TgToggle = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$tgToggle = $author$project$Vega$TgToggle;
...
var $author$project$GalleryInteraction$interaction5 = function () {
	var table = A2(
		...
		A2(
			$elm$core$Basics$composeL,
			A2($author$project$Vega$dataFromColumns, 'clusters', _List_Nil),
			A2(
		...
		A2(
			...
			$author$project$Vega$vStrs(
				_List_fromArray(
					['South Asia', 'Europe & Cental Asia', 'Sub-Saharan Africa', 'America', 'East Asia & Pacific', 'Middle East & North Africa']))));
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
														...
														A2(
															...
															A2(
																				...
																				_List_fromArray(
																					[
																						...
																						_List_fromArray(
																							[
																								$author$project$Vega$esSelector(
																								$author$project$Vega$str('@point:mousedown, @point:touchstart'))
																							]),
																						_List_fromArray(
																							[
																						...
																						_List_fromArray(
																							[
																								$author$project$Vega$esSelector(
																								$author$project$Vega$str('window:mouseup, window:touchend'))
																							]),
																						_List_fromArray(
																							[
																...
																A2(
																	...
																	_List_fromArray(
																		[
																			$author$project$Vega$siUpdate('active.country')
																		]))),
															A2(
																$author$project$Vega$signal,
																'timeline',
																		...
																		_List_fromArray(
																			[
																				...
																				_List_fromArray(
																					[
																						$author$project$Vega$esSelector(
																						$author$project$Vega$str('@point:mouseover'))
																					]),
																				_List_fromArray(
																					[
																						$author$project$Vega$evUpdate('isActive ? active : datum')
																					])),
																				A2(
																				$author$project$Vega$evHandler,
																				_List_fromArray(
																					[
																						$author$project$Vega$esSelector(
																						$author$project$Vega$str('@point:mouseout'))
																					]),
																				_List_fromArray(
																					[
																						$author$project$Vega$evUpdate('active')
																					])),
																				A2(
																				$author$project$Vega$evHandler,
																				_List_fromArray(
																					[
																						$author$project$Vega$esSignal('active')
																					]),
																				_List_fromArray(
																					[
																						$author$project$Vega$evUpdate('active')
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					$author$project$Vega$esSelector(
																					$author$project$Vega$str('mousemove!, touchmove!'))
																				]),
																			_List_fromArray(
																				[
																					$author$project$Vega$evUpdate('isActive ? scale(\'xScale\', active.this.fertility) : tX')
																				]))
																		]))
																]))),
													A2(
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$author$project$Vega$evUpdate('isActive ? scale(\'yScale\', active.this.life_expect) : tY')
																			]))
																	]))
															]))),
												A2(
														...
														[
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			$author$project$Vega$evUpdate('isActive ? scale(\'xScale\', active.prev.fertility) : pX')
																		]))
																]))
														]))),
											A2(
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$author$project$Vega$evUpdate('isActive ? scale(\'yScale\', active.prev.life_expect) : pY')
																	]))
															]))
													]))),
										A2(
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$author$project$Vega$evUpdate('isActive ? scale(\'xScale\', active.next.fertility) : nX')
																]))
														]))
												]))),
									A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Vega$evUpdate('isActive ? scale(\'yScale\', active.next.life_expect) : nY')
															]))
													]))
											]))),
								A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Vega$evUpdate('isActive ? sqrt(pow(x()-tX, 2) + pow(y()-tY, 2)) : thisDist')
														]))
												]))
										]))),
							A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Vega$evUpdate('isActive ? sqrt(pow(x()-pX, 2) + pow(y()-pY, 2)): prevDist')
													]))
											]))
									]))),
						A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('isActive ? sqrt(pow(x()-nX, 2) + pow(y()-nY, 2)) : nextDist')
												]))
										]))
								]))),
					A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$evUpdate('isActive ? ((pX-tX) * (x()-tX) + (pY-tY) * (y()-tY))/prevDist || -999999 : prevScore')
											]))
									]))
							]))),
				A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$evUpdate('isActive ? ((nX-tX) * (x()-tX) + (nY-tY) * (y()-tY))/nextDist || -999999 : nextScore')
										]))
								]))
						]))),
			A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$evUpdate('isActive ? (min(maxYear, currentYear+5, max(minYear, currentYear-5, prevScore > nextScore ? (currentYear - 2.5*prevScore/sqrt(pow(pX-tX, 2) + pow(pY-tY, 2))) : (currentYear + 2.5*nextScore/sqrt(pow(nX-tX, 2) + pow(nY-tY, 2)))))) : interYear')
									]))
							]))
					]))),
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('isActive ? (min(maxYear, max(minYear, prevScore > nextScore ? (thisDist < prevDist ? currentYear : currentYear-5) : (thisDist < nextDist ? currentYear : currentYear+5)))) : currentYear')
								]))
						]))
				])));
	var sc = A2(
						...
						_List_fromArray(
							[
								...
								$author$project$Vega$doData(
									_List_fromArray(
										[
											$author$project$Vega$daDataset('gapminder'),
											$author$project$Vega$daField(
											$author$project$Vega$field('fertility'))
										]))),
								$author$project$Vega$scRange($author$project$Vega$raWidth)
							]))),
				A2(
							...
							$author$project$Vega$doData(
								_List_fromArray(
									[
										$author$project$Vega$daDataset('gapminder'),
										$author$project$Vega$daField(
										$author$project$Vega$field('life_expect'))
									]))),
							$author$project$Vega$scRange($author$project$Vega$raHeight)
						]))),
			A2(
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('gapminder'),
									$author$project$Vega$daField(
									$author$project$Vega$field('cluster'))
								]))),
						$author$project$Vega$scRange($author$project$Vega$raCategory)
					]))),
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('clusters'),
								$author$project$Vega$daField(
								$author$project$Vega$field('id'))
							]))),
					$author$project$Vega$scRange(
					$author$project$Vega$raData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('clusters'),
								$author$project$Vega$daField(
	...
	var mk = A2(
		...
		A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$srData(
										$author$project$Vega$str('country_timeline'))
									])),
								$author$project$Vega$mInteractive($author$project$Vega$false),
								$author$project$Vega$mEncode(
								_List_fromArray(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$mName('point'),
						$author$project$Vega$mFrom(
						_List_fromArray(
							[
								$author$project$Vega$srData(
								$author$project$Vega$str('interpolate'))
							])),
						$author$project$Vega$mEncode(
						_List_fromArray(
							[
									...
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vScale('cScale'),
												$author$project$Vega$vField(
												$author$project$Vega$field('this.cluster'))
											])),
										$author$project$Vega$maSize(
										_List_fromArray(
											[
									...
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vScale('xScale'),
												$author$project$Vega$vField(
												$author$project$Vega$field('inter_fertility'))
											])),
										$author$project$Vega$maY(
										_List_fromArray(
											[
												$author$project$Vega$vScale('yScale'),
												$author$project$Vega$vField(
												$author$project$Vega$field('inter_life_expect'))
											])),
										$author$project$Vega$maFillOpacity(
										_List_fromArray(
											[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('country'))
										])),
		...
		$author$project$Vega$legend(
			_List_fromArray(
				[
					$author$project$Vega$leFill('cScale'),
					$author$project$Vega$leTitle(
					$author$project$Vega$str('Region')),
					$author$project$Vega$leOrient($author$project$Vega$loRight),
					$author$project$Vega$leEncode(
					_List_fromArray(
						[
							$author$project$Vega$enSymbols(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vScale('lScale'),
													$author$project$Vega$vField(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('timeline && datum.country == timeline.country')),
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$daSource('gapminder')
						]))),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.year == currentYear'))
					]),
				A2(
					$author$project$Vega$data,
					'thisYear',
				...
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.year == currentYear - stepYear'))
					]),
				A2(
					$author$project$Vega$data,
					'prevYear',
				...
				_List_fromArray(
					[
						...
						A2($author$project$Vega$trFormula, 'interYear > currentYear ? datum.next.fertility : (datum.prev.fertility||datum.this.fertility)', 'target_fertility'),
						A2($author$project$Vega$trFormula, 'interYear > currentYear ? datum.next.life_expect : (datum.prev.life_expect||datum.this.life_expect)', 'target_life_expect'),
						A2($author$project$Vega$trFormula, 'interYear==2000 ? datum.this.fertility : datum.this.fertility + (datum.target_fertility-datum.this.fertility) * abs(interYear-datum.this.year)/5', 'inter_fertility'),
						A2($author$project$Vega$trFormula, 'interYear==2000 ? datum.this.life_expect : datum.this.life_expect + (datum.target_life_expect-datum.this.life_expect) * abs(interYear-datum.this.year)/5', 'inter_life_expect')
					]),
				A2(
					$author$project$Vega$data,
					'interpolate',
					_List_fromArray(
						[
							$author$project$Vega$daSource('countries')
						]))),
				A2(
				$author$project$Vega$data,
				'trackCountries',
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$tgToggle('{country: active.country}')
									]))
							]))
					]))
			]));
	var ax = A2(
		...
		A2(
			...
			A3(
				...
				_List_fromArray(
					[
						$author$project$Vega$axTitle(
						$author$project$Vega$str('Fertility')),
		...
		A3(
			...
			_List_fromArray(
				[
					$author$project$Vega$axTitle(
					$author$project$Vega$str('Life Expectancy')),
					$author$project$Vega$axGrid($author$project$Vega$true),
					$author$project$Vega$axTickCount(
					$author$project$Vega$num(5))
				])));
...
var $author$project$Vega$CEWResize = 28;
var $author$project$Vega$cuEWResize = 28;
...
var $author$project$Vega$EnInteractive = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$enInteractive = $author$project$Vega$EnInteractive;
var $author$project$Vega$EnName = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$enName = $author$project$Vega$EnName;
...
var $author$project$Vega$TgRemoveAll = {$: 3};
var $author$project$Vega$tgRemoveAll = $author$project$Vega$TgRemoveAll;
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Vega$esSelector(
																$author$project$Vega$str('mouseup[!event.item]'))
															]),
														_List_fromArray(
															[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Vega$esSelector(
															$author$project$Vega$str('@legendSymbol:click, @legendLabel:click'))
														]),
													_List_fromArray(
														[
															$author$project$Vega$evUpdate('event.shiftKey'),
															$author$project$Vega$evForce($author$project$Vega$true)
														]))
												]))
										]))),
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Vega$evUpdate('{value: datum.value}'),
														$author$project$Vega$evForce($author$project$Vega$true)
													]))
											]))
									]))),
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$esSignal('clear')
												]),
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('clear ? [0, 0] : brush')
												])),
											A2(
											$author$project$Vega$evHandler,
											_List_fromArray(
												[
													$author$project$Vega$esSelector(
													$author$project$Vega$str('@xAxis:mousedown'))
												]),
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('[x(), x()]')
											...
											_List_fromArray(
												[
													$author$project$Vega$esSelector(
													$author$project$Vega$str('[@xAxis:mousedown, window:mouseup] > window:mousemove!'))
												]),
											_List_fromArray(
												[
													$author$project$Vega$evUpdate('[brush[0], clamp(x(), 0, width)]')
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Vega$evUpdate('span(brush) ? invert(\'xScale\', brush) : null')
								]))
						]))
				])));
	var sc = A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										$author$project$Vega$mName('xAxis'),
										$author$project$Vega$mInteractive($author$project$Vega$true),
										$author$project$Vega$mEncode(
										_List_fromArray(
											[
												$author$project$Vega$enEnter(
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Vega$cursorValue($author$project$Vega$cuEWResize)
															]))
													])),
												$author$project$Vega$enUpdate(
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$author$project$Vega$vSignal('span(range(\'xScale\'))')
															]))
													]))
											]))
									]))),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Vega$vSignal('domain ? 0.2 : 0')
														]))
												]))
										]))
								]))),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vSignal('domain ? 1 : 0')
											])),
										$author$project$Vega$maX(
										_List_fromArray(
											[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Vega$enName('legendSymbol'),
									$author$project$Vega$enInteractive($author$project$Vega$true),
									$author$project$Vega$enUpdate(
									_List_fromArray(
										[
											$author$project$Vega$maFill(
							...
							_List_fromArray(
								[
									$author$project$Vega$enName('legendLabel'),
									$author$project$Vega$enInteractive($author$project$Vega$true),
									$author$project$Vega$enUpdate(
									_List_fromArray(
										[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum[\'Horsepower\'] != null && datum[\'Miles_per_Gallon\'] != null && datum[\'Origin\'] != null'))
					]),
				A2(
					$author$project$Vega$data,
					'source',
					...
					[
						...
						_List_fromArray(
							[
								...
								'clear',
								_List_fromArray(
									[$author$project$Vega$tgRemoveAll])),
								A2(
								$author$project$Vega$trigger,
								'!shift',
								_List_fromArray(
								...
								_List_fromArray(
									[
										$author$project$Vega$tgInsert('clicked')
									])),
								A2(
								$author$project$Vega$trigger,
								'shift && clicked',
								_List_fromArray(
									[
										$author$project$Vega$tgToggle('clicked')
									]))
							]))
					]))
			]));
...
var $author$project$Vega$VRound = function (a) {
	return {$: 19, a: a};
};
var $author$project$Vega$vRound = $author$project$Vega$VRound;
var $author$project$GalleryInteraction$interaction7 = function () {
	var si = A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siUpdate('time(\'Jan 1 2005\')'),
						$author$project$Vega$siOn(
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$author$project$Vega$esSelector(
										$author$project$Vega$str('mousemove'))
									]),
								_List_fromArray(
									[
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siUpdate('time(\'Mar 1 2010\')')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Vega$doData(
								_List_fromArray(
									[
										$author$project$Vega$daDataset('stocks'),
										$author$project$Vega$daField(
										$author$project$Vega$field('date'))
									]))),
							$author$project$Vega$scRange($author$project$Vega$raWidth)
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('indexed_stocks'),
									$author$project$Vega$daField(
									$author$project$Vega$field('indexed_price'))
								]))),
						$author$project$Vega$scNice($author$project$Vega$niTrue),
						$author$project$Vega$scZero($author$project$Vega$true),
						$author$project$Vega$scRange($author$project$Vega$raHeight)
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('stocks'),
								$author$project$Vega$daField(
								$author$project$Vega$field('symbol'))
							]))),
					$author$project$Vega$scRange($author$project$Vega$raCategory)
				])));
	var mk1 = A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Vega$srData(
								$author$project$Vega$str('series'))
							])),
						$author$project$Vega$mEncode(
						_List_fromArray(
							[
	...
	var ds1 = $author$project$Vega$dataSource(
		_List_fromArray(
			[
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.date == maxDate'))
					]),
				A2(
					$author$project$Vega$data,
					'label',
					_List_fromArray(
						[
							$author$project$Vega$daSource('series')
						])))
			]));
	var mk = A2(
		$elm$core$Basics$composeL,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Vega$str('indexed_stocks'),
										'series',
										_List_fromArray(
											[
													...
													$author$project$Vega$vObject(
														_List_fromArray(
															[
																$author$project$Vega$vScale('yScale'),
																$author$project$Vega$vNum(0),
																$author$project$Vega$vRound($author$project$Vega$true)
															])))
												])),
											$author$project$Vega$maStroke(
											_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vScale('xScale'),
												$author$project$Vega$vSignal('indexDate'),
												$author$project$Vega$vOffset(
												$author$project$Vega$vNum(0.5))
											])),
										$author$project$Vega$maY(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('timeFormat(indexDate, \'%b %Y\')')
										])),
									$author$project$Vega$maFill(
									_List_fromArray(
										[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('month(datum.date) == month(indexDate) && year(datum.date) == year(indexDate)'))
					]),
				A2(
					$author$project$Vega$data,
					'index',
					_List_fromArray(
						[
							$author$project$Vega$daSource('stocks')
						]))),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						...
						A2($author$project$Vega$trFormula, 'datum.index.price > 0 ? (datum.price - datum.index.price)/datum.index.price : 0', 'indexed_price')
					]),
				A2(
					$author$project$Vega$data,
					'indexed_stocks',
		...
		A3(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$str('%'))
				])));
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				$author$project$Vega$width(650),
				$author$project$Vega$height(300),
				$author$project$Vega$padding(5),
				$author$project$Vega$autosize(
				_List_fromArray(
...
var $author$project$Vega$AxGridScale = function (a) {
	return {$: 22, a: a};
};
var $author$project$Vega$axGridScale = $author$project$Vega$AxGridScale;
var $author$project$Vega$AxLabelFlush = function (a) {
	return {$: 30, a: a};
};
var $author$project$Vega$axLabelFlush = $author$project$Vega$AxLabelFlush;
var $author$project$Vega$AxLabelOverlap = function (a) {
	return {$: 40, a: a};
};
var $author$project$Vega$axLabelOverlap = $author$project$Vega$AxLabelOverlap;
var $author$project$Vega$AxLabels = function (a) {
	return {$: 24, a: a};
};
var $author$project$Vega$axLabels = $author$project$Vega$AxLabels;
var $author$project$Vega$AxMaxExtent = function (a) {
	return {$: 44, a: a};
};
var $author$project$Vega$axMaxExtent = $author$project$Vega$AxMaxExtent;
...
var $author$project$Vega$Full = {$: 0};
var $author$project$Vega$bcFull = $author$project$Vega$Full;
var $author$project$Vega$DReferences = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$daReferences = $author$project$Vega$DReferences;
var $author$project$Vega$DValues = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$daValues = $author$project$Vega$DValues;
...
var $author$project$Vega$AlignAll = {$: 0};
var $author$project$Vega$grAlignAll = $author$project$Vega$AlignAll;
var $author$project$Vega$hLeft = $author$project$Vega$vStr('left');
var $author$project$Vega$hRight = $author$project$Vega$vStr('right');
var $author$project$Vega$InDebounce = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$inDebounce = $author$project$Vega$InDebounce;
...
var $author$project$Vega$LAlign = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$loAlign = $author$project$Vega$LAlign;
var $author$project$Vega$LBounds = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vega$loBounds = $author$project$Vega$LBounds;
var $author$project$Vega$LOffset = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$loOffset = $author$project$Vega$LOffset;
var $author$project$Vega$LPadding = function (a) {
	return {$: 3, a: a};
};
var $author$project$Vega$loPadding = $author$project$Vega$LPadding;
var $author$project$Vega$MStyle = function (a) {
	return {$: 13, a: a};
};
var $author$project$Vega$mStyle = $author$project$Vega$MStyle;
...
var $author$project$Vega$Sum = {$: 17};
var $author$project$Vega$opSum = $author$project$Vega$Sum;
var $author$project$Vega$OParity = {$: 1};
var $author$project$Vega$osParity = $author$project$Vega$OParity;
...
var $author$project$Vega$WnAggOperation = F4(
	function (a, b, c, d) {
		return {$: 1, a: a, b: b, c: c, d: d};
	});
var $author$project$Vega$wnAggOperation = F3(
	function (op, inField, outFieldName) {
		return A4($author$project$Vega$WnAggOperation, op, $elm$core$Maybe$Nothing, inField, outFieldName);
	});
var $author$project$GalleryInteraction$interaction8 = function () {
	var ti2 = A2(
		$author$project$Vega$title,
		$author$project$Vega$str('Pi Estimate'),
		_List_fromArray(
			[
	...
	var ti1 = A2(
		$author$project$Vega$title,
		$author$project$Vega$str('In Points and Out Points'),
		_List_fromArray(
			[
				$author$project$Vega$tiFrame($author$project$Vega$tfGroup)
			]));
	var si = A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siValue(
					$author$project$Vega$vNum(1000)),
					$author$project$Vega$siBind(
					$author$project$Vega$iRange(
						_List_fromArray(
							[
								$author$project$Vega$inMin(10),
								$author$project$Vega$inMax(5000),
								$author$project$Vega$inStep(1),
								$author$project$Vega$inDebounce(10)
							])))
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('pi_estimates'),
									$author$project$Vega$daField(
									$author$project$Vega$field('data'))
								]))),
						$author$project$Vega$scRange($author$project$Vega$raHeight),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
										[
											$author$project$Vega$daDataset('pi'),
											$author$project$Vega$daField(
											$author$project$Vega$field('value'))
										]),
										_List_fromArray(
										[
											$author$project$Vega$daDataset('pi_estimates'),
											$author$project$Vega$daField(
											$author$project$Vega$field('estimate'))
										])
									]))
							]))),
					$author$project$Vega$scRange($author$project$Vega$raHeight),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$srData(
										$author$project$Vega$str('pi_estimates'))
									])),
								$author$project$Vega$mEncode(
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Vega$vScale('data_point_scale'),
														$author$project$Vega$vField(
														$author$project$Vega$field('data'))
													])),
												$author$project$Vega$maY(
												_List_fromArray(
													[
														$author$project$Vega$vScale('pi_scale'),
														$author$project$Vega$vField(
														$author$project$Vega$field('estimate'))
													])),
												$author$project$Vega$maSize(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vStr('darkgrey')
												])),
											$author$project$Vega$maX(
											_List_fromArray(
												[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Vega$vStr('Real Pi: 3.1415...')
											]))
									]))
							]))
					]))),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('pi_estimate'))
						])),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('\'Estimate: \' + format(datum.estimate, \',.3f\')')
										]))
								]))
						]))
				])));
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('random_data'))
						])),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$author$project$Vega$vStr('#003f5c')
												]),
											_List_fromArray(
												[
													$author$project$Vega$vStr('#ffa600')
												]))
										])),
									$author$project$Vega$maX(
									_List_fromArray(
	...
	var lo = $author$project$Vega$layout(
		_List_fromArray(
			[
				...
				$author$project$Vega$loOffset(
				$author$project$Vega$num(20)),
				$author$project$Vega$loBounds($author$project$Vega$bcFull),
				$author$project$Vega$loAlign($author$project$Vega$grAlignAll)
			]));
	var ds = $author$project$Vega$dataSource(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$num(50001),
						$author$project$Vega$num(1)),
						A2($author$project$Vega$trFormula, 'random()', 'x'),
						A2($author$project$Vega$trFormula, 'random()', 'y'),
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.data <= num_points'))
					]),
				A2($author$project$Vega$data, 'random_data', _List_Nil)),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						A2($author$project$Vega$trFormula, '(datum.x * datum.x + datum.y * datum.y) < 1', 'is_inside'),
						A2(
						$author$project$Vega$trWindow,
						_List_fromArray(
							[
								A3(
								$author$project$Vega$wnAggOperation,
								$author$project$Vega$opSum,
								$elm$core$Maybe$Just(
									$author$project$Vega$field('is_inside')),
								'num_inside')
							]),
						_List_Nil),
						A2($author$project$Vega$trFormula, '4 * datum.num_inside / datum.data', 'estimate')
					]),
				A2(
					$author$project$Vega$data,
					'pi_estimates',
					_List_fromArray(
						[
							$author$project$Vega$daSource('random_data')
						]))),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.data == num_points')),
						A2($author$project$Vega$trFormula, 'datum.estimate', 'value')
					]),
				A2(
					$author$project$Vega$data,
					'pi_estimate',
					_List_fromArray(
						[
							$author$project$Vega$daSource('pi_estimates')
						]))),
				A3(
				...
				A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							'value',
							$author$project$Vega$vNum(3.141592653589793))
						]),
					_List_Nil))
			]));
	var cf = $author$project$Vega$config(
	...
	var ax2 = A2(
		...
		A2(
			...
			A2(
				...
				A2(
					...
					A3(
						...
						_List_fromArray(
							[
								$author$project$Vega$axTitle(
								$author$project$Vega$str('Number of points')),
								$author$project$Vega$axLabelFlush(
								$author$project$Vega$num(1)),
								$author$project$Vega$axLabelOverlap($author$project$Vega$osParity),
				...
				A3(
					...
					_List_fromArray(
						[
							$author$project$Vega$axGrid($author$project$Vega$true),
							$author$project$Vega$axGridScale('pi_scale'),
							$author$project$Vega$axDomain($author$project$Vega$false),
							$author$project$Vega$axLabels($author$project$Vega$false),
							$author$project$Vega$axMaxExtent(
							$author$project$Vega$vNum(0)),
							$author$project$Vega$axMinExtent(
							$author$project$Vega$vNum(0)),
			...
			A3(
				...
				_List_fromArray(
					[
						$author$project$Vega$axTitle(
						$author$project$Vega$str('Estimated pi value')),
						$author$project$Vega$axLabelOverlap($author$project$Vega$osParity),
						$author$project$Vega$axZIndex(
						$author$project$Vega$num(1))
					]))),
		A3(
			...
			_List_fromArray(
				[
					$author$project$Vega$axGrid($author$project$Vega$true),
					$author$project$Vega$axGridScale('data_point_scale'),
					$author$project$Vega$axDomain($author$project$Vega$false),
					$author$project$Vega$axLabels($author$project$Vega$false),
					$author$project$Vega$axMaxExtent(
					$author$project$Vega$vNum(0)),
	...
	var ax1 = A2(
			...
			A2(
				...
				A3(
					...
					_List_fromArray(
						[
							$author$project$Vega$axGrid($author$project$Vega$true),
							$author$project$Vega$axGridScale('yScale'),
							$author$project$Vega$axDomain($author$project$Vega$false),
							$author$project$Vega$axLabels($author$project$Vega$false),
							$author$project$Vega$axMaxExtent(
							$author$project$Vega$vNum(0)),
		...
		A3(
			...
			_List_fromArray(
				[
					$author$project$Vega$axGrid($author$project$Vega$true),
					$author$project$Vega$axGridScale('xScale'),
					$author$project$Vega$axDomain($author$project$Vega$false),
					$author$project$Vega$axLabels($author$project$Vega$false),
					$author$project$Vega$axMaxExtent(
					$author$project$Vega$vNum(0)),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						['cell'])),
					$author$project$Vega$mName('concat_1_group'),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
							$author$project$Vega$enUpdate(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$GalleryInteraction$sourceExample))
					]))
			]));
};
var $author$project$GalleryInteraction$main = $elm$browser$Browser$element(
	{
		...
		aL: $author$project$GalleryInteraction$view
	});
