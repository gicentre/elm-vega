...
var $author$project$GalleryOther$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$GalleryOther$dPath = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.9/data/';
...
var $author$project$Vega$MCustom = F2(
	function (a, b) {
		return {$: 68, a: a, b: b};
	});
var $author$project$Vega$maCustom = $author$project$Vega$MCustom;
...
var $author$project$GalleryOther$beeswarm1 = function () {
	var si = A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$doData(
							_List_fromArray(
								[
									$author$project$Vega$daDataset('people'),
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Vega$str('people'))
						])),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('pow(2 * radius, 2)')
										])),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vStr('purple')
										])),
									$author$project$Vega$maStrokeWidth(
									_List_fromArray(
										[
								...
								[
									...
									_List_fromArray(
										[
											...
											$author$project$Vega$numSignal('radius'),
											_List_fromArray(
												[
													$author$project$Vega$fpIterations(
													$author$project$Vega$numSignal('collide'))
												])),
											A2(
	...
	return $author$project$Vega$toVega(
		_List_fromArray(
			[
				...
				A4($author$project$Vega$paddings, 5, 0, 5, 20),
...
var $author$project$Vega$AxFormatAsTemporal = {$: 14};
var $author$project$Vega$axFormatAsTemporal = $author$project$Vega$AxFormatAsTemporal;
var $author$project$Vega$AxLabelAlign = function (a) {
	return {$: 25, a: a};
};
var $author$project$Vega$axLabelAlign = $author$project$Vega$AxLabelAlign;
...
var $author$project$Vega$AxTitleFontSize = function (a) {
	return {$: 69, a: a};
};
var $author$project$Vega$axTitleFontSize = $author$project$Vega$AxTitleFontSize;
...
var $author$project$Vega$Day = {$: 5};
var $author$project$Vega$day = $author$project$Vega$Day;
...
var $author$project$Vega$AlignRight = {$: 2};
var $author$project$Vega$haRight = $author$project$Vega$AlignRight;
...
var $author$project$Vega$Top = {$: 2};
var $author$project$Vega$loTop = $author$project$Vega$Top;
...
var $author$project$Vega$rect = 6;
var $author$project$Vega$SClamp = function (a) {
	return {$: 10, a: a};
};
var $author$project$Vega$scClamp = $author$project$Vega$SClamp;
...
var $author$project$Vega$TSequenceAs = F4(
	function (a, b, c, d) {
		return {$: 49, a: a, b: b, c: c, d: d};
	});
var $author$project$Vega$trSequenceAs = $author$project$Vega$TSequenceAs;
...
var $author$project$Vega$wnOperationOn = $author$project$Vega$WnOperation;
var $author$project$Vega$WnSort = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$wnSort = $author$project$Vega$WnSort;
var $author$project$Vega$Lag = {$: 6};
var $author$project$Vega$woLag = $author$project$Vega$Lag;
var $author$project$Vega$Year = {$: 0};
var $author$project$Vega$year = $author$project$Vega$Year;
var $author$project$GalleryOther$calendar1 = function () {
	var si = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$siUpdate('step*52 + offset*11')
						]))),
			A2(
				$author$project$Vega$signal,
				'height',
				_List_fromArray(
					[
						$author$project$Vega$siUpdate('step*5')
					]))),
		A2(
			$author$project$Vega$signal,
			'scheme',
			_List_fromArray(
				[
					$author$project$Vega$siValue(
					$author$project$Vega$vStr('pinkyellowgreen')),
					$author$project$Vega$siBind(
					$author$project$Vega$iSelect(
						_List_fromArray(
							[
								...
								$author$project$Vega$vStrs(
									_List_fromArray(
										['pinkyellowgreen', 'blueorange', 'brownbluegreen', 'purplegreen', 'purpleorange', 'redblue', 'redgrey', 'redyellowblue', 'redyellowgreen', 'spectral'])))
							])))
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$raStep(
							$author$project$Vega$vSignal('step'))),
						$author$project$Vega$scDomain(
						$author$project$Vega$doData(
							_List_fromArray(
								[
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$scClamp($author$project$Vega$true),
					$author$project$Vega$scRange(
					A2(
						$author$project$Vega$raScheme,
						$author$project$Vega$strSignal('scheme'),
						_List_Nil)),
					$author$project$Vega$scDomain(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('weeks'),
								$author$project$Vega$daField(
								$author$project$Vega$field('w0')),
								$author$project$Vega$daSort(_List_Nil)
							])))
				])));
	var nestedMk = A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('values'))
						])),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											$author$project$Vega$vSignal('month(datum.date) * offset'))
										])),
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('timeFormat(datum.date, \'%a %b %d, %Y\') + \'\\n\' + format(datum.value, \'+.2%\')')
										]))
								])),
							$author$project$Vega$enUpdate(
							_List_fromArray(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Vega$daSource('values')
						]))),
				A2(
				$author$project$Vega$transform,
				_List_fromArray(
					[
						A4(
						$author$project$Vega$trSequenceAs,
						$author$project$Vega$num(0),
						$author$project$Vega$num(53),
						$author$project$Vega$num(1),
						'weeknum'),
						A2($author$project$Vega$trFormula, 'datetime(parent.year, 0, 1 + datum.weeknum * 7)', 'date'),
						A2(
						...
						_List_fromArray(
							[
								...
								A2($author$project$Vega$tbAs, 'w0', 'w1')
							])),
						A2($author$project$Vega$trFormula, 'timeOffset(\'day\', datum.w0)', 'w0'),
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.date < data(\'max\')[0].max_date'))
					]),
				A2($author$project$Vega$data, 'weeks', _List_Nil))
			]));
	var nestedAx = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A3(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$num(8)),
						$author$project$Vega$axFormatAsTemporal,
						$author$project$Vega$axFormat(
						$author$project$Vega$str('%a')),
						$author$project$Vega$axTitle(
						$author$project$Vega$strSignal('parent.year')),
						$author$project$Vega$axTitleAngle(
						$author$project$Vega$num(0)),
						$author$project$Vega$axTitleAlign($author$project$Vega$haRight),
						$author$project$Vega$axTitleX(
						$author$project$Vega$num(-8)),
						$author$project$Vega$axTitleY(
						$author$project$Vega$num(-2)),
						$author$project$Vega$axTitleFontSize(
		...
		A3(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$axLabelAlign($author$project$Vega$haLeft),
										...
										[
											...
											_List_fromArray(
												[
													...
													$author$project$Vega$num(0)),
													$author$project$Vega$vOffset(
													$author$project$Vega$vSignal('month(datum.value) * offset'))
												])),
											$author$project$Vega$maOpacity(
											_List_fromArray(
												[
													$author$project$Vega$vSignal('date(datum.value) < 8 ? 1 : 0')
												]))
										]))
								]))
						]))
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							$author$project$Vega$field('datum.year'),
		...
		$author$project$Vega$legend(
			_List_fromArray(
				[
					...
					$author$project$Vega$str('Daily Change, S&P 500')),
					...
					$author$project$Vega$num(15)),
					$author$project$Vega$leOrient($author$project$Vega$loTop),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A4(
								$author$project$Vega$wnOperationOn,
								$author$project$Vega$woLag,
								$elm$core$Maybe$Nothing,
								$elm$core$Maybe$Just(
									$author$project$Vega$field('close')),
								'prev')
							]),
						_List_fromArray(
							[
						...
						A2($author$project$Vega$trFormula, 'datum.prev ? (datum.close - datum.prev) / datum.prev : 0', 'value'),
						A2($author$project$Vega$trFormula, 'year(datum.date)', 'year'),
						A2(
						$author$project$Vega$trTimeUnit,
						$author$project$Vega$field('date'),
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Vega$tbUnits(
								_List_fromArray(
									[$author$project$Vega$day])),
								A2($author$project$Vega$tbAs, 'd0', 'd1')
							]))
					]),
				A2(
					$author$project$Vega$data,
					...
					_List_fromArray(
						[
							$author$project$Vega$daUrl(
							$author$project$Vega$str('https://raw.githubusercontent.com/vega/vega/master/docs/data/sp500-2000.csv')),
							$author$project$Vega$daFormat(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											_Utils_Tuple2('close', $author$project$Vega$foNum),
											_Utils_Tuple2(
											'date',
...
var $author$project$GalleryOther$heatmap1 = function () {
	var ti = A2(
		$author$project$Vega$title,
		$author$project$Vega$str('Seattle Annual Temperatures'),
		_List_fromArray(
			[
				$author$project$Vega$tiAnchor($author$project$Vega$anMiddle),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$author$project$Vega$raScheme,
						$author$project$Vega$strSignal('palette'),
						_List_Nil)),
					$author$project$Vega$scDomain(
					$author$project$Vega$doData(
						_List_fromArray(
							[
								$author$project$Vega$daDataset('temperature'),
								$author$project$Vega$daField(
								$author$project$Vega$field('celsius'))
							]))),
					$author$project$Vega$scReverse(
					$author$project$Vega$booSignal('reverse')),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vSignal('timeFormat(datum.date, \'%b %d %I:00 %p\') + \': \' + datum.celsius + \'°\'')
										]))
								])),
							$author$project$Vega$enUpdate(
							_List_fromArray(
		...
		$author$project$Vega$legend(
			_List_fromArray(
				[
					...
					$author$project$Vega$leType($author$project$Vega$ltGradient),
					$author$project$Vega$leTitle(
					$author$project$Vega$str('Avg. Temp (°C)')),
					$author$project$Vega$leTitleFontSize(
					$author$project$Vega$num(12)),
					$author$project$Vega$leTitlePadding(
					$author$project$Vega$num(4)),
					$author$project$Vega$leGradientLength(
					$author$project$Vega$numSignal('height - 16'))
				])));
	var ds = $author$project$Vega$dataSource(
		_List_fromArray(
			[
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$Vega$siValue(
						$author$project$Vega$vStr('Viridis')),
						$author$project$Vega$siBind(
						$author$project$Vega$iSelect(
							_List_fromArray(
								[
									$author$project$Vega$inOptions(
									$author$project$Vega$vStrs(colors))
								])))
					]))),
		A2(
			$author$project$Vega$signal,
...
var $author$project$Vega$bcFlush = $author$project$Vega$Flush;
...
var $author$project$Vega$HmField = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$hmField = $author$project$Vega$HmField;
var $author$project$Vega$HmOpacity = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$hmOpacity = $author$project$Vega$HmOpacity;
var $author$project$Vega$HmResolve = function (a) {
	return {$: 3, a: a};
};
var $author$project$Vega$hmResolve = $author$project$Vega$HmResolve;
var $author$project$Vega$Image = 2;
var $author$project$Vega$image = 2;
var $author$project$Vega$Kd2Bandwidth = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Vega$kd2Bandwidth = $author$project$Vega$Kd2Bandwidth;
var $author$project$Vega$Kd2CellSize = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$kd2CellSize = $author$project$Vega$Kd2CellSize;
var $author$project$Vega$Kd2Counts = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$kd2Counts = $author$project$Vega$Kd2Counts;
var $author$project$Vega$Kd2GroupBy = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$kd2GroupBy = $author$project$Vega$Kd2GroupBy;
...
var $author$project$Vega$MImage = function (a) {
	return {$: 46, a: a};
};
var $author$project$Vega$maImage = $author$project$Vega$MImage;
var $author$project$Vega$MSmooth = function (a) {
	return {$: 47, a: a};
};
var $author$project$Vega$maSmooth = $author$project$Vega$MSmooth;
var $author$project$Vega$ResolveSignal = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$resolveSignal = $author$project$Vega$ResolveSignal;
...
var $author$project$Vega$TKde2 = F5(
	function (a, b, c, d, e) {
...
var $author$project$GalleryOther$heatmap2 = function () {
	var si = A2(
					...
					A2(
								...
								A2(
									...
									A2(
										...
										_List_fromArray(
											[
												$author$project$Vega$siValue(
												$author$project$Vega$vStr('Acceleration')),
												$author$project$Vega$siBind(
												$author$project$Vega$iSelect(
													_List_fromArray(
														[
						...
						A2(
							...
							_List_fromArray(
								[
									$author$project$Vega$siValue(
									$author$project$Vega$vStr('independent')),
									$author$project$Vega$siBind(
									$author$project$Vega$iSelect(
										_List_fromArray(
											[
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Vega$siValue(
					$author$project$Vega$vStr('Density')),
					$author$project$Vega$siUpdate('[if(resolve == \'shared\', \'Global\' + if(counts, \' Count\', \' Prob.\'), \'Local Density\'), \'(Normalized)\']')
				])));
	var sc = A2(
		$elm$core$Basics$composeL,
		A2(
							...
							$author$project$Vega$doData(
								_List_fromArray(
									[
										...
										$author$project$Vega$daField(
										$author$project$Vega$fSignal('fieldX'))
									]))),
							$author$project$Vega$scRange($author$project$Vega$raWidth),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$author$project$Vega$raScheme,
						$author$project$Vega$str('viridis'),
						_List_Nil)),
					$author$project$Vega$scZero($author$project$Vega$true)
				])));
	var nestedMk = A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Vega$maImage(
									_List_fromArray(
										[
											$author$project$Vega$vField(
											$author$project$Vega$field('image'))
										])),
									$author$project$Vega$maWidth(
									_List_fromArray(
										[
		...
		A3(
			...
			_List_fromArray(
				[
					...
					$author$project$Vega$num(1)),
					$author$project$Vega$axTitle(
					$author$project$Vega$strSignal('fieldX'))
				])));
	var mk = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$marks,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							$author$project$Vega$field('datum.Origin'),
							$author$project$Vega$ascend)
						])),
					$author$project$Vega$mGroup(
					_List_fromArray(
						[
							A2(
							$author$project$Vega$title,
							$author$project$Vega$strSignal('parent.Origin'),
							_List_fromArray(
								[
									$author$project$Vega$tiFrame($author$project$Vega$tfGroup)
								])),
	...
	var lo = $author$project$Vega$layout(
		_List_fromArray(
			[
				$author$project$Vega$loBounds($author$project$Vega$bcFlush),
				$author$project$Vega$loColumns(
	...
	var le = A2(
		...
		$author$project$Vega$legend(
			_List_fromArray(
				[
					$author$project$Vega$leFill('density'),
					$author$project$Vega$leTitle(
					$author$project$Vega$strSignal('title')),
					$author$project$Vega$leGradientLength(
					$author$project$Vega$numSignal('height - 28'))
				])));
	var ds = $author$project$Vega$dataSource(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum[fieldX] != null && datum.Miles_per_Gallon != null'))
					]),
				A2(
					$author$project$Vega$data,
					'source',
				...
				_List_fromArray(
					[
						A5(
						$author$project$Vega$trKde2d,
						$author$project$Vega$numSignal('width'),
						$author$project$Vega$numSignal('height'),
						$author$project$Vega$fExpr('scale(\'xScale\', datum[fieldX])'),
						$author$project$Vega$fExpr('scale(\'yScale\', datum.Miles_per_Gallon)'),
						_List_fromArray(
							[
								A2(
								$author$project$Vega$kd2Bandwidth,
								$author$project$Vega$numSignal('bandWidthX'),
								$author$project$Vega$numSignal('bandWidthY')),
								$author$project$Vega$kd2CellSize(
								$author$project$Vega$numSignal('cellSize')),
								$author$project$Vega$kd2Counts(
								$author$project$Vega$booSignal('counts')),
								$author$project$Vega$kd2GroupBy(
								_List_fromArray(
									[
										$author$project$Vega$field('Origin')
									]))
						...
						_List_fromArray(
							[
								$author$project$Vega$hmField(
								$author$project$Vega$field('grid')),
								$author$project$Vega$hmResolve(
								$author$project$Vega$resolveSignal('resolve')),
								$author$project$Vega$hmColor(
								$author$project$Vega$strExpr(
									$author$project$Vega$expr('scale(\'density\', datum.$value / datum.$max)'))),
...
var $author$project$Vega$AlignTop = {$: 0};
var $author$project$Vega$vaTop = $author$project$Vega$AlignTop;
var $author$project$GalleryOther$parallel1 = function () {
	var nestedMk = A2(
		$elm$core$Basics$composeL,
		$author$project$Vega$marks,
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Vega$srData(
							$author$project$Vega$str('fields'))
						])),
					$author$project$Vega$mEncode(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('ord'),
											$author$project$Vega$vField(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Vega$trFilter(
						$author$project$Vega$expr('datum.Horsepower && datum.Miles_per_Gallon')),
						A2($author$project$Vega$trFormulaInitOnly, 'isNumber(datum.year) ? datum.year : year(datum.Year)', 'Year')
					]),
				A2(
					$author$project$Vega$data,
					'cars',
								...
								[
									...
									_List_fromArray(
										[
											_Utils_Tuple2(
											'Year',
											$author$project$Vega$foDate('%Y-%m-%d'))
										]))
								]))
						]))),
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$vStrs(
							_List_fromArray(
								['Cylinders', 'Displacement', 'Weight_in_lbs', 'Horsepower', 'Acceleration', 'Miles_per_Gallon', 'Year'])))
					]))
			]));
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								...
								$author$project$Vega$daField(
								$author$project$Vega$field(fName))
							]))),
					$author$project$Vega$scZero($author$project$Vega$false),
					$author$project$Vega$scNice($author$project$Vega$niTrue)
				]));
	...
	var dimensionAxis = function (sName) {
		return A3(
			...
			_List_fromArray(
				[
					$author$project$Vega$axTitle(
					$author$project$Vega$str(sName)),
					$author$project$Vega$axOffset(
					$author$project$Vega$vObject(
						_List_fromArray(
							[
								$author$project$Vega$vStr(sName),
								$author$project$Vega$vScale('ord'),
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Vega$num(-2)),
						$author$project$Vega$axTitleY(
						$author$project$Vega$num(410)),
						$author$project$Vega$axTitleAngle(
						$author$project$Vega$num(0)),
						$author$project$Vega$axTitleAlign($author$project$Vega$haRight),
						$author$project$Vega$axTitleBaseline($author$project$Vega$vaTop)
					]))
			]));
	var ax = A2(
		$elm$core$Basics$composeL,
...
var $author$project$GalleryOther$timeline1 = function () {
					...
					$author$project$Vega$doData(
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Vega$field('born'),
										$author$project$Vega$field('died')
									]))
							]))),
					$author$project$Vega$scRound($author$project$Vega$true)
				])));
		...
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$Basics$composeL,
						A2($author$project$Vega$dataFromColumns, 'people', _List_Nil),
						A2(
							$author$project$Vega$dataColumn,
							'label',
							$author$project$Vega$vStrs(
					...
					A2(
						...
						$author$project$Vega$vNums(
							_List_fromArray(
								[-7506057600000, -7389766800000, -7154586000000, -6904544400000, -6679904400000])))),
				A2(
					$author$project$Vega$dataColumn,
					'died',
					$author$project$Vega$vNums(
						_List_fromArray(
							[-5366196000000, -4528285200000, -4528285200000, -4213184400000, -4370518800000])))),
			A2(
				$author$project$Vega$dataColumn,
				'enter',
				$author$project$Vega$vNums(
					_List_fromArray(
						[-5701424400000, -5453884800000, -5327740800000, -5075280000000, -4822819200000])))),
		A2(
			$author$project$Vega$dataColumn,
			'leave',
			$author$project$Vega$vNums(
				_List_fromArray(
					[-5453884800000, -5327740800000, -5075280000000, -4822819200000, -4570358400000]))));
	var mk = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$srData(
											$author$project$Vega$str('events'))
										])),
									$author$project$Vega$mEncode(
									_List_fromArray(
										[
												...
												[
													...
													_List_fromArray(
														[
															$author$project$Vega$vScale('xScale'),
															$author$project$Vega$vField(
															$author$project$Vega$field('when'))
														])),
													$author$project$Vega$maY(
													_List_fromArray(
														[
								...
								[
									...
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScale'),
											$author$project$Vega$vField(
											$author$project$Vega$field('enter'))
										])),
									$author$project$Vega$maX2(
									_List_fromArray(
										[
											$author$project$Vega$vScale('xScale'),
											$author$project$Vega$vField(
											$author$project$Vega$field('leave'))
										])),
									$author$project$Vega$maY(
									_List_fromArray(
										[
	...
	var events = A2(
		...
		A2(
			$elm$core$Basics$composeL,
			A2(
				$author$project$Vega$dataFromColumns,
				'events',
				_List_fromArray(
					[
						$author$project$Vega$json,
			...
			A2(
				...
				$author$project$Vega$vStrs(
					_List_fromArray(
						['Decl. of Independence', 'U.S. Constitution', 'Louisiana Purchase', 'Monroe Doctrine'])))),
		A2(
			$author$project$Vega$dataColumn,
			'when',
			$author$project$Vega$vStrs(
				_List_fromArray(
					['July 4, 1776', '3/4/1789', 'April 30, 1803', 'Dec 2, 1823']))));
	var ds = $author$project$Vega$dataSource(
		_List_fromArray(
			[
				people(_List_Nil),
...
var $author$project$Vega$CPCase = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vega$cpCase = $author$project$Vega$CPCase;
var $author$project$Vega$CPPattern = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$cpPattern = $author$project$Vega$CPPattern;
var $author$project$Vega$CPStopwords = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$cpStopwords = $author$project$Vega$CPStopwords;
var $author$project$Vega$ExField = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Vega$maDir = $author$project$Vega$MDir;
...
var $author$project$Vega$LeftToRight = {$: 0};
var $author$project$Vega$tdLeftToRight = $author$project$Vega$LeftToRight;
var $author$project$Vega$textDirectionValue = function (dir) {
	switch (dir.$) {
		case 0:
			return $author$project$Vega$vStr('ltr');
		case 1:
			return $author$project$Vega$vStr('rtl');
		default:
			var sig = dir.a;
			return $author$project$Vega$vSignal(sig);
	}
};
var $author$project$Vega$TCountPattern = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $author$project$Vega$trCountPattern = $author$project$Vega$TCountPattern;
var $author$project$Vega$TWordcloud = function (a) {
	return {$: 58, a: a};
};
var $author$project$Vega$trWordcloud = $author$project$Vega$TWordcloud;
var $author$project$Vega$Uppercase = 1;
var $author$project$Vega$uppercase = 1;
var $author$project$Vega$vAlphabetic = $author$project$Vega$vStr('alphabetic');
var $author$project$Vega$WcFont = function (a) {
	return {$: 0, a: a};
};
var $author$project$Vega$wcFont = $author$project$Vega$WcFont;
var $author$project$Vega$WcFontSize = function (a) {
	return {$: 3, a: a};
};
var $author$project$Vega$wcFontSize = $author$project$Vega$WcFontSize;
var $author$project$Vega$WcFontSizeRange = function (a) {
	return {$: 4, a: a};
};
var $author$project$Vega$wcFontSizeRange = $author$project$Vega$WcFontSizeRange;
var $author$project$Vega$WcFontWeight = function (a) {
	return {$: 2, a: a};
};
var $author$project$Vega$wcFontWeight = $author$project$Vega$WcFontWeight;
var $author$project$Vega$WcPadding = function (a) {
	return {$: 5, a: a};
};
var $author$project$Vega$wcPadding = $author$project$Vega$WcPadding;
var $author$project$Vega$WcRotate = function (a) {
	return {$: 6, a: a};
};
var $author$project$Vega$wcRotate = $author$project$Vega$WcRotate;
var $author$project$Vega$WcSize = function (a) {
	return {$: 8, a: a};
};
var $author$project$Vega$wcSize = $author$project$Vega$WcSize;
var $author$project$Vega$WcText = function (a) {
	return {$: 7, a: a};
};
var $author$project$Vega$wcText = $author$project$Vega$WcText;
var $author$project$GalleryOther$wordcloud1 = function () {
		...
		A2(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[$author$project$Vega$hCenter])),
									$author$project$Vega$maDir(
									_List_fromArray(
										[
											$author$project$Vega$textDirectionValue($author$project$Vega$tdLeftToRight)
										])),
									$author$project$Vega$maBaseline(
									_List_fromArray(
										[$author$project$Vega$vAlphabetic])),
									$author$project$Vega$maFill(
									_List_fromArray(
										[
											$author$project$Vega$vScale('cScale'),
					...
					_List_fromArray(
						[
							$author$project$Vega$trWordcloud(
							_List_fromArray(
								[
									$author$project$Vega$wcSize(
									$author$project$Vega$nums(
										_List_fromArray(
											[800, 400]))),
									$author$project$Vega$wcText(
									$author$project$Vega$field('text')),
									$author$project$Vega$wcRotate(
									$author$project$Vega$numExpr(
										$author$project$Vega$exField('datum.angle'))),
									$author$project$Vega$wcFont(
									$author$project$Vega$str('Helvetica Neue, Arial')),
									$author$project$Vega$wcFontSize(
									$author$project$Vega$numExpr(
										$author$project$Vega$exField('datum.count'))),
									$author$project$Vega$wcFontWeight(
									$author$project$Vega$strExpr(
										$author$project$Vega$exField('datum.weight'))),
									$author$project$Vega$wcFontSizeRange(
									$author$project$Vega$nums(
										_List_fromArray(
											[12, 56]))),
									$author$project$Vega$wcPadding(
									$author$project$Vega$num(2))
								]))
						]))
				])));
	var inText = _List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(
						$author$project$Vega$trCountPattern,
						$author$project$Vega$field('data'),
						_List_fromArray(
							[
								$author$project$Vega$cpCase($author$project$Vega$uppercase),
								$author$project$Vega$cpPattern(
								$author$project$Vega$str('[\\w\']{3,}')),
								$author$project$Vega$cpStopwords(
								$author$project$Vega$str(stopwords))
							])),
						A2($author$project$Vega$trFormulaInitOnly, '[-45, 0, 45][~~(random() * 3)]', 'angle'),
						A2($author$project$Vega$trFormulaInitOnly, 'if(datum.text==\'VEGA\', 600, 300)', 'weight')
					]),
				A2(
					$author$project$Vega$data,
					'table',
					_List_fromArray(
						[
							$author$project$Vega$daValue(
							$author$project$Vega$vStrs(inText))
						])))
			]));
	return $author$project$Vega$toVega(
		_List_fromArray(
...
var $author$project$GalleryOther$mySpecs = $author$project$Vega$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('heatmap1', $author$project$GalleryOther$heatmap1),
			_Utils_Tuple2('heatmap2', $author$project$GalleryOther$heatmap2),
			_Utils_Tuple2('parallel1', $author$project$GalleryOther$parallel1),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$GalleryOther$sourceExample))
					]))
			]));
};
var $author$project$GalleryOther$main = $elm$browser$Browser$element(
	{
		aA: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$GalleryOther$mySpecs,
				$author$project$GalleryOther$elmToJS($author$project$GalleryOther$mySpecs))),
		aI: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		aK: F2(
			function (_v0, model) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}),
		aL: $author$project$GalleryOther$view
	});
_Platform_export({'GalleryOther':{'init':$author$project$GalleryOther$main(
