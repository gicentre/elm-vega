...
var _gicentre$eve$Isotype$toRows = F2(
	function (country, animalFreqs) {
		var toRow = F2(
			function (animal, n) {
				return _gicentre$eve$Eve$dataRow(
					{
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'country',
							_1: _gicentre$eve$Eve$Str(country)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'animal',
								_1: _gicentre$eve$Eve$Str(animal)
							},
							_1: {
								ctor: '::',
								_0: {
...
var _gicentre$eve$Isotype$isotypes = function () {
	var person = 'M0 -1h-0.8c0.3 -0.2 0.6 -0.5 0.6 -0.9c0 -0.6 -0.4 -1 -1 -1c-0.6 0 -1 0.4 -1 1c0 0.4 0.2 0.7 0.6 0.9h-0.8c-0.4 0 -0.7 0.3 -0.7 0.6v1.9c0 0.3 0.3 0.6 0.6 0.6h0.2c0 0 0 0.1 0 0.1v1.9c0 0.3 0.2 0.6 0.3 0.6h1.3c0.2 0 0.3 -0.3 0.3 -0.6v-1.8c0 0 0 -0.1 0 -0.1h0.2c0.3 0 0.6 -0.3 0.6 -0.6v-2c0.2 -0.3 -0.1 -0.6 -0.4 -0.6z';
...
var _gicentre$eve$Isotype$personGrid = function () {
	var enc = function (_p2) {
		return _gicentre$eve$Eve$encoding(
			A3(
				...
				{
					ctor: '::',
					_0: _gicentre$eve$Eve$PName('col'),
					_1: {
						ctor: '::',
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$eve$Eve$PName('row'),
						_1: {
							ctor: '::',
							_0: _gicentre$eve$Eve$PmType(_gicentre$eve$Eve$Ordinal),
							_1: {
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$eve$Eve$MPath(
								A2(
									_elm_lang$core$Maybe$withDefault,
									'circle',
									A2(_elm_lang$core$Dict$get, 'person', _gicentre$eve$Isotype$isotypes))),
							_1: {ctor: '[]'}
						},
						A2(
							_gicentre$eve$Eve$color,
							{
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _gicentre$eve$Eve$MString('rgb(177,113,130)'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _gicentre$eve$Eve$MString('rgb(167,165,156)'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
	...
	var trans = function (_p4) {
		return _gicentre$eve$Eve$transform(
			A3(
				...
				'ceil (datum.id/10)',
				'col',
				A3(_gicentre$eve$Eve$calculate, 'datum.id - datum.col*10', 'row', _p4)));
	};
	...
	return _gicentre$eve$Eve$toVegaLite(
		{
			...
			_1: {
				ctor: '::',
				_0: _gicentre$eve$Eve$height(400),
				_1: {
					ctor: '::',
					_0: data(
						{ctor: '[]'}),
...
var _gicentre$eve$Isotype$livestock = function () {
		...
		return _gicentre$eve$Eve$encoding(
			A3(
				...
				A3(
					...
					{
						ctor: '::',
						_0: _gicentre$eve$Eve$PName('animal'),
						_1: {
							ctor: '::',
							_0: _gicentre$eve$Eve$PmType(_gicentre$eve$Eve$Ordinal),
							_1: {
					...
					A2(
						...
						{
							ctor: '::',
							_0: _gicentre$eve$Eve$FName('country'),
							_1: {
								ctor: '::',
						...
						A2(
							...
							{
								ctor: '::',
								_0: _gicentre$eve$Eve$MName('animal'),
								_1: {
									ctor: '::',
													...
													_1: {
														...
														_0: {
															...
															_1: A2(
																_elm_lang$core$Maybe$withDefault,
																'circle',
																A2(_elm_lang$core$Dict$get, 'cow', _gicentre$eve$Isotype$isotypes))
														},
														_1: {
															ctor: '::',
															_0: {
																...
																_1: A2(
																	_elm_lang$core$Maybe$withDefault,
																	'circle',
																	A2(_elm_lang$core$Dict$get, 'pig', _gicentre$eve$Isotype$isotypes))
															},
															_1: {
																ctor: '::',
																_0: {
																	...
																	_1: A2(
																		_elm_lang$core$Maybe$withDefault,
																		'circle',
																		A2(_elm_lang$core$Dict$get, 'sheep', _gicentre$eve$Isotype$isotypes))
																},
																_1: {ctor: '[]'}
															}
														}
	...
	var data = function (_p7) {
		return A2(
			_gicentre$eve$Eve$dataFromRows,
			{ctor: '[]'},
			A3(
	...
	return _gicentre$eve$Eve$toVegaLite(
		{
			ctor: '::',
			_0: _gicentre$eve$Eve$width(800),
			_1: {
				ctor: '::',
...
var _gicentre$eve$Isotype$specs = {
	ctor: '::',
	_0: _gicentre$eve$Isotype$livestock,
	_1: {ctor: '[]'}
};
var _gicentre$eve$Isotype$fromElm = _elm_lang$core$Native_Platform.outgoingPort(
	'fromElm',
	function (v) {
		return v;
	});
var _gicentre$eve$Isotype$init = function (specs) {
	return {
		ctor: '_Tuple2',
		_0: specs,
		_1: _gicentre$eve$Isotype$fromElm(
			_elm_lang$core$Json_Encode$list(specs))
	};
};
var _gicentre$eve$Isotype$main = _elm_lang$core$Platform$program(
	{
		init: _gicentre$eve$Isotype$init(_gicentre$eve$Isotype$specs),
		update: F2(
			function (_p8, model) {
...
var _gicentre$eve$Isotype$FromElm = {ctor: 'FromElm'};

var Elm = {};
Elm['Isotype'] = Elm['Isotype'] || {};
if (typeof _gicentre$eve$Isotype$main !== 'undefined') {
    _gicentre$eve$Isotype$main(Elm['Isotype'], 'Isotype', undefined);
}
