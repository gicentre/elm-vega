...
var _gicentre$elm_vega$HelloWorld$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _gicentre$elm_vega$HelloWorld$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _gicentre$elm_vega$HelloWorld$myVis,
			_1: _gicentre$elm_vega$HelloWorld$elmToJS(_gicentre$elm_vega$HelloWorld$myVis)
		},
		update: F2(
			function (_p0, model) {
...
if (typeof _gicentre$elm_vega$HelloWorld$main !== 'undefined') {
    _gicentre$elm_vega$HelloWorld$main(Elm['HelloWorld'], 'HelloWorld', undefined);
}
