...
var _gicentre$elm_vega$HelloWorld$init = function (spec) {
	return {
		ctor: '_Tuple2',
		_0: spec,
		_1: _gicentre$elm_vega$HelloWorld$fromElm(spec)
	};
};
...
var _gicentre$elm_vega$HelloWorld$FromElm = {ctor: 'FromElm'};
