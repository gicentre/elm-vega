						...
						A2(
							_gicentre$elm_vega$VegaLite$color,
							{
								...
								_0: A3(
									...
									_gicentre$elm_vega$VegaLite$selectionName('highlight'),
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$mStr('rgb(194,81,64)'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _gicentre$elm_vega$VegaLite$mStr('rgb(167,165,156)'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							A2(
								...
								{
									ctor: '::',
									_0: _gicentre$elm_vega$VegaLite$mNum(90),
									_1: {ctor: '[]'}
								},
								_p2))))));
	};
