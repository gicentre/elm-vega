						...
						A2(
							...
							function (_p42) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p43._0,
									_1: _gicentre$elm_vega$VegaLite$foDataType(_p43._1)
								};
							},
							_p41._0))
				},
	...
	switch (_p45.ctor) {
		...
		case 'MOrient':
			return {
				...
				_0: 'orient',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$markOrientLabel(_p45._0))
			};
		case 'MShape':
			return {
				ctor: '_Tuple2',
		...
		case 'MFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeight(_p45._0)
			};
		case 'MRadius':
			return {
				ctor: '_Tuple2',
	...
	switch (_p49.ctor) {
		...
		case 'DTMonth':
			return {
				...
				_0: 'month',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$monthLabel(_p49._0))
			};
		case 'DTDate':
			return {
				ctor: '_Tuple2',
	...
	switch (_p56.ctor) {
		...
		case 'SDomain':
			return {
				ctor: '_Tuple2',
				_0: 'domain',
				_1: _gicentre$elm_vega$VegaLite$scaleDomainProperty(_p56._0)
			};
		case 'SRange':
			var _p57 = _p56._0;
			switch (_p57.ctor) {
		...
		case 'SScheme':
			return A2(_gicentre$elm_vega$VegaLite$scheme, _p56._0, _p56._1);
		case 'SPadding':
			return {
				ctor: '_Tuple2',
				_0: 'padding',
		...
		case 'SInterpolate':
			return {
				ctor: '_Tuple2',
				_0: 'interpolate',
				_1: _gicentre$elm_vega$VegaLite$interpolateProperty(_p56._0)
			};
		case 'SNice':
			return {
				ctor: '_Tuple2',
				_0: 'nice',
				_1: _gicentre$elm_vega$VegaLite$nice(_p56._0)
			};
		case 'SZero':
			return {
				ctor: '_Tuple2',
	...
	switch (_p68.ctor) {
		...
		case 'Bind':
			return {
				...
				_0: 'bind',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$binding, _p68._0))
			};
		case 'Nearest':
			return {
				ctor: '_Tuple2',
	...
	switch (_p74.ctor) {
		...
		case 'TitleFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'titleFontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeight(_p74._0)
			};
		case 'TitleFontSize':
			return {
				ctor: '_Tuple2',
	...
	switch (_p77.ctor) {
		...
		case 'Op':
			return {
				...
				_0: 'op',
				_1: _elm_lang$core$Json_Encode$string(
					_gicentre$elm_vega$VegaLite$opLabel(_p77._0))
			};
		default:
			return {
				ctor: '_Tuple2',
	...
	switch (_p79.ctor) {
		...
		case 'TFontWeight':
			return {
				ctor: '_Tuple2',
				_0: 'fontWeight',
				_1: _gicentre$elm_vega$VegaLite$fontWeight(_p79._0)
			};
		case 'TLimit':
			return {
				ctor: '_Tuple2',
	...
	switch (_p80.ctor) {
		...
		case 'Axis':
			return {
				...
				_0: 'axis',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$axisConfig, _p80._0))
			};
		case 'AxisX':
			return {
				ctor: '_Tuple2',
		...
		case 'Legend':
			return {
				...
				_0: 'legend',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$legendProperty, _p80._0))
			};
		case 'MarkStyle':
			return {
				ctor: '_Tuple2',
		...
		case 'TitleStyle':
			return {
				...
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$titleConfig, _p80._0))
			};
		case 'NamedStyle':
			return {
				ctor: '_Tuple2',
		...
		case 'Scale':
			return {
				...
				_0: 'scale',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$scaleConfig, _p80._0))
			};
		case 'Stack':
		...
		case 'Range':
			return {
				...
				_0: 'range',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$rangeConfig, _p80._0))
			};
		case 'SelectionStyle':
		...
		default:
			return {
				...
				_0: 'view',
				_1: _elm_lang$core$Json_Encode$object(
					A2(_elm_lang$core$List$map, _gicentre$elm_vega$VegaLite$viewConfig, _p80._0))
			};
	}
};
			...
			A2(
				...
				function (_p92) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p93._0,
						_1: _gicentre$elm_vega$VegaLite$datavalue(_p93._1)
					};
				},
				row)));
};
		...
		case 'MAggregate':
			return {
				...
				_0: {
					...
					_0: 'aggregate',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$opLabel(_p98._0))
				},
				_1: {ctor: '[]'}
			};
		case 'MPath':
		...
		case 'TAggregate':
			return {
				...
				_0: {
					...
					_0: 'aggregate',
					_1: _elm_lang$core$Json_Encode$string(
						_gicentre$elm_vega$VegaLite$opLabel(_p107._0))
				},
				_1: {ctor: '[]'}
			};
		case 'TTimeUnit':
...
var _gicentre$elm_vega$VegaLite$Padding = F4(
	function (a, b, c, d) {
