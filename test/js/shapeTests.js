...
var _gicentre$elm_vega$ShapeTests$chart = F2(
	function (des, enc) {
		return _gicentre$elm_vega$Eve$toVegaLite(
			{
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$description(des),
				_1: {
					ctor: '::',
					_0: A2(
							...
							return _gicentre$elm_vega$Eve$transform(
								A3(
									...
									A2(
										...
										_gicentre$elm_vega$Eve$FExpr('datum.YearOfManufacture == 1970'),
										_p0)));
						}(
							{ctor: '[]'}),
						_1: {
	...
	function (_p3) {
		return A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Eve$MNumber(20),
					_1: {ctor: '[]'}
				},
				_p3));
	});
...
var _gicentre$elm_vega$ShapeTests$scatter12 = A2(
	...
	_gicentre$elm_vega$Eve$shape(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Eve$MPath(_gicentre$elm_vega$ShapeTests$unitSquare),
			_1: {ctor: '[]'}
		}));
...
var _gicentre$elm_vega$ShapeTests$scatter14 = A2(
	...
	function (_p11) {
		return A2(
			...
			{
				ctor: '::',
				_0: _gicentre$elm_vega$Eve$MPath(_gicentre$elm_vega$ShapeTests$largeSquare),
				_1: {ctor: '[]'}
			},
			A2(
				_gicentre$elm_vega$Eve$color,
