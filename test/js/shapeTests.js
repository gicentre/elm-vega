...
var _gicentre$elm_vega$ShapeTests$cross = 'M -1.5 -1.5 m1 0 h 1 v 1 h 1 v 1 h -1 v 1 h -1  v -1 h -1 v -1 h 1z';
var _gicentre$elm_vega$ShapeTests$tri = 'M -1.5 -1.5 h 3 l -1.5 3z';
var _gicentre$elm_vega$ShapeTests$square = 'M -1.5 -1.5 h 3 v 3 h -3z';
var _gicentre$elm_vega$ShapeTests$largeSquare = 'M -5 -5 h 10 v 10 h -10z';
var _gicentre$elm_vega$ShapeTests$unitSquare = 'M -0.5 -0.5 h 1 v 1 h -1z';
var _gicentre$elm_vega$ShapeTests$chart = F2(
	function (des, enc) {
		return _gicentre$elm_vega$Vega$toVegaLite(
			{
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$description(des),
				_1: {
					ctor: '::',
					_0: A2(
							...
							return _gicentre$elm_vega$Vega$transform(
								A3(
									...
									A2(
										...
										_gicentre$elm_vega$Vega$FExpr('datum.YearOfManufacture == 1970'),
										_p0)));
						}(
							{ctor: '[]'}),
						_1: {
...
var _gicentre$elm_vega$ShapeTests$scatter1 = A2(
...
var _gicentre$elm_vega$ShapeTests$scatter2 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
...
var _gicentre$elm_vega$ShapeTests$scatter3 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Enlarged shapes (but legend shapes should remain same size)',
	function (_p2) {
		return A2(
			_gicentre$elm_vega$Vega$shape,
			{
			...
			A2(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$MNumber(200),
					_1: {ctor: '[]'}
				},
				_p2));
	});
var _gicentre$elm_vega$ShapeTests$scatter4 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Reduced shapes (but legend shapes should remain same size)',
	function (_p3) {
		return A2(
			_gicentre$elm_vega$Vega$shape,
			{
			...
			A2(
				...
				{
					ctor: '::',
					_0: _gicentre$elm_vega$Vega$MNumber(20),
					_1: {ctor: '[]'}
				},
				_p3));
	});
var _gicentre$elm_vega$ShapeTests$scatter5 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Fixed shape, sized by number of cylinder category',
	_gicentre$elm_vega$Vega$size(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$MName('Cylinders'),
...
var _gicentre$elm_vega$ShapeTests$scatter6 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Sized by number of cylinders, shape by origin',
	function (_p4) {
		return A2(
			_gicentre$elm_vega$Vega$shape,
			{
...
var _gicentre$elm_vega$ShapeTests$scatter7 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
...
var _gicentre$elm_vega$ShapeTests$scatter8 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
...
var _gicentre$elm_vega$ShapeTests$scatter9 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Custom-shaped and coloured by origin (should only have a single set of legend items)',
	function (_p7) {
		return A2(
			_gicentre$elm_vega$Vega$shape,
			{
...
var _gicentre$elm_vega$ShapeTests$scatter10 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Custom-shaped and coloured by origin (should only have a single set of legend items)',
	function (_p8) {
		return A2(
					...
					_1: {
						...
						_0: _gicentre$elm_vega$Vega$MScale(
							_gicentre$elm_vega$Vega$categoricalDomainMap(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'Europe', _1: _gicentre$elm_vega$ShapeTests$square},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'Japan', _1: _gicentre$elm_vega$ShapeTests$cross},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'USA', _1: _gicentre$elm_vega$ShapeTests$tri},
											_1: {ctor: '[]'}
										}
									}
								})),
...
var _gicentre$elm_vega$ShapeTests$scatter11 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
...
var _gicentre$elm_vega$ShapeTests$scatter12 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Custom nominal shape with unit area.',
	_gicentre$elm_vega$Vega$shape(
		{
			ctor: '::',
			_0: _gicentre$elm_vega$Vega$MPath(_gicentre$elm_vega$ShapeTests$unitSquare),
			_1: {ctor: '[]'}
		}));
var _gicentre$elm_vega$ShapeTests$scatter13 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Custom nominal shape with unit area sized by Cylinders.',
	function (_p10) {
		return A2(
			_gicentre$elm_vega$Vega$shape,
			{
...
var _gicentre$elm_vega$ShapeTests$scatter14 = A2(
	_gicentre$elm_vega$ShapeTests$chart,
	'Custom nominal shape with area of 10x10 pixel units.',
	function (_p11) {
		return A2(
			_gicentre$elm_vega$Vega$shape,
			{
				ctor: '::',
				_0: _gicentre$elm_vega$Vega$MPath(_gicentre$elm_vega$ShapeTests$largeSquare),
				_1: {ctor: '[]'}
			},
			A2(
				_gicentre$elm_vega$Vega$color,
...
if (typeof _gicentre$elm_vega$ShapeTests$main !== 'undefined') {
    _gicentre$elm_vega$ShapeTests$main(Elm['ShapeTests'], 'ShapeTests', undefined);
}
