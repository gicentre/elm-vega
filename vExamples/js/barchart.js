...
var _user$project$Barchart$barchart = function () {
	var mk = function (_p0) {
										...
										_0: _user$project$Vega$maX(
											{
												...
												_1: {
													...
													_0: _user$project$Vega$vField(
														_user$project$Vega$field('category')),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
												...
												_0: _user$project$Vega$maY(
													{
														...
														_1: {
															ctor: '::',
															_0: _user$project$Vega$vField(
																_user$project$Vega$field('amount')),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
				...
				'xScale',
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$Vega$scPadding(
									_user$project$Vega$num(5.0e-2)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Barchart$mySpecs = _user$project$Vega$combineSpecs(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'barchart', _1: _user$project$Barchart$barchart},
		_1: {ctor: '[]'}
	});
var _user$project$Barchart$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _user$project$Barchart$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _user$project$Barchart$mySpecs,
